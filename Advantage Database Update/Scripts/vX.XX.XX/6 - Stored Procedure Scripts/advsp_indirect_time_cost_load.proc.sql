if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[advsp_indirect_time_cost_load]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[advsp_indirect_time_cost_load]
GO
