			...
			(SELECT 
				...
				(SELECT
					...
					GROUP BY
						...
						ARS.JOB_COMPONENT_NBR,
						ARS.FNC_CODE,
						ARS.FNC_TYPE) AS TTD ON TTD.JOB_NUMBER = BIA.JOB_NUMBER AND 
												TTD.JOB_COMPONENT_NBR = BIA.JOB_COMPONENT_NBR AND
												TTD.FNC_CODE = BIA.FNC_CODE INNER JOIN
			...
			(SELECT
				...
				(SELECT
					...
					GROUP BY
						...
						ARS.FNC_TYPE) AS TTD ON TTD.JOB_NUMBER = BIA.JOB_NUMBER AND 
												TTD.JOB_COMPONENT_NBR = BIA.JOB_COMPONENT_NBR AND
												TTD.FNC_CODE = BIA.FNC_CODE LEFT OUTER JOIN
				(SELECT	
						AR.AR_INV_NBR, 
						AR.AR_INV_SEQ,
						AR.AR_TYPE, 
