...
SELECT
        ...
        [JobProcessControlChangedByUser] = (SELECT PROCESS_USER FROM JOB_PROCESS_LOG JJ WHERE JC.JOB_NUMBER = JJ.JOB_NUMBER AND JC.JOB_COMPONENT_NBR = JJ.JOB_COMPONENT_NBR AND JPL_DATE.PROCESS_DATE = JJ.PROCESS_DATE)
	FROM
