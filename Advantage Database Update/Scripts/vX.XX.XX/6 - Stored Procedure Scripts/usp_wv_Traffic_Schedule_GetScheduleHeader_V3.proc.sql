/****** Object:  StoredProcedure [dbo].[usp_wv_Traffic_Schedule_GetScheduleHeader_V3]    Script Date: 1/26/2022 2:39:26 PM ******/
SET ANSI_NULLS ON
GO
...
/*
	...
	exec usp_wv_Traffic_Schedule_GetScheduleHeader_V3 0,0,'JH',@Skip = 0,@Take = 200,@TotalRows=@totalRows OUTPUT
	print @totalRows
*/
...
SELECT CTE.RowId,
	...
	INNER JOIN OFFICE WITH(NOLOCK) ON OFFICE.OFFICE_CODE = OfficeCode
