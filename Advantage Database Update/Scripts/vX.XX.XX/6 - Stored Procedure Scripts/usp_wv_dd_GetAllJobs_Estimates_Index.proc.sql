IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[usp_wv_dd_GetAllJobs_Estimates_Index]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
    DROP PROCEDURE [dbo].[usp_wv_dd_GetAllJobs_Estimates_Index]
GO
...
/*
	...
	print @index
*/
CREATE procedure [dbo].[usp_wv_dd_GetAllJobs_Estimates_Index](
			@UserID VarChar(100),
...
GRANT EXECUTE ON [usp_wv_dd_GetAllJobs_Estimates_Index] TO PUBLIC AS dbo
GO
