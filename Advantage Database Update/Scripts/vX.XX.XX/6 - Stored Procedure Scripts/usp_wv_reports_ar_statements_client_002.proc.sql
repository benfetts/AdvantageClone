IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[usp_wv_reports_ar_statements_client_002]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_wv_reports_ar_statements_client_002]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_reports_ar_statements_client_002] 
@ID VarChar(4000),
...
PrtFtrName int, LogoPath varchar(254), CurrentAR Money, OverThirtyAR Money, OverSixtyAR Money, TotalAR Money)
...
SELECT @ARCount = COUNT(*) FROM @AR_LINE_ITEM
--SELECT @ARCount
