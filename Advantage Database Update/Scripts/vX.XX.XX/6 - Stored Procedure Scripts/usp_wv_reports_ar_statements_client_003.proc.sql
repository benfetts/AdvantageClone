IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[usp_wv_reports_ar_statements_client_003]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_wv_reports_ar_statements_client_003]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_reports_ar_statements_client_003] 
@ID VarChar(4000),
...
--If REC_TYPE = P and MANUAL_INV = 0 or NULL then leave job description and reference
if @CR_REC_TYPE = 'P'
BEGIN	
