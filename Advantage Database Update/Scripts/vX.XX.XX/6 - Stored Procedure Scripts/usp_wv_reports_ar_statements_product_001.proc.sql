IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[usp_wv_reports_ar_statements_product_001]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_wv_reports_ar_statements_product_001]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_reports_ar_statements_product_001] 
@ID VarChar(4000),
...
--SELECT @pair_value1,@pair_value2,@pair_value3
