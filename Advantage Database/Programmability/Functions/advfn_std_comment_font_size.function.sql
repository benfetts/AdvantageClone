CREATE FUNCTION [dbo].[advfn_std_comment_font_size](
...
RETURNS smallint
AS
-- advfn_std_comment_font_size
-- returns a default font size (@font_size) based on a heirarchy of values
-- #00 11/13/12 - Initial release
-- #01 11/19/12 - revised for null division and product, with provision for null office at client level
-- #02 11/21/12 - added null office back in for all levels
BEGIN
