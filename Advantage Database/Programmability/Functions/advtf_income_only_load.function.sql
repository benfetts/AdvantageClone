CREATE FUNCTION [dbo].[advtf_income_only_load]	
	(
...
RETURNS
	@INCOME_ONLY_TABLE TABLE 
		(
			...
			[JobComponentDescription] VARCHAR(60) NOT NULL,
...
BEGIN
	...
	FROM
		...
		@MEDIA_ORDERS AS MO ON MO.OrderNumber = INCOME_ONLY.ORDER_NBR AND
