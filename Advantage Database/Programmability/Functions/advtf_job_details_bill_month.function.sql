...
CREATE FUNCTION [dbo].[advtf_job_details_bill_month]
(
	@JOB_NUMBER int, 
	@JOB_COMPONENT_NBR smallint
)
RETURNS @JOB_DETAILS TABLE 
(
	ID bigint IDENTITY(1,1) NOT NULL,
	JobNumber int NULL,
	JobComponentNumber smallint NULL,
	AccountsRecievablePostPeriodCode varchar(6) NULL,
	[Hours] decimal NULL,
...
BEGIN
	...
	SELECT
		...
		[AccountsRecievablePostPeriodCode] = ISNULL(JDI.[AccountsRecievablePostPeriodCode], ''),
	...
	GROUP BY
		ISNULL(JDI.[AccountsRecievablePostPeriodCode], ''),
		JDI.[JobNumber],
