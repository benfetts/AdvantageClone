...
BEGIN
	...
	FROM
		...
		FROM dbo.NIELSEN_TV_INTAB a
			...
			INNER JOIN dbo.MEDIA_SPOT_TV_RESEARCH_DAYTIME d ON MEDIA_SPOT_TV_RESEARCH_ID = @MEDIA_SPOT_TV_RESEARCH_ID
	...
	SELECT
			u.nielsen_demo_code, u.avg_intab, u.stream, u.nielsen_tv_book_id, u.media_spot_tv_research_daytime_id
	FROM @tt
	UNPIVOT
	(
		avg_intab
