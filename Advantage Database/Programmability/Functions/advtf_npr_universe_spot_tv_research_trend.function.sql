CREATE FUNCTION [dbo].[advtf_npr_universe_spot_tv_research_trend](
...
BEGIN
    ...
    GROUP BY d.MEDIA_SPOT_TV_PUERTO_RICO_RESEARCH_DAYTIME_ID, u.[DATE]

	INSERT INTO @RETURN_TABLE
	SELECT
		u.nielsen_demo_code, u.ue, [media_spot_tv_research_daytime_id], [trend_date]
	FROM @tt
	UNPIVOT
	(
		ue
