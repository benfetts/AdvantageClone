CREATE PROCEDURE [dbo].[advsp_ap_available_newspaper_orders] @vn_code varchar(6) = NULL, @office_code varchar(4) = NULL,
...
BEGIN
	...
	FROM
		...
		INNER JOIN [dbo].V_NEWS_DETAIL O ON A.ORDER_NBR = O.ORDER_NBR 
