CREATE PROC [dbo].[advsp_bcc_billing_worksheet_production_v2]
...
DECLARE @FUNCTIONRESULTS TABLE (
	...
	[GLLabor] varchar(51) NULL,
	[GLVendorCosts] varchar(51) NULL,
	[GLOther] varchar(40) NULL
)
...
END
	...
	SELECT
			...
			[GLLabor] = JLU3.UDV_CODE + ' ' + COALESCE(JLU3.UDV_DESC,''),
			[GLVendorCosts] = JLU4.UDV_CODE + ' ' + COALESCE(JLU4.UDV_DESC,''),
			[GLOther] = JLU5.UDV_DESC
	FROM	dbo.JOB_LOG JL
		...
		LEFT OUTER JOIN dbo.JOB_LOG_UDV5 JLU5 ON JL.UDV5_CODE = JLU5.UDV_CODE 
