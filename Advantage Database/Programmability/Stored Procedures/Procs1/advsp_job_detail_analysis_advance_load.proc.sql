if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[advsp_job_detail_analysis_advance_load]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[advsp_job_detail_analysis_advance_load]
GO

CREATE PROCEDURE [dbo].[advsp_job_detail_analysis_advance_load]
