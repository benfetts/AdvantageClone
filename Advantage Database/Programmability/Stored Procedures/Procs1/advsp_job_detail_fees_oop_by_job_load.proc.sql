if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[advsp_job_detail_fees_oop_by_job_load]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[advsp_job_detail_fees_oop_by_job_load]
GO

CREATE PROCEDURE [dbo].[advsp_job_detail_fees_oop_by_job_load](
	@DATE_TYPE AS int,
