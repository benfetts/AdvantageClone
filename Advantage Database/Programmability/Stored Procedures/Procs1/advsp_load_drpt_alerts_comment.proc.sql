CREATE PROCEDURE [dbo].[advsp_load_drpt_alerts_comment]

AS
BEGIN

	DELETE FROM [dbo].[DRPT_ALERTS_COMMENT]
	
	DBCC CHECKIDENT (DRPT_ALERTS_COMMENT, reseed, 0)
	
	INSERT INTO [dbo].[DRPT_ALERTS_COMMENT]
	SELECT 
		[AlertID] = A.ALERT_ID, 
