CREATE PROCEDURE [dbo].[advsp_load_drpt_job_details]

AS
BEGIN

	DELETE FROM [dbo].[DRPT_JOB_DETAILS]
	
	DBCC CHECKIDENT (DRPT_JOB_DETAILS, reseed, 0)
	
	INSERT INTO [dbo].[DRPT_JOB_DETAILS]
	SELECT 
