CREATE PROCEDURE [dbo].[advsp_load_drpt_job_summary]

AS
BEGIN

	DELETE FROM [dbo].[DRPT_JOB_SUMMARY]
	
	DBCC CHECKIDENT (DRPT_JOB_SUMMARY, reseed, 0)
	
	INSERT INTO [dbo].[DRPT_JOB_SUMMARY]
	SELECT 
