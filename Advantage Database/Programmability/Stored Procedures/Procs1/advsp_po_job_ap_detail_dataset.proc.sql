...
(
	...
	PO_APPROVED varchar(25) NULL,
	PO_APPROVED_BY varchar(100) NULL,
	PO_APPROVED_DATE smalldatetime NULL
	)
...
UPDATE A
SET A.PO_APPROVED = B.PO_APPROVAL_FLAG, A.PO_APPROVED_BY = B.PO_APPROVAL_USER, A.PO_APPROVED_DATE = B.PO_APPROVAL_DATE
FROM @poh A
    INNER JOIN PO_APPROVAL B ON
...
Begin
	SELECT 
		...
		CASE WHEN COALESCE(PO_APPROVED , 0) = 1 THEN 'Yes' ELSE 'No' END 'POApproved',
		PO_APPROVED_BY 'POApprovedBy',
