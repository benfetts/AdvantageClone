if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_cp_calendar_task_month_rpt2]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_cp_calendar_task_month_rpt2]
GO
...
********************************************************************************************/
CREATE PROCEDURE [dbo].[usp_cp_calendar_task_month_rpt2] 
@CDPID int,
@UserID VarChar(100),
@EmpCode Varchar(6),
