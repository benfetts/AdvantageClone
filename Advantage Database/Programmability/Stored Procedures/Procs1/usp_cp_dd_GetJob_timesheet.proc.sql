...
CREATE PROCEDURE [dbo].[usp_cp_dd_GetJob_timesheet]
@CDPID int,
...
If @Rescrictions > 0
	...
	WHERE     (JOB_COMPONENT.JOB_PROCESS_CONTRL NOT IN (2,3,5,6,9,10,12,13)) AND (CP_SEC_CLIENT.CDP_CONTACT_ID = @CDPID)
