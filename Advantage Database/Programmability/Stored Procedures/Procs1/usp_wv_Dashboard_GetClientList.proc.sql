if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_Dashboard_GetClientList]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_Dashboard_GetClientList]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_Dashboard_GetClientList]
(
	@EmpCode varchar(6),
...
Begin
	...
	Begin
		...
		SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 ...
						 DASH_DATA_PROJ_HDR.SC_DESCRIPTION, DASH_DATA_PROJ_HDR.DP_TM_CODE, DASH_DATA_PROJ_HDR.DP_TM_DESC, DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC, DASH_DATA_PROJ_HDR.JOB_COMP_DATE,
						 DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE, ISNULL(DASH_DATA_PROJ_DTL.HOURS_QTY,0) AS HOURS, ISNULL(DASH_DATA_PROJ_DTL.TOTAL_BILL,0) AS DOLLARS
					  FROM DASH_DATA_PROJ_HDR INNER JOIN DASH_DATA_PROJ_DTL ON DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR = DASH_DATA_PROJ_DTL.JOB_COMPONENT_NBR AND DASH_DATA_PROJ_HDR.JOB = DASH_DATA_PROJ_DTL.JOB_NUMBER'
				IF @Restrictions > 0
					Begin
		...
		SELECT @sql = @sql + ' WHERE (DASH_DATA_PROJ_HDR.JOB_COMP_DATE >= @StartDate) AND (DASH_DATA_PROJ_HDR.JOB_COMP_DATE <= @EndDate)'
				IF @Restrictions > 0
					...
					End
		SELECT @sql = @sql + ' GROUP BY DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE, DASH_DATA_PROJ_HDR.CL_NAME, 
                      DASH_DATA_PROJ_HDR.DIV_CODE, DASH_DATA_PROJ_HDR.DIV_NAME, DASH_DATA_PROJ_HDR.PRD_CODE, DASH_DATA_PROJ_HDR.PRD_DESCRIPTION, DASH_DATA_PROJ_HDR.SC_CODE, DASH_DATA_PROJ_HDR.SC_DESCRIPTION, 
                      DASH_DATA_PROJ_HDR.DP_TM_CODE, DASH_DATA_PROJ_HDR.DP_TM_DESC, DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC, DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE, 
                      DASH_DATA_PROJ_HDR.JOB_COMP_DATE'
	...
	Begin
		...
		SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 ...
						 DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE, ISNULL(DASH_DATA_PROJ_DTL.HOURS_QTY,0) AS HOURS, ISNULL(DASH_DATA_PROJ_DTL.TOTAL_BILL,0) AS DOLLARS
					  FROM DASH_DATA_PROJ_HDR INNER JOIN DASH_DATA_PROJ_DTL ON DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR = DASH_DATA_PROJ_DTL.JOB_COMPONENT_NBR AND DASH_DATA_PROJ_HDR.JOB = DASH_DATA_PROJ_DTL.JOB_NUMBER
					   INNER JOIN JOB_TRAFFIC ON DASH_DATA_PROJ_HDR.JOB = JOB_TRAFFIC.JOB_NUMBER AND 
	...
	Begin
		...
		Begin
			...
			SELECT @sql = @sql + ' GROUP BY DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE, DASH_DATA_PROJ_HDR.CL_NAME, 
                      ...
                      DASH_DATA_PROJ_HDR.DP_TM_CODE, DASH_DATA_PROJ_HDR.DP_TM_DESC, DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC, DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE, 
                      DASH_DATA_PROJ_HDR.JOB_COMP_DATE'
			SELECT @paramlist = '@StartDate Datetime, @EndDate Datetime, @Dept varchar(4000), @Office varchar(4000), @Month int, @Level varchar(10), @CancelledCode VARCHAR(100), @UserID varchar(100), @EMP_CODE AS VARCHAR(6), @Client varchar(4000), @AE varchar(4000), @SalesClass varchar(4000), @JobType varchar(4000)'
			print @sql
