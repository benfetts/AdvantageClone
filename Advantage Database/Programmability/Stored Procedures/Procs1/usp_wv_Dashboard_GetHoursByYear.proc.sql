if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_Dashboard_GetHoursByYear]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_Dashboard_GetHoursByYear]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_Dashboard_GetHoursByYear]
(
	@EmpCode varchar(6),
