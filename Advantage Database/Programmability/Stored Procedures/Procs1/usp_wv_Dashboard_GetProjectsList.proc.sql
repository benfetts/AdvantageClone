if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_Dashboard_GetProjectsList]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_Dashboard_GetProjectsList]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_Dashboard_GetProjectsList]
(
	@EmpCode varchar(6),
...
Begin
	...
	Begin
		--Get jobs created:
		SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 DASH_DATA_PROJ_HDR.CL_NAME, DASH_DATA_PROJ_HDR.DIV_CODE, DASH_DATA_PROJ_HDR.DIV_NAME, DASH_DATA_PROJ_HDR.PRD_CODE, DASH_DATA_PROJ_HDR.PRD_DESCRIPTION, DASH_DATA_PROJ_HDR.SC_CODE, 
						 DASH_DATA_PROJ_HDR.SC_DESCRIPTION, DASH_DATA_PROJ_HDR.JOB_COMP_COMMENTS, DASH_DATA_PROJ_HDR.CMP_IDENTIFIER, DASH_DATA_PROJ_HDR.CMP_NAME, DASH_DATA_PROJ_HDR.DP_TM_CODE,
						 DASH_DATA_PROJ_HDR.DP_TM_DESC, DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC, DASH_DATA_PROJ_HDR.JOB_COMP_DATE, DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE,
						 JOB_TRAFFIC.TRF_CODE, TRAFFIC.TRF_DESCRIPTION
					   FROM TRAFFIC INNER JOIN JOB_TRAFFIC ON dbo.TRAFFIC.TRF_CODE = JOB_TRAFFIC.TRF_CODE RIGHT OUTER JOIN DASH_DATA_PROJ_HDR ON JOB_TRAFFIC.JOB_COMPONENT_NBR = DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR AND JOB_TRAFFIC.JOB_NUMBER = DASH_DATA_PROJ_HDR.JOB'
				IF @Restrictions > 0
					Begin
	...
	Begin
		...
		SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 ...
						 DASH_DATA_PROJ_HDR.DP_TM_DESC, DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC, DASH_DATA_PROJ_HDR.JOB_COMP_DATE, DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE,
						 JOB_TRAFFIC.TRF_CODE, TRAFFIC.TRF_DESCRIPTION
					   FROM DASH_DATA_PROJ_HDR INNER JOIN 
						JOB_TRAFFIC ON DASH_DATA_PROJ_HDR.JOB = JOB_TRAFFIC.JOB_NUMBER AND 
						DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR = JOB_TRAFFIC.JOB_COMPONENT_NBR INNER JOIN TRAFFIC ON JOB_TRAFFIC.TRF_CODE = TRAFFIC.TRF_CODE'
				IF @Restrictions > 0
					Begin
						SELECT @sql = @sql + ' INNER JOIN SEC_CLIENT ON DASH_DATA_PROJ_HDR.CL_CODE = SEC_CLIENT.CL_CODE AND DASH_DATA_PROJ_HDR.DIV_CODE = SEC_CLIENT.DIV_CODE AND DASH_DATA_PROJ_HDR.PRD_CODE = SEC_CLIENT.PRD_CODE'
					End
	...
	Begin
		...
		Begin
			SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 ...
						 JOB_TRAFFIC.TRF_CODE, TRAFFIC.TRF_DESCRIPTION
					   FROM DASH_DATA_PROJ_HDR INNER JOIN
							JOB_TRAFFIC ON DASH_DATA_PROJ_HDR.JOB = JOB_TRAFFIC.JOB_NUMBER INNER JOIN TRAFFIC ON JOB_TRAFFIC.TRF_CODE = TRAFFIC.TRF_CODE'
					IF @Restrictions > 0
						Begin
							SELECT @sql = @sql + ' INNER JOIN SEC_CLIENT ON DASH_DATA_PROJ_HDR.CL_CODE = SEC_CLIENT.CL_CODE AND DASH_DATA_PROJ_HDR.DIV_CODE = SEC_CLIENT.DIV_CODE AND DASH_DATA_PROJ_HDR.PRD_CODE = SEC_CLIENT.PRD_CODE'
						End
...
Begin
	...
	Begin
		...
		SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 ...
						 DASH_DATA_PROJ_HDR.DP_TM_DESC, DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC, DASH_DATA_PROJ_HDR.JOB_COMP_DATE, DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE,
						 JOB_TRAFFIC.TRF_CODE, TRAFFIC.TRF_DESCRIPTION
					   FROM TRAFFIC INNER JOIN JOB_TRAFFIC ON dbo.TRAFFIC.TRF_CODE = JOB_TRAFFIC.TRF_CODE RIGHT OUTER JOIN DASH_DATA_PROJ_HDR ON JOB_TRAFFIC.JOB_COMPONENT_NBR = DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR
					    AND JOB_TRAFFIC.JOB_NUMBER = DASH_DATA_PROJ_HDR.JOB'
				IF @Restrictions > 0
					Begin
						SELECT @sql = @sql + ' INNER JOIN SEC_CLIENT ON DASH_DATA_PROJ_HDR.CL_CODE = SEC_CLIENT.CL_CODE AND DASH_DATA_PROJ_HDR.DIV_CODE = SEC_CLIENT.DIV_CODE AND DASH_DATA_PROJ_HDR.PRD_CODE = SEC_CLIENT.PRD_CODE'
					End
		...
		SELECT @paramlist = '@StartDate SmallDatetime, @EndDate SmallDatetime, @Dept varchar(4000), @Office varchar(4000), @Month int, @Level varchar(10), @UserID varchar(100), @EMP_CODE AS VARCHAR(6), @Client varchar(4000), @AE varchar(4000), @SalesClass varchar(4000), @JobType varchar(4000), @Division varchar(6)'
		print @sql
		EXEC sp_executesql @sql, @paramlist, @StartDate, @EndDate, @Dept, @Office, @Month, @Level, @UserID, @EMP_CODE, @Client, @AE, @SalesClass, @JobType, @Division
	End
	If @Project = 'Completed'
	Begin
		--Get jobs completed:
		...
		Begin
			...
			SELECT @sql = @sql + ' WHERE (JOB_TRAFFIC.TRF_CODE = @CancelledCode) AND (NOT (DASH_DATA_PROJ_HDR.COMPLETED_DATE IS NULL)) AND (DASH_DATA_PROJ_HDR.COMPLETED_DATE >= @StartDate) AND (DASH_DATA_PROJ_HDR.COMPLETED_DATE <= @EndDate)'
				...
				if @Division <> ''
					...
					End	
			--SELECT @sql = @sql + ' GROUP BY DASH_DATA_PROJ_HDR.CL_CODE, DASH_DATA_PROJ_HDR.DIV_CODE, DASH_DATA_PROJ_HDR.CL_NAME, DASH_DATA_PROJ_HDR.DIV_NAME'
			SELECT @paramlist = '@StartDate SmallDatetime, @EndDate SmallDatetime, @Dept varchar(4000), @Office varchar(4000), @Month int, @Level varchar(10), @CancelledCode VARCHAR(100), @UserID varchar(100), @EMP_CODE AS VARCHAR(6), @Client varchar(4000), @AE varchar(4000), @SalesClass varchar(4000), @JobType varchar(4000), @Division varchar(6)'
			print @sql
			EXEC sp_executesql @sql, @paramlist, @StartDate, @EndDate, @Dept, @Office, @Month, @Level, @CancelledCode, @UserID, @EMP_CODE, @Client, @AE, @SalesClass, @JobType, @Division
		End
		Else
		Begin
			SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
...
Begin
	...
	Begin
		...
		SELECT @paramlist = '@StartDate SmallDatetime, @EndDate SmallDatetime, @Dept varchar(4000), @Office varchar(4000), @Month int, @Level varchar(10), @UserID varchar(100), @EMP_CODE AS VARCHAR(6), @Client varchar(4000), @AE varchar(4000), @SalesClass varchar(4000), @JobType varchar(4000), @Division varchar(6), @Product varchar(6)'
		print @sql
		EXEC sp_executesql @sql, @paramlist, @StartDate, @EndDate, @Dept, @Office, @Month, @Level, @UserID, @EMP_CODE, @Client, @AE, @SalesClass, @JobType, @Division, @Product
	End
	If @Project = 'Completed'
	Begin
		--Get jobs completed:
		...
		Begin
			...
			SELECT @sql = @sql + ' WHERE (JOB_TRAFFIC.TRF_CODE = @CancelledCode) AND (NOT (DASH_DATA_PROJ_HDR.COMPLETED_DATE IS NULL)) AND (DASH_DATA_PROJ_HDR.COMPLETED_DATE >= @StartDate) AND (DASH_DATA_PROJ_HDR.COMPLETED_DATE <= @EndDate)'
				...
				if @Product <> ''
					...
					End
			--SELECT @sql = @sql + ' GROUP BY DASH_DATA_PROJ_HDR.CL_CODE, DASH_DATA_PROJ_HDR.DIV_CODE, DASH_DATA_PROJ_HDR.PRD_CODE, DASH_DATA_PROJ_HDR.CL_NAME, DASH_DATA_PROJ_HDR.DIV_NAME, DASH_DATA_PROJ_HDR.PRD_DESCRIPTION'
			SELECT @paramlist = '@StartDate SmallDatetime, @EndDate SmallDatetime, @Dept varchar(4000), @Office varchar(4000), @Month int, @Level varchar(10), @CancelledCode VARCHAR(100), @UserID varchar(100), @EMP_CODE AS VARCHAR(6), @Client varchar(4000), @AE varchar(4000), @SalesClass varchar(4000), @JobType varchar(4000), @Division varchar(6), @Product varchar(6)'
			print @sql
			EXEC sp_executesql @sql, @paramlist, @StartDate, @EndDate, @Dept, @Office, @Month, @Level, @CancelledCode, @UserID, @EMP_CODE, @Client, @AE, @SalesClass, @JobType, @Division, @Product
		End
		Else
		Begin
			SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
...
Begin
	...
	Begin
		...
		SELECT @sql = @sql + ' WHERE (DASH_DATA_PROJ_HDR.JOB_COMP_DATE >= @StartDate) AND (DASH_DATA_PROJ_HDR.JOB_COMP_DATE <= @EndDate)'
				IF @Dept = 'None'
					Begin
						SELECT @sql = @sql + ' AND DASH_DATA_PROJ_HDR.DP_TM_CODE IS NULL'
					End
				IF @Restrictions > 0
					Begin
						SELECT @sql = @sql + ' AND (UPPER(SEC_CLIENT.USER_ID) = UPPER(@UserID)) AND (SEC_CLIENT.TIME_ENTRY = 0 OR SEC_CLIENT.TIME_ENTRY IS NULL)'
...
Begin
	...
	Begin
		...
		SELECT @sql = 'SELECT DASH_DATA_PROJ_HDR.JOB, DASH_DATA_PROJ_HDR.JOB_DESC, DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR, DASH_DATA_PROJ_HDR.JOB_COMP_DESC, DASH_DATA_PROJ_HDR.CL_CODE,
						 DASH_DATA_PROJ_HDR.CL_NAME, DASH_DATA_PROJ_HDR.DIV_CODE, DASH_DATA_PROJ_HDR.DIV_NAME, DASH_DATA_PROJ_HDR.PRD_CODE, DASH_DATA_PROJ_HDR.PRD_DESCRIPTION, DASH_DATA_PROJ_HDR.SC_CODE, 
						 DASH_DATA_PROJ_HDR.SC_DESCRIPTION, DASH_DATA_PROJ_HDR.JOB_COMP_COMMENTS, DASH_DATA_PROJ_HDR.CMP_IDENTIFIER, DASH_DATA_PROJ_HDR.CMP_NAME, DASH_DATA_PROJ_HDR.DP_TM_CODE,
						 DASH_DATA_PROJ_HDR.DP_TM_DESC, ISNULL(DASH_DATA_PROJ_HDR.JOB_TYPE, '''') AS JOB_TYPE, ISNULL(DASH_DATA_PROJ_HDR.JT_DESC, '''') AS JT_DESC, DASH_DATA_PROJ_HDR.JOB_COMP_DATE, DASH_DATA_PROJ_HDR.JOB_FIRST_USE_DATE, DASH_DATA_PROJ_HDR.COMPLETED_DATE,
						 JOB_TRAFFIC.TRF_CODE, TRAFFIC.TRF_DESCRIPTION
					   FROM TRAFFIC INNER JOIN JOB_TRAFFIC ON dbo.TRAFFIC.TRF_CODE = JOB_TRAFFIC.TRF_CODE RIGHT OUTER JOIN DASH_DATA_PROJ_HDR ON JOB_TRAFFIC.JOB_COMPONENT_NBR = DASH_DATA_PROJ_HDR.JOB_COMPONENT_NBR
					    AND JOB_TRAFFIC.JOB_NUMBER = DASH_DATA_PROJ_HDR.JOB'
				IF @Restrictions > 0
		...
		SELECT @sql = @sql + ' WHERE (DASH_DATA_PROJ_HDR.JOB_COMP_DATE >= @StartDate) AND (DASH_DATA_PROJ_HDR.JOB_COMP_DATE <= @EndDate)'
				IF @JobType = 'None'
					Begin
						SELECT @sql = @sql + ' AND DASH_DATA_PROJ_HDR.JOB_TYPE IS NULL'
					End
				IF @Restrictions > 0
					Begin
						SELECT @sql = @sql + ' AND (UPPER(SEC_CLIENT.USER_ID) = UPPER(@UserID)) AND (SEC_CLIENT.TIME_ENTRY = 0 OR SEC_CLIENT.TIME_ENTRY IS NULL)'
					End
		--SELECT @sql = @sql + ' GROUP BY DASH_DATA_PROJ_HDR.JOB_TYPE, DASH_DATA_PROJ_HDR.JT_DESC'
		SELECT @paramlist = '@StartDate SmallDatetime, @EndDate SmallDatetime, @Dept varchar(4000), @Office varchar(4000), @Month int, @Level varchar(10), @UserID varchar(100), @EMP_CODE AS VARCHAR(6), @Client varchar(4000), @AE varchar(4000), @SalesClass varchar(4000), @JobType varchar(4000)'
		print @sql
		EXEC sp_executesql @sql, @paramlist, @StartDate, @EndDate, @Dept, @Office, @Month, @Level, @UserID, @EMP_CODE, @Client, @AE, @SalesClass, @JobType
	End
