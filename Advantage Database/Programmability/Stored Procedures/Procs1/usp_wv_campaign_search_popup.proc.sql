...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_campaign_search_popup]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_campaign_search_popup]
GO
...
****************************************************************************************/
CREATE PROCEDURE [dbo].[usp_wv_campaign_search_popup] 
    @UserID			VARCHAR(100),
