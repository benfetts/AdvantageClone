...
CREATE PROCEDURE [dbo].[usp_wv_data_production_jobs] AS
...
CREATE TABLE #PRODUCTION_JOBS( 	
	...
	JOB_COMPONENT_NUMBER	VARCHAR(3) NULL,
	SALES_CODE			VARCHAR(6) NULL,
	FUNCTION_CODE		VARCHAR(6) NULL,
	FUNCTION_TYPE		VARCHAR(1) NULL,
	RECORD_TYPE		VARCHAR(6) NULL,
	ITEM_DATE			DATETIME NULL,
	ITEM_DESC			VARCHAR(50) NULL,
	QTYHOURS			DECIMAL NULL,
	NET_COST			DECIMAL NULL,
	MARKUP			DECIMAL NULL,
	AMOUNT			DECIMAL NULL,
	VENDOR_TAX			DECIMAL NULL,
	RESALE_TAX			DECIMAL NULL,
	AR_INVOICE_NUMBER		BIGINT NULL,
	NONBILL			VARCHAR(1) NULL,
	BILLED_PERIOD		VARCHAR(6) NULL,
	POST_PERIOD			VARCHAR(6) NULL,
	GL_ACCOUNT_SALES		VARCHAR(50) NULL,
	GL_ACCOUNT_COS		VARCHAR(50) NULL,
)
--************************ EMPLOYEE TIME ***********************************
...
SELECT  JOB_LOG.OFFICE_CODE AS OFFICE_CODE, 
	...
	ADVANCE_BILLING.ADV_BILL_NET_AMT + ADVANCE_BILLING.EXT_MARKUP_AMT + ADVANCE_BILLING.EXT_NONRESALE_TAX AS AMOUNT,
