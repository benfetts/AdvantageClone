...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_dd_GetAllJobCompsJJ_withClosed]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_dd_GetAllJobCompsJJ_withClosed]
GO


CREATE PROCEDURE [dbo].[usp_wv_dd_GetAllJobCompsJJ_withClosed] 
@UserID VarChar(100),
