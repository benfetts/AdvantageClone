if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_dd_GetAllJobsJobJacket]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_dd_GetAllJobsJobJacket]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_dd_GetAllJobsJobJacket] 
@UserID VarChar(100),
