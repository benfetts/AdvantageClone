...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_dd_GetAllJobs_Traffic]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_dd_GetAllJobs_Traffic]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_dd_GetAllJobs_Traffic] 
@UserID VarChar(100)
AS
