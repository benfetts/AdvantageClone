if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_dd_GetJobCompScheduleAll]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_dd_GetJobCompScheduleAll]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_dd_GetJobCompScheduleAll] 
@UserID VARCHAR(100)
AS
DECLARE 
@Restrictions INT
