...
CREATE PROCEDURE [dbo].[usp_wv_dd_GetJob_CreativeBrief_withClosed] 
@UserID VarChar(100),
...
If @Rescrictions > 0
	...
	INNER JOIN CRTV_BRF_DTL 
		 ON JOB_COMPONENT.JOB_NUMBER = CRTV_BRF_DTL.JOB_NUMBER 
		AND JOB_COMPONENT.JOB_COMPONENT_NBR = CRTV_BRF_DTL.JOB_COMPONENT_NBR 
