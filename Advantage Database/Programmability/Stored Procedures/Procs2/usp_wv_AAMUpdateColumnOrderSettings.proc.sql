IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[usp_wv_AAMUpdateColumnOrderSettings]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_wv_AAMUpdateColumnOrderSettings]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_AAMUpdateColumnOrderSettings] /*WITH ENCRYPTION*/
