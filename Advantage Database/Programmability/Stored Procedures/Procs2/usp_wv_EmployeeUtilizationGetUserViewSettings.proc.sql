IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[usp_wv_EmployeeUtilizationGetUserViewSettings]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[usp_wv_EmployeeUtilizationGetUserViewSettings]
GO

/****** Object:  StoredProcedure [dbo].[usp_wv_EmployeeUtilizationGetUserViewSettings]    Script Date: 7/21/2020 4:21:43 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[usp_wv_EmployeeUtilizationGetUserViewSettings]
