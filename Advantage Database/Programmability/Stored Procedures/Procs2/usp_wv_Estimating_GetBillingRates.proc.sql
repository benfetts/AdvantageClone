...
CREATE PROCEDURE [dbo].[usp_wv_Estimating_GetBillingRates] 
    ...
    @THIS_EMP_CODE AS VARCHAR(6),
	@THIS_EMP_TITLE_ID AS INTEGER,
...
--		JOB_NUMBER = @THIS_JOB_NUMBER;
	...
	if @THIS_FNC_TYPE = 'E'
		Begin
			SET @THIS_EFF_DATE = GETDATE()
		End	
	Else
		Begin
			SET @THIS_EFF_DATE = NULL
		End
--RUN BEN'S SPROC:	
	EXECUTE dbo.sp_get_billing_rates
		@emp_code = @THIS_EMP_CODE,
		...
		@emp_title_id = @THIS_EMP_TITLE_ID,
