if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_Estimating_Quote_DetailsBySeq]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_Estimating_Quote_DetailsBySeq]
GO
...
CREATE PROCEDURE [dbo].[usp_wv_Estimating_Quote_DetailsBySeq] 
@EstNo Int,
@EstCompNo Int,
@QuoteNo Int,
@RevNo Int,
...
SELECT     ESTIMATE_QUOTE.ESTIMATE_NUMBER, ESTIMATE_QUOTE.EST_COMPONENT_NBR, ESTIMATE_QUOTE.EST_QUOTE_NBR, 
                      ...
                      ESTIMATE_REV_DET.FNC_CODE, FUNCTIONS.FNC_DESCRIPTION, ISNULL(ESTIMATE_REV_DET.EST_FNC_COMMENT, '') as EST_FNC_COMMENT,
					  ISNULL(ESTIMATE_REV_DET.EST_FNC_COMMENT_HTML, '') as EST_FNC_COMMENT_HTML, ESTIMATE_REV_DET.EST_REV_SUP_BY_CDE, 
                      ISNULL(ESTIMATE_REV_DET.EST_REV_SUP_BY_NTE, '') as EST_REV_SUP_BY_NTE, ISNULL(ESTIMATE_REV_DET.EST_REV_SUP_BY_HTML, '') as EST_REV_SUP_BY_HTML,
					  ESTIMATE_REV_DET.EST_REV_QUANTITY, ESTIMATE_REV_DET.EST_REV_RATE, 
                      ...
                      ESTIMATE_REV_DET.EST_NONBILL_FLAG, ESTIMATE_REV_DET.FEE_TIME, ESTIMATE_REV_DET.EMPLOYEE_TITLE_ID, FUNCTIONS.FNC_TYPE,
