...
CREATE PROCEDURE [dbo].[usp_wv_dd_GetJob_JobSpecs_withClosed] 
@UserID VarChar(100),
...
If @Rescrictions > 0
	...
	INNER JOIN JOB_SPECS 
		 ON JOB_COMPONENT.JOB_NUMBER = JOB_SPECS.JOB_NUMBER 
		AND JOB_COMPONENT.JOB_COMPONENT_NBR = JOB_SPECS.JOB_COMPONENT_NBR 
