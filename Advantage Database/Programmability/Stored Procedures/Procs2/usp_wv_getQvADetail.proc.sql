if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_getQvADetail]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_getQvADetail]
GO

CREATE PROCEDURE [dbo].[usp_wv_getQvADetail]
@JobNum Varchar(6),
@JobComp Varchar(6),
@UserID Varchar(100)
