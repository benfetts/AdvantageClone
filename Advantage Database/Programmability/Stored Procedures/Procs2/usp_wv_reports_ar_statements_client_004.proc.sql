...
,ISNULL(ClientCode,'')+CAST(ISNULL(CDP_CONTACT_ID,0) AS VARCHAR)+ISNULL(ContactCode,'') AS GROUPING_KEY
from @AR_LINE_ITEM
GROUP BY 
...
PrtFtrFax,PrtFtrEmail,PrtName,PrtFtrName,LogoPath,CurrentAR,OverThirtyAR,OverSixtyAR,TotalAR
