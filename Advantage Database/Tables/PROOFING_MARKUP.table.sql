...
BEGIN
	...
	ALTER TABLE [dbo].[PROOFING_MARKUP]  WITH CHECK ADD  CONSTRAINT [FK_PROOFING_MARKUP_ALERT] FOREIGN KEY([ALERT_ID])
	REFERENCES [dbo].[ALERT] ([ALERT_ID])
	ALTER TABLE [dbo].[PROOFING_MARKUP] CHECK CONSTRAINT [FK_PROOFING_MARKUP_ALERT]
