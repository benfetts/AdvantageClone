if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[V_DRPT_DIRECT_INDIRECT_TIME_LIVE]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[V_DRPT_DIRECT_INDIRECT_TIME_LIVE]
GO

CREATE VIEW [dbo].[V_DRPT_DIRECT_INDIRECT_TIME_LIVE]
