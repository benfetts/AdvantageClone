...
AS
	...
	FROM 
		...
		[dbo].[GLSUMMARY] AS GLS ON GLS.GLSPP = GLEH.GLEHPP AND
									GLS.GLSCODE = GLED.GLETCODE INNER JOIN 
		...
		[dbo].[OFFICE] AS O ON O.OFFICE_CODE = GLO.GLOXOFFICE LEFT OUTER JOIN
		[dbo].[GLSOURCE] AS GLSR ON GLSR.GLSRCODE = GLEH.GLEHSOURCE
