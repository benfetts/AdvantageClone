...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[V_PROD_INV_DEF]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[V_PROD_INV_DEF]
GO

CREATE VIEW dbo.V_PROD_INV_DEF 
AS
...
IF ( @@ERROR = 0 )
	GRANT ALL ON [V_PROD_INV_DEF] TO PUBLIC AS dbo
GO	
