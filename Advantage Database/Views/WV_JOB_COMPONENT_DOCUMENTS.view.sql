...
CREATE VIEW dbo.WV_JOB_COMPONENT_DOCUMENTS
AS
SELECT     dbo.JOB_COMPONENT_DOCUMENTS.JOB_NUMBER, dbo.JOB_COMPONENT_DOCUMENTS.JOB_COMPONENT_NUMBER, 
...
FROM         dbo.DOCUMENTS  INNER JOIN
                      dbo.JOB_COMPONENT_DOCUMENTS ON dbo.DOCUMENTS.DOCUMENT_ID = dbo.JOB_COMPONENT_DOCUMENTS.DOCUMENT_ID
