...
-- View
CREATE VIEW dbo.WV_MYALERTSLISTJJ
AS
SELECT     dbo.ALERT.ALERT_ID, dbo.ALERT.SUBJECT, dbo.ALERT.GENERATED, [dbo].[advfn_get_user_name](ALERT.ALERT_USER) AS USER_NAME, 
                      ...
                      dbo.ALERT.ALERT_USER, dbo.ALERT.CP_ALERT, dbo.ALERT.DUE_DATE, dbo.ALERT.TIME_DUE, dbo.ALERT.ALERT_STATE_ID
