...
Partial Public NotInheritable Class AdvantageOutlookAddin
    ...
    Protected Overrides Sub Initialize()
        ...
        Globals.AdvantageOutlookAddin = Me
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _AdvantageOutlookAddin As AdvantageOutlookAddin
    ...
    Friend Shared Property AdvantageOutlookAddin() As AdvantageOutlookAddin
        Get
            Return _AdvantageOutlookAddin
        End Get
        Set
            If (_AdvantageOutlookAddin Is Nothing) Then
                _AdvantageOutlookAddin = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.AdvantageOutlookAddin.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.AdvantageOutlookAddin.GetFormRegions(explorer, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.AdvantageOutlookAddin.GetFormRegions(inspector, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
End Class
