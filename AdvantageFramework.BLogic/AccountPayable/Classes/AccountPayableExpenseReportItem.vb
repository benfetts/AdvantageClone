Namespace AccountPayable.Classes
    ...
    <Serializable()>
    Public Class AccountPayableExpenseReportItem
...
#Region " Properties "
        ...
        <System.ComponentModel.Browsable(False),
        Xml.Serialization.XmlIgnore()>
        Public WriteOnly Property Functions As Generic.List(Of AdvantageFramework.Database.Entities.Function)
            Set(value As Generic.List(Of AdvantageFramework.Database.Entities.Function))
                _Functions = value
            End Set
        End Property
        <System.ComponentModel.Browsable(False),
        Xml.Serialization.XmlIgnore()>
        Public WriteOnly Property NonClientGLAccountList As Generic.List(Of AdvantageFramework.Database.Entities.GeneralLedgerAccount)
            Set(value As Generic.List(Of AdvantageFramework.Database.Entities.GeneralLedgerAccount))
                _NonClientGLAccountList = value
            End Set
        End Property
        <System.ComponentModel.Browsable(False),
        Xml.Serialization.XmlIgnore()>
        Public WriteOnly Property ProductionGLAccountList As Generic.List(Of AdvantageFramework.Database.Entities.GeneralLedgerAccount)
            Set(value As Generic.List(Of AdvantageFramework.Database.Entities.GeneralLedgerAccount))
                _ProductionGLAccountList = value
            End Set
        End Property
        <System.ComponentModel.Browsable(False),
        Xml.Serialization.XmlIgnore()>
        Public WriteOnly Property IsAPLimitByOfficeEnabled As Boolean
            Set(value As Boolean)
                _IsAPLimitByOfficeEnabled = value
            End Set
        End Property
        <System.ComponentModel.Browsable(False),
        Xml.Serialization.XmlIgnore()>
        Public WriteOnly Property APHeaderOfficeCode As String
            Set(value As String)
                _APHeaderOfficeCode = value
            End Set
        End Property
        ...
        End Property
        <System.Runtime.Serialization.DataMemberAttribute(),
        AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, IsReadOnlyColumn:=True, DefaultColumnType:=BaseClasses.Methods.DefaultColumnTypes.JobDescription)>
        ...
        <System.Runtime.Serialization.DataMemberAttribute(),
        AdvantageFramework.BaseClasses.Attributes.Entity(ShowColumnInGrid:=False)>
        Public Property HasHeaderDocuments() As Boolean
