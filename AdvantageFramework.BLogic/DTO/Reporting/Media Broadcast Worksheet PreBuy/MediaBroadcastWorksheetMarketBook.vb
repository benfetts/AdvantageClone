Namespace DTO.Reporting.MediaBroadcastWorksheetPreBuy
...
#Region " Properties "
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(ShowColumnInGrid:=False)>
        Public Property OldComscoreMarketNumber As Integer
...
#Region " Methods "
        ...
        Public Sub New(MediaBroadcastWorksheetMarket As AdvantageFramework.Database.Entities.MediaBroadcastWorksheetMarket)
            ...
            Me.Client = MediaBroadcastWorksheetMarket.MediaBroadcastWorksheet.ClientCode
            Me.ClientName = MediaBroadcastWorksheetMarket.MediaBroadcastWorksheet.Client.Name
            ...
            ElseIf MediaBroadcastWorksheetMarket.MediaBroadcastWorksheet.RatingsServiceID = AdvantageFramework.Nielsen.Database.Entities.Methods.RatingsServiceID.Comscore Then
                ...
                Me.OldComscoreMarketNumber = MediaBroadcastWorksheetMarket.Market.ComscoreMarketNumber.Value

                Me.NielsenMarketNumber = MediaBroadcastWorksheetMarket.Market.ComscoreNewMarketNumber.Value
