Namespace Estimate.Printing.Classes
    ...
    <Serializable()>
    Public Class EstimatePrintDetail
...
#Region " Variables "
        ...
        Private _EstimateRateMarkup As Nullable(Of Decimal) = Nothing
        Private _IncludeRateMarkup As Nullable(Of Short) = Nothing
...
#Region " Properties "
        ...
        End Property
        <System.Runtime.Serialization.DataMemberAttribute()>
        Public Property EstimateRateMarkup() As Nullable(Of Decimal)
            Get
                EstimateRateMarkup = _EstimateRateMarkup
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _EstimateRateMarkup = value
            End Set
        End Property
        <System.Runtime.Serialization.DataMemberAttribute()>
        Public Property IncludeRateMarkup() As Nullable(Of Short)
            Get
