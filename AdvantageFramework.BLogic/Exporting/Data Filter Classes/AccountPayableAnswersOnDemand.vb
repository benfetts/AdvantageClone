...
#Region " Methods "
        ...
        End Sub
        Public Sub New(ByVal DateStart As Date, ByVal DateEnd As Date)
        ...
        Public Function EntityFilterString() As String Implements Interfaces.IExportDataFilter.EntityFilterString
            ...
            FilterString = String.Format("EXEC dbo.advsp_ap_export_answers_on_demand @DATE_START, @DATE_END, @ENTRY_OR_INVOICE_DATE")
