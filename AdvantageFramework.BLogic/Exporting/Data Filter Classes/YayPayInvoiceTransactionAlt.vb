Namespace Exporting.DataFilterClasses
    ...
    <Serializable()>
    Public Class YayPayInvoiceTransactionAlt
...
#Region " Methods "
        ...
        Public Function EntityFilterString() As String Implements Interfaces.IExportDataFilter.EntityFilterString
            ...
            FilterString = String.Format("EXEC dbo.advsp_yaypay_invoices_transactions_onaccount_export '{0}', '{1}'", Me.StartDate.ToShortDateString, Me.EndDate.ToShortDateString)
