...
#Region " Properties "
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="", ShowColumnInGrid:=False)>
        Public Property WorksheetMakegoodNumber As Integer
...
#Region " Methods "
        ...
        Public Overrides Sub SetRequiredFields()
            ...
            For Each PropertyDescriptor In PropertyDescriptors
                ...
                Select Case PropertyDescriptor.Name
                    ...
                    Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.StartTime.ToString, AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.EndTime.ToString, AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.Days.ToString

                        SetRequired(AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.StartTime.ToString, {"Radio", "TV"}.Contains(Me.MediaType))
        ...
        Public Overrides Function ValidateCustomProperties(ByVal PropertyName As String, ByRef IsValid As Boolean, ByRef Value As Object) As String
            ...
            Select Case PropertyName
                ...
                Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.Days.ToString

                    DaysAndTimeController = New AdvantageFramework.Controller.DaysAndTimeController(Nothing)
                    DaysAndTime = New AdvantageFramework.DTO.DaysAndTime()

                    If Me.MediaType.Substring(0, 1) = "R" Then

                        DaysAndTime.BroadcastType = DTO.DaysAndTime.BroadcastTypes.Radio

                    ElseIf Me.MediaType.Substring(0, 1) = "T" Then
                    ...
                    DaysAndTimeController.ParseDays(DaysAndTime, PropertyValue, IsValid)
                ...
                Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.StartTime.ToString
                ...
                Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.OrderLineNumber.ToString
                ...
                Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.GrossRate.ToString
                ...
                Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.Length.ToString
                ...
                Case AdvantageFramework.MediaManager.Classes.BroadcastOrderVerification.Properties.Spots.ToString
