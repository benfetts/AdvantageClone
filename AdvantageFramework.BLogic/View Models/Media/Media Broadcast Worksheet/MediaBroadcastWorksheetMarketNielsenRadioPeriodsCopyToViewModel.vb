Namespace ViewModels.Media.MediaBroadcastWorksheet
	...
	Public Class MediaBroadcastWorksheetMarketNielsenRadioPeriodsCopyToViewModel
...
#Region " Properties "
		...
		Public Property CopyFromWorksheetNielsenRadioPeriods As Generic.List(Of AdvantageFramework.DTO.Media.MediaBroadcastWorksheet.NielsenRadioPeriod)
...
#Region " Methods "
		...
		Public Sub New()
			...
			Me.CopyFromWorksheetNielsenRadioPeriods = New Generic.List(Of AdvantageFramework.DTO.Media.MediaBroadcastWorksheet.NielsenRadioPeriod)
