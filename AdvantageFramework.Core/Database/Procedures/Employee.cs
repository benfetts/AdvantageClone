...
namespace AdvantageFramework.Core.Database.Procedures
{
    public static class Employee
    {
        ...
        //public static IEnumerable<AdvantageFramework.Core.> LoadAlertRecipients(AdvantageFramework.Core.Database.DbContext dbContext, string dl)
        //{
        //    List<AdvantageFramework.Core.Database.Entities.AlertRecipient> rv = null;
        //    string str = "";
        //    int i = 0;
        ...
        //    {
        //        var parameters = new[] {
        //            new Microsoft.Data.SqlClient.SqlParameter("@CL_CODE", SqlDbType.VarChar, 6) { Direction = ParameterDirection.Input, Value = str },
        //            new Microsoft.Data.SqlClient.SqlParameter("@DIV_CODE", SqlDbType.VarChar, 6) { Direction = ParameterDirection.Input, Value = str},
        //            new Microsoft.Data.SqlClient.SqlParameter("@PRD_CODE", SqlDbType.VarChar, 6) { Direction = ParameterDirection.Input, Value = str},
        //            new Microsoft.Data.SqlClient.SqlParameter("@JOB_NUMBER", SqlDbType.Int) { Direction = ParameterDirection.Input, Value = 0},
        //            new Microsoft.Data.SqlClient.SqlParameter("@JOB_COMPONENT_NBR", SqlDbType.SmallInt) { Direction = ParameterDirection.Input, Value = 0},
        //            new Microsoft.Data.SqlClient.SqlParameter("@CMP_IDENTIFIER", SqlDbType.Int) { Direction = ParameterDirection.Input, Value = 0},
        ...
        //            new Microsoft.Data.SqlClient.SqlParameter("@USER_CODE", SqlDbType.VarChar, 100) { Direction = ParameterDirection.Input, Value = str},
        //            new Microsoft.Data.SqlClient.SqlParameter("@IS_REVIEWERS", SqlDbType.Bit) { Direction = ParameterDirection.Input, Value = 0},
        //            new Microsoft.Data.SqlClient.SqlParameter("@EMAIL_GR_CODE", SqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = str}
        //        };
        ...
        //        rv = (from AlertRecipient in dbContext.AlertRecipients.FromSqlRaw("EXEC [dbo].[usp_wv_AutoCompleteRecipientsLoad]  " +
        //              "@CL_CODE, " +
        //              "@DIV_CODE, " +
        //              "@PRD_CODE, " +
        //              "@JOB_NUMBER, " +
        ...
        //              "@USER_CODE, " +
        //              "@IS_REVIEWERS, " +
        //              "@EMAIL_GR_CODE;", parameters).AsEnumerable()
        //              select new AdvantageFramework.Core.Database.Entities.AlertRecipient()
        //              {
        //                  EmpCode = AlertRecipient.EmpCode,
        //                   = AlertRecipient.EmployeeFullName,
        //                  IsImployee = comment.MarkupDocumentID ?? 0,
        //                  IsClientcontact = comment.AlertStateID,
        //                  InAlertGroup = comment.LongComment,
        //                  ConceptShareUserID = comment.MarkupID,
        //                  IsConceptShareUser = comment.EmployeeFullName,
        //              }).ToList();


        //        //&& ProofingMarkup.DocumentId == documentID

        //        //                      join ProofingMarkup in dbContext.ProofingMarkups on AlertComment.CommentId equals ProofingMarkup.CommentId into grouping
        //        //from ProofingMarkup in grouping.DefaultIfEmpty()
        ...
        //        //var proofingMarkupCommentIds = from ProofingMarkup in proofingMarkups
        //        //                               where ProofingMarkup.DocumentId == documentID
        //        //                               select ProofingMarkup.CommentId;

        //        //rv = (from AlertComment in dbContext.AlertComments
        //        //      join SecUser in dbContext.SecurityUsers.AsQueryable() on AlertComment.UserCode.ToLower() equals SecUser.UserCode.ToLower()
        ...
        //        //      where AlertComment.AlertId == alertID && AlertComment.ParentId == null && (AlertComment.DocumentId == null || proofingMarkupCommentIds.Contains(AlertComment.CommentId))
        //        //      orderby AlertComment.GeneratedDate descending, AlertComment.CommentId descending
        ...
        //        //          EmployeeFullName = EmployeeCloak != null ? EmployeeCloak.EmpFname + (EmployeeCloak.EmpMi != null ? " " + EmployeeCloak.EmpMi + ". " : " ") + EmployeeCloak.EmpLname : AlertComment.UserCode,
        //        //      }).ToList();
        ...
        //            alertComment.Replies = LoadReplies(dbContext, alertComment);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
