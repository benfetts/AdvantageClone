...
{
    [Table("CLIENT")]
    [Index(nameof(ActiveFlag), Name = "IDX_CLIENT_ACTIVE_FLAG")]
    [Index(nameof(ReqTimeComment), nameof(ActiveFlag), Name = "IDX_CLIENT_REQ_TIME_COMMENT")]
    public partial class Client
    {
        public Client()
        {
            CdpContactHdrs = new HashSet<ClientContact>();
        ...
        public long? DcProfileId { get; set; }
        [Column("DC_REPORT_ID")]
        public long? DcReportId { get; set; }
        [Column("DC_OAUTH2_TOKEN")]
        public string DcOauth2Token { get; set; }
        [Column("DC_ENABLED")]
        public bool DcEnabled { get; set; }

        [InverseProperty(nameof(ClientContact.ClCodeNavigation))]
        public virtual ICollection<ClientContact> CdpContactHdrs { get; set; }
