...
{
    [Table("PRODUCT")]
    [Index(nameof(ActiveFlag), Name = "IDX_PRODUCT_ACTIVE_FLAG")]
    [Index(nameof(ClCode), nameof(DivCode), nameof(PrdCode), Name = "IDX_PRODUCT_CL_CODE")]
    public partial class Product
    {
        public Product()
        {
            SecClients = new HashSet<UserClientDivisionProductAccess>();
        }
        ...
        [InverseProperty(nameof(UserClientDivisionProductAccess.Product))]
        public virtual ICollection<UserClientDivisionProductAccess> SecClients { get; set; }
    }
}
