Namespace AdvancedReportWriterReports
    ...
    Partial Public Class ClientPLDetailReport
        ...
        Private Sub InitializeComponent()
            ...
            'ObjectDataSource1
            '
            Me.ObjectDataSource1.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.ClientPLDetail)
            Me.ObjectDataSource1.Name = "ObjectDataSource1"
            '
            'ClientPLDetailReport
            '
