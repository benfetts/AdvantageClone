Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailFunctionReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFunctionReport)
            '
            'ParameterCriteria
            '
