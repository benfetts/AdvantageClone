Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailIFeesOOPCampaignReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFeesOOPCampaign)
            '
            'ParameterCriteria
            '
