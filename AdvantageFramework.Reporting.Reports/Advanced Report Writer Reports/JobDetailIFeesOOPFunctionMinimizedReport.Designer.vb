Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailIFeesOOPFunctionMinimizedReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFeesOOPFunctionMinimized)
            '
            'ParameterCriteria
            '
