Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailIFeesOOPFunctionReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFeesOOPFunction)
            '
            'ParameterCriteria
            '
