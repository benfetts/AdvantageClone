Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailIFeesOOPJob1MinimizedReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFeesOOPJobMinimized)
            '
            'ParameterCriteria
            '
