Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailIFeesOOPJob2MinimizedReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFeesOOPJob2Minimized)
            '
            'ParameterCriteria
            '
