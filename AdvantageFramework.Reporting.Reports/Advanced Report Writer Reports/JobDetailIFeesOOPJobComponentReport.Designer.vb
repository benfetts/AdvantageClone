Namespace AdvancedReportWriterReports
    ...
    Partial Public Class JobDetailIFeesOOPJobComponentReport
        ...
        Private Sub InitializeComponent()
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Reporting.Database.Classes.JobDetailFeesOOPJobComponent)
            '
            'ParameterCriteria
            '
