...
#Region " Variables "
        ...
        Private _BillingInvoiceSummary As Generic.List(Of Database.Classes.BillingInvoiceSummary) = Nothing
        Private _CurrentDataLine As Database.Classes.BillingInvoiceSummary = Nothing
...
#Region " Properties "
        ...
        Public ReadOnly Property AdvancedReportWriterReport As AdvantageFramework.Reporting.AdvancedReportWriterReports Implements IUserDefinedReport.AdvancedReportWriterReport
            Get
                AdvancedReportWriterReport = AdvantageFramework.Reporting.AdvancedReportWriterReports.Clients
            End Get
        End Property
        ...
        Private Sub BillingInvoiceSummary_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
            ...
            Try
                ...
                Using DbContext = New Database.DbContext(Session.ConnectionString, Session.UserCode)
                    _BillingInvoiceSummary = Reporting.Database.Procedures.BillingInvoice _
                        .LoadBillingInvoiceSummary(DbContext, AP_ID, Worksheets, Invoices, LocationName, EntryStart, EntryEnd, InvoiceStart, InvoiceEnd, Clients, Divisions, Products, Markets, Vendors).ToList()
                End Using

                Me.DataSource = _BillingInvoiceSummary

                If (_BillingInvoiceSummary IsNot Nothing) Then
                    If (_BillingInvoiceSummary.Count > 0) Then
                        _CurrentDataLine = _BillingInvoiceSummary.FirstOrDefault
                    Else
                        _CurrentDataLine = New Database.Classes.BillingInvoiceSummary
                    End If
                Else
                    _CurrentDataLine = New Database.Classes.BillingInvoiceSummary
                End If
        ...
        Private Sub BillingInvoiceSummary_DataSourceRowChanged(sender As Object, e As DevExpress.XtraReports.UI.DataSourceRowEventArgs) Handles MyBase.DataSourceRowChanged
