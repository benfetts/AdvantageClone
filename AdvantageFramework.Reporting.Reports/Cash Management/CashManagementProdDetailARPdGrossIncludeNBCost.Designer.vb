Namespace CashManagement
    ...
    Partial Public Class CashManagementProdDetailARPdGrossIncludeNBCost
        ...
        Private Sub InitializeComponent()
            ...
            Me.label28.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailable")})
            ...
            Me.label21.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ARGrossPaidTotal")})
            ...
            Me.label35.Text = "Gross Paid" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "Amount"
            ...
            Me.label84.SizeF = New System.Drawing.SizeF(377.5416!, 14.0!)
            Me.label84.Text = "* Indicates partial payment, amount not included unless applied to jobs."
            '
            'pageInfo2
            '
            ...
            'label62
            '
            Me.label62.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ARGrossPaidTotal")})
            ...
            'label66
            '
            Me.label66.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailable")})
            ...
            'label70
            '
            Me.label70.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ARGrossPaidTotal")})
            ...
            'label74
            '
            Me.label74.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailable")})
            ...
            'label43
            '
            Me.label43.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailable")})
            ...
            'label47
            '
            Me.label47.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ARGrossPaidTotal")})
            ...
            'label54
            '
            Me.label54.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ARGrossPaidTotal")})
            ...
            'label58
            '
            Me.label58.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailable")})
            ...
            'label78
            '
            Me.label78.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ARGrossPaidTotal")})
            ...
            'label82
            '
            Me.label82.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailable")})
            ...
            '
            'CashManagementProdDetailARPdGrossIncludeNBCost
            '
            ...
            Me.DisplayName = "Cash Mgmt Prod Detail-AR Pd Gross-Include NB Cost"
