Namespace CashManagement
    ...
    Partial Public Class CashManagementProdSummaryARPdGross
        ...
        Private Sub InitializeComponent()
            ...
            Me.label84.SizeF = New System.Drawing.SizeF(350.0!, 14.0!)
            Me.label84.Text = "Partial payments not included unless applied to jobs."
            '
            'pageInfo2
            '
            ...
            'label74
            '
            Me.label74.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailableBillable")})
            ...
            'label43
            '
            Me.label43.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailableBillable")})
            ...
            'label82
            '
            Me.label82.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimatedGrossCashAvailableBillable")})
            ...
            '
            'CashManagementProdSummaryARPdGross
            '
            ...
            Me.DisplayName = "Cash Mgmt Prod Summary-AR Pd Gross"
