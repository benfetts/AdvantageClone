Namespace Employee.DirectIndirectTime
    Partial Public Class HoursWorkedSummaryByDate
        ...
        Private Sub InitializeComponent()
            ...
            Me.label18.LocationFloat = New DevExpress.Utils.PointFloat(153.125!, 61.79164!)
            Me.label18.Multiline = True
            Me.label18.Name = "label18"
            Me.label18.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
            Me.label18.SizeF = New System.Drawing.SizeF(200.0!, 23.0!)
            ...
            Me.label10.Text = "Hours Worked - Summary by Date"
            '
            'label9
            '
            ...
            'EmployeeHeader
            '
            Me.EmployeeHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label8, Me.label1, Me.label2})
            ...
            Me.label1.LocationFloat = New DevExpress.Utils.PointFloat(153.125!, 0!)
            ...
            Me.label2.ProcessDuplicatesMode = DevExpress.XtraReports.UI.ProcessDuplicatesMode.Suppress
            ...
            Me.DateHeader.HeightF = 0!
            Me.DateHeader.Level = 1
            Me.DateHeader.Name = "DateHeader"
            '
            'DateFooter
            '
            Me.DateFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label12, Me.label11, Me.label13})
            ...
            Me.label12.LocationFloat = New DevExpress.Utils.PointFloat(413.5415!, 9.999974!)
            ...
            Me.label11.LocationFloat = New DevExpress.Utils.PointFloat(349.9584!, 9.999974!)
    ...
    "tered From:',IIf([Parameters].[DateType]=3,'Approval Date From:','')))"
            ...
            '
            'HoursWorkedSummaryByDate
            '
            Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() {Me.Detail, Me.TopMargin, Me.BottomMargin, Me.PageHeader, Me.PageFooter, Me.EmployeeHeader, Me.DateHeader, Me.DateFooter})
            Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.EmployeeName, Me.DateCriteria})
            Me.DataSource = Me.BindingSource
            Me.DisplayName = "Hours Worked - Summary by Date"
