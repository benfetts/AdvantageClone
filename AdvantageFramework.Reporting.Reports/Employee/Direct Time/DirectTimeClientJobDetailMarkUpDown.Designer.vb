Namespace Employee.DirectTime
    ...
    Partial Public Class DirectTimeClientJobDetailMarkUpDown
        ...
        Private Sub InitializeComponent()
            ...
            'label32
            '
            Me.label32.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TotalAmount", "{0:n2}")})
    ...
    ")))"
            ...
            '
            'DirectTimeClientJobDetailMarkUpDown
            '
            ...
            Me.DisplayName = "02-Direct Time by Client-Job Detail wMrkUpDn"
