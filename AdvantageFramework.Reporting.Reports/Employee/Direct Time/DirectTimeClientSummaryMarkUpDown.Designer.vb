Namespace Employee.DirectTime
    ...
    Partial Public Class DirectTimeClientSummaryMarkUpDown
        ...
        Private Sub InitializeComponent()
            ...
            Me.label12.LocationFloat = New DevExpress.Utils.PointFloat(650.0!, 70.29165!)
            ...
            'label16
            '
            Me.label16.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TotalAmount", "{0:n2}")})
            Me.label16.Font = New System.Drawing.Font("Arial", 9.0!, System.Drawing.FontStyle.Bold)
            Me.label16.LocationFloat = New DevExpress.Utils.PointFloat(649.9999!, 9.999974!)
            ...
            'ReportFooter
            '
            Me.ReportFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label17, Me.label13, Me.label16})
            ...
            Me.label13.LocationFloat = New DevExpress.Utils.PointFloat(549.9999!, 9.999974!)
            ...
            'PageHeader
            '
            Me.PageHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label5, Me.label21, Me.label20, Me.label19, Me.label18, Me.label12, Me.label9, Me.label8, Me.label2, Me.label1, Me.line2, Me.line1})
            Me.PageHeader.HeightF = 104.1667!
            Me.PageHeader.Name = "PageHeader"
            '
            'label5
            '
            Me.label5.LocationFloat = New DevExpress.Utils.PointFloat(549.9999!, 32.99999!)
            Me.label5.Name = "label5"
            Me.label5.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
            Me.label5.SizeF = New System.Drawing.SizeF(200.0!, 23.0!)
            Me.label5.StylePriority.UseTextAlignment = False
            Me.label5.Text = "Include Markup/Down:  Yes"
            ...
            Me.label4.LocationFloat = New DevExpress.Utils.PointFloat(549.9999!, 0!)
            ...
            'Client_Header
            '
            Me.Client_Header.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label7, Me.label4, Me.label3})
            ...
            'label7
            '
            Me.label7.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TotalAmount", "{0:n2}")})
            Me.label7.LocationFloat = New DevExpress.Utils.PointFloat(650.0!, 0!)
            ...
            '
            'DirectTimeClientSummaryMarkUpDown
            '
            ...
            Me.DisplayName = "01-Direct Time by Client-Summary wMrkUpDn"
