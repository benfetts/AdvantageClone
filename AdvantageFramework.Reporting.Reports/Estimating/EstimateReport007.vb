...
Namespace Estimating
    ...
    Public Class EstimateReport007
...
#Region "  Form Event Handlers "
        ...
        Private Sub EstimateReport_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
            ...
            If _EstimatePrint IsNot Nothing Then
                If _EstimatePrint.OneRevision = 1 And _EstimatePrint.MaxRevision = 0 Then
                    Me.XrLabelOriginalEstimate.Text = ""
                    Me.XrLabelRevisedEstimate.Text = "Revision 00" & _EstimatePrint.MaxRevision.ToString
                ...
                Else
                    Me.XrLabelOriginalEstimate.Text = "Revision 00" & _EstimatePrint.MaxRevision - 1
                    Me.XrLabelRevisedEstimate.Text = "Revision 00" & _EstimatePrint.MaxRevision.ToString
                End If
            End If
            ...
            Try
                ...
                ElseIf _EstimatePrintSetting IsNot Nothing Then
                    ...
                    Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                        ...
                        EstimatePrintDetails = AdvantageFramework.Estimate.Printing.LoadEstimatePrintDetails003WV(DbContext, _EstimateNumber, _EstimateComponentNumber, _UserCode, _EstimateQuoteNumber, _EstimatePrintSetting.GroupingOptionGroupOption, 7, _EstimateQuoteNumbers, _Combine, _EstimateCompNumbers).ToList
