Namespace Estimating
    ...
    Partial Public Class TaxInformationSubReport003
        ...
        Private Sub InitializeComponent()
            ...
            Me.XrLabelCityTax.SizeF = New System.Drawing.SizeF(161.0!, 17.0!)
            ...
            Me.XrLabelCityTaxData.LocationFloat = New DevExpress.Utils.PointFloat(368.2357!, 0.0!)
            ...
            'BindingSource
            '
            Me.BindingSource.DataSource = GetType(AdvantageFramework.Estimate.Printing.Classes.TaxInformation)
            '
