Namespace FinanceAndAccounting
    ...
    Partial Public Class AccountPayableBatchSummaryReport
        ...
        Private Sub InitializeComponent()
            ...
            Me.LabelGroupFooter_CurrencyTotal = New DevExpress.XtraReports.UI.XRLabel()
            Me.LabelGroupFooter_SumForeignCurrency = New DevExpress.XtraReports.UI.XRLabel()
            Me.LineGroupFooter_Bottom = New DevExpress.XtraReports.UI.XRLine()
            Me.LabelGroupFooter_SumDisbursed = New DevExpress.XtraReports.UI.XRLabel()
            Me.LabelGroupFooter_Vendor = New DevExpress.XtraReports.UI.XRLabel()
            ...
            'Detail
            '
            Me.Detail.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LabelDetail_GLACode, Me.LabelDetail_Disbursed, Me.LabelDetail_Status, Me.LabelDetail_GLTransaction, Me.LabelDetail_PostPeriod, Me.LabelDetail_DateToPay, Me.LabelDetail_InvoiceDate, Me.LabelDetail_Invoice, Me.LabelDetail_Vendor})
            ...
            Me.LabelPageHeader_Title.LocationFloat = New DevExpress.Utils.PointFloat(0.00004768372!, 4.083315!)
            ...
            Me.LabelPageHeader_Title.SizeF = New System.Drawing.SizeF(501.0417!, 29.00001!)
            ...
            Me.LabelPageHeader_Title.Text = "Accounts Payable Batch Report - Summary"
            ...
            'GroupHeader
            '
            Me.GroupHeader.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("Vendor", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
            Me.GroupHeader.HeightF = 0!
            Me.GroupHeader.Name = "GroupHeader"
            '
            'GroupFooter
            '
            Me.GroupFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LabelGroupFooter_CurrencyTotal, Me.LabelGroupFooter_SumForeignCurrency, Me.LineGroupFooter_Bottom, Me.LabelGroupFooter_SumDisbursed, Me.LabelGroupFooter_Vendor})
            Me.GroupFooter.HeightF = 59.12485!
            Me.GroupFooter.Name = "GroupFooter"
            '
            'LabelGroupFooter_CurrencyTotal
            '
            Me.LabelGroupFooter_CurrencyTotal.BackColor = System.Drawing.Color.Transparent
            Me.LabelGroupFooter_CurrencyTotal.BorderColor = System.Drawing.Color.Black
            Me.LabelGroupFooter_CurrencyTotal.Borders = DevExpress.XtraPrinting.BorderSide.None
            Me.LabelGroupFooter_CurrencyTotal.BorderWidth = 1.0!
            Me.LabelGroupFooter_CurrencyTotal.CanGrow = False
            Me.LabelGroupFooter_CurrencyTotal.Font = New System.Drawing.Font("Arial", 8.25!, CType((System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.FontStyle))
            Me.LabelGroupFooter_CurrencyTotal.ForeColor = System.Drawing.Color.Black
            Me.LabelGroupFooter_CurrencyTotal.LocationFloat = New DevExpress.Utils.PointFloat(800.0001!, 27.0!)
            Me.LabelGroupFooter_CurrencyTotal.Name = "LabelGroupFooter_CurrencyTotal"
            Me.LabelGroupFooter_CurrencyTotal.Padding = New DevExpress.XtraPrinting.PaddingInfo(0, 0, 0, 0, 100.0!)
            Me.LabelGroupFooter_CurrencyTotal.SizeF = New System.Drawing.SizeF(99.99995!, 19.0!)
            Me.LabelGroupFooter_CurrencyTotal.StylePriority.UseBorders = False
            Me.LabelGroupFooter_CurrencyTotal.StylePriority.UseFont = False
            Me.LabelGroupFooter_CurrencyTotal.Text = "Batch Total:"
            Me.LabelGroupFooter_CurrencyTotal.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopLeft
            '
            'LabelGroupFooter_SumForeignCurrency
            '
            Me.LabelGroupFooter_SumForeignCurrency.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ForeignCurrencyTotal", "{0:$0.00}")})
            Me.LabelGroupFooter_SumForeignCurrency.LocationFloat = New DevExpress.Utils.PointFloat(900.0!, 27.00001!)
            Me.LabelGroupFooter_SumForeignCurrency.Name = "LabelGroupFooter_SumForeignCurrency"
            Me.LabelGroupFooter_SumForeignCurrency.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
            Me.LabelGroupFooter_SumForeignCurrency.SizeF = New System.Drawing.SizeF(100.0!, 23.0!)
            Me.LabelGroupFooter_SumForeignCurrency.StylePriority.UseTextAlignment = False
            XrSummary2.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
            Me.LabelGroupFooter_SumForeignCurrency.Summary = XrSummary2
            Me.LabelGroupFooter_SumForeignCurrency.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopRight
            '
            'LineGroupFooter_Bottom
            '
            Me.LineGroupFooter_Bottom.BorderColor = System.Drawing.Color.Black
            Me.LineGroupFooter_Bottom.Borders = DevExpress.XtraPrinting.BorderSide.None
            Me.LineGroupFooter_Bottom.BorderWidth = 0!
            Me.LineGroupFooter_Bottom.ForeColor = System.Drawing.Color.Gray
            Me.LineGroupFooter_Bottom.LocationFloat = New DevExpress.Utils.PointFloat(0!, 0!)
            Me.LineGroupFooter_Bottom.Name = "LineGroupFooter_Bottom"
            Me.LineGroupFooter_Bottom.SizeF = New System.Drawing.SizeF(1000.0!, 4.000004!)
            Me.LineGroupFooter_Bottom.StylePriority.UseBorderColor = False
            Me.LineGroupFooter_Bottom.StylePriority.UseBorderWidth = False
            Me.LineGroupFooter_Bottom.StylePriority.UseForeColor = False
            '
            'LabelGroupFooter_SumDisbursed
            '
            Me.LabelGroupFooter_SumDisbursed.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Disbursed", "{0:$0.00}")})
            Me.LabelGroupFooter_SumDisbursed.LocationFloat = New DevExpress.Utils.PointFloat(900.0!, 4.000004!)
            Me.LabelGroupFooter_SumDisbursed.Name = "LabelGroupFooter_SumDisbursed"
            Me.LabelGroupFooter_SumDisbursed.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
            Me.LabelGroupFooter_SumDisbursed.SizeF = New System.Drawing.SizeF(100.0!, 23.0!)
            Me.LabelGroupFooter_SumDisbursed.StylePriority.UseTextAlignment = False
            XrSummary3.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
            Me.LabelGroupFooter_SumDisbursed.Summary = XrSummary3
            Me.LabelGroupFooter_SumDisbursed.Text = "LabelGroupFooter_SumDisbursed"
            Me.LabelGroupFooter_SumDisbursed.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopRight
            '
            'LabelGroupFooter_Vendor
            '
            Me.LabelGroupFooter_Vendor.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Vendor")})
            Me.LabelGroupFooter_Vendor.Font = New System.Drawing.Font("Arial", 8.25!, CType((System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.FontStyle))
            Me.LabelGroupFooter_Vendor.LocationFloat = New DevExpress.Utils.PointFloat(0!, 4.000004!)
            Me.LabelGroupFooter_Vendor.Name = "LabelGroupFooter_Vendor"
            Me.LabelGroupFooter_Vendor.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
            Me.LabelGroupFooter_Vendor.SizeF = New System.Drawing.SizeF(235.4167!, 23.0!)
            Me.LabelGroupFooter_Vendor.StylePriority.UseFont = False
            Me.LabelGroupFooter_Vendor.Text = "XrLabel1"
            '
            'BindingSource
            '
            ...
            '
            'AccountPayableBatchSummaryReport
            '
            Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() {Me.Detail, Me.TopMargin, Me.BottomMargin, Me.PageHeader, Me.PageFooter, Me.ReportFooter, Me.GroupHeader, Me.GroupFooter})
        ...
        Friend WithEvents LabelGroupFooter_SumDisbursed As DevExpress.XtraReports.UI.XRLabel
        Friend WithEvents LabelGroupFooter_Vendor As DevExpress.XtraReports.UI.XRLabel
        ...
        Private WithEvents LineGroupFooter_Bottom As DevExpress.XtraReports.UI.XRLine
        ...
        Private WithEvents LabelGroupFooter_CurrencyTotal As DevExpress.XtraReports.UI.XRLabel
        Friend WithEvents LabelGroupFooter_SumForeignCurrency As DevExpress.XtraReports.UI.XRLabel
    End Class
