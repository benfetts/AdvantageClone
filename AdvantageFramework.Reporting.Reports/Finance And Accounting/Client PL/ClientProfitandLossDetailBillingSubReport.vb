...
Namespace FinanceAndAccounting.ClientPL
    ...
    Public Class ClientProfitandLossDetailBillingSubReport
...
#Region " Properties "
        ...
        Private Sub label18_SummaryRowChanged(sender As Object, e As EventArgs) Handles label18.SummaryRowChanged
            ...
            _TotalSalesClassTotalYTD = Convert.ToDecimal(Me.GetCurrentColumnValue(AdvantageFramework.Reporting.Database.Classes.ClientPLDetail.Properties.SumofTotalBilledClient.ToString))
        ...
        Private Sub label21_SummaryRowChanged(sender As Object, e As EventArgs) Handles label21.SummaryRowChanged
            ...
            _TotalTypeTotalYTD = Convert.ToDecimal(Me.GetCurrentColumnValue(AdvantageFramework.Reporting.Database.Classes.ClientPLDetail.Properties.SumofTotalBilledClient.ToString))
