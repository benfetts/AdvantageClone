Namespace FinanceAndAccounting.ClientPL
    ...
    Partial Public Class ClientProfitandLossDetailOfficeBillingSubReport
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ClientProfitandLossDetailOfficeBillingSubReport))
            ...
            Me.OfficeHeader.HeightF = 23.95835!
            ...
            Me.label20.LocationFloat = New DevExpress.Utils.PointFloat(143.75!, 0.9583473!)
            ...
            Me.label5.LocationFloat = New DevExpress.Utils.PointFloat(0!, 0.9583473!)
            ...
            Me.label4.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "BilledTotalCurrent")})
            ...
            'label11
            '
            Me.label11.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "BilledTotal", "{0:n2}")})
            ...
            'label6
            '
            Me.label6.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "BilledTotal", "{0:n2}")})
            ...
            Me.label6.Summary = XrSummary9
            Me.label6.Text = "label3"
            Me.label6.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopRight
            '
            'label7
            '
            Me.label7.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "BilledTotalCurrent")})
    ...
    "+ [ManualCOS],0)"
            ...
            Me.label3.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "BilledTotal", "{0:n2}")})
            ...
            Me.label16.SizeF = New System.Drawing.SizeF(750.0!, 50.00002!)
            ...
            Me.DisplayName = "01-Client PL Detail Report-1 Office Billing Sub"
