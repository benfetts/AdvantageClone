...
Namespace FinanceAndAccounting.ClientPL
    ...
    Public Class ClientProfitandLossDetailOfficeDirectExpensesSubReport
...
#Region " Properties "
        ...
        Private Sub ClientProfitandLossDetailServiceCostSubReport_BeforePrint(sender As Object, e As PrintEventArgs) Handles Me.BeforePrint
            If ReportType = "Summary" Then
                Me.OfficeHeader.Visible = False
