Namespace FinanceAndAccounting.ClientPL
    ...
    Partial Public Class ClientProfitandLossDetailSalesClassCostofBillingSubReport
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ClientProfitandLossDetailSalesClassCostofBillingSubReport))
            ...
            'SalesClassFooter
            '
            Me.SalesClassFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.line5, Me.line6, Me.line3, Me.line4, Me.label23, Me.label22, Me.label10, Me.label12, Me.label11})
            Me.SalesClassFooter.Dpi = 100.0!
            Me.SalesClassFooter.HeightF = 35.0!
    ...
    "nbillableAPCostOfSales]"
            ...
            'ClientHeader
            '
            Me.ClientHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label18, Me.label17, Me.label2, Me.label3, Me.label4})
            ...
            Me.label2.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ClientDescription")})
            Me.label2.Dpi = 100.0!
    ...
    "+ [ManualCOS] + [CRClientCostOfSales] + [NonbillableAPCostOfSales],0)"
            ...
            '
            'ClientProfitandLossDetailSalesClassCostofBillingSubReport
            '
            Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() {Me.Detail, Me.TopMargin, Me.BottomMargin, Me.ClientHeader, Me.TypeHeader, Me.TypeFooter, Me.SalesClassHeader, Me.SalesClassFooter})
            ...
            Me.DisplayName = "Client PL Detail Report SC-2 Cost of Billing Sub"
