...
Namespace FinanceAndAccounting.SalesJournal
    ...
    Public Class SalesJournal12PeriodByTypeJob
...
#Region " Properties "
        ...
        Private Sub XrSubreport_Footer_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrSubreport_Footer.BeforePrint
            'objects
            Dim SalesJournal12PeriodFooterSub As SalesJournal12PeriodFooterSub = Nothing

            If TypeOf XrSubreport_Footer.ReportSource Is SalesJournal12PeriodFooterSub Then

                SalesJournal12PeriodFooterSub = XrSubreport_Footer.ReportSource

                Try
                    SalesJournal12PeriodFooterSub.StartPeriod.Value = Me.StartPeriod.Value
                    SalesJournal12PeriodFooterSub.EndPeriod.Value = Me.EndPeriod.Value
                    SalesJournal12PeriodFooterSub.DataSource = Me.DataSource
                    ...
                    If SalesJournal12PeriodFooterSub.RowCount = 0 Then
                ...
                Catch ex As Exception
                    SalesJournal12PeriodFooterSub.DataSource = Nothing
                End Try
