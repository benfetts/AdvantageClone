Namespace FinanceAndAccounting
    ...
    Public Class ServiceFeeReconciliationFeeDetailSubReport
        ...
        Private Sub LoadDetailGroupFields()
            ...
            If _ServiceFeeReconciliationSummaryStyle = AdvantageFramework.Database.Entities.ServiceFeeReconciliationSummaryStyles.Employee Then
                ...
                Do Until TableCellHeader_Description.WidthF >= 500
                    ...
                    TableCellHeader_FeeQuantity.WidthF = 100
                    TableCellHeader_FeeAmount.WidthF = 100
                ...
                Do Until TableCellDetails_Description.WidthF >= 500
                    ...
                    TableCellDetails_FeeQuantity.WidthF = 100
                    TableCellDetails_FeeAmount.WidthF = 100

                Loop

                LabelGroupFooterDetail_FeeAmount.WidthF = 100
                LabelGroupFooterDetail_FeeAmount.LocationF = New System.Drawing.PointF(600, 2)

                LabelGroupFooterDetail_FeeQuantity.WidthF = 100
                LabelGroupFooterDetail_FeeQuantity.LocationF = New System.Drawing.PointF(500, 2)
