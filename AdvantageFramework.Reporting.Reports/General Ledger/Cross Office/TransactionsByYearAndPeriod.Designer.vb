Namespace GeneralLedger.CrossOffice
    ...
    Partial Public Class TransactionsByYearAndPeriod
        ...
        Private Sub InitializeComponent()
            ...
            'PageHeader
            '
            Me.PageHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label9, Me.label8, Me.label7, Me.label6, Me.line2, Me.label5, Me.label4, Me.label3, Me.label2, Me.label1, Me.line1})
            ...
            Me.label3.LocationFloat = New DevExpress.Utils.PointFloat(74.99997!, 71.99999!)
            ...
            Me.label1.Text = "Cross Office Amount By Year and Period"
            '
            'line1
            '
            ...
            Me.GLYearHeader.Level = 2
            Me.GLYearHeader.Name = "GLYearHeader"
            Me.GLYearHeader.RepeatEveryPage = True
            '
            'label10
            '
            ...
            Me.GLPeriodHeader.HeightF = 31.0!
            ...
            Me.label11.LocationFloat = New DevExpress.Utils.PointFloat(74.99997!, 6.0!)
            ...
            '
            'TransactionsByYearAndPeriod
            '
            Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() {Me.Detail, Me.TopMargin, Me.BottomMargin, Me.PageHeader, Me.PageFooter, Me.GLYearHeader, Me.GLYearFooter, Me.GLPeriodHeader, Me.GLOfficeCodeHeader})
            Me.ComponentStorage.AddRange(New System.ComponentModel.IComponent() {Me.BindingSource})
            Me.DataSource = Me.BindingSource
            Me.DisplayName = "01 - Transactions by Year and Period"
