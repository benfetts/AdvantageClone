Namespace Invoices.ComboInvoice
	...
	Public Class IncomeOnlyInvoice
...
#Region " Methods "
		...
		Private Sub XrSubreportInvoiceBodies_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrSubreportInvoiceBodies.BeforePrint
			...
			'objects
			Dim ComboIncomeOnlyInvoiceSubReport As IComboInvoice = Nothing
			...
			If MediaType = "P" Then
				...
				If _InvoicePrintingSetting IsNot Nothing Then
					...
					If _InvoicePrintingSetting.ReportFormatType.GetValueOrDefault(1) = AdvantageFramework.InvoicePrinting.InvoiceTypes.Production Then
						...
						ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.StandardInvoice.ComboIncomeOnlyInvoiceSubReport
					...
					ElseIf _InvoicePrintingSetting.ReportFormatType.GetValueOrDefault(1) = AdvantageFramework.InvoicePrinting.InvoiceTypes.ProductionCurrentTTD Then
						...
						ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.CurrentTTD.ComboIncomeOnlyInvoiceSubReport
					...
					ElseIf _InvoicePrintingSetting.ReportFormatType.GetValueOrDefault(1) = AdvantageFramework.InvoicePrinting.InvoiceTypes.ProductionEstimatePriorCurrentTTD Then
						...
						ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.EstimatePriorCurrentTTD.ComboIncomeOnlyInvoiceSubReport
					...
					ElseIf _InvoicePrintingSetting.ReportFormatType.GetValueOrDefault(1) = AdvantageFramework.InvoicePrinting.InvoiceTypes.ProductionNetCommissionTaxCurrent Then
						...
						ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.NetCommissionTaxCurrent.ComboIncomeOnlyInvoiceSubReport
					...
					ElseIf _InvoicePrintingSetting.ReportFormatType.GetValueOrDefault(1) = AdvantageFramework.InvoicePrinting.InvoiceTypes.ProductionGrandTotal Then
						...
						ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.GrandTotal.ComboIncomeOnlyInvoiceSubReport
					...
					ElseIf _InvoicePrintingSetting.ReportFormatType.GetValueOrDefault(1) = AdvantageFramework.InvoicePrinting.InvoiceTypes.ProductionEstimateCurrentTTD Then
						...
						ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.EstimateCurrentTTD.ComboIncomeOnlyInvoiceSubReport
			...
			Else
				...
				ComboIncomeOnlyInvoiceSubReport = New AdvantageFramework.Reporting.Reports.Invoices.StandardMediaInvoice.ComboIncomeOnlyInvoiceSubReport

			End If

			If ComboIncomeOnlyInvoiceSubReport IsNot Nothing Then

				ComboIncomeOnlyInvoiceSubReport.Session = _Session
				ComboIncomeOnlyInvoiceSubReport.InvoicePrintingSetting = _InvoicePrintingSetting
				ComboIncomeOnlyInvoiceSubReport.InvoicePrintingMediaSetting = _InvoicePrintingMediaSetting
				ComboIncomeOnlyInvoiceSubReport.AgencyInvoicePrintingMediaSetting = _AgencyInvoicePrintingMediaSetting
				ComboIncomeOnlyInvoiceSubReport.OneTimeInvoicePrintingMediaSetting = _OneTimeInvoicePrintingMediaSetting
				ComboIncomeOnlyInvoiceSubReport.AccountReceivableInvoice = _AccountReceivableInvoice
				ComboIncomeOnlyInvoiceSubReport.IsDraft = _IsDraft
				ComboIncomeOnlyInvoiceSubReport.MediaType = MediaType
				ComboIncomeOnlyInvoiceSubReport.ApplyExchangeRate = _ApplyExchangeRate
				ComboIncomeOnlyInvoiceSubReport.ExchangeRateAmount = _ExchangeRateAmount

				ComboIncomeOnlyInvoiceSubReport.SetParameterValues()

				XrSubreportInvoiceBodies.ReportSource = ComboIncomeOnlyInvoiceSubReport

				XrSubreportInvoiceBodies.ReportSource.CreateDocument()

				If XrSubreportInvoiceBodies.ReportSource.RowCount = 0 Then

					e.Cancel = True
					GroupFooterInvoiceData.PageBreak = DevExpress.XtraReports.UI.PageBreak.None

				Else

					GroupFooterInvoiceData.PageBreak = DevExpress.XtraReports.UI.PageBreak.AfterBandExceptLastEntry
		...
		Private Sub XrPictureBoxHeaderLogo_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrPictureBoxHeaderLogo.BeforePrint
			...
			If _InvoicePrintingComboSetting IsNot Nothing Then
				...
				If String.IsNullOrWhiteSpace(_InvoicePrintingComboSetting.LocationCode) = False Then
                    ...
                    XrPictureBoxHeaderLogo.Image = AdvantageFramework.Reporting.Reports.GetLogoImage(_Agency, _InvoicePrintingComboSetting.PageHeaderLogoPath)
