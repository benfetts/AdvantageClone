Namespace Invoices.CurrentTTD
	...
	"d ([Parameters.HeaderGroupBy] == 0 Or [Parameters.HeaderGroupBy] == 1)"
			...
			Me.XrLabelJobVersionData.LocationFloat = New DevExpress.Utils.PointFloat(0.00003178914!, 153.0!)
			...
			Me.XrLabelTotal.LocationFloat = New DevExpress.Utils.PointFloat(452.9584!, 87.57998!)
	...
	"t])"
			...
			Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.TotalHGBPhrase, Me.HeaderGroupByLabel1, Me.HeaderGroupByData1, Me.TotalPhrase, Me.JobComponentAmount, Me.TTDJobComponentAmount})
