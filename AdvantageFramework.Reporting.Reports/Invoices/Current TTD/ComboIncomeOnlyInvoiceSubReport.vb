        ...
        Private Sub Invoice_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
            ...
            If _InvoicePrintingSetting IsNot Nothing AndAlso _AccountReceivableInvoice IsNot Nothing Then
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
					...
					CurrentTTDInvoiceDetails = AdvantageFramework.InvoicePrinting.LoadCurrentTTDInvoiceDetails(DbContext, _Session.UserCode, _AccountReceivableInvoice.InvoiceNumber, _AccountReceivableInvoice.InvoiceSequenceNumber, _InvoicePrintingSetting.AddressBlockType, _InvoicePrintingSetting.PrintClientName, _InvoicePrintingSetting.PrintDivisionName,
					...
					For Each CurrentTTDInvoiceDetail In CurrentTTDInvoiceDetails.ToList

                        If CurrentTTDInvoiceDetail.FunctionType = "I" Then

                            If AdvantageFramework.Database.Procedures.IncomeOnly.Load(DbContext).Any(Function(Entity) Entity.ARInvoiceNumber = CurrentTTDInvoiceDetail.InvoiceNumber AndAlso Entity.ARInvoiceSequence = CurrentTTDInvoiceDetail.InvoiceSequenceNumber AndAlso
                                                                                                                          Entity.ARType = CurrentTTDInvoiceDetail.InvoiceType AndAlso
                                                                                                                          Entity.JobNumber = CurrentTTDInvoiceDetail.JobNumber AndAlso Entity.JobComponentNumber = CurrentTTDInvoiceDetail.ComponentNumber AndAlso
                                                                                                                          Entity.FunctionCode = CurrentTTDInvoiceDetail.FunctionCode AndAlso
                                                                                                                          Entity.OrderNumber Is Nothing AndAlso Entity.LineNumber Is Nothing) = False Then

                                CurrentTTDInvoiceDetails.Remove(CurrentTTDInvoiceDetail)
        ...
        Private Sub GroupFooterJobComponentComment_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupFooterJobComponentComment.BeforePrint
            ...
            Else
                ...
                If _InvoicePrintingSetting.SummaryLevel = AdvantageFramework.InvoicePrinting.SummaryLevels.None Then
                    ...
                    If TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.CurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                ...
                ElseIf _InvoicePrintingSetting.SummaryLevel = AdvantageFramework.InvoicePrinting.SummaryLevels.Invoice Then
                    ...
                    If TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.CurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber")).Sum(Function(Entity) Entity.CommissionAmount.GetValueOrDefault(0)) = 0 Then
