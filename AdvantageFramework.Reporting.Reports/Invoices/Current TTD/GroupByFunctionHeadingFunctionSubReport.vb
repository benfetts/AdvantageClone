...
#Region " Methods "
        ...
        Private Sub XrLabelIsTaxable_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrLabelIsTaxable.BeforePrint
            ...
            If _InvoicePrintingSetting IsNot Nothing Then
                ...
                If _InvoicePrintingSetting.IndicateTaxableFunctions.GetValueOrDefault(False) Then
                    ...
                    If CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.CurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionCode = Me.GetCurrentColumnValue("FunctionCode")).Sum(Function(Entity) Entity.TotalTax.GetValueOrDefault(0)) <> 0 Then
        ...
        Private Sub GroupFooterFunctionHeading_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupFooterFunctionHeading.BeforePrint
			...
			e.Cancel = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.CurrentTTDInvoiceDetail)).All(Function(Entity) Entity.FunctionHeading = Me.GetCurrentColumnValue("FunctionHeading"))
        ...
        Private Sub XrSubreportFunctionDetails_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrSubreportFunctionDetails.BeforePrint
            ...
            If e.Cancel = False AndAlso TypeOf XrSubreportFunctionDetails.ReportSource Is FunctionDetailSubReport AndAlso
                ...
                CurrentTTDInvoiceDetails = CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.CurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionCode = FunctionCode).ToList
