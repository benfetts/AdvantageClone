...
#Region " Methods "
        ...
        Private Sub GroupFooterInsideOutside_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupFooterInsideOutside.BeforePrint
			...
			e.Cancel = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.CurrentTTDInvoiceDetail)).All(Function(Entity) Entity.FunctionType = Me.GetCurrentColumnValue("FunctionType"))
