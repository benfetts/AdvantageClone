Namespace Invoices.EstimateCurrentTTD
	...
	"d ([Parameters.HeaderGroupBy] == 0 Or [Parameters.HeaderGroupBy] == 1)"
			...
			Me.XrTableCellJobSubTotal.Weight = 1.6320298611983586R
			'
			'XrTableCell5
			'
			...
			Me.XrTableCell5.Weight = 0.42649252588655656R
			'
			'XrTableCellSpacer2
			'
			Me.XrTableCellSpacer2.Dpi = 100.0!
			Me.XrTableCellSpacer2.Name = "XrTableCellSpacer2"
			Me.XrTableCellSpacer2.Weight = 0.085778038909061216R
			'
			...
			Me.XrTableJobSubTotalData.Weight = 0.42687574855592691R
			'
			'XrTableCellSpacer1
			'
			Me.XrTableCellSpacer1.Dpi = 100.0!
			Me.XrTableCellSpacer1.Name = "XrTableCellSpacer1"
			Me.XrTableCellSpacer1.Weight = 0.077471131217534378R
			'
			'XrTableCell1
			'
			...
			Me.XrTableCell1.Weight = 0.43665780093934786R
			'
			...
			'GroupFooterInvoice
			'
			Me.GroupFooterInvoice.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelGrandTotal, Me.XrLabelTotal, Me.XrLabelInvoiceEstimateSubTotalData, Me.XrLabelInvoiceSubTotalData, Me.XrLabelTaxable, Me.XrSubreportInvoiceTaxInformation, Me.XrLabelInvoiceSubTotal, Me.XrLabelInvoiceTTDSubTotalData, Me.Line206})
			...
			Me.XrLabelInvoiceEstimateSubTotalData.LocationFloat = New DevExpress.Utils.PointFloat(433.8607!, 5.937449!)
	...
	"mount])"
			...
			Me.XrLabelGrandTotal.LocationFloat = New DevExpress.Utils.PointFloat(543.5082!, 87.57998!)
