Namespace Invoices.EstimateCurrentTTD
	...
	Partial Public Class GroupByFunctionHeadingFunctionSubReport
		...
		Private Sub InitializeComponent()
			...
			'GroupHeader
			'
			Me.GroupHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrSubreportFunctionDetails, Me.XrLabelEstimateCurrentAmount, Me.XrLabelTTDCurrentAmount, Me.XrLabelFunctionDescription, Me.XrLabelCurrentAmount, Me.XrLabelIsTaxable})
			...
			'
			Me.GroupHeaderFunctionHeading.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelEstimateTotalAmountHeader, Me.XrLabelTTDTotalAmountHeader, Me.XrLabelTotalAmountHeader, Me.XrLabelFunctionType})
			Me.GroupHeaderFunctionHeading.Dpi = 100.0!
			...
			Me.XrRichTextEstimateFunctionComment.SizeF = New System.Drawing.SizeF(358.8598!, 17.0!)
			'
			...
			'
			Me.GroupFooterFunctionHeading.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelEstimateTotalAmount, Me.XrLineEstimateTotalAmount, Me.XrLabelTTDTotalAmount, Me.XrLineTTDTotalAmount, Me.XrLabelTotalAmount, Me.XrLineTotalAmount})
			Me.GroupFooterFunctionHeading.Dpi = 100.0!
			...
			Me.XrLabelEstimateTotalAmount.LocationFloat = New DevExpress.Utils.PointFloat(433.8607!, 2.000014!)
			...
			Me.XrLineEstimateTotalAmount.LocationFloat = New DevExpress.Utils.PointFloat(433.86!, 0!)
