Namespace Invoices.EstimateCurrentTTD
	...
	Partial Public Class GroupByInsideOutsideFunctionSubReport
		...
		Private Sub InitializeComponent()
			...
			'
			Me.GroupHeaderInsideOutside.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelEstimateTotalAmountHeader, Me.XrLabelTTDTotalAmountHeader, Me.XrLabelTotalAmountHeader, Me.XrLabelFunctionType})
			Me.GroupHeaderInsideOutside.Dpi = 100.0!
	...
	"rameters.ShowQuantity],[Quantity],NULL))"
			...
			'
			Me.GroupFooterInsideOutside.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelEstimateTotalAmount, Me.XrLineEstimateTotalAmount, Me.XrLabelTTDTotalAmount, Me.XrLineTTDTotalAmount, Me.XrLabelTotalAmount, Me.XrLineTotalAmount})
			Me.GroupFooterInsideOutside.Dpi = 100.0!
			...
			Me.XrTableComments.SizeF = New System.Drawing.SizeF(358.8603!, 34.0!)
			'
