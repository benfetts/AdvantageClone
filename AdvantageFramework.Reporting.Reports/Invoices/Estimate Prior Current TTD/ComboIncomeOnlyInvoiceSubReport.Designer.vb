Namespace Invoices.EstimatePriorCurrentTTD
	...
	"1"
			...
			Me.XrLabelTotalToDate.Dpi = 100.0!
	...
	"d ([Parameters.HeaderGroupBy] == 0 Or [Parameters.HeaderGroupBy] == 1)"
			...
			'
			Me.GroupHeaderJobComponentComment.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelJobVersionData, Me.XrRichText2, Me.XrRichText3, Me.XrRichText1, Me.XrRichText4, Me.XrTableComment})
			...
			Me.GroupHeaderJobComponentComment.HeightF = 172.8!
			...
			Me.XrLabelJobVersionData.LocationFloat = New DevExpress.Utils.PointFloat(0.00006357829!, 153.0!)
			...
			Me.XrLabelJobVersionData.SizeF = New System.Drawing.SizeF(749.9999!, 17.0!)
			'
			'XrRichText2
			'
			...
			Me.XrTableRowBillingApprovalClientComment.Dpi = 100.0!
			...
			Me.XrTableCellBillingApprovalClientComment.Dpi = 100.0!
			...
			Me.XrTableRowBillingJobComment.Dpi = 100.0!
			...
			Me.XrTableCellBillingJobComment.Dpi = 100.0!
			...
			Me.XrTableRowJobComment.Dpi = 100.0!
			...
			Me.XrTableCellJobComment.Dpi = 100.0!
			...
			Me.XrTableRowJobComponentComment.Dpi = 100.0!
			...
			Me.XrTableCellJobComponentComment.Dpi = 100.0!
			...
			Me.XrTableRowJobCampaignComment.Dpi = 100.0!
			...
			Me.XrTableCellJobCampaignComment.Dpi = 100.0!
			...
			'XrTableCell5
			'
			Me.XrTableCell5.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimateNetAmount")})
			...
			'XrTableCellSpacer3
			'
			Me.XrTableCellSpacer3.Dpi = 100.0!
			Me.XrTableCellSpacer3.Name = "XrTableCellSpacer3"
			Me.XrTableCellSpacer3.Weight = 0.090552550099134682R
			'
			'XrTableCell2
			'
			Me.XrTableCell2.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "PriorNetAmount")})
			...
			'XrTableCellSpacer2
			'
			Me.XrTableCellSpacer2.Dpi = 100.0!
			...
			'XrTableCellSpacer1
			'
			Me.XrTableCellSpacer1.Dpi = 100.0!
			Me.XrTableCellSpacer1.Name = "XrTableCellSpacer1"
			Me.XrTableCellSpacer1.Weight = 0.10314051708565128R
			'
			'XrTableCell1
			'
			Me.XrTableCell1.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TTDNetAmount")})
			...
			Me.XrLabelPriorTotalAmount.Dpi = 100.0!
			...
			Me.XrLabelEstimateCommissionAmount.Dpi = 100.0!
			...
			Me.XrLabelPriorCommissionAmount.Dpi = 100.0!
			...
			Me.XrLabelTTDCommissionAmount.Dpi = 100.0!
			...
			Me.XrLabelCommission.Dpi = 100.0!
			...
			Me.XrLabelCommissionAmount.Dpi = 100.0!
			...
			Me.XrLabelInvoiceEstimateSubTotalData.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "EstimateJobComponentAmount")})
			Me.XrLabelInvoiceEstimateSubTotalData.Dpi = 100.0!
			...
			Me.XrLabelInvoicePriorSubTotalData.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "PriorJobComponentAmount")})
			Me.XrLabelInvoicePriorSubTotalData.Dpi = 100.0!
			...
			Me.XrLabelInvoiceTTDSubTotalData.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TTDJobComponentAmount")})
			Me.XrLabelInvoiceTTDSubTotalData.Dpi = 100.0!
	...
	"x] ,0)"
			...
			'
			Me.TTDJobComponentAmount.Expression = "[TTDNetAmount] +Iif([Parameters.ShowCommissionSeparately], 0 ,[TTDCommissionAmoun" &
	"t])"
			...
			'
			Me.EstimateJobComponentAmount.Expression = "[EstimateNetAmount] +Iif([Parameters.ShowCommissionSeparately], 0 ,[EstimateCommi" &
	"ssionAmount])"
			...
			'
			Me.PriorJobComponentAmount.Expression = "[PriorNetAmount] +Iif([Parameters.ShowCommissionSeparately], 0 ,[PriorCommissionA" &
	"mount])"
			...
			Me.XrLabelGrandTotal.LocationFloat = New DevExpress.Utils.PointFloat(543.4277!, 88.54166!)
			...
			Me.XrLabelTotal.LocationFloat = New DevExpress.Utils.PointFloat(433.7783!, 88.54166!)
			...
			Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.TotalHGBPhrase, Me.HeaderGroupByLabel1, Me.HeaderGroupByData1, Me.TotalPhrase, Me.JobComponentAmount, Me.TTDJobComponentAmount, Me.EstimateJobComponentAmount, Me.PriorJobComponentAmount})
