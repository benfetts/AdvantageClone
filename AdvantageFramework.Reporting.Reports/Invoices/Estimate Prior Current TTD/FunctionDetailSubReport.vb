...
#Region " Variables "
		...
		Private _InvoiceDetails As Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail) = Nothing
...
#Region " Properties "
		...
		Public WriteOnly Property AccountReceivableInvoice As AdvantageFramework.InvoicePrinting.Classes.AccountReceivableInvoice
			...
			End Set
		End Property
		Public WriteOnly Property InvoiceDetails As Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail)
			Set(value As Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail))
...
#Region " Methods "
		...
		End Sub
		Private Sub XrLabelPriorTotalAmount_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrLabelPriorTotalAmount.BeforePrint

			XrLabelPriorTotalAmount.Text = FormatNumber(Me.PriorTotalAmount.Value, 2)

		End Sub
		Private Sub XrLabelEstimateTotalAmount_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrLabelEstimateTotalAmount.BeforePrint

			XrLabelEstimateTotalAmount.Text = FormatNumber(Me.EstimateTotalAmount.Value, 2)
