...
#Region " Methods "
        ...
        Private Sub XrSubreportFunctionDetails_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrSubreportFunctionDetails.BeforePrint
			...
			If e.Cancel = False AndAlso TypeOf XrSubreportFunctionDetails.ReportSource Is FunctionDetailSubReport AndAlso
				...
				If FunctionType = "E" Then
					...
					EstimatePriorCurrentTTDInvoiceDetails = CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = "E").ToList
				...
				FunctionDetailSubReport.PriorTotalAmount.Value = GetPriorTotalAmount(FunctionType)
				FunctionDetailSubReport.EstimateTotalAmount.Value = GetEstimateTotalAmount(FunctionType)
        ...
        End Sub
		Private Function GetPriorTotalAmount(FunctionType As String) As Decimal
			...
			Try
				...
				PriorTotalAmount = CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = FunctionType).Select(Function(Entity) Entity.PriorNetAmount.GetValueOrDefault(0)).Sum
		...
		Private Function GetTTDTotalAmount(FunctionType As String) As Decimal
			...
			Try
				...
				If FunctionType = "E" Then
					...
					TTDTotalAmount = CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = "E").Select(Function(Entity) Entity.TTDNetAmount.GetValueOrDefault(0)).Sum
		...
		End Function
		Private Function GetEstimateTotalAmount(FunctionType As String) As Decimal
			...
			Try
				...
				EstimateTotalAmount = CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = FunctionType).Select(Function(Entity) Entity.EstimateNetAmount.GetValueOrDefault(0)).Sum
		...
		Private Function CheckForCurrentAmount(FunctionType As String) As Boolean
			...
			If FunctionType = "E" Then
				...
				If CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.EstimatePriorCurrentTTDInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = "E").Select(Function(Entity) Entity.NetAmount.GetValueOrDefault(0)).Sum <> 0 Then
