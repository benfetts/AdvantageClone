Namespace Invoices
    ...
    Public Class InvoiceBackupDHNCTT
                    ...
                    If AdvantageFramework.Database.Procedures.Agency.IsMultiCurrencyEnabled(DbContext) Then
                        ...
                        If String.IsNullOrWhiteSpace(_AccountReceivableInvoice.CurrencyCode) = False Then
                            ...
                            If String.IsNullOrWhiteSpace(_AccountReceivableInvoice.CurrencySymbol) = False Then
                                ...
                                XrLabel22.TextFormatString = _AccountReceivableInvoice.CurrencySymbol & "{0:n2}"
                                XrLabel21.TextFormatString = _AccountReceivableInvoice.CurrencySymbol & "{0:n2}"
                                XrLabel20.TextFormatString = _AccountReceivableInvoice.CurrencySymbol & "{0:n2}"
                                XrLabelInvoiceSubTotalData.TextFormatString = _AccountReceivableInvoice.CurrencySymbol & "{0:n2}"

                            Else

                                XrLabel22.TextFormatString = "{0:n2}"
                                XrLabel21.TextFormatString = "{0:n2}"
                                XrLabel20.TextFormatString = "{0:n2}"
                                XrLabelInvoiceSubTotalData.TextFormatString = "{0:n2}"
                        ...
                        Else
                            ...
                            XrLabel22.TextFormatString = "{0:c2}"
                            XrLabel21.TextFormatString = "{0:c2}"
                            XrLabel20.TextFormatString = "{0:c2}"
                            XrLabelInvoiceSubTotalData.TextFormatString = "{0:c2}"
