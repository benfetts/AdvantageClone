Namespace Invoices.NetCommissionTaxCurrent
    ...
    Partial Public Class ComboIncomeOnlyInvoiceSubReport
        ...
        Private Sub InitializeComponent()
			...
			Me.XrLabelTaxForJob = New DevExpress.XtraReports.UI.XRLabel()
	...
	"1"
			...
			Me.XrLabelCurrentTotal.Dpi = 100.0!
	...
	"d ([Parameters.HeaderGroupBy] == 0 Or [Parameters.HeaderGroupBy] == 1)"
			...
			'
			Me.GroupFooterJobComponent.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLineJobTotal, Me.XrLabelNetTotalAmount, Me.XrLine4, Me.XrLine5, Me.XrLabelCommissionTotalAmount, Me.XrLine2, Me.XrLineCommissionJC2, Me.XrLabelCurrentTotalAmount, Me.XrLine1, Me.XrLineCurrentTotalJC2, Me.XrSubreportBillingHistory, Me.XrLabelTaxForJob, Me.XrLabelTaxAmount, Me.XrLineJC1, Me.XrLineJC2})
			...
			Me.XrLabelNetTotalAmount.Dpi = 100.0!
			...
			Me.XrLabelCommissionTotalAmount.Dpi = 100.0!
			...
			Me.XrLineCommissionJC2.Dpi = 100.0!
			...
			Me.XrLabelCurrentTotalAmount.Dpi = 100.0!
			...
			Me.XrLineCurrentTotalJC2.Dpi = 100.0!
			...
			'XrLabelTaxForJob
			'
			Me.XrLabelTaxForJob.BackColor = System.Drawing.Color.Transparent
			Me.XrLabelTaxForJob.BorderColor = System.Drawing.Color.Black
			Me.XrLabelTaxForJob.Borders = DevExpress.XtraPrinting.BorderSide.None
			Me.XrLabelTaxForJob.BorderWidth = 1.0!
			Me.XrLabelTaxForJob.CanGrow = False
			Me.XrLabelTaxForJob.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TotalPhrase")})
			Me.XrLabelTaxForJob.Dpi = 100.0!
			Me.XrLabelTaxForJob.Font = New System.Drawing.Font("Arial", 9.0!, System.Drawing.FontStyle.Bold)
			Me.XrLabelTaxForJob.ForeColor = System.Drawing.Color.Black
			Me.XrLabelTaxForJob.LocationFloat = New DevExpress.Utils.PointFloat(85.4166!, 10.41667!)
			Me.XrLabelTaxForJob.Name = "XrLabelTaxForJob"
			Me.XrLabelTaxForJob.SizeF = New System.Drawing.SizeF(240.9584!, 17.0!)
			Me.XrLabelTaxForJob.StylePriority.UsePadding = False
			Me.XrLabelTaxForJob.Text = "Total for Job"
			Me.XrLabelTaxForJob.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopLeft
			'
			'XrLabelTaxAmount
			'
	...
	"Job/Component:')"
			...
			Me.XrLabelGrandTotal.LocationFloat = New DevExpress.Utils.PointFloat(543.4274!, 16.04169!)
			...
			Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.TotalHGBPhrase, Me.HeaderGroupByLabel1, Me.HeaderGroupByData1, Me.TotalPhrase})
		...
		Friend WithEvents XrLabelTaxForJob As DevExpress.XtraReports.UI.XRLabel
