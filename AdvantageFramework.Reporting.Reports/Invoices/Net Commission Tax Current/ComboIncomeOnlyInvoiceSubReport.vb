        ...
        Private Sub Invoice_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
            ...
            If _InvoicePrintingSetting IsNot Nothing AndAlso _AccountReceivableInvoice IsNot Nothing Then
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
					...
					For Each StandardInvoiceDetail In StandardInvoiceDetails.ToList

                        If StandardInvoiceDetail.FunctionType = "I" Then

                            If AdvantageFramework.Database.Procedures.IncomeOnly.Load(DbContext).Any(Function(Entity) Entity.ARInvoiceNumber = StandardInvoiceDetail.InvoiceNumber AndAlso Entity.ARInvoiceSequence = StandardInvoiceDetail.InvoiceSequenceNumber AndAlso
                                                                                                                          Entity.ARType = StandardInvoiceDetail.InvoiceType AndAlso
                                                                                                                          Entity.JobNumber = StandardInvoiceDetail.JobNumber AndAlso Entity.JobComponentNumber = StandardInvoiceDetail.ComponentNumber AndAlso
                                                                                                                          Entity.FunctionCode = StandardInvoiceDetail.FunctionCode AndAlso
                                                                                                                          Entity.OrderNumber Is Nothing AndAlso Entity.LineNumber Is Nothing) = False Then

                                StandardInvoiceDetails.Remove(StandardInvoiceDetail)
        ...
        Private Sub GroupHeaderFunction_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupHeaderFunction.BeforePrint
            ...
            If _InvoicePrintingSetting IsNot Nothing Then
                ...
                If _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 1 Then
                    ...
                    GroupByFunctionSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                ...
                ElseIf _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 7 Then
                    ...
                    GroupByFunctionTypeFunctionSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                                                                                                                                                             Entity.JobNumber = Me.GetCurrentColumnValue("JobNumber") AndAlso
                                                                                                                                                             Entity.ComponentNumber = Me.GetCurrentColumnValue("ComponentNumber")).ToList
                ...
                ElseIf _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 2 Then
                    ...
                    GroupByFunctionHeadingFunctionSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                                                                                                                                                                Entity.JobNumber = Me.GetCurrentColumnValue("JobNumber") AndAlso
                                                                                                                                                                Entity.ComponentNumber = Me.GetCurrentColumnValue("ComponentNumber")).ToList
                ...
                ElseIf _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 8 Then
                    ...
                    GroupByFunctionTypeSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                                                                                                                                                     Entity.JobNumber = Me.GetCurrentColumnValue("JobNumber") AndAlso
                                                                                                                                                     Entity.ComponentNumber = Me.GetCurrentColumnValue("ComponentNumber")).ToList
                ...
                ElseIf _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 5 Then
                    ...
                    GroupByFunctionHeadingSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                                                                                                                                                        Entity.JobNumber = Me.GetCurrentColumnValue("JobNumber") AndAlso
                                                                                                                                                        Entity.ComponentNumber = Me.GetCurrentColumnValue("ComponentNumber")).ToList
                ...
                ElseIf _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 6 Then
                    ...
                    GroupByInsideOutsideSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                                                                                                                                                      Entity.JobNumber = Me.GetCurrentColumnValue("JobNumber") AndAlso
                                                                                                                                                      Entity.ComponentNumber = Me.GetCurrentColumnValue("ComponentNumber")).ToList
                ...
                ElseIf _InvoicePrintingSetting.GroupingOptionType.GetValueOrDefault(1) = 3 Then
                    ...
                    GroupByInsideOutsideFunctionSubReport.DataSource = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FullInvoiceNumber = Me.GetCurrentColumnValue("FullInvoiceNumber") AndAlso
                                                                                                                                                              Entity.JobNumber = Me.GetCurrentColumnValue("JobNumber") AndAlso
                                                                                                                                                              Entity.ComponentNumber = Me.GetCurrentColumnValue("ComponentNumber")).ToList
