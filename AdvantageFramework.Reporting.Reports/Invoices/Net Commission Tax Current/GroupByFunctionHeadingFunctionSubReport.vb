Namespace Invoices.NetCommissionTaxCurrent
	...
	Public Class GroupByFunctionHeadingFunctionSubReport
...
#Region " Methods "
		...
		End Sub
		Private Sub GroupFooterFunctionHeading_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupFooterFunctionHeading.BeforePrint

			e.Cancel = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).All(Function(Entity) Entity.FunctionHeading = Me.GetCurrentColumnValue("FunctionHeading"))
