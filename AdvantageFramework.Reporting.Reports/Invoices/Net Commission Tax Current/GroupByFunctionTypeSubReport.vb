Namespace Invoices.NetCommissionTaxCurrent
	...
	Public Class GroupByFunctionTypeSubReport
...
#Region " Methods "
		...
		End Sub
		Private Sub XrLabelCurrentTotalCurrentAmount_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrLabelCurrentTotalCurrentAmount.BeforePrint
		...
		End Sub
		Private Sub XrLabelCommissionCurrentAmount_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrLabelCommissionCurrentAmount.BeforePrint
		...
		End Sub
		Private Sub XrLabelTaxCurrentAmount_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrLabelTaxCurrentAmount.BeforePrint
		...
		End Sub
		Private Sub XrLabelNetCurrentAmount_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrLabelNetCurrentAmount.BeforePrint
        ...
        Private Sub XrSubreportFunctionDetails_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrSubreportFunctionDetails.BeforePrint
            ...
            If e.Cancel = False AndAlso TypeOf XrSubreportFunctionDetails.ReportSource Is FunctionDetailSubReport AndAlso
                ...
                StandardInvoiceDetails = CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = FunctionType).ToList
        ...
        Private Sub XrRichTextEstimateFunctionComment_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles XrRichTextEstimateFunctionComment.BeforePrint
            ...
            Try
                ...
                For Each FunctionComment In CType(Me.DataSource, Generic.List(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).Where(Function(Entity) Entity.FunctionType = Me.GetCurrentColumnValue("FunctionType")).Select(Function(Entity) Entity.EstimateFunctionComment).ToList
