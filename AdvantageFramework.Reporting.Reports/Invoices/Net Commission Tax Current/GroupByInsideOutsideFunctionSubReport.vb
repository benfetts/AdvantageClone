Namespace Invoices.NetCommissionTaxCurrent
	...
	Public Class GroupByInsideOutsideFunctionSubReport
...
#Region " Methods "
		...
		End Sub
		Private Sub GroupFooterInsideOutside_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupFooterInsideOutside.BeforePrint

			e.Cancel = TryCast(Me.DataSource, IEnumerable(Of AdvantageFramework.InvoicePrinting.Classes.StandardInvoiceDetail)).All(Function(Entity) Entity.FunctionType = Me.GetCurrentColumnValue("FunctionType"))
