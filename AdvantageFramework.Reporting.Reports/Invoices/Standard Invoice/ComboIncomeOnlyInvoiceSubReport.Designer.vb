Namespace Invoices.StandardInvoice
	...
	"1"
			...
			'GroupHeaderInvoice
			'
			Me.GroupHeaderInvoice.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelRate, Me.XrLineInvoiceHeaderLine1, Me.XrLabelHoursQuantity, Me.XrLineInvoiceHeaderLine2, Me.XrLabelCurrent})
			...
			Me.XrLabelRate.LocationFloat = New DevExpress.Utils.PointFloat(484.08!, 3.0!)
			...
			Me.XrLabelHoursQuantity.Dpi = 100.0!
			...
			Me.XrLabelHoursQuantity.LocationFloat = New DevExpress.Utils.PointFloat(568.5753!, 3.0!)
	...
	"d ([Parameters.HeaderGroupBy] == 0 Or [Parameters.HeaderGroupBy] == 1)"
			...
			'
			Me.GroupHeaderJobComponentComment.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelJobVersionData, Me.XrRichText4, Me.XrRichText2, Me.XrRichText3, Me.XrRichText1, Me.XrTableComment})
			...
			Me.XrLabelJobVersionData.LocationFloat = New DevExpress.Utils.PointFloat(0!, 153.0!)
			...
			Me.XrLabelJobVersionData.SizeF = New System.Drawing.SizeF(750.0!, 17.0!)
			'
			'XrRichText4
			'
			...
			Me.XrTableJobTax.SizeF = New System.Drawing.SizeF(368.29!, 17.0!)
			...
			Me.XrTableCellJobSubTotal.Weight = 1.5052289390060281R
			'
			...
			Me.XrTableJobSubTotalData.Weight = 0.49477106099397195R
			'
			...
			Me.XrSubreportJobTaxInformation.SizeF = New System.Drawing.SizeF(368.2882!, 54.24004!)
			'
			...
			Me.XrLabelJobTotalAmount.Dpi = 100.0!
			Me.XrLabelJobTotalAmount.Font = New System.Drawing.Font("Arial", 9.0!, System.Drawing.FontStyle.Bold)
			Me.XrLabelJobTotalAmount.LocationFloat = New DevExpress.Utils.PointFloat(651.1072!, 85.66003!)
			...
			Me.XrLabelJobTotalAmount.Summary = XrSummary2
			...
			Me.XrLineJC1.LocationFloat = New DevExpress.Utils.PointFloat(651.0309!, 79.66!)
			...
			Me.XrLineJC2.LocationFloat = New DevExpress.Utils.PointFloat(651.0309!, 76.66!)
			...
			Me.XrLabelCommissionAmount.Summary = XrSummary3
			...
			'GroupFooterInvoice
			'
			Me.GroupFooterInvoice.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabelTotal, Me.XrLabelGrandTotal, Me.XrLabelTaxable, Me.XrSubreportInvoiceTaxInformation, Me.XrLabelInvoiceSubTotal, Me.XrLabelInvoiceSubTotalData})
			...
			Me.XrLabelInvoiceSubTotalData.LocationFloat = New DevExpress.Utils.PointFloat(651.0309!, 5.937481!)
			...
			Me.XrLabelInvoiceSubTotalData.Summary = XrSummary5
	...
	"x] ,0)"
			...
			Me.XrLabelTotal.LocationFloat = New DevExpress.Utils.PointFloat(452.9268!, 88.54166!)
			...
			Me.XrLabelGrandTotal.LocationFloat = New DevExpress.Utils.PointFloat(543.5033!, 88.54166!)
			...
			Me.XrLabelGrandTotal.Summary = XrSummary4
			...
			Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.TotalJobPhrase, Me.JobComponentAmount, Me.HeaderGroupByLabel1, Me.HeaderGroupByData1, Me.TotalHGBPhrase})
