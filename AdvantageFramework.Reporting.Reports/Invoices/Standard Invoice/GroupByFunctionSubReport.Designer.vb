Namespace Invoices.StandardInvoice
    ...
    Partial Public Class GroupByFunctionSubReport
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(GroupByFunctionSubReport))
    ...
    "rs.ShowEmployeeFunctionDetails] == False, False)"
            '
            '
            '
    ...
    "rs.ShowVendorFunctionDetails] == False, False)"
            '
            '
            '
    ...
    "rs.ShowIncomeOnlyFunctionDetails] == False, False)"
            '
            '
            '
            ...
            Me.GroupHeader.SortingSummary = XrGroupSortingSummary1
            '
            'XrLabelIsTaxable
            '
    ...
    "rameters.ShowQuantity],[Quantity],NULL))"
            ...
            'XrTableComments
            '
            Me.XrTableComments.LocationFloat = New DevExpress.Utils.PointFloat(75.0!, 0!)
            ...
            Me.XrTableCellBillingApprovalFunctionComment.Summary = XrSummary3
            ...
            Me.XrTableCellBillingDetailComment.Summary = XrSummary4
