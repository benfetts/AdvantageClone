...
Namespace JobAnalysisDetail.Version3
    ...
    Public Class SummaryByJobComponentReport
...
#Region " Properties "
        ...
        Public ReadOnly Property AdvancedReportWriterReport As AdvantageFramework.Reporting.AdvancedReportWriterReports Implements IUserDefinedReport.AdvancedReportWriterReport
            Get
                AdvancedReportWriterReport = AdvantageFramework.Reporting.AdvancedReportWriterReports.JobDetailAnalysisV3JobComp
            End Get
        End Property
...
#End Region
        ...
        Private Sub SummaryByJobComponentReport_BeforePrint(sender As Object, e As PrintEventArgs) Handles Me.BeforePrint
