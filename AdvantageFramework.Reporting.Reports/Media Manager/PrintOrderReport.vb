...
#Region " Variables "
        ...
        'Private _GroupHeaderEveryPage2Printed As Boolean = False
        Private _AgencyList As Generic.List(Of AdvantageFramework.Database.Entities.Agency) = Nothing
        'Private _EndOfReportReached As Boolean = False
...
#Region "  Form Event Handlers "
        ...
        Private Sub PrintOrderReport_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        ...
        End Sub
        Private Sub PrintOrderReport_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
            ...
            If _LineNumbers IsNot Nothing AndAlso _Session IsNot Nothing Then
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    ...
                    If MultiCurrencyOn Then
                        ...
                        _PrintOrders = AdvantageFramework.MediaManager.LoadPrintOrder(DbContext, _OrderNumber, String.Join(",", _LineNumbers), _MediaFrom.Substring(0, 1), _ExchangeRate).ToList
...
#Region "  Control Event Handlers "
        ...
        Private Sub GroupHeaderEveryPage2_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupHeaderEveryPage2.BeforePrint
            ...
            'If Not _GroupHeaderEveryPage2Printed AndAlso Not _EndOfReportReached Then
            ...
            '    _GroupHeaderEveryPage2Printed = True
        ...
        Private Sub DetailSubreport_AdditionalAdSizes_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles DetailSubreport_AdditionalAdSizes.BeforePrint
            ...
            Dim AdditionalAdSizeCodeArray As IEnumerable(Of String) = Nothing
            Dim AdSizeCodeArray As String() = Nothing
                ...
                Try
                    ...
                    Using DbContext As New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                        ...
                        AdSizeCodes = (From Entity In DbContext.InternetPackageDetails
                                       ...
                                       Select Entity.AdSizeCode).Distinct.ToList

                        AdditionalAdSizeCodeArray = (From Entity In DbContext.InternetPackageDetails
                                                     Where Entity.OrderNumber = OrderNumber AndAlso
                                                           Entity.LineNumber = LineNumber AndAlso
                                                           Entity.IsActiveRevision = True AndAlso
                                                           (Entity.AdditionalAdSizeCodes IsNot Nothing AndAlso
                                                           Entity.AdditionalAdSizeCodes.Trim <> "")
                                                     Select Entity.AdditionalAdSizeCodes).Distinct.ToArray

                        If AdditionalAdSizeCodeArray IsNot Nothing AndAlso AdditionalAdSizeCodeArray.Count > 0 Then

                            For Each Item In AdditionalAdSizeCodeArray

                                AdSizeCodeArray = Item.Split(",")

                                For i = 0 To AdSizeCodeArray.Length - 1

                                    If AdSizeCodes.Contains(AdSizeCodeArray(i)) = False Then

                                        AdSizeCodes.Add(AdSizeCodeArray(i))
