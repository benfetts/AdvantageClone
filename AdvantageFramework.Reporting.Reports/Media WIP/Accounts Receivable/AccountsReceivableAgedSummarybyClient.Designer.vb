Namespace MediaWIP.AccountsReceivable
    ...
    Partial Public Class AccountsReceivableAgedSummarybyClient
        ...
        Private Sub InitializeComponent()
            ...
            'ClientFooter
            '
            Me.ClientFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.label17, Me.label16, Me.label15, Me.label14, Me.label13, Me.label12, Me.label11, Me.label3})
            Me.ClientFooter.HeightF = 16.05!
            ...
            Me.label21.Text = "Sorted by GL Account and Client"
            '
            'label20
            '
            ...
            Me.label20.Text = "Accounts Receivable Aged Summary by Client "
            '
            'PageFooter
            '
    ...
    ""
            ...
            '
            'AccountsReceivableAgedSummarybyClient
            '
