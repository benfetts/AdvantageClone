Namespace Media
    ...
    Public Class MediaBroadcastWorksheetPostBuyStationDaypartSummaryReport
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetPostBuyStationDaypartSummaryReport_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    ...
                    Me.DataSource = (From Entity In _MediaBroadcastWorksheetPostBuyReport
                                     ...
                                     Select New AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetPostBuyReport With {
                                            ...
                                            .DetailActual = Group.Sum(Function(Entity) Entity.DetailActual)}).OrderBy(Function(Entity) Entity.MarketName).ThenBy(Function(Entity) Entity.StationName).ThenBy(Function(Entity) Entity.Daypart).ToList
                    ...
                    '                          Entity.MarketName, Entity.MediaBroadcastWorksheetMarketID, Entity.NielsenMarketNumber, Entity.FlightDates,
                    '                          Entity.PostBook, Entity.StationName, Entity.Daypart, Entity.OrdSpots, Entity.ReportedDates,
                    '                          Entity.ActualSpots, Entity.Cost, Entity.Actual, Entity.Estimate, Entity.RatingsServiceID Into RptGroup = Group
                    '                 Select New AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetPostBuyReport With {
                    '                                  .ClientName = ClientName,
                    '                                  .DivisionName = DivisionName,
                    '                                  .ProductDescription = ProductDescription,
                    ...
                    '                                  .DetailActual = RptGroup.Sum(Function(Entity) Entity.DetailActual)}).OrderBy(Function(Entity) Entity.MarketName).ThenBy(Function(Entity) Entity.StationName).ThenBy(Function(Entity) Entity.Daypart).ToList
...
#Region "  Control Event Handlers "
        ...
        Private Sub GroupHeaderStation_Index_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupHeaderStation_Index.BeforePrint
            ...
            Else
                ...
                ActualTotal = (From Entity In DirectCast(Me.DataSource, Generic.List(Of AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetPostBuyReport))
                               Where Entity.StationName = StationName AndAlso
                                 Entity.MediaBroadcastWorksheetMarketID = MediaBroadcastWorksheetMarketID
                               Select Entity.DetailActual).Sum

                EstimateTotal = (From Entity In DirectCast(Me.DataSource, Generic.List(Of AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetPostBuyReport))
                                 Where Entity.StationName = StationName AndAlso
                                   Entity.MediaBroadcastWorksheetMarketID = MediaBroadcastWorksheetMarketID
                                 Select Entity.DetailEstimate).Sum
                ...
                Else
                    ...
                    GroupHeaderStation_Index.Text = FormatNumber(ActualTotal / EstimateTotal * 100, 0)
