Namespace Media
    ...
    Public Class MediaBroadcastWorksheetPostBuyStationSummaryReport
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetPostBuyStationSummaryReport_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    ...
                    Me.DataSource = (From Entity In _MediaBroadcastWorksheetPostBuyReport
                                     ...
                                     Select New AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetPostBuyReport With {
                                            ...
                                            .DetailActual = Group.Sum(Function(Entity) Entity.DetailActual)}).OrderBy(Function(Entity) Entity.MarketName).ThenBy(Function(Entity) Entity.StationName).ToList
                    ...
                    '                          Entity.MarketName, Entity.MediaBroadcastWorksheetMarketID, Entity.FlightDates, Entity.PostBook, Entity.StationName,
                    ...
                    '                                  .PostBook = PostBook,
                    '                                  .StationName = StationName,
                    '                                  .OrdSpots = RptGroup.Sum(Function(Entity) Entity.OrdSpots),
                    '                                  .ActualSpots = ActualSpots,
                    '                                  .Cost = Cost,
                    '                                  .Index = Index,
                    '                                  .ReportedDates = ReportedDates,
                    ...
                    '                                  .DetailActual = RptGroup.Sum(Function(Entity) Entity.DetailActual)}).OrderBy(Function(Entity) Entity.MarketName).ThenBy(Function(Entity) Entity.StationName).ToList
