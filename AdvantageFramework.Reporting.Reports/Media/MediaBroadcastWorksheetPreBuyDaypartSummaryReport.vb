Namespace Media
    ...
    Public Class MediaBroadcastWorksheetPreBuyDaypartSummaryReport
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetPreBuyDaypartSummaryReport_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
            ...
            If _Session IsNot Nothing Then
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    ...
                    Me.DataSource = AdvantageFramework.Reporting.LoadMediaBroadcastWorksheetPreBuyData(DbContext, _ParameterDictionary).OrderBy(Function(Entity) Entity.MarketName).ThenBy(Function(Entity) Entity.Daypart).ToList
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.MediaBroadcastWorksheetInitialCriteria.WorksheetMarketVendors.ToString) Then
                    ...
                    If WorksheetMarketVendors IsNot Nothing Then
                        ...
                        CurrentMediaBroadcastWorksheetMarketID = Me.GetCurrentColumnValue(AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetPreBuyReport.Properties.MediaBroadcastWorksheetMarketID.ToString)
