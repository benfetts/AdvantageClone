Namespace Media
    ...
    Public Class MediaBroadcastWorksheetRadioPostBuyStationDaypartSummaryReport
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetRadioPostBuyStationDaypartSummaryReport_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
...
#Region "  Control Event Handlers "
        ...
        Private Sub GroupHeaderStation_Index_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupHeaderStation_Index.BeforePrint
            ...
            Else
                ...
                MediaBroadcastWorksheetMarketID = Me.GetCurrentColumnValue(AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPostBuyReport.Properties.MediaBroadcastWorksheetMarketID.ToString)
                ...
                ActualTotal = (From Entity In DirectCast(Me.DataSource, Generic.List(Of AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPostBuyReport))
                ...
                EstimateTotal = (From Entity In DirectCast(Me.DataSource, Generic.List(Of AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPostBuyReport))
                                 Where Entity.StationName = StationName AndAlso
                                   Entity.MediaBroadcastWorksheetMarketID = MediaBroadcastWorksheetMarketID
