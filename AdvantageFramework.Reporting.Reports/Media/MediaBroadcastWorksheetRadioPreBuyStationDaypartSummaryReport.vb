Namespace Media
    ...
    Public Class MediaBroadcastWorksheetRadioPreBuyStationDaypartSummaryReport
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetRadioPreBuyStationDaypartSummaryReport_DataSourceDemanded(sender As Object, e As EventArgs) Handles Me.DataSourceDemanded
            ...
            If _Session IsNot Nothing Then
                ...
                If _UseImpressions Then
                    ...
                    GroupHeaderStation_Estimate.TextFormatString = "{0:n0}"
                    ...
                    GroupHeaderStation_Actual.TextFormatString = "{0:n0}"
...
#Region "  Control Event Handlers "
        ...
        Private Sub GroupHeaderStation_Index_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles GroupHeaderStation_Index.BeforePrint
            ...
            Else
                ...
                MediaBroadcastWorksheetMarketID = Me.GetCurrentColumnValue(AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPreBuyReport.Properties.MediaBroadcastWorksheetMarketID.ToString)

                StationName = Me.GetCurrentColumnValue(AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPreBuyReport.Properties.StationName.ToString)

                SpotUpdatedEstimateTotal = (From Entity In DirectCast(Me.DataSource, Generic.List(Of AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPreBuyReport))
                ...
                SpotEstimateTotal = (From Entity In DirectCast(Me.DataSource, Generic.List(Of AdvantageFramework.Reporting.Database.Classes.MediaBroadcastWorksheetRadioPreBuyReport))
                                     Where Entity.StationName = StationName AndAlso
                                       Entity.MediaBroadcastWorksheetMarketID = MediaBroadcastWorksheetMarketID
