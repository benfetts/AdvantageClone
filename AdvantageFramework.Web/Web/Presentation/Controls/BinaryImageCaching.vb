...
Namespace Web.Presentation.Controls
    ...
    Public Class BinaryImageCaching

    End Class

    Public Class FileCacheStrategy
        Inherits DevExpress.Web.RuntimeStorageStrategy
        ...
        '    
        Public Overrides Function GetResourceKey(ByVal control As DevExpress.Web.ASPxWebControlBase, ByVal content() As Byte, ByVal mimeType As String) As String
        ...
        End Function
        Public Overrides Sub StoreResourceData(ByVal control As DevExpress.Web.ASPxWebControlBase, ByVal key As String, ByVal data As DevExpress.Web.BinaryStorageData)
            ...
            End Using
        End Sub
        Public Overrides Function GetResourceData(ByVal key As String) As DevExpress.Web.BinaryStorageData
            Using stream As New FileStream(GetFilePath(key), FileMode.Open)
                ...
                Return New DevExpress.Web.BinaryStorageData(content, mimeType)
            End Using
            Return Nothing
        End Function
    ...
    Public Class StaticImageStrategy
        ...
        Public Overrides Function GetResourceUrl(ByVal control As DevExpress.Web.ASPxWebControlBase, ByVal content() As Byte, ByVal mimeType As String, ByVal contentDisposition As String) As String
            Dim fileExtension As String = ""
            If mimeType.StartsWith("image/") Then
                fileExtension = "." & mimeType.Substring("image/".Length)
            End If
