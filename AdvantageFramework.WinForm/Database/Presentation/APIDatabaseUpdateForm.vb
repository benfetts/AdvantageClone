Namespace Database.Presentation
    ...
    Public Class APIDatabaseUpdateForm
...
#Region " Methods "
        ...
        Private Sub LoadScriptUpdates()
            ...
            If DatabaseVersion <> "" Then
                ...
                If My.Computer.FileSystem.DirectoryExists(My.Application.Info.DirectoryPath & "\API Scripts") Then

                    ReleaseDatabaseVersion = If(DatabaseVersion.Length = 10, DatabaseVersion.Substring(0, DatabaseVersion.Length - 3), DatabaseVersion)

                    DirectoryInfoList = My.Computer.FileSystem.GetDirectoryInfo(My.Application.Info.DirectoryPath & "\API Scripts").GetDirectories.ToList
        ...
        Private Sub LoadVersionNumbers()
            ...
            Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(Session.ConnectionString, Session.UserCode)
                ...
                Try
                    ...
                    LabelForm_APIVersionNumber.Text = SecurityDbContext.Database.SqlQuery(Of String)("SELECT VERSION_ID FROM dbo.ADVAN_UPDATE").FirstOrDefault

                Catch ex As Exception
                    LabelForm_APIVersionNumber.Text = ""
                End Try
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm(InternalOnlyMode As Boolean, BatchMode As Boolean)
            ...
            'objects
            Dim APIDatabaseUpdateForm As AdvantageFramework.Database.Presentation.APIDatabaseUpdateForm = Nothing

            APIDatabaseUpdateForm = New AdvantageFramework.Database.Presentation.APIDatabaseUpdateForm(InternalOnlyMode, BatchMode)

            APIDatabaseUpdateForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub APIDatabaseUpdateForm_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        End Sub
        Private Sub APIDatabaseUpdateForm_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
