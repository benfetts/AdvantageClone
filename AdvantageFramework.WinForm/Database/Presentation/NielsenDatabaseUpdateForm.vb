Namespace Database.Presentation
    ...
    Public Class NielsenDatabaseUpdateForm
...
#Region " Methods "
        ...
        Private Sub LoadScriptUpdates()
            ...
            If DatabaseVersion <> "" Then
                ...
                If My.Computer.FileSystem.DirectoryExists(My.Application.Info.DirectoryPath & "\Nielsen Scripts") Then

                    ReleaseDatabaseVersion = If(DatabaseVersion.Length = 10, DatabaseVersion.Substring(0, DatabaseVersion.Length - 3), DatabaseVersion)

                    DirectoryInfoList = My.Computer.FileSystem.GetDirectoryInfo(My.Application.Info.DirectoryPath & "\Nielsen Scripts").GetDirectories.ToList
        ...
        Private Sub LoadVersionNumbers()
            ...
            Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(Session.ConnectionString, Session.UserCode)
                ...
                Try
                    ...
                    LabelForm_NielsenVersionNumber.Text = SecurityDbContext.Database.SqlQuery(Of String)("SELECT VERSION_ID FROM dbo.ADVAN_UPDATE").FirstOrDefault

                Catch ex As Exception
                    LabelForm_NielsenVersionNumber.Text = ""
                End Try
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm(InternalOnlyMode As Boolean, BatchMode As Boolean)
            ...
            'objects
            Dim NielsenDatabaseUpdateForm As AdvantageFramework.Database.Presentation.NielsenDatabaseUpdateForm = Nothing

            NielsenDatabaseUpdateForm = New AdvantageFramework.Database.Presentation.NielsenDatabaseUpdateForm(InternalOnlyMode, BatchMode)

            NielsenDatabaseUpdateForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub NielsenDatabaseUpdateForm_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        End Sub
        Private Sub NielsenDatabaseUpdateForm_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
