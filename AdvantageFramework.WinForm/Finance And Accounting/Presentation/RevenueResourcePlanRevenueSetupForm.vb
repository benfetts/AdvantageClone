Namespace FinanceAndAccounting.Presentation
    ...
    Public Class RevenueResourcePlanRevenueSetupForm
...
#Region " Variables "
        ...
        Protected _ViewModel As AdvantageFramework.ViewModels.FinanceAndAccounting.RevenueResourcePlan.RevenueSetupViewModel = Nothing
...
#Region " Methods "
        ...
        Private Sub RefreshViewModel()
            ...
            ButtonItemRevenue_ViewDetails.Enabled = _ViewModel.RevenueViewDetailsEnabled
        ...
        Private Sub LoadGrid()
            ...
            DataGridViewForm_Clients.DataSource = _ViewModel.PlanClientRevenues
        ...
        Private Sub FormatGrid()
            ...
            If DataGridViewForm_Clients.Columns.ColumnByFieldName(AdvantageFramework.DTO.FinanceAndAccounting.RevenueResourcePlan.PlanClientRevenue.Properties.OwnerCode.ToString) IsNot Nothing Then
                ...
                DataGridViewForm_Clients.Columns(AdvantageFramework.DTO.FinanceAndAccounting.RevenueResourcePlan.PlanClientRevenue.Properties.OwnerCode.ToString).ColumnEdit = SubItemGridLookUpEditControl
        ...
        Private Sub LoadDashboard()
            ...
            Else
                ...
                If AdvantageFramework.My.Resources.RevenueResourcePlanRevenueDashboard IsNot Nothing AndAlso AdvantageFramework.My.Resources.RevenueResourcePlanRevenueDashboard.Length > 0 Then

                    MemoryStream = New System.IO.MemoryStream(AdvantageFramework.My.Resources.RevenueResourcePlanRevenueDashboard)
        ...
        End Sub
        Private Function CheckForOpenRevenueManageTab(RevenueResourcePlanRevenueID As Integer) As Boolean
            ...
            If TypeOf MdiParent Is AdvantageFramework.WinForm.Presentation.BaseForms.MDIApplicationForm Then
                ...
                For Each MdiChildForm In DirectCast(MdiParent, AdvantageFramework.WinForm.Presentation.BaseForms.MDIApplicationForm).MdiChildren
                    ...
                    If TypeOf MdiChildForm Is AdvantageFramework.FinanceAndAccounting.Presentation.RevenueResourcePlanRevenueManageForm Then

                        If DirectCast(MdiChildForm, AdvantageFramework.FinanceAndAccounting.Presentation.RevenueResourcePlanRevenueManageForm).RevenueResourcePlanRevenueID = RevenueResourcePlanRevenueID Then
            ...
            CheckForOpenRevenueManageTab = IsOpened
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm(RevenueResourcePlanID As Integer)
            ...
            'objects
            Dim RevenueResourcePlanRevenueSetupForm As RevenueResourcePlanRevenueSetupForm = Nothing

            RevenueResourcePlanRevenueSetupForm = New RevenueResourcePlanRevenueSetupForm(RevenueResourcePlanID)

            RevenueResourcePlanRevenueSetupForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub RevenueResourcePlanRevenueSetupForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

            ButtonItemActions_Add.Image = AdvantageFramework.My.Resources.AddImage
            ButtonItemActions_Delete.Image = AdvantageFramework.My.Resources.DeleteImage
            ButtonItemActions_Refresh.Image = AdvantageFramework.My.Resources.RefreshImage

            ButtonItemRevenue_ViewDetails.Image = AdvantageFramework.My.Resources.ViewImage
            ...
            _ViewModel = _Controller.RevenueSetup_Load(_RevenueResourcePlanID)
        ...
        End Sub
        Private Sub RevenueResourcePlanRevenueSetupForm_Shown(sender As Object, e As EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_Add_Click(sender As Object, e As EventArgs) Handles ButtonItemActions_Add.Click
            ...
            If RevenueResourcePlanRevenueAddDialog.ShowFormDialog(_RevenueResourcePlanID) = Windows.Forms.DialogResult.OK Then

                Me.SetFormActionAndShowWaitForm(AdvantageFramework.WinForm.Presentation.FormActions.Loading)

                _Controller.RevenueSetup_LoadPlanClientRevenues(_ViewModel)
        ...
        Private Sub ButtonItemActions_Delete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_Delete.Click
            ...
            If CheckForOpenRevenueManageTab(_ViewModel.SelectedPlanClientRevenue.ID) = False Then

                If AdvantageFramework.WinForm.MessageBox.Show("Are you sure you want to delete this revenue plan?", AdvantageFramework.WinForm.MessageBox.MessageBoxButtons.YesNo) = AdvantageFramework.WinForm.MessageBox.DialogResults.Yes Then

                    Me.SetFormActionAndShowWaitForm(AdvantageFramework.WinForm.Presentation.FormActions.Deleting)

                    _Controller.RevenueSetup_Delete(_ViewModel, DataGridViewForm_Clients.GetFirstSelectedRowDataBoundItem())
            ...
            Else
                ...
                AdvantageFramework.WinForm.MessageBox.Show("Please close revenue detail window before deleting.")
        ...
        End Sub
        Private Sub ButtonItemRevenue_ViewDetails_Click(sender As Object, e As EventArgs) Handles ButtonItemRevenue_ViewDetails.Click

            If CheckForOpenRevenueManageTab(_ViewModel.SelectedPlanClientRevenue.ID) = False Then

                RevenueResourcePlanRevenueManageForm.ShowForm(_ViewModel.SelectedPlanClientRevenue.RevenueResourcePlanID, _ViewModel.SelectedPlanClientRevenue.ID, _ViewModel.SelectedPlanClientRevenue.RevenueResourcePlanRevenueRevisionID)
        ...
        Private Sub ButtonItemDashboard_Edit_Click(sender As Object, e As EventArgs) Handles ButtonItemDashboard_Edit.Click
            ...
            If DashboardViewerForm_Dashboard.Dashboard IsNot Nothing Then
                ...
                If AdvantageFramework.Reporting.Presentation.DashboardEditorForm.ShowFormDialog(Me.Session, _ViewModel.DashboardDataSource, DashboardLayout, False) = Windows.Forms.DialogResult.OK Then
                    ...
                    _Controller.RevenueSetup_SaveDashboard(_ViewModel, DashboardLayout)
        ...
        Private Sub DataGridViewForm_Clients_FocusedRowChangedEvent(sender As Object, e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles DataGridViewForm_Clients.FocusedRowChangedEvent
            ...
            If Me.FormAction = AdvantageFramework.WinForm.Presentation.FormActions.None AndAlso Me.FormShown AndAlso
                ...
                _Controller.RevenueSetup_SelectedPlanClientRevenueChanged(_ViewModel, DataGridViewForm_Clients.GetFirstSelectedRowDataBoundItem())
        ...
        Private Sub DataGridViewForm_Clients_CellValueChangedEvent(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles DataGridViewForm_Clients.CellValueChangedEvent
            ...
            If Me.FormAction = AdvantageFramework.WinForm.Presentation.FormActions.None AndAlso Me.FormShown Then
                ...
                If e.Column.FieldName = AdvantageFramework.DTO.FinanceAndAccounting.RevenueResourcePlan.PlanClientRevenue.Properties.Notes.ToString OrElse
                        e.Column.FieldName = AdvantageFramework.DTO.FinanceAndAccounting.RevenueResourcePlan.PlanClientRevenue.Properties.RevisionNotes.ToString OrElse
                        e.Column.FieldName = AdvantageFramework.DTO.FinanceAndAccounting.RevenueResourcePlan.PlanClientRevenue.Properties.OwnerCode.ToString Then

                    _Controller.RevenueSetup_Save(_ViewModel, DataGridViewForm_Clients.GetRowDataBoundItem(e.RowHandle))
        ...
        Private Sub DataGridViewForm_Clients_RowDoubleClickEvent(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowClickEventArgs) Handles DataGridViewForm_Clients.RowDoubleClickEvent
            ...
            If Me.FormAction = AdvantageFramework.WinForm.Presentation.FormActions.None AndAlso Me.FormShown Then
                ...
                ButtonItemRevenue_ViewDetails.RaiseClick()
