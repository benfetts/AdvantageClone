Namespace Maintenance.Accounting.Presentation
    ...
    Partial Class VendorImportStagingForm
        ...
        Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(VendorImportStagingForm))
            Me.DataGridViewForm_ImportedVendors = New AdvantageFramework.WinForm.Presentation.Controls.DataGridView()
            ...
            '
            'DataGridViewForm_ImportedVendors
            '
            Me.DataGridViewForm_ImportedVendors.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                        Or System.Windows.Forms.AnchorStyles.Left) _
                        Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
            Me.DataGridViewForm_ImportedVendors.ControlType = AdvantageFramework.WinForm.Presentation.Controls.DataGridView.Type.EditableGrid
            Me.DataGridViewForm_ImportedVendors.ItemDescription = "Item(s)"
            Me.DataGridViewForm_ImportedVendors.Location = New System.Drawing.Point(12, 12)
            Me.DataGridViewForm_ImportedVendors.MultiSelect = True
            Me.DataGridViewForm_ImportedVendors.Name = "DataGridViewForm_ImportedVendors"
            Me.DataGridViewForm_ImportedVendors.NewItemRowPosition = DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.None
            Me.DataGridViewForm_ImportedVendors.ShowSelectDeselectAllButtons = False
            Me.DataGridViewForm_ImportedVendors.Size = New System.Drawing.Size(934, 466)
            Me.DataGridViewForm_ImportedVendors.TabIndex = 0
            Me.DataGridViewForm_ImportedVendors.UseEmbeddedNavigator = False
            Me.DataGridViewForm_ImportedVendors.ViewCaptionHeight = -1
            '
            ...
            Me.RibbonBarMergeContainerForm_ImportStaging.RibbonTabText = "Vendor Import"
            ...
            Me.Controls.Add(Me.DataGridViewForm_ImportedVendors)
            Me.Icon = CType(resources.GetObject("$this.Icon"), System.Drawing.Icon)
            Me.Name = "VendorImportStagingForm"
            Me.Text = "Vendor Import Staging"
            CType(Me.ErrorProvider, System.ComponentModel.ISupportInitialize).EndInit()
            Me.RibbonBarMergeContainerForm_ImportStaging.ResumeLayout(False)
            Me.ResumeLayout(False)

        End Sub
        Friend WithEvents DataGridViewForm_ImportedVendors As AdvantageFramework.WinForm.Presentation.Controls.DataGridView
