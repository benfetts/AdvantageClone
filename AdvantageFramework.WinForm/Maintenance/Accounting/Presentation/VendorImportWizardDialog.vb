Namespace Maintenance.Accounting.Presentation
    ...
    Public Class VendorImportWizardDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowWizardDialog() As System.Windows.Forms.DialogResult
            ...
            'objects
            Dim VendorImportWizardDialog As VendorImportWizardDialog = Nothing

            VendorImportWizardDialog = New VendorImportWizardDialog

            ShowWizardDialog = VendorImportWizardDialog.ShowDialog()
...
#Region "  Form Event Handlers "
        ...
        Private Sub VendorImportWizardDialog_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        End Sub
        Private Sub VendorImportWizardDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            TextBoxSelectImportOptions_ImportFile.SetAgencyImportPath("Vendor", True)

            WizardControlForm_Wizard.Image = AdvantageFramework.My.Resources.AdvantageLogoImage

            Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)

                If DbContext.ImportVendorStagings.Any Then

                    AdvantageFramework.WinForm.MessageBox.Show("Please complete the pending vendor import records prior to importing a new file.")
                    Me.Close()
        ...
        Private Sub WizardControlForm_Wizard_NextClick(ByVal sender As Object, ByVal e As DevExpress.XtraWizard.WizardCommandButtonClickEventArgs) Handles WizardControlForm_Wizard.NextClick
            ...
            If e.Page Is WizardPageWizard_SelectImportOptions Then
                ...
                If CanContinue Then
                    ...
                    If AdvantageFramework.Importing.CheckForStandardDefinitionFile(Importing.ImportType.Vendor, TextBoxSelectImportOptions_ImportFile.Text) = False Then
            ...
            If e.Direction = DevExpress.XtraWizard.Direction.Forward Then
                ...
                If e.Page Is WizardPageWizard_ImportingPage Then
                    ...
                    Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        If AdvantageFramework.Importing.ImportStandardDefinitionFile(Me.Session, Importing.ImportType.Vendor, TextBoxSelectImportOptions_ImportFile.Text, CheckBoxSelectImportOptions_AutoTrimOverflowData.Checked) Then
