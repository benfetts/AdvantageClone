Namespace Media.Presentation
    ...
    Public Class MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog
...
#Region " Variables "
        ...
        Protected _ViewModel As AdvantageFramework.ViewModels.Media.MediaBroadcastWorksheet.MediaBroadcastWorksheetMarketDetailsMakegoodDetailsViewModel = Nothing
        ...
        Protected _LineNumber As Integer = 0
...
#Region " Methods "
        ...
        Private Sub New(MediaBroadcastWorksheetMarketDetailsViewModel As AdvantageFramework.ViewModels.Media.MediaBroadcastWorksheet.MediaBroadcastWorksheetMarketDetailsViewModel,
                        VendorCode As String, LineNumber As Integer)
        ...
        Private Sub LoadViewModel()
            ...
            _ViewModel = _Controller.MarketDetailsMakegoodDetails_Load(_MediaBroadcastWorksheetMarketDetailsViewModel, _VendorCode, _LineNumber)
        ...
        Private Sub FormatGridOriginalState()
            ...
            BandedDataGridViewForm_MakegoodDetails.MakeColumnVisible(AdvantageFramework.Controller.Media.MediaBroadcastWorksheetController.MarketDetailsColumns.TotalSpots.ToString)
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(MediaBroadcastWorksheetMarketDetailsViewModel As AdvantageFramework.ViewModels.Media.MediaBroadcastWorksheet.MediaBroadcastWorksheetMarketDetailsViewModel,
                                              VendorCode As String, LineNumber As Integer) As System.Windows.Forms.DialogResult

            'objects
            Dim MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog As MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog = Nothing

            MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog = New MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog(MediaBroadcastWorksheetMarketDetailsViewModel, VendorCode, LineNumber)

            ShowFormDialog = MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog.ShowDialog()
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

            BandedDataGridViewForm_MakegoodDetails.OptionsBehavior.Editable = False
        ...
        End Sub
        Private Sub MediaBroadcastWorksheetMarketDetailMakegoodDetailsDialog_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        End Sub
        Private Sub BandedDataGridViewForm_MakegoodDetails_CustomDrawCellEvent(sender As Object, e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles BandedDataGridViewForm_MakegoodDetails.CustomDrawCellEvent
            ...
            If e.Column.FieldName = AdvantageFramework.Controller.Media.MediaBroadcastWorksheetController.MarketDetailsColumns.LineNumber.ToString Then
                ...
                If DirectCast(BandedDataGridViewForm_MakegoodDetails.CurrentView.GetRow(e.RowHandle), System.Data.DataRowView).Item(AdvantageFramework.Controller.Media.MediaBroadcastWorksheetController.MarketDetailsColumns.MakegoodNumber.ToString) <> 0 Then

                    e.DisplayText = e.CellValue.ToString.PadLeft(4, "0") & "-" & DirectCast(BandedDataGridViewForm_MakegoodDetails.CurrentView.GetRow(e.RowHandle), System.Data.DataRowView).Item(AdvantageFramework.Controller.Media.MediaBroadcastWorksheetController.MarketDetailsColumns.MakegoodNumber.ToString).ToString.PadLeft(2, "0")

                Else

                    e.DisplayText = e.CellValue.ToString.PadLeft(4, "0")

                End If

            End If

            If DirectCast(BandedDataGridViewForm_MakegoodDetails.CurrentView.GetRow(e.RowHandle), System.Data.DataRowView).Item("RowType") = "Non-Airing" Then
            ...
            If DirectCast(BandedDataGridViewForm_MakegoodDetails.CurrentView.GetRow(e.RowHandle), System.Data.DataRowView).Item("RowType") = "Variance" Then
