Namespace Media.Presentation
    ...
    Public Class MediaBroadcastWorksheetMarketGoalsCopyToDialog
...
#Region " Variables "
        ...
        Protected _ViewModel As AdvantageFramework.ViewModels.Media.MediaBroadcastWorksheet.MediaBroadcastWorksheetMarketGoalsCopyToViewModel = Nothing
...
#Region " Methods "
        ...
        Private Sub New(MediaBroadcastWorksheetMarketGoalsCopyToViewModel As AdvantageFramework.ViewModels.Media.MediaBroadcastWorksheet.MediaBroadcastWorksheetMarketGoalsCopyToViewModel,
            ...
            _ViewModel = MediaBroadcastWorksheetMarketGoalsCopyToViewModel
        ...
        Private Sub FormatGrid()
            ...
            If DataGridViewForm_Markets.Columns(AdvantageFramework.DTO.Media.MediaBroadcastWorksheet.WorksheetMarketGoalsCopy.Properties.MediaBroadcastWorksheetMarketRadioEthnicityID.ToString) IsNot Nothing AndAlso
                ...
                SubItemGridLookUpEditControl.DataSource = _Controller.MarketGoalsCopyTo_GetRepositoryMarketRadioEthnicity(_ViewModel)
        ...
        Private Sub RepositoryItemSelected_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs)
            ...
            DirectCast(DataGridViewForm_Markets.CurrentView.GetRow(DataGridViewForm_Markets.CurrentView.FocusedRowHandle), AdvantageFramework.DTO.Media.MediaBroadcastWorksheet.WorksheetMarketGoalsCopy).Selected = e.NewValue
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(MediaBroadcastWorksheetMarketGoalsCopyToViewModel As AdvantageFramework.ViewModels.Media.MediaBroadcastWorksheet.MediaBroadcastWorksheetMarketGoalsCopyToViewModel,
            ...
            'objects
            Dim MediaBroadcastWorksheetMarketGoalsCopyToDialog As MediaBroadcastWorksheetMarketGoalsCopyToDialog = Nothing

            MediaBroadcastWorksheetMarketGoalsCopyToDialog = New MediaBroadcastWorksheetMarketGoalsCopyToDialog(MediaBroadcastWorksheetMarketGoalsCopyToViewModel, MediaBroadcastWorksheetMarketGoalsViewModel)

            ShowFormDialog = MediaBroadcastWorksheetMarketGoalsCopyToDialog.ShowDialog()
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaBroadcastWorksheetMarketGoalsCopyToDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End Sub
        Private Sub MediaBroadcastWorksheetMarketGoalsCopyToDialog_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        Private Sub DataGridViewForm_Markets_SelectAllEvent() Handles DataGridViewForm_Markets.SelectAllEvent
            ...
            _Controller.MarketGoalsCopyTo_SelectDeselectAll(_ViewModel, True)
        ...
        Private Sub DataGridViewForm_Markets_DeselectAllEvent() Handles DataGridViewForm_Markets.DeselectAllEvent
            ...
            _Controller.MarketGoalsCopyTo_SelectDeselectAll(_ViewModel, False)
