Namespace Media.Presentation
    ...
    Public Class MediaRequestForProposalProcessGenerateRFPDialog
...
#Region " Variables "
        ...
        Protected _ViewModel As AdvantageFramework.ViewModels.Media.RequestForProposalProcessGenerateViewModel = Nothing
        Protected _Controller As AdvantageFramework.Controller.Media.MediaRequestForProposalController = Nothing
        Protected _GenerateRFPs As Generic.List(Of AdvantageFramework.DTO.Media.RFP.GenerateRFP) = Nothing
        Private _ViewMode As ViewMode = ViewMode.GenerateRFP
...
#Region " Methods "
        ...
        Private Sub New(GenerateRFPs As Generic.List(Of AdvantageFramework.DTO.Media.RFP.GenerateRFP), ContactTypeIDs As Generic.List(Of String))
        ...
        Private Sub LoadViewModel()
            ...
            If _ViewMode = ViewMode.GenerateRFP Then

                _ViewModel = _Controller.LoadRequestForProposalProcessGenerateViewModel(_GenerateRFPs, _ContactTypeIDs)
        ...
        Private Sub RefreshViewModel(GridOnly As Boolean)
            ...
            If _ViewMode = ViewMode.GenerateRFP Then
                ...
                Me.DataGridViewForm_VendorReps.DataSource = _ViewModel.GenerateRFPVendorReps

                ButtonItemActions_Process.Enabled = DataGridViewForm_VendorReps.GetAllRowsDataBoundItems.OfType(Of AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep).Where(Function(VR) VR.Process = True).Any
        ...
        End Sub
        Private Sub GenerateRFPs()

            'objects
            Dim GenerateRFPVendorReps As Generic.List(Of AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep) = Nothing
            ...
            GenerateRFPVendorReps = DataGridViewForm_VendorReps.GetAllRowsDataBoundItems.OfType(Of AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep).Where(Function(VR) VR.Process = True).ToList

            If AdvantageFramework.Reporting.Reports.ProcessGenerateRFPs(Me.Session, GenerateRFPVendorReps, TextBoxForm_Subject.GetText, TextBoxForm_Body.GetText, CheckBoxForm_CCToSender.Checked, AtLeastOneEmailFailed) Then

                If AtLeastOneEmailFailed Then

                    AdvantageFramework.WinForm.MessageBox.Show("Generate RFP Successful - however one or more emails failed to send.")

                Else

                    AdvantageFramework.WinForm.MessageBox.Show("Generate RFP Successful.")
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(GenerateRFPs As Generic.List(Of AdvantageFramework.DTO.Media.RFP.GenerateRFP), ContactTypeIDs As Generic.List(Of String)) As System.Windows.Forms.DialogResult

            'objects
            Dim MediaRequestForProposalProcessGenerateRFPDialog As MediaRequestForProposalProcessGenerateRFPDialog = Nothing

            MediaRequestForProposalProcessGenerateRFPDialog = New MediaRequestForProposalProcessGenerateRFPDialog(GenerateRFPs, ContactTypeIDs)

            ShowFormDialog = MediaRequestForProposalProcessGenerateRFPDialog.ShowDialog()
        ...
        Public Shared Function ShowFormDialog(AlertID As Integer) As System.Windows.Forms.DialogResult
            ...
            MediaRequestForProposalProcessGenerateRFPDialog = New MediaRequestForProposalProcessGenerateRFPDialog(AlertID)
...
#Region "  Form Event Handlers "
        ...
        Private Sub MediaRequestForProposalProcessGenerateRFPDialog_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        End Sub
        Private Sub MediaRequestForProposalProcessGenerateRFPDialog_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        Private Sub DataGridViewForm_VendorReps_CustomDrawCellEvent(sender As Object, e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles DataGridViewForm_VendorReps.CustomDrawCellEvent
            ...
            If e.Column.FieldName = AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep.Properties.DefaultCorrespondenceMethod.ToString Then
        ...
        Private Sub DataGridViewForm_VendorReps_ShowingEditorEvent(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles DataGridViewForm_VendorReps.ShowingEditorEvent
            ...
            If DataGridViewForm_VendorReps.CurrentView.FocusedColumn.FieldName <> AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep.Properties.Process.ToString AndAlso
        ...
        Private Sub DataGridViewForm_VendorReps_CustomRowCellEditEvent(sender As Object, e As DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs) Handles DataGridViewForm_VendorReps.CustomRowCellEditEvent
            ...
            If e.Column.FieldName = AdvantageFramework.DTO.Media.RFP.EmailVendorRepContact.Properties.Include.ToString OrElse e.Column.FieldName = AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep.Properties.Process.ToString Then
        ...
        Private Sub RepositoryItemBookend_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs)
            ...
            If _ViewMode = ViewMode.GenerateRFP Then
                ...
                GenerateRFPVendorRep = DataGridViewForm_VendorReps.CurrentView.GetRow(DataGridViewForm_VendorReps.CurrentView.FocusedRowHandle)

                _Controller.GenerateRFP_CheckUncheck(_ViewModel, GenerateRFPVendorRep, e.NewValue)
        ...
        Private Sub DataGridViewForm_VendorReps_RepositoryDataSourceLoadingEvent(FieldName As String, ByRef Datasource As Object) Handles DataGridViewForm_VendorReps.RepositoryDataSourceLoadingEvent
            ...
            If FieldName = AdvantageFramework.DTO.Media.RFP.GenerateRFPVendorRep.Properties.ContactType.ToString Then
