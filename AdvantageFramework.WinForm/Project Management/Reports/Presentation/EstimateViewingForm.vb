...
Namespace ProjectManagement.Reports.Presentation
    ...
    Public Class EstimateViewingForm
...
#Region " Properties "
        ...
        Public ReadOnly Property ErrorProvider As System.Windows.Forms.ErrorProvider Implements AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm.ErrorProvider
            ...
            End Get
        End Property
        Public Property FormAction As AdvantageFramework.WinForm.Presentation.FormActions Implements AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm.FormAction
...
#Region " Methods "
        ...
        Private Function LoadEstimates(Optional ByVal ClientCode As String = Nothing) As Generic.List(Of AdvantageFramework.Estimate.Printing.Classes.EstimateQuote)
            ...
            '        ElseIf EstNum <> EstimateQuote.EstimateNumber Then
            '            _MultiSelect = False
            '        End If
        ...
        Private Function Save() As Boolean
            ...
            If DataGridViewEstimates.HasRows Then
                ...
                EstimateQuotes = DataGridViewEstimates.GetAllModifiedRows.OfType(Of AdvantageFramework.Estimate.Printing.Classes.EstimateQuote)().ToList
        ...
        Private Sub EnableOrDisableActions()
            ...
            BarButtonItemActionsSave.Enabled = DataGridViewEstimates.UserEntryChanged
            BarButtonItemPrintOptionsSetup.Enabled = DataGridViewEstimates.HasASelectedRow
            BarButtonItemCommentsJob.Enabled = DataGridViewEstimates.HasASelectedRow 'AndAlso DataGridViewEstimates.GetAllSelectedRowsDataBoundItems.OfType(Of AdvantageFramework.Estimate.Printing.Classes.EstimateQuote.Where(Function(Entity) Entity.RecordType = "P").Any)
            BarButtonItemCommentsFunction.Enabled = DataGridViewEstimates.HasASelectedRow 'AndAlso DataGridViewEstimates.GetAllSelectedRowsDataBoundItems.OfType(Of AdvantageFramework.InvoicePrinting.Classes.AccountReceivableInvoice)().Where(Function(Entity) Entity.RecordType = "P").Any)
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal Session As AdvantageFramework.Security.Session, ByVal EstimateFormatType As AdvantageFramework.Estimate.Printing.EstimateFormatTypes, ByVal EstimateQuotes As Generic.List(Of AdvantageFramework.Estimate.Printing.Classes.EstimateQuote),
            ...
            'objects
            Dim EstimateViewingForm As EstimateViewingForm = Nothing

            EstimateViewingForm = New EstimateViewingForm(Session, EstimateFormatType, EstimateQuotes, EstimatePrintingSettings, EstimatePrintingSetting, UserDefinedReportID, EstimateFormat, DateToPrint)

            ShowFormDialog = EstimateViewingForm.ShowDialog()
...
#Region "  Control Event Handlers "
        ...
        Private Sub PrintPreviewBarItemExportToPDF_ItemClick(sender As Object, e As ItemClickEventArgs) Handles PrintPreviewBarItemExportToPDF.ItemClick

            ExportTo(InvoicePrinting.ToFileOptions.PDF)

        End Sub
        Private Sub PrintPreviewBarItemExportTo_ItemClick(sender As Object, e As ItemClickEventArgs) Handles PrintPreviewBarItemExportTo.ItemClick
            Dim EstimateQuotes As Generic.List(Of AdvantageFramework.Estimate.Printing.Classes.EstimateQuote) = Nothing
            ...
            If DataGridViewEstimates.HasASelectedRow Then
                ...
                If My.Computer.FileSystem.DirectoryExists(ExportPath) Then
                    ...
                    EstimateFormatType = _EstimateFormatType
