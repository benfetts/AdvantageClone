Namespace Reporting.Presentation
    ...
    Public Class AccountsPayableInvoiceDetailInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim AccountsPayableInvoiceDetailInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.AccountsPayableInvoiceDetailInitialLoadingDialog = Nothing

            AccountsPayableInvoiceDetailInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.AccountsPayableInvoiceDetailInitialLoadingDialog(DynamicReport, ParameterDictionary)

            ShowFormDialog = AccountsPayableInvoiceDetailInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = AccountsPayableInvoiceDetailInitialLoadingDialog.ParameterDictionary
...
#Region "  Form Event Handlers "
        ...
        Private Sub AccountPayableInvoiceDetailInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.StartingPostPeriodCode.ToString) AndAlso
                    ...
                    Try
                        ...
                        ComboBoxForm_StartingPostPeriod.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.StartingPostPeriodCode.ToString)
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.EndingPostPeriodCode.ToString) AndAlso
                    ...
                    Try
                        ...
                        ComboBoxForm_EndingPostPeriod.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.EndingPostPeriodCode.ToString)
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.AgingDate.ToString) AndAlso
                        IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.AgingDate.ToString)) = False Then

                    Try

                        DateTimePickerForm_AgingDate.ValueObject = _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.AgingDate.ToString)
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                If ComboBoxForm_StartingPostPeriod.SelectedValue <= ComboBoxForm_EndingPostPeriod.SelectedValue Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.StartingPostPeriodCode.ToString) = ComboBoxForm_StartingPostPeriod.GetSelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.EndingPostPeriodCode.ToString) = ComboBoxForm_EndingPostPeriod.GetSelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.IncludeOpenAccountsPayableOnly.ToString) = CheckBoxForm_IncludeOpenAccountsPayableOnly.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.IncludeBroadcastOrderLineMonth.ToString) = RadioButtonMediaOption_IncludeBroadcastByOrderLineMonth.Checked

                    _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.AgingDate.ToString) = DateTimePickerForm_AgingDate.GetValue
                    _ParameterDictionary(AdvantageFramework.Reporting.AccountsPayableInvoiceDetailInitialCriteria.AgingOptionIsInvoiceDate.ToString) = RadioButtonForm_InvoiceDate.Checked
