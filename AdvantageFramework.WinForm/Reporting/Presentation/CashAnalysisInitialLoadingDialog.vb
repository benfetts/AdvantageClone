Namespace Reporting.Presentation
    ...
    Public Class CashAnalysisInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim CashAnalysisInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.CashAnalysisInitialLoadingDialog = Nothing

            CashAnalysisInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.CashAnalysisInitialLoadingDialog(DynamicReport, ParameterDictionary)

            ShowFormDialog = CashAnalysisInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = CashAnalysisInitialLoadingDialog.ParameterDictionary
...
#Region "  Form Event Handlers "
        ...
        Private Sub CashAnalysisInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                If ComboBoxForm_StartingPostPeriod.SelectedValue <= ComboBoxForm_EndingPostPeriod.SelectedValue Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.CashAnaylsisParameters.StartingPostPeriodCode.ToString) = ComboBoxForm_StartingPostPeriod.SelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.CashAnaylsisParameters.EndingPostPeriodCode.ToString) = ComboBoxForm_EndingPostPeriod.SelectedValue
                    If _DynamicReport = DynamicReports.CashAnalysis Then
