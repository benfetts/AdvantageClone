Namespace Reporting.Presentation
    ...
    Public Class CashManagementProductionInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim CashManagementProductionInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.CashManagementProductionInitialLoadingDialog = Nothing

            CashManagementProductionInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.CashManagementProductionInitialLoadingDialog(DynamicReport, ParameterDictionary)

            ShowFormDialog = CashManagementProductionInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = CashManagementProductionInitialLoadingDialog.ParameterDictionary
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.CashManagementProductionInitialParameters.IncludeClosed.ToString) = IIf(CheckBoxForm_IncludeClosedJobs.Checked, 0, 1)
                _ParameterDictionary(AdvantageFramework.Reporting.CashManagementProductionInitialParameters.IncludeNonBillable.ToString) = IIf(CheckBox_IncludeNonBillable.Checked, 1, 0)
        ...
        Private Sub CheckBoxForm_IncludeClosedJobs_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxForm_IncludeClosedJobs.CheckedChanged
