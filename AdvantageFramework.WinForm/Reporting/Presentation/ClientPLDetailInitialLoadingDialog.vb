Namespace Reporting.Presentation
    ...
    Public Class ClientPLDetailInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal ShowReportOption As Boolean, ByRef ReportType As AdvantageFramework.Reporting.ReportTypes, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim ClientPLDetailInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.ClientPLDetailInitialLoadingDialog = Nothing

            ClientPLDetailInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.ClientPLDetailInitialLoadingDialog(ShowReportOption, ReportType, ParameterDictionary)

            ShowFormDialog = ClientPLDetailInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = ClientPLDetailInitialLoadingDialog.ParameterDictionary
                ReportType = ClientPLDetailInitialLoadingDialog.ReportType
...
#Region "  Form Event Handlers "
        ...
        Private Sub ClientPLInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                ...
                ComboBoxTopSection_Report.DataSource = AdvantageFramework.EnumUtilities.LoadEnumObjects(GetType(AdvantageFramework.Reporting.ClientPLReportTypes)).OrderBy(Function(EnumObject) EnumObject.Description).ToList
                ...
                ComboBoxForm_PriorPeriod1Start.Visible = False
                ComboBoxForm_PriorPeriod1End.Visible = False
                ComboBoxForm_PriorPeriod2Start.Visible = False
                ComboBoxForm_PriorPeriod2End.Visible = False

                LabelForm_PriorPeriod1Start.Visible = False
                LabelForm_PriorPeriod2Start.Visible = False
                LabelForm_PriorPeriod1End.Visible = False
                LabelForm_PriorPeriod2End.Visible = False

                ' ComboBox_OverheadSet.DataSource = AdvantageFramework.Database.Procedures.OverheadAccount.LoadDistinctOverheadAccounts(DbContext).ToList
