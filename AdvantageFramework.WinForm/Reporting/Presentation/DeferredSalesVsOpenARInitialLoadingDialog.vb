Namespace Reporting.Presentation
    ...
    Public Class DeferredSalesVsOpenARInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByVal ShowReportOption As Boolean, ByRef ReportType As AdvantageFramework.Reporting.ReportTypes, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim DeferredSalesVsOpenARInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.DeferredSalesVsOpenARInitialLoadingDialog = Nothing

            DeferredSalesVsOpenARInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.DeferredSalesVsOpenARInitialLoadingDialog(DynamicReport, ShowReportOption, ReportType, ParameterDictionary)

            ShowFormDialog = DeferredSalesVsOpenARInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = DeferredSalesVsOpenARInitialLoadingDialog.ParameterDictionary
                ReportType = DeferredSalesVsOpenARInitialLoadingDialog.ReportType
...
#Region "  Form Event Handlers "
        ...
        Private Sub MonthEndProductionWIPInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Me.CheckBoxFrom_IncludeMarkup.Checked = True
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.DeferredSalesVsOpenARInitialParameters.PeriodCutoff.ToString) = ComboBoxForm_EndPostPeriod.SelectedValue
                _ParameterDictionary(AdvantageFramework.Reporting.DeferredSalesVsOpenARInitialParameters.IncludeMedia.ToString) = If(CheckBoxFrom_IncludeMarkup.Checked, 2, 1)
