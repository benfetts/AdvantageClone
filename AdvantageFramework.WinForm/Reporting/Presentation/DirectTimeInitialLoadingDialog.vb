Namespace Reporting.Presentation
    ...
    Public Class DirectTimeInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByVal ShowReportOption As Boolean, ByRef ReportType As AdvantageFramework.Reporting.ReportTypes, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim DirectTimeInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.DirectTimeInitialLoadingDialog = Nothing

            DirectTimeInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.DirectTimeInitialLoadingDialog(DynamicReport, ShowReportOption, ReportType, ParameterDictionary)

            ShowFormDialog = DirectTimeInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = DirectTimeInitialLoadingDialog.ParameterDictionary
                ReportType = DirectTimeInitialLoadingDialog.ReportType
