Namespace Reporting.Presentation
    ...
    Public Class EstimateInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim EstimateInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.EstimateInitialLoadingDialog = Nothing

            EstimateInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.EstimateInitialLoadingDialog(0)

            ShowFormDialog = EstimateInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = EstimateInitialLoadingDialog.ParameterDictionary
...
#Region "  Form Event Handlers "
        ...
        Private Sub EstimateInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    DateTimePickerForm_From.Value = _ParameterDictionary(AdvantageFramework.Reporting.EstimateParameters.FromDate.ToString)
                ...
                Try
                    ...
                    DateTimePickerForm_To.Value = _ParameterDictionary(AdvantageFramework.Reporting.EstimateParameters.ToDate.ToString)
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                If DateTimePickerForm_From.Value <= DateTimePickerForm_To.Value Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimateParameters.FromDate.ToString) = DateTimePickerForm_From.Value
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimateParameters.ToDate.ToString) = DateTimePickerForm_To.Value
