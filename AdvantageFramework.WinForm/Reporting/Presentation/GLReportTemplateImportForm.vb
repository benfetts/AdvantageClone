Namespace Reporting.Presentation
    ...
    Public Class GLReportTemplateImportForm
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog() As System.Windows.Forms.DialogResult
            ...
            'objects
            Dim GLReportTemplateImportForm As GLReportTemplateImportForm = Nothing

            GLReportTemplateImportForm = New GLReportTemplateImportForm()

            ShowFormDialog = GLReportTemplateImportForm.ShowDialog()
        ...
        Public Shared Sub ShowForm()
            ...
            GLReportTemplateImportForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub GLReportTemplateImportForm_Load(sender As Object, e As EventArgs) Handles Me.Load

            If Me.IsFormModal Then

                TextBoxForm_UserDefinedReportContentsFile.Width = 727
                ButtonForm_Import.Visible = True

            Else

                TextBoxForm_UserDefinedReportContentsFile.Width = 807
                ButtonForm_Import.Visible = False

            End If

        End Sub
        Private Sub GLReportTemplateImportForm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        End Sub
        Private Sub GLReportTemplateImportForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
            ...
            TextBoxForm_GLReportTemplateContentsFile.SetRequired(True)
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_Import_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItemActions_Import.Click, ButtonForm_Import.Click
            ...
            If Me.Validator Then
                ...
                TextBoxForm_UserDefinedReportContentsFile.Enabled = False

                Me.ShowWaitForm("Processing...")

                AdvantageFramework.Reporting.Presentation.GLReportTemplateImport(Me.Session, TextBoxForm_GLReportTemplateContentsFile.Text, TextBoxForm_UserDefinedReportContentsFile.Text)
                ...
                TextBoxForm_UserDefinedReportContentsFile.Enabled = True
