Namespace Reporting.Presentation
    ...
    Public Class JobStatusReportUpdateDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal ReportID As Integer, ByRef Description As String, ByRef UserDefinedReportCategoryID As Nullable(Of Integer), ByVal AllowReportTypeChange As Boolean) As System.Windows.Forms.DialogResult
            ...
            'objects
            Dim JobStatusReportUpdateDialog As AdvantageFramework.Reporting.Presentation.JobStatusReportUpdateDialog = Nothing

            JobStatusReportUpdateDialog = New AdvantageFramework.Reporting.Presentation.JobStatusReportUpdateDialog(ReportID, Description, UserDefinedReportCategoryID, AllowReportTypeChange)

            ShowFormDialog = JobStatusReportUpdateDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                Description = JobStatusReportUpdateDialog.Description
                UserDefinedReportCategoryID = JobStatusReportUpdateDialog.UserDefinedReportCategoryID
...
#Region "  Form Event Handlers "
        ...
        Private Sub JobStatusReportUpdateDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
