Namespace Reporting.Presentation
    ...
    Public Class JobStatusReportsForm
            ...
            If UserDefinedReportCategoryID > 0 Then
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        DataGridViewForm_Reports.DataSource = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Load(ReportingDbContext).Include("UserDefinedReportCategory").ToList.Where(Function(Entity) Entity.UserDefinedReportCategoryID.GetValueOrDefault(0) = UserDefinedReportCategoryID AndAlso Entity.Type = AdvantageFramework.Reporting.DynamicReports.JobStatus).Select(Function(Entity) New AdvantageFramework.Database.Classes.UDReport(Entity)).OrderBy(Function(Entity) Entity.ReportCategory).ThenBy(Function(Entity) Entity.Description).ThenBy(Function(Entity) Entity.DatasetType).ToList
            ...
            Else
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        DataGridViewForm_Reports.DataSource = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Load(ReportingDbContext).Include("UserDefinedReportCategory").ToList.Where(Function(Entity) Entity.Type = AdvantageFramework.Reporting.DynamicReports.JobStatus).Select(Function(Entity) New AdvantageFramework.Database.Classes.UDReport(Entity)).OrderBy(Function(Entity) Entity.ReportCategory).ThenBy(Function(Entity) Entity.Description).ThenBy(Function(Entity) Entity.DatasetType).ToList
            ...
            If DataGridViewForm_Reports.HasOnlyOneSelectedRow Then
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    If UDReport IsNot Nothing Then
                        ...
                        AdvantageFramework.Reporting.Presentation.JobStatusReportEditForm.ShowForm(UDReport.ID)
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm()
            ...
            'objects
            Dim JobStatusReportsForm As JobStatusReportsForm = Nothing

            JobStatusReportsForm = New JobStatusReportsForm

            JobStatusReportsForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub JobStatusReportsForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_Add.Click
            ...
            AdvantageFramework.Reporting.Presentation.JobStatusReportEditForm.ShowForm(0)
        ...
        Private Sub ButtonItemActions_EditReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_EditReport.Click
            ...
            If ReportID > 0 Then
                ...
                AdvantageFramework.Reporting.Presentation.JobStatusReportEditForm.ShowForm(ReportID)
        ...
        Private Sub ButtonItemActions_UpdateInfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_UpdateInfo.Click
            ...
            If DynamicReport IsNot Nothing Then
                ...
                If AdvantageFramework.Reporting.Presentation.JobStatusReportUpdateDialog.ShowFormDialog(DynamicReport.ID, DynamicReport.Description, DynamicReport.UserDefinedReportCategoryID, False) = Windows.Forms.DialogResult.OK Then
