Namespace Reporting.Presentation
    ...
    Public Class JobVersionReportsForm
...
#Region " Methods "
            ...
            If UserDefinedReportCategoryID > 0 Then
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        DataGridViewForm_Reports.DataSource = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Load(ReportingDbContext).Include("UserDefinedReportCategory").ToList.Where(Function(Entity) Entity.UserDefinedReportCategoryID.GetValueOrDefault(0) = UserDefinedReportCategoryID AndAlso Entity.Type = AdvantageFramework.Reporting.DynamicReports.JobVersion AndAlso Entity.TemplateCode IsNot Nothing).Select(Function(Entity) New AdvantageFramework.Database.Classes.UDReport(Entity)).OrderBy(Function(Entity) Entity.ReportCategory).ThenBy(Function(Entity) Entity.Description).ThenBy(Function(Entity) Entity.DatasetType).ToList
            ...
            Else
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        DataGridViewForm_Reports.DataSource = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Load(ReportingDbContext).Include("UserDefinedReportCategory").ToList.Where(Function(Entity) Entity.Type = AdvantageFramework.Reporting.DynamicReports.JobVersion AndAlso Entity.TemplateCode IsNot Nothing).Select(Function(Entity) New AdvantageFramework.Database.Classes.UDReport(Entity)).OrderBy(Function(Entity) Entity.ReportCategory).ThenBy(Function(Entity) Entity.Description).ThenBy(Function(Entity) Entity.DatasetType).ToList
        ...
        Private Sub ViewDynamicReport()
            ...
            Dim JobVersionUDReport As AdvantageFramework.Reporting.Database.Entities.DynamicReport = Nothing
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        If UDReport IsNot Nothing Then
                            ...
                            JobVersionUDReport = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.LoadByDynamicReportID(ReportingDbContext, UDReport.ID)
                            JobVersionTemplate = AdvantageFramework.Database.Procedures.JobVersionTemplate.LoadByJobVersionTemplateCode(DbContext, JobVersionUDReport.TemplateCode)

                            If JobVersionTemplate IsNot Nothing Then
                                If JobVersionTemplate.IsInactive = -1 Then
                                    AdvantageFramework.WinForm.MessageBox.Show("The Job Version Template associated with this report is inactive. This report is no longer available.")
                                    Exit Sub
                                End If
                            Else
                                AdvantageFramework.WinForm.MessageBox.Show("The Job Version Template associated with this report has been deleted. This report is no longer available.")
                                Exit Sub
                            End If

                            AdvantageFramework.Reporting.Presentation.JobVersionReportEditForm.ShowForm(UDReport.ID)
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm()
            ...
            'objects
            Dim JobVersionReportsForm As JobVersionReportsForm = Nothing

            JobVersionReportsForm = New JobVersionReportsForm

            JobVersionReportsForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub JobVersionReportsForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_Add.Click
            ...
            AdvantageFramework.Reporting.Presentation.JobVersionReportEditForm.ShowForm(0)
            ...
            If ReportID > 0 Then
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                        ...
                        JobVersionUDReport = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.LoadByDynamicReportID(ReportingDbContext, ReportID)
                ...
                AdvantageFramework.Reporting.Presentation.JobVersionReportEditForm.ShowForm(ReportID)
        ...
        Private Sub ButtonItemActions_UpdateInfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_UpdateInfo.Click
            ...
            Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                    ...
                    If DynamicReport IsNot Nothing Then
                        JobVersionTemplate = AdvantageFramework.Database.Procedures.JobVersionTemplate.LoadByJobVersionTemplateCode(DbContext, DynamicReport.TemplateCode)
                        If JobVersionTemplate IsNot Nothing Then
                            If JobVersionTemplate.IsInactive = -1 Then
                                AdvantageFramework.WinForm.MessageBox.Show("The Job Version Template associated with this report is inactive. This report is no longer available.")
                                Exit Sub
            ...
            If DynamicReport IsNot Nothing Then
                ...
                If AdvantageFramework.Reporting.Presentation.JobVersionReportUpdateDialog.ShowFormDialog(DynamicReport.ID, DynamicReport.TemplateCode, DynamicReport.Description, DynamicReport.UserDefinedReportCategoryID, False) = Windows.Forms.DialogResult.OK Then
