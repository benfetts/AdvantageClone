Namespace Reporting.Presentation
    ...
    Public Class LegacyCustomReportImportForm
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm()
            ...
            'objects
            Dim LegacyCustomReportImportForm As LegacyCustomReportImportForm = Nothing

            LegacyCustomReportImportForm = New LegacyCustomReportImportForm

            LegacyCustomReportImportForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub LegacyCustomReportImportForm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        End Sub
        Private Sub LegacyCustomReportImportForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

            Me.ShowUnsavedChangesOnFormClosing = False

        End Sub
        Private Sub LegacyCustomReportImportForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_Import_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItemActions_Import.Click
            ...
            If Me.Validator Then
                ...
                AdvantageFramework.Reporting.Presentation.LegacyCustomReportUpdate(Me.Session, TextBoxForm_ApplicationContentsFile.Text)
