Namespace Reporting.Presentation
    ...
    Public Class MediaSpecificationReportEditForm
...
#Region " Methods "
        ...
        End Sub
        Private Sub LoadGrid(ByVal DateFrom As Date, ByVal DateTo As Date, ByVal DateType As Short, ByVal status As Integer, ByVal AcceptedOnly As Boolean)

            Try

                DataGridViewForm_JobVersionReport.DataSource = LoadMediaSpecificationReportDataTable(DateFrom, DateTo, DateType, status, AcceptedOnly, Me.Session.UserCode)

                Me.DataGridViewForm_JobVersionReport.CurrentView.ViewCaption = Me.DataGridViewForm_JobVersionReport.CurrentView.RowCount & " " & Me.ComboBoxTemplates_Templates.SelectedText & " Report(s)"

                For Each Column In DataGridViewForm_JobVersionReport.Columns

                    If Column IsNot Nothing Then

                        If Column.FieldName = "InternetGuaranteedImpressions" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                        If Column.FieldName = "NewspaperPrintQuantity" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                        If Column.FieldName = "NewspaperCirculation" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                        If Column.FieldName = "VendorSundayCirculation" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                        If Column.FieldName = "VendorDailyCirculation" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                        If Column.FieldName = "OrderBillAmount" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                        If Column.FieldName = "OrderNetAmount" Then
                            Column.DisplayFormat.FormatString = "n2"
                            Column.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                        End If
                    End If
        ...
        End Sub
        Private Function LoadMediaSpecificationReportDataTable(ByVal DateFrom As Date, ByVal DateTo As Date, ByVal DateType As Short, ByVal status As Integer, ByVal AcceptedOnly As Boolean, ByVal UserID As String) As System.Data.DataTable
            ...
            Using DbContext = New AdvantageFramework.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                ...
                Try
                    ...
                    Using SqlCommand = DbContext.CreateCommand()
                        ...
                        If Me.ComboBox_ReportType.SelectedValue = 77 Then
                            SqlCommand.CommandText = "advsp_media_spec"
                        ElseIf Me.ComboBox_ReportType.SelectedValue = 113 Then
                        ...
                        End If
                        SqlCommand.Parameters.AddWithValue("AcceptedOnly", AcceptedOnly)
            ...
            LoadMediaSpecificationReportDataTable = DataTable
        ...
        Private Sub LoadDynamicReportTemplate(ByVal DynamicReportID As Integer)
            ...
            IsActiveFilterString = DataGridViewForm_JobVersionReport.CurrentView.ActiveFilterEnabled

            DataGridViewForm_JobVersionReport.CurrentView.ActiveFilterEnabled = False
            ...
            Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(Me.Session.ConnectionString, Me.Session.UserCode)
                ...
                If DynamicReport IsNot Nothing Then
                    ...
                    Me.Text = "Media Specification Report - " & DynamicReport.Description

                    _Description = DynamicReport.Description
                    _UserDefinedReportCategoryID = DynamicReport.UserDefinedReportCategoryID

                    LoadGrid(CDate("01/01/1900"), CDate("01/01/1900"), CShort(0), ComboBoxTemplates_Templates.GetSelectedValue, False)
                    ...
                    If IsActiveFilterString Then
                        ...
                        DataGridViewForm_JobVersionReport.CurrentView.ActiveFilterEnabled = True
        ...
        Private Sub SaveAsDynamicReportTemplate()
            ...
            If AdvantageFramework.Reporting.Presentation.MediaSpecificationReportUpdateDialog.ShowFormDialog(0, Description, UserDefinedReportCategoryID, False) = System.Windows.Forms.DialogResult.OK Then
...
#Region "  Show Form Methods "
        ...
        Public Shared Sub ShowForm(ByVal DynamicReportID As Integer)
            ...
            'objects
            Dim MediaSpecificationReportEditForm As AdvantageFramework.Reporting.Presentation.MediaSpecificationReportEditForm = Nothing

            MediaSpecificationReportEditForm = New AdvantageFramework.Reporting.Presentation.MediaSpecificationReportEditForm(DynamicReportID)

            MediaSpecificationReportEditForm.Show()
...
#Region "  Form Event Handlers "
        ...
        Private Sub JobVersionReportEditForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            ButtonItemActions_AcceptedOnly.Image = My.Resources.MediaImage
            ...
            ComboBoxTemplates_Templates.DataSource = AdvantageFramework.EnumUtilities.GetEnumDataTable(GetType(AdvantageFramework.Reporting.MediaSpecificationStatusCriteria), False, True)
            ComboBoxTemplates_Templates.SelectedValue = 1

            ComboBoxCriteria_Criteria.DataSource = AdvantageFramework.EnumUtilities.GetEnumDataTable(GetType(AdvantageFramework.Reporting.MediaSpecificationInitialCriteria), False, True)

            ComboBox_ReportType.DataSource = AdvantageFramework.EnumUtilities.GetEnumDataTable(GetType(AdvantageFramework.Reporting.MediaSpecificationsReportTypes), False, True)
            ComboBoxTemplates_Templates.SelectedValue = 1
        ...
        Private Sub JobVersionReportEditForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
            ...
            Else
                ...
                If AdvantageFramework.Reporting.Presentation.MediaSpecificationReportUpdateDialog.ShowFormDialog(0, _Description, _UserDefinedReportCategoryID, True) = Windows.Forms.DialogResult.OK Then

                    Try
                        LoadGrid(CDate("01/01/1900"), CDate("01/01/1900"), CShort(0), ComboBoxTemplates_Templates.GetSelectedValue, False)

                        Me.Text = "Media Specification Report - " & _Description
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_View_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemActions_View.Click
            ...
            If Me.Validator Then
                ...
                If Me.ComboBox_ReportType.SelectedValue = 113 Then
                ...
                LoadGrid(CDate(DateTimePickerDateFrom_From.Value.ToShortDateString), CDate(DateTimePickerDateTo_To.Value.ToShortDateString),
                         CShort(ComboBoxCriteria_Criteria.GetSelectedValue), ComboBoxTemplates_Templates.GetSelectedValue,
                         ButtonItemActions_AcceptedOnly.Checked)
        ...
        Private Sub ButtonItemDateFrom_YTD_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemDateFrom_YTD.Click
            ...
            DateTimePickerDateTo_To.Value = New Date(Now.Year, 12, 31)
            DateTimePickerDateFrom_From.Value = Now
        ...
        Private Sub ButtonItemDateTo_MTD_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemDateTo_MTD.Click
			...
			If Now.Month = 4 Or Now.Month = 9 Or Now.Month = 6 Or Now.Month = 11 Then
                DateTimePickerDateTo_To.Value = New Date(Now.Year, Now.Month, 30)
            End If
            If Now.Month = 2 Then
				If DateTime.IsLeapYear(Now.Year) = True Then
                    DateTimePickerDateTo_To.Value = New Date(Now.Year, Now.Month, 29)
                Else
                    DateTimePickerDateTo_To.Value = New Date(Now.Year, Now.Month, 28)
                End If
            End If
			If Now.Month = 1 Or Now.Month = 3 Or Now.Month = 5 Or Now.Month = 7 Or Now.Month = 8 Or Now.Month = 10 Or Now.Month = 12 Then
                DateTimePickerDateTo_To.Value = New Date(Now.Year, Now.Month, 31)
            End If
        ...
        Private Sub ButtonItemDateFrom_1Year_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemDateFrom_1Year.Click
            ...
            DateTimePickerDateTo_To.Value = Now.AddYears(1)
            DateTimePickerDateFrom_From.Value = Now
        ...
        Private Sub ButtonItemDateTo_2Years_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonItemDateTo_2Years.Click
            ...
            DateTimePickerDateTo_To.Value = Now.AddYears(2)
            DateTimePickerDateFrom_From.Value = Now
