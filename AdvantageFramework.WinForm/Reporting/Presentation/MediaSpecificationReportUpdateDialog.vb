Namespace Reporting.Presentation
    ...
    Public Class MediaSpecificationReportUpdateDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal ReportID As Integer, ByRef Description As String, ByRef UserDefinedReportCategoryID As Nullable(Of Integer), ByVal AllowReportTypeChange As Boolean) As System.Windows.Forms.DialogResult
            ...
            'objects
            Dim MediaSpecificationReportUpdateDialog As AdvantageFramework.Reporting.Presentation.MediaSpecificationReportUpdateDialog = Nothing

            MediaSpecificationReportUpdateDialog = New AdvantageFramework.Reporting.Presentation.MediaSpecificationReportUpdateDialog(ReportID, Description, UserDefinedReportCategoryID, AllowReportTypeChange)

            ShowFormDialog = MediaSpecificationReportUpdateDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                Description = MediaSpecificationReportUpdateDialog.Description
                UserDefinedReportCategoryID = MediaSpecificationReportUpdateDialog.UserDefinedReportCategoryID
