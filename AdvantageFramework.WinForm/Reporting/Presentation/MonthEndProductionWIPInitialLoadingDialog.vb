Namespace Reporting.Presentation
    ...
    Public Class MonthEndProductionWIPInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByVal ShowReportOption As Boolean, ByRef ReportType As AdvantageFramework.Reporting.ReportTypes, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim MonthEndProductionWIPInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.MonthEndProductionWIPInitialLoadingDialog = Nothing

            MonthEndProductionWIPInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.MonthEndProductionWIPInitialLoadingDialog(DynamicReport, ShowReportOption, ReportType, ParameterDictionary)

            ShowFormDialog = MonthEndProductionWIPInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = MonthEndProductionWIPInitialLoadingDialog.ParameterDictionary
                ReportType = MonthEndProductionWIPInitialLoadingDialog.ReportType
        ...
        Private Sub MonthEndProductionWIPInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    ComboBoxForm_EndPostPeriod.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.EndPeriod.ToString)
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.EndPeriod.ToString) = ComboBoxForm_EndPostPeriod.SelectedValue
                _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.OrderOption.ToString) = If(RadioButtonControl_OpenOnly.Checked, 2, 1)
                ...
                If _ShowReportOption = True Then
                    If ComboBoxTopSection_Report.HasASelectedValue Then
                        ...
                        If CInt(ComboBoxTopSection_Report.GetSelectedValue) = AdvantageFramework.Reporting.MonthEndReportTypes.MediaWIPSummaryByClientBillingAPBalance Then
                            ...
                            _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.WIPOption.ToString) = "G"
                        ...
                        ElseIf CInt(ComboBoxTopSection_Report.GetSelectedValue) = AdvantageFramework.Reporting.MonthEndReportTypes.MediaOrdersWithZeroBalance Then
                            ...
                            _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.WIPOption.ToString) = "Z"
                ...
                Else
                    ...
                    ElseIf RadioButtonControl_OpenOrdersGLAccountLineOrders.Checked Then
                        _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.WIPOption.ToString) = "L"
