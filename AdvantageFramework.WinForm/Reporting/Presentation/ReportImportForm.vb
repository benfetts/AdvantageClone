...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog() As System.Windows.Forms.DialogResult
            ...
            'objects
            Dim ReportImportForm As ReportImportForm = Nothing

            ReportImportForm = New ReportImportForm()

            ShowFormDialog = ReportImportForm.ShowDialog()
...
#Region "  Form Event Handlers "
        ...
        Private Sub ReportImportForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        End Sub
        Private Sub ReportImportForm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        End Sub
        Private Sub ReportImportForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonItemActions_Import_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItemActions_Import.Click, ButtonForm_Import.Click
            ...
            If Me.Validator Then
                ...
                AdvantageFramework.Reporting.Presentation.ReportImport(Me.Session, TextBoxForm_ApplicationContentsFile.Text)
