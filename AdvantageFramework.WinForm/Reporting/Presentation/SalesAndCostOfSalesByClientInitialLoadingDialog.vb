Namespace Reporting.Presentation
    ...
    Public Class SalesAndCostOfSalesByClientInitialLoadingDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal DynamicReport As AdvantageFramework.Reporting.DynamicReports, ByRef ParameterDictionary As Generic.Dictionary(Of String, Object)) As Windows.Forms.DialogResult
            ...
            'objects
            Dim SalesAndCostOfSalesByClientInitialLoadingDialog As AdvantageFramework.Reporting.Presentation.SalesAndCostOfSalesByClientInitialLoadingDialog = Nothing

            SalesAndCostOfSalesByClientInitialLoadingDialog = New AdvantageFramework.Reporting.Presentation.SalesAndCostOfSalesByClientInitialLoadingDialog(DynamicReport, ParameterDictionary)

            ShowFormDialog = SalesAndCostOfSalesByClientInitialLoadingDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ParameterDictionary = SalesAndCostOfSalesByClientInitialLoadingDialog.ParameterDictionary
...
#Region "  Form Event Handlers "
        ...
        Private Sub SalesAndCostOfSalesByClientInitialLoadingDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.EndingPostPeriodCode.ToString) AndAlso
                        IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.EndingPostPeriodCode.ToString)) = False Then

                    Try

                        ComboBoxForm_StartingPostPeriod.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.EndingPostPeriodCode.ToString)
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.EndingPostPeriodCode.ToString) AndAlso
                    ...
                    Try
                        ...
                        ComboBoxForm_EndingPostPeriod.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.EndingPostPeriodCode.ToString)
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.RecordSourceID.ToString) AndAlso
                        IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.RecordSourceID.ToString)) = False Then

                    Try

                        ComboBoxForm_RecordSource.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.RecordSourceID.ToString)
...
#Region "  Control Event Handlers "
        ...
        Private Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If Me.Validator Then
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.StartingPostPeriodCode.ToString) = ComboBoxForm_StartingPostPeriod.GetSelectedValue
                _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.EndingPostPeriodCode.ToString) = ComboBoxForm_EndingPostPeriod.GetSelectedValue

                If ComboBoxForm_RecordSource.HasASelectedValue Then

                    _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.RecordSourceID.ToString) = ComboBoxForm_RecordSource.GetSelectedValue

                Else

                    _ParameterDictionary(AdvantageFramework.Reporting.SalesAndCOSbyClientInitialParameters.RecordSourceID.ToString) = 0
