Namespace Reporting.Presentation
    ...
    Public Class SprintReportUpdateDialog
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByVal ReportID As Integer, ByRef Description As String, ByRef UserDefinedReportCategoryID As Nullable(Of Integer), ByVal AllowReportTypeChange As Boolean) As System.Windows.Forms.DialogResult
            ...
            'objects
            Dim SprintReportUpdateDialog As AdvantageFramework.Reporting.Presentation.SprintReportUpdateDialog = Nothing

            SprintReportUpdateDialog = New AdvantageFramework.Reporting.Presentation.SprintReportUpdateDialog(ReportID, Description, UserDefinedReportCategoryID, AllowReportTypeChange)

            ShowFormDialog = SprintReportUpdateDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                Description = SprintReportUpdateDialog.Description
                UserDefinedReportCategoryID = SprintReportUpdateDialog.UserDefinedReportCategoryID
