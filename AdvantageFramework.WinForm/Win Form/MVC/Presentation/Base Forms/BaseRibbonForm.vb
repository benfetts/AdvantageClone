...
#Region " Methods "
		...
		End Sub
		Public Sub SetBaseFormParent(ByVal IBaseFormParent As AdvantageFramework.WinForm.MVC.Presentation.BaseForms.Interfaces.IBaseForm, ByVal ChildForm As AdvantageFramework.WinForm.MVC.Presentation.BaseForms.Interfaces.IBaseForm)
...
#Region "  Form Event Handlers "
		...
		Private Sub MVCBaseRibbonForm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		End Sub
		Private Sub MVCBaseRibbonForm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

			If Me.Enabled AndAlso (Me.ChildForms Is Nothing OrElse Me.ChildForms.Count = 0) AndAlso _ShowUnsavedChangesOnFormClosing AndAlso e.CloseReason = Windows.Forms.CloseReason.UserClosing Then
		...
		End Sub
		Private Sub MVCBaseRibbonForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		End Sub
		Private Sub MVCBaseRibbonForm_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
