...
#Region " Variables "
		...
		Protected _ControlType As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.Type = AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.Type.[Checked1Unchecked0]
		Protected _CheckValueType As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.CheckValueTypes = AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.CheckValueTypes.Integer
...
#Region " Properties "
		...
		Public Property SecurityEnabled As Boolean
			...
			End Set
		End Property
		Public Property ControlType() As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.Type
			Get
				ControlType = _ControlType
			End Get
			Set(ByVal value As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.Type)
				_ControlType = value
				SetupCheckBox()
			End Set
		End Property
		Public Property CheckValueType As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.CheckValueTypes
			Get
				CheckValueType = _CheckValueType
			End Get
			Set(ByVal value As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox.CheckValueTypes)
...
#Region " Methods "
		...
		Public Sub HandlesControl(ByVal RelatedControl As Object, ByVal RadioButtonStyle As Boolean)
			...
			If TypeOf RelatedControl Is AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox AndAlso Me.Checked = If(RadioButtonStyle, True, False) Then
		...
		Public Sub HandlesControl(ByVal RelatedControls As Generic.List(Of Object), ByVal RadioButtonStyle As Boolean)
			...
			For Each Control In RelatedControls
				...
				If TypeOf Control Is AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox AndAlso Me.Checked = If(RadioButtonStyle, True, False) Then
			...
			If ChildControls IsNot Nothing Then
				...
				If ChildControls.Count > 0 Then
					...
					For Each Control In ChildControls
						...
						If TypeOf Control Is AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox AndAlso Not Me.Checked Then
		...
		Public Sub HandleSiblingControls()
			...
			Dim CheckboxSibling As AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox = Nothing
			...
			If SiblingControls IsNot Nothing Then
				...
				If SiblingControls.Count > 0 OrElse OldestSibling IsNot Nothing Then
					...
					If OldestSibling IsNot Nothing AndAlso TypeOf OldestSibling Is AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox Then
					...
					For Each Control In SiblingList
						...
						If TypeOf Control Is AdvantageFramework.WinForm.MVC.Presentation.Controls.CheckBox AndAlso Me.Checked Then
