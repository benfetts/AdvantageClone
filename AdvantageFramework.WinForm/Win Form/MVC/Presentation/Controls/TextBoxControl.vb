...
#Region " Variables "
		...
		Protected _PropertyType As AdvantageFramework.BaseClasses.PropertyTypes = AdvantageFramework.BaseClasses.PropertyTypes.Default
		...
		Protected _CheckingSpelling As Boolean = False
...
#Region " Methods "
		...
		Protected Friend Function Validate(ByRef ErrorMessage As String) As Boolean
			...
			Try
				...
				If IsValid Then
                    ...
                    If _PropertyType = BaseClasses.PropertyTypes.Code AndAlso Me.Text.Trim <> "" Then

                        ErrorMessage = AdvantageFramework.BaseClasses.ValidatePropertyType(Nothing, Nothing, _PropertyType, Me.Text, IsValid)
		...
		Public Sub CheckSpelling()
			...
			If DirectCast(Me.FindForm, AdvantageFramework.WinForm.MVC.Presentation.BaseForms.Interfaces.IBaseForm).SpellChecker IsNot Nothing AndAlso _CheckingSpelling = False Then

				_CheckingSpelling = True

				Try

					SpellChecker = DirectCast(Me.FindForm, AdvantageFramework.WinForm.MVC.Presentation.BaseForms.Interfaces.IBaseForm).SpellChecker
...
#Region "  Control Event Handlers "
		...
		Private Sub TextBox_HandleCreated(sender As Object, e As EventArgs) Handles Me.HandleCreated
			...
			'AddHandler AdvantageFramework.WinForm.MVC.Presentation.Controls.LoadFormSettingsEvent, AddressOf LoadFormSettings

		End Sub
		Private Sub TextBox_HandleDestroyed(sender As Object, e As EventArgs) Handles Me.HandleDestroyed

			'RemoveHandler AdvantageFramework.WinForm.MVC.Presentation.Controls.LoadFormSettingsEvent, AddressOf LoadFormSettings
		...
		Private Sub TextBox_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.TextChanged
			...
			Dim CustomValidatorControl As AdvantageFramework.WinForm.MVC.Presentation.Controls.Validation.CustomValidatorControl = Nothing
			...
			If Me.Focused = False Then
				...
				If ParentForm IsNot Nothing AndAlso TypeOf ParentForm Is AdvantageFramework.WinForm.MVC.Presentation.BaseForms.BaseForm Then

					If DirectCast(ParentForm, AdvantageFramework.WinForm.MVC.Presentation.BaseForms.BaseForm).SuperValidator IsNot Nothing Then

						CustomValidatorControl = DirectCast(ParentForm, AdvantageFramework.WinForm.MVC.Presentation.BaseForms.BaseForm).SuperValidator.GetValidator1(Me)
