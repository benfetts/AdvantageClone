Namespace WinForm.Presentation.Controls
    ...
    Partial Class BandedDataGridView
        ...
        Private Sub InitializeComponent()
            Me.BandedDataGridView_GridControl = New AdvantageFramework.WinForm.Presentation.Controls.GridControl()
            Me.BandedGridViewGridControl_MainView = New AdvantageFramework.WinForm.Presentation.Controls.BandedGridView()
        ...
        End Sub
        Protected WithEvents BandedDataGridView_GridControl As AdvantageFramework.WinForm.Presentation.Controls.GridControl
        Protected WithEvents BandedGridViewGridControl_MainView As AdvantageFramework.WinForm.Presentation.Controls.BandedGridView
