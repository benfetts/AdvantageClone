...
#Region " Variables "
        ...
        Protected _DataSourceViewOption As AdvantageFramework.WinForm.Presentation.Controls.BandedDataGridView.DataSourceViewOptions = DataSourceViewOptions.Default
...
#Region " Properties "
        ...
        Public Property AllowExtraItemsInGridLookupEdits As Boolean
            Get
                AllowExtraItemsInGridLookupEdits = BandedGridViewGridControl_MainView.AllowExtraItemsInGridLookupEdits
            End Get
            Set(value As Boolean)
                BandedGridViewGridControl_MainView.AllowExtraItemsInGridLookupEdits = value
            End Set
        End Property
        Public Property RunStandardValidation As Boolean
            Get
                RunStandardValidation = BandedGridViewGridControl_MainView.RunStandardValidation
            End Get
            Set(value As Boolean)
                BandedGridViewGridControl_MainView.RunStandardValidation = value
            End Set
        End Property
        ...
        Public Property AutoFilterLookupColumns As Boolean
            Get
                AutoFilterLookupColumns = BandedGridViewGridControl_MainView.AutoFilterLookupColumns
            End Get
            Set(value As Boolean)
                BandedGridViewGridControl_MainView.AutoFilterLookupColumns = value
            End Set
        End Property
        Public Property AutoloadRepositoryDatasource As Boolean
            Get
                AutoloadRepositoryDatasource = BandedGridViewGridControl_MainView.AutoloadRepositoryDatasource
            End Get
            Set(value As Boolean)
                BandedGridViewGridControl_MainView.AutoloadRepositoryDatasource = value
            End Set
        End Property
        ...
        Public ReadOnly Property Columns() As DevExpress.XtraGrid.Columns.GridColumnCollection
            ...
            End Get
        End Property
        Public Property ControlType() As AdvantageFramework.WinForm.Presentation.Controls.BandedDataGridView.Type
            Get
        ...
        Public ReadOnly Property GridControl As AdvantageFramework.WinForm.Presentation.Controls.GridControl
            ...
            End Get
        End Property
        Public ReadOnly Property CurrentView As AdvantageFramework.WinForm.Presentation.Controls.BandedGridView
            Get
        ...
        Public Property AllowSelectGroupHeaderRow As Boolean
            ...
            End Set
        End Property
        Public Property DataSourceViewOption As AdvantageFramework.WinForm.Presentation.Controls.BandedDataGridView.DataSourceViewOptions
            Get
                DataSourceViewOption = _DataSourceViewOption
            End Get
            Set(value As AdvantageFramework.WinForm.Presentation.Controls.BandedDataGridView.DataSourceViewOptions)
...
#Region " Methods "
        ...
        Public Sub ClearDatasource(Optional ByVal DefaultList As Object = Nothing)
            ...
            BandedGridViewGridControl_MainView.DataSourceClearing = True
            ...
            BandedGridViewGridControl_MainView.DataSourceClearing = False
        ...
        Protected Overridable Sub SetupDataGrid()
            ...
            BandedGridViewGridControl_MainView.ControlType = _ControlType
            ...
            Select Case _ControlType
                ...
                Case Type.DynamicReport
                    ...
                    _BookmarkColumnIndex = -1
                    BandedGridViewGridControl_MainView.OptionsView.GroupFooterShowMode = DevExpress.XtraGrid.Views.Grid.GroupFooterShowMode.VisibleIfExpanded
                    _ByPassUserEntryChanged = True

                Case Type.EditableGrid

                    _BookmarkColumnIndex = 0
                    BandedGridViewGridControl_MainView.OptionsBehavior.CacheValuesOnRowUpdating = DevExpress.Data.CacheRowValuesMode.Disabled
        ...
        Protected Function LoadDataSourceView(ByVal JobComponents As IEnumerable(Of AdvantageFramework.IncomeOnly.Classes.JobComponent)) As Object
            ...
            LoadDataSourceView = (From JobComponent In JobComponents.ToList
                                  Select JobComponent.ID,
                                         ...
                                         [JobComponentNumber] = AdvantageFramework.StringUtilities.PadWithCharacter(JobComponent.JobComponentNumber.ToString, 2, "0", True),
        ...
        Protected Function LoadDataSourceView(ByVal Users As IEnumerable(Of AdvantageFramework.Security.Database.Entities.User)) As Object
            ...
            LoadDataSourceView = (From User In Users.ToList
                                  Select User.ID,
                                         ...
                                         User.EmployeeCode,
                                         User.Employee,
                                         User.Employee.Department).ToList.Select(Function(Entity) New With {.ID = Entity.ID,
                                                                                                            .UserCode = Entity.UserCode,
                                                                                                            .EmployeeCode = Entity.EmployeeCode,
                                                                                                            .EmployeeName = Entity.Employee.ToString,
                                                                                                            .DepartmentCode = IIf(Convert.ToString(Entity.Department) = System.String.Empty, Nothing, Entity.Department.Code),
                                                                                                            .DepartmentName = IIf(Convert.ToString(Entity.Department) = System.String.Empty, Nothing, Entity.Department.Description)}).ToList
        ...
        Protected Sub LoadDataSource(ByRef Value As Object)
            ...
            If TypeOf Value Is DevExpress.Data.Linq.LinqInstantFeedbackSource Then
                ...
                BandedDataGridView_GridControl.DataSource = Value
            ...
            Else
                ...
                If _BindingSource IsNot Nothing Then
                    ...
                    BandedGridViewGridControl_MainView.ObjectType = GetType(Object)
            ...
            ElseIf BandedGridViewGridControl_MainView.FocusedRowHandle = 0 AndAlso _BindingSource.Position = 1 AndAlso _IsFirstLoad = False Then
        ...
        Protected Sub LoadDataSourceViewOptions()
            ...
            Select Case _DataSourceViewOption
                ...
                Case DataSourceViewOptions.JobComp_CodeAndDescriptionCombined
                    ...
                    BandedGridViewGridControl_MainView.GridControl.RepositoryItems.Add(RepositoryItemCheckEdit)
        ...
        Public Function SaveLayout() As Boolean
            ...
            BandedGridViewGridControl_MainView.SaveLayoutToStream(FileStream, BandedGridViewGridControl_MainView.OptionsLayout)
        ...
        Public Function LoadLayout() As Boolean
            ...
            BandedGridViewGridControl_MainView.RestoreLayoutFromXml(My.Application.Info.DirectoryPath & "\Dynamic Report Files\Layout1.xml", BandedGridViewGridControl_MainView.OptionsLayout)
        ...
        Public Sub Print(ByVal LookAndFeel As DevExpress.LookAndFeel.UserLookAndFeel, ByVal DocumentDescription As String, Optional ByVal Images() As System.Drawing.Image = Nothing,
            ...
            If KeepLoading Then
                ...
                AddHandler PrintableComponentLink.CreateReportHeaderArea, AddressOf PrintableComponentLink_CreateReportHeaderArea
                ...
                RemoveHandler PrintableComponentLink.CreateReportHeaderArea, AddressOf PrintableComponentLink_CreateReportHeaderArea
        ...
        Public Sub ClearGridCustomization()
            ...
            BandedGridViewGridControl_MainView.RestoredLayoutNonVisibleGridColumnList = Nothing
...
#Region "  Control Event Handlers "
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_AddNewRowEvent(ByVal RowObject As Object) Handles BandedGridViewGridControl_MainView.AddNewRowEvent

            RaiseEvent AddNewRowEvent(RowObject)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_BeforeAddNewRowEvent(RowObject As Object, ByRef Cancel As Boolean) Handles BandedGridViewGridControl_MainView.BeforeAddNewRowEvent
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CellValueChanging(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles BandedGridViewGridControl_MainView.CellValueChanging

            _ChangesAutoSaved = False

            RaiseEvent CellValueChangingEvent(_ChangesAutoSaved, e)

            If _ChangesAutoSaved = False AndAlso BandedGridViewGridControl_MainView.UpdatingFilterData = False AndAlso
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles BandedGridViewGridControl_MainView.CellValueChanged
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_LoadGridColumnComboBoxEvent(ByVal GridColumn As DevExpress.XtraGrid.Columns.GridColumn) Handles BandedGridViewGridControl_MainView.LoadGridColumnComboBoxEvent

            RaiseEvent LoadGridColumnComboBoxEvent(GridColumn)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_RowClick(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowClickEventArgs) Handles BandedGridViewGridControl_MainView.RowClick
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_RowCountChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.RowCountChanged
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_DataSourceChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.DataSourceChanged

            RaiseEvent DataSourceChangedEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles BandedGridViewGridControl_MainView.FocusedRowChanged
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_SelectionChanged(ByVal sender As System.Object, ByVal e As DevExpress.Data.SelectionChangedEventArgs) Handles BandedGridViewGridControl_MainView.SelectionChanged
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_IsExistAnyRowFooterCellEvent(ByVal RowHandle As Integer, ByRef Exists As Boolean) Handles BandedGridViewGridControl_MainView.IsExistAnyRowFooterCellEvent
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_ColumnAddedEvent(ByVal GridColumn As DevExpress.XtraGrid.Columns.GridColumn) Handles BandedGridViewGridControl_MainView.ColumnAddedEvent

            RaiseEvent ColumnAddedEvent(GridColumn)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_ColumnChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.ColumnChanged

            RaiseEvent ColumnChangedEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_ColumnPositionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.ColumnPositionChanged

            RaiseEvent ColumnPositionChangedEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomColumnDisplayText(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs) Handles BandedGridViewGridControl_MainView.CustomColumnDisplayText

            RaiseEvent CustomColumnDisplayTextEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_AsyncCompleted(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.AsyncCompleted
        ...
        End Sub
        Private Sub BandedDataGridView_GridControl_ProcessGridKey(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles BandedDataGridView_GridControl.ProcessGridKey
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomRowFilter(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowFilterEventArgs) Handles BandedGridViewGridControl_MainView.CustomRowFilter
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_ValidatingEditor(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs) Handles BandedGridViewGridControl_MainView.ValidatingEditor

            RaiseEvent ValidatingEditorEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles BandedGridViewGridControl_MainView.InitNewRow
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_ShownEditor(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.ShownEditor

            RaiseEvent ShownEditorEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_QueryPopupNeedDatasource(ByVal FieldName As String, ByRef OverrideDefaultDatasource As Boolean, ByRef Datasource As Object) Handles BandedGridViewGridControl_MainView.QueryPopupNeedDatasource

            RaiseEvent QueryPopupNeedDatasourceEvent(FieldName, OverrideDefaultDatasource, Datasource)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_HiddenEditor(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.HiddenEditor

            RaiseEvent HiddenEditorEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_SubItemTextBoxButtonClickEvent(ByVal RowObject As Object) Handles BandedGridViewGridControl_MainView.SubItemTextBoxButtonClickEvent
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_BeforeLeaveRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowAllowEventArgs) Handles BandedGridViewGridControl_MainView.BeforeLeaveRow

            If BandedGridViewGridControl_MainView.IsValidRowHandle(e.RowHandle) Then

                RaiseEvent LeavingRowEvent(e)

                If BandedGridViewGridControl_MainView.IsNewItemRow(e.RowHandle) Then

                    BandedGridViewGridControl_MainView.RefreshData()
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomSummaryCalculate(ByVal sender As Object, ByVal e As DevExpress.Data.CustomSummaryEventArgs) Handles BandedGridViewGridControl_MainView.CustomSummaryCalculate

            RaiseEvent CustomSummaryCalculateEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_ColumnFilterChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.ColumnFilterChanged
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomColumnSort(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CustomColumnSortEventArgs) Handles BandedGridViewGridControl_MainView.CustomColumnSort

            RaiseEvent CustomColumnSortEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_TopRowChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BandedGridViewGridControl_MainView.TopRowChanged

            RaiseEvent TopRowChangedEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_RowCellStyle(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs) Handles BandedGridViewGridControl_MainView.RowCellStyle

            RaiseEvent RowCellStyleEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomRowCellEdit(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs) Handles BandedGridViewGridControl_MainView.CustomRowCellEdit

            RaiseEvent CustomRowCellEditEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_ColumnEditValueChangedEvent(ByRef Saved As Boolean, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles BandedGridViewGridControl_MainView.ColumnEditValueChangedEvent

            'RaiseEvent ColumnEditValueChangedEvent(Saved, e)

            'If Saved = False AndAlso BandedGridViewGridControl_MainView.UpdatingFilterData = False AndAlso _
            '        Me.IsNewItemOrAutoFilterRow(e.RowHandle) = False AndAlso _ByPassUserEntryChanged = False AndAlso
            '        _SuspendedForLoading = False Then
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_ShowingEditor(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles BandedGridViewGridControl_MainView.ShowingEditor
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomDrawCell(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles BandedGridViewGridControl_MainView.CustomDrawCell

            RaiseEvent CustomDrawCellEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_PopupMenuShowing(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs) Handles BandedGridViewGridControl_MainView.PopupMenuShowing
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_RepositoryDataSourceLoadingEvent(ByVal FieldName As String, ByRef Cancel As Boolean) Handles BandedGridViewGridControl_MainView.RepositoryDataSourceLoadingEvent

            RaiseEvent RepositoryDataSourceLoading(FieldName, Cancel)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_ShowFilterPopupListBox(sender As Object, e As DevExpress.XtraGrid.Views.Grid.FilterPopupListBoxEventArgs) Handles BandedGridViewGridControl_MainView.ShowFilterPopupListBox
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_RowCellClick(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs) Handles BandedGridViewGridControl_MainView.RowCellClick
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CustomDrawRowIndicator(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowIndicatorCustomDrawEventArgs) Handles BandedGridViewGridControl_MainView.CustomDrawRowIndicator
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_OnEditUnboundColumnClickEvent(GridColumn As DevExpress.XtraGrid.Columns.GridColumn) Handles BandedGridViewGridControl_MainView.OnEditUnboundColumnClickEvent
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_MouseDown(sender As Object, e As Windows.Forms.MouseEventArgs) Handles BandedGridViewGridControl_MainView.MouseDown
            ...
            If e.Button = Windows.Forms.MouseButtons.Right Then
                ...
                If _ShowColumnMenuOnRightClick Then
                    ...
                    If BandedGridViewGridControl_MainView.CalcHitInfo(e.X, e.Y).HitTest = DevExpress.XtraGrid.Views.Grid.ViewInfo.GridHitTest.Column Then
            ...
            If Me.AllowDragAndDrop Then
                ...
                If System.Windows.Forms.Control.ModifierKeys = System.Windows.Forms.Keys.None Then
                    ...
                    GridHitInfo = BandedGridViewGridControl_MainView.CalcHitInfo(New System.Drawing.Point(e.X, e.Y))
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_MouseMove(sender As Object, e As Windows.Forms.MouseEventArgs) Handles BandedGridViewGridControl_MainView.MouseMove
            ...
            If Me.AllowDragAndDrop AndAlso e.Button = System.Windows.Forms.MouseButtons.Left AndAlso _DragAndDropGridHitInfo IsNot Nothing Then
                ...
                If DragRectangle.Contains(New System.Drawing.Point(e.X, e.Y)) = False Then
                    ...
                    BandedDataGridView_GridControl.DoDragDrop(_DragAndDropGridHitInfo, System.Windows.Forms.DragDropEffects.All)
                    _DragAndDropGridHitInfo = Nothing
        ...
        End Sub
        Private Sub BandedDataGridView_GridControl_DragDrop(sender As Object, e As Windows.Forms.DragEventArgs) Handles BandedDataGridView_GridControl.DragDrop
            ...
            Try
                ...
                DragHitInfo = BandedGridViewGridControl_MainView.CalcHitInfo(BandedDataGridView_GridControl.PointToClient(New System.Drawing.Point(e.X, e.Y)))
            ...
            If GridHitInfo IsNot Nothing AndAlso DragHitInfo IsNot Nothing Then
                ...
                RaiseEvent DragAndDropRowsEvent(DragHitInfo.RowHandle, BandedGridViewGridControl_MainView.GetSelectedRows)

            End If

        End Sub
        Private Sub BandedDataGridView_GridControl_DragOver(sender As Object, e As Windows.Forms.DragEventArgs) Handles BandedDataGridView_GridControl.DragOver
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CellMerge(sender As Object, e As DevExpress.XtraGrid.Views.Grid.CellMergeEventArgs) Handles BandedGridViewGridControl_MainView.CellMerge

            RaiseEvent CellMergeEvent(sender, e)

        End Sub
        Private Sub BandedDataGridView_HandleCreated(sender As Object, e As EventArgs) Handles Me.HandleCreated

            'AddHandler AdvantageFramework.WinForm.Presentation.Controls.LoadFormSettingsEvent, AddressOf LoadFormSettings

        End Sub
        Private Sub BandedDataGridView_HandleDestroyed(sender As Object, e As EventArgs) Handles Me.HandleDestroyed

            'RemoveHandler AdvantageFramework.WinForm.Presentation.Controls.LoadFormSettingsEvent, AddressOf LoadFormSettings
            RemoveHandler BandedDataGridView_GridControl.EmbeddedNavigator.ButtonClick, AddressOf GridViewGridControl_EmbeddedNavigator_ButtonClick
            ...
            If _BindingSource IsNot Nothing Then
                ...
                Try
                    ...
                    BandedDataGridView_GridControl.RepositoryItems.Clear()
                ...
                Try
                    ...
                    For Each GridColumn In BandedGridViewGridControl_MainView.Columns.OfType(Of DevExpress.XtraGrid.Columns.GridColumn).ToList
                        ...
                        BandedGridViewGridControl_MainView.Columns.Remove(GridColumn)
            ...
            Try
                ...
                BandedDataGridView_GridControl.MainView = Nothing
            ...
            Try
                ...
                BandedGridViewGridControl_MainView.Dispose()
            ...
            Try
                ...
                BandedDataGridView_GridControl.Dispose()
        ...
        End Sub
        Private Sub BandedGridViewGridControl_MainView_CanAutoFillValueEvent(ByRef CanAutoFillValue As Boolean, PropertyDescriptor As ComponentModel.PropertyDescriptor) Handles BandedGridViewGridControl_MainView.CanAutoFillValueEvent

            RaiseEvent CanAutoFillValueEvent(CanAutoFillValue, PropertyDescriptor)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_GotFocus(sender As Object, e As EventArgs) Handles BandedGridViewGridControl_MainView.GotFocus

            RaiseEvent GotFocusEvent(sender, e)

        End Sub
        Private Sub BandedGridViewGridControl_MainView_LostFocus(sender As Object, e As EventArgs) Handles BandedGridViewGridControl_MainView.LostFocus
