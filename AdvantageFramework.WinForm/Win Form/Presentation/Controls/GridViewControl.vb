...
#Region " Properties "
        ...
        Friend Property Session As AdvantageFramework.Security.Session
            ...
            End Set
        End Property
        Friend Property ControlType() As AdvantageFramework.WinForm.Presentation.Controls.DataGridView.Type
            Get
...
#Region " Methods "
        ...
        Protected Overrides Sub OnDataController_DataSourceChanged(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            If Me.GridControl IsNot Nothing AndAlso TypeOf Me.GridControl.FindForm Is AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm Then

                If CType(Me.GridControl.FindForm, AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm).IsFormClosing = False Then
                    ...
                    Select Case ControlType
                        ...
                        Case SubItemGridLookUpEditControl.Type.ClientContact
                            ...
                            Try
                                ...
                                If GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, AdvantageFramework.Database.Entities.ClientContact.Properties.ContactTypeID.ToString) > 0 Then

                                    PropertyTypeValues.Add(BaseClasses.PropertyTypes.ContactTypeID, GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, AdvantageFramework.Database.Entities.ClientContact.Properties.ContactTypeID.ToString))
                        ...
                        Case SubItemGridLookUpEditControl.Type.BillingCoopCode
                            ...
                            Value = GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, AdvantageFramework.Database.Entities.BillingCoop.Properties.Description.ToString)

                            DefaultColumnTypeValues.Add(BaseClasses.DefaultColumnTypes.BillingCoopDescription, Value)

                        Case SubItemGridLookUpEditControl.Type.Task

                            Value = GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, AdvantageFramework.Database.Entities.Task.Properties.Description.ToString)

                            DefaultColumnTypeValues.Add(BaseClasses.DefaultColumnTypes.TaskDescription, Value)
                        ...
                        Case SubItemGridLookUpEditControl.Type.IOOrderNumber
                            ...
                            SetRowCellValueByFieldName(Me.FocusedRowHandle, AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.MediaType.ToString, GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.MediaType.ToString))
                            SetRowCellValueByFieldName(Me.FocusedRowHandle, AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.OrderDescription.ToString, GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, "Description"))

                        Case SubItemGridLookUpEditControl.Type.InternetType

                            DefaultColumnTypeValues.Add(BaseClasses.DefaultColumnTypes.InternetTypeDescription, GridLookUpEdit.Properties.View.GetRowCellValue(GridLookUpEdit.Properties.View.FocusedRowHandle, AdvantageFramework.Database.Entities.InternetType.Properties.Description.ToString))
                        ...
                        Case SubItemGridLookUpEditControl.Type.BuyerEmployeeCode
                            ...
                            DefaultColumnTypeValues.Add(BaseClasses.DefaultColumnTypes.BuyerEmployeeName, Value)
        ...
        Protected Sub SubItemGridLookUpEditControl_QueryPopup(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
            ...
            If _ControlType = DataGridView.Type.EditableGrid AndAlso TypeOf Me.ActiveEditor Is DevExpress.XtraEditors.GridLookUpEdit Then
                                ...
                                Select Case PropertyType
                                    ...
                                    Case BaseClasses.PropertyTypes.ClientCode
                                        ...
                                        If OverrideDefaultDatasource = False Then
                                            ...
                                            DataSource = From Client In AdvantageFramework.Database.Procedures.Client.LoadByUserCodeWithOfficeLimits(_Session, DbContext, SecurityDbContext)
                                    ...
                                    Case BaseClasses.PropertyTypes.DivisionCode
                                        ...
                                        If ClientCode <> "" Then
                                            ...
                                            If OverrideDefaultDatasource = False Then
                                                ...
                                                DataSource = From Division In AdvantageFramework.Database.Procedures.Division.LoadByUserCodeWithOfficeLimits(_Session, DbContext, SecurityDbContext)
                                    ...
                                    Case BaseClasses.PropertyTypes.ProductCode
                                        ...
                                        If ClientCode <> "" AndAlso DivisionCode <> "" Then
                                            ...
                                            If OverrideDefaultDatasource = False Then
                                                ...
                                                DataSource = From Product In AdvantageFramework.Database.Procedures.Product.LoadByUserCodeWithOfficeLimits(_Session, DbContext, SecurityDbContext, False, True)
        ...
        Protected Sub SubItemPopupEditControl_QueryPopupNeedAvailableCodes(ByRef AvailableObjects As Object, ByRef OverrideDefault As Boolean)
            ...
            If _ControlType = DataGridView.Type.EditableGrid AndAlso TypeOf Me.ActiveEditor Is DevExpress.XtraEditors.PopupContainerEdit Then
        ...
        End Sub
        Protected Sub AddSubItemTimeEdit(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ByVal SubItemTimeInputType As AdvantageFramework.WinForm.Presentation.Controls.SubItemTimeInput.Type)

            Dim SubItemTimeInput As AdvantageFramework.WinForm.Presentation.Controls.SubItemTimeInput = Nothing

            SubItemTimeInput = AdvantageFramework.WinForm.Presentation.Controls.CreateSubItemTimeEdit(SubItemTimeInputType)
        ...
        End Sub
        Protected Sub AddSubItemTimeEdit(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ByRef SubItemTimeInput As AdvantageFramework.WinForm.Presentation.Controls.SubItemTimeInput)

            Me.GridControl.RepositoryItems.Add(SubItemTimeInput)

            GridColumn.ColumnEdit = SubItemTimeInput
        ...
        Protected Sub AddSubItemDateEdit(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn)
            ...
            If SubItemDateInput IsNot Nothing Then
                ...
                SubItemDateInput.ControlType = SubItemDateInput.Type.Default
                AddSubItemDateEdit(GridColumn, SubItemDateInput)

            End If

        End Sub
        Protected Sub AddSubItemDateEdit(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, SubItemDateInputType As AdvantageFramework.WinForm.Presentation.Controls.SubItemDateInput.Type)
            ...
            If SubItemDateInput IsNot Nothing Then
                ...
                SubItemDateInput.ControlType = SubItemDateInputType
                AddSubItemDateEdit(GridColumn, SubItemDateInput)
        ...
        Protected Sub AddSubItemToGridColumn(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ByRef RepositoryItem As DevExpress.XtraEditors.Repository.RepositoryItem, ByVal DbContext As AdvantageFramework.Database.DbContext, ByVal DataContext As AdvantageFramework.Database.DataContext)
            ...
            ElseIf TypeOf RepositoryItem Is AdvantageFramework.WinForm.Presentation.Controls.SubItemTimeInput Then
        ...
        End Sub
        Private Function CreateSubItemMemoEdit(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ObjectType As System.Type) As DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit

            Dim SubItemMemoEdit As DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit = Nothing
            ...
            Try
                ...
                If Session IsNot Nothing Then
                    ...
                    SubItemMemoEdit = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit
                    ...
                    Using DbContext = New AdvantageFramework.Database.DbContext(Session.ConnectionString, Session.UserCode)
                        ...
                        Try
                            ...
                            MaxLength = AdvantageFramework.BaseClasses.Entity.LoadPropertyMaxLength(AdvantageFramework.BaseClasses.Entity.LoadProperty(RealObjectType, GridColumn.FieldName))
                        ...
                        SubItemMemoEdit.WordWrap = True
                        SubItemMemoEdit.Appearance.Options.UseTextOptions = True
                        SubItemMemoEdit.Appearance.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap
                        SubItemMemoEdit.Appearance.TextOptions.Trimming = DevExpress.Utils.Trimming.None
        ...
        Protected Sub AddSubItemByDefaultColumnTypeAttribute(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ByVal DefaultColumnType As AdvantageFramework.BaseClasses.DefaultColumnTypes, ByVal ValueType As System.Type, ByVal DbContext As AdvantageFramework.Database.DbContext, ByVal DataContext As AdvantageFramework.Database.DataContext)
            ...
            If _ControlType = DataGridView.Type.DynamicReport AndAlso DefaultColumnType = BaseClasses.Methods.DefaultColumnTypes.Memo Then

                GridColumn.AppearanceCell.Options.UseTextOptions = True
                GridColumn.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap
                GridColumn.AppearanceCell.TextOptions.Trimming = DevExpress.Utils.Trimming.None

                RepositoryItem = CreateSubItemMemoEdit(GridColumn, _ObjectType)
        ...
        Protected Sub AddSubItem(ByRef GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ByVal PropertyDescriptor As System.ComponentModel.PropertyDescriptor, ByVal EntityAttribute As AdvantageFramework.BaseClasses.Attributes.EntityAttribute, ByVal DbContext As AdvantageFramework.Database.DbContext, ByVal DataContext As AdvantageFramework.Database.DataContext)
            ...
            If Me.OptionsBehavior.Editable AndAlso GridColumn.OptionsColumn.ReadOnly = False Then
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Classes.EmployeeStandardTime) AndAlso
                    ...
                    AddSubItemTimeEdit(GridColumn, SubItemTimeInput.Type.Default)

                ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Views.BroadcastOrderDetailView) AndAlso
                        (GridColumn.FieldName = AdvantageFramework.Database.Views.BroadcastOrderDetailView.Properties.RunDateTime.ToString) Then

                    AddSubItemTimeEdit(GridColumn, SubItemTimeInput.Type.HourAndMinute)
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail) Then
                    ...
                    ElseIf GridColumn.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.Quantity.ToString OrElse
                            ...
                            GridColumn.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.ForeignRate.ToString OrElse
                            ...
                            GridColumn.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.ForeignDisbursed.ToString Then
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail) Then
                    ...
                    ElseIf GridColumn.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.Impressions.ToString OrElse
                            ...
                            GridColumn.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignGrossAmount.ToString OrElse
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Views.BroadcastOrderDetailView) AndAlso
                    GridColumn.FieldName = AdvantageFramework.Database.Views.BroadcastOrderDetailView.Properties.OrderNumber.ToString Then

                    AddSubItemGridLookupEdit(GridColumn, SubItemGridLookUpEditControl.Type.RadioOrderNumber, EntityAttribute, PropertyDescriptor, DbContext, DataContext)

                ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Views.BroadcastOrderDetailView) AndAlso
                    GridColumn.FieldName = AdvantageFramework.Database.Views.BroadcastOrderDetailView.Properties.OrderLineNumber.ToString Then

                    AddSubItemGridLookupEdit(GridColumn, SubItemGridLookUpEditControl.Type.RadioOrderLineNumber, EntityAttribute, PropertyDescriptor, DbContext, DataContext)

                    'ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Views.BroadcastOrderDetailVerificationView) AndAlso
                    '    GridColumn.FieldName = AdvantageFramework.Database.Views.BroadcastOrderDetailVerificationView.Properties.OrderLineNumber.ToString Then
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.ProductionSummary) Then

                    If GridColumn.FieldName = AdvantageFramework.BillingCommandCenter.Classes.ProductionSummary.Properties.ReconcileStatus.ToString Then
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.CashReceipts.Classes.ImportClientCashReceipt) AndAlso
                        GridColumn.FieldName = AdvantageFramework.CashReceipts.Classes.ImportClientCashReceipt.Properties.ARInvoiceSequence.ToString Then

                    AddSubItemGridLookupEdit(GridColumn, AdvantageFramework.WinForm.Presentation.Controls.SubItemGridLookUpEditControl.Type.AccountReceivableSequenceNumber, EntityAttribute, PropertyDescriptor, DbContext, DataContext)
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.CashReceipts.Classes.ImportClientCashReceipt) AndAlso
                    ...
                    AddSubItemGridLookupEdit(GridColumn, SubItemGridLookUpEditControl.Type.CashReceiptPaymentType, EntityAttribute, PropertyDescriptor, DbContext, DataContext)

                ElseIf _ObjectType Is GetType(AdvantageFramework.DocumentManager.Classes.Document) AndAlso
                        GridColumn.FieldName = AdvantageFramework.DocumentManager.Classes.Document.Properties.Description.ToString Then

                    AddSubItemTextBox(GridColumn, AdvantageFramework.WinForm.Presentation.Controls.SubItemTextBox.Type.Default)

                ElseIf _ObjectType Is GetType(AdvantageFramework.DocumentManager.Classes.Document) AndAlso
                        GridColumn.FieldName = AdvantageFramework.DocumentManager.Classes.Document.Properties.FileType.ToString Then

                    AddSubItemImageComboBox(GridColumn, SubItemImageComboBox.Type.DocumentType)

                ElseIf _ObjectType Is GetType(AdvantageFramework.IncomeOnly.Classes.IncomeOnly) AndAlso
                        (GridColumn.FieldName = AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.OrderNumber.ToString OrElse
                         GridColumn.FieldName = AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.OrderLineNumber.ToString) Then

                    If GridColumn.FieldName = AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.OrderNumber.ToString Then

                        AddSubItemGridLookupEdit(GridColumn, SubItemGridLookUpEditControl.Type.IOOrderNumber, EntityAttribute, PropertyDescriptor, DbContext, DataContext)

                    ElseIf GridColumn.FieldName = AdvantageFramework.IncomeOnly.Classes.IncomeOnly.Properties.OrderLineNumber.ToString Then

                        AddSubItemGridLookupEdit(GridColumn, SubItemGridLookUpEditControl.Type.IOOrderLineNumber, EntityAttribute, PropertyDescriptor, DbContext, DataContext)

                    End If

                ElseIf _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.VCCOrder) AndAlso
                        GridColumn.FieldName = AdvantageFramework.MediaManager.Classes.VCCOrder.Properties.FollowupDate.ToString Then

                    AddSubItemDateEdit(GridColumn, AdvantageFramework.WinForm.Presentation.Controls.SubItemDateInput.Type.ShortDateAndTime)

                ElseIf _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail) AndAlso GridColumn.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail.Properties.ClientPO.ToString Then

                    AddSubItemTextBox(GridColumn, SubItemTextBox.Type.ClientPO)

                ElseIf GridColumn.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail.Properties.AdNumber.ToString AndAlso
                        _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail) Then

                    AddSubItemTextBox(GridColumn, SubItemTextBox.Type.AdNumber)

                ElseIf GridColumn.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail.Properties.AdSizeCode.ToString AndAlso
                        _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail) Then

                    AddSubItemTextBox(GridColumn, SubItemTextBox.Type.AdSizeCode)
            ...
            ElseIf Me.OptionsBehavior.Editable = False Then
                ...
                ElseIf DefaultColumnType <> BaseClasses.DefaultColumnTypes.None Then
                    ...
                    If _ObjectType Is GetType(AdvantageFramework.Database.Classes.BillingRateDetail) OrElse
                            ...
                            _ObjectType Is GetType(AdvantageFramework.Database.Classes.VendorInvoiceDetail) OrElse
                            _ObjectType Is GetType(AdvantageFramework.IncomeOnly.Classes.JobComponentServiceFeeContract) OrElse
                            _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem) Then
            ...
            ElseIf Me.OptionsBehavior.Editable AndAlso GridColumn.OptionsColumn.ReadOnly Then
                ...
                ElseIf _ObjectType Is GetType(AdvantageFramework.Importing.Classes.ImportPTOItem) AndAlso
                        GridColumn.FieldName = AdvantageFramework.Importing.Classes.ImportPTOItem.Properties.ActivityStart.ToString Then
        ...
        Protected Sub ModifyColumn(ByVal GridColumn As DevExpress.XtraGrid.Columns.GridColumn, ByVal DbContext As AdvantageFramework.Database.DbContext, ByVal DataContext As AdvantageFramework.Database.DataContext)
            ...
            If PropertyDescriptor IsNot Nothing AndAlso Me.SkipAddingControlsOnModifyColumn = False Then
                ...
                Finally
                    ...
                    If EntityAttribute IsNot Nothing Then
                        ...
                        If EntityAttribute.DisplayFormat <> "" Then
                            ...
                            If EntityAttribute.DisplayFormat.StartsWith("c") OrElse EntityAttribute.DisplayFormat.StartsWith("n") OrElse
                                    EntityAttribute.DisplayFormat.StartsWith("f") Then
                ...
                If _ControlType = DataGridView.Type.DynamicReport Then
                ...
                If Column IsNot Nothing Then
                    ...
                    If Column.FieldName = "Code" Then
                        ...
                        If _ObjectType Is GetType(AdvantageFramework.Database.Entities.Status) OrElse _ObjectType Is GetType(AdvantageFramework.Database.Entities.Role) OrElse
                                ...
                                _ObjectType Is GetType(AdvantageFramework.Database.Entities.InvoiceCategory) OrElse _ObjectType Is GetType(AdvantageFramework.Database.Entities.VendorServiceTax) Then
                    ...
                    ElseIf Column.FieldName = "ClientCode" Then
                        ...
                        If Me.IsNewItemOrAutoFilterRow() = False Then
                            ...
                            ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.JobCoop) Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.BillingCommandCenter.Classes.JobCoop.Properties.BillingCoopCode.ToString)
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail) Then
                        ...
                        If Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.LineTotal.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.ForeignDisbursed.ToString OrElse
                        ...
                        ElseIf (Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.ExtendedNonResaleTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableProductionDistributionDetail.Properties.ForeignExtendedNonResaleTax.ToString) AndAlso
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail) Then
                        ...
                        If Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.InsertionDate.ToString Then
                            ...
                            If Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.ForeignGrossAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.ForeignGrossAmount.ToString)

                            ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.GrossAmount.ToString).Visible Then
                            ...
                            ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.ForeignNetAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.ForeignNetAmount.ToString)
                        ...
                        ElseIf GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.SalesTaxCode.ToString) Is Nothing AndAlso
                                (Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.VendorTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.ForeignVendorTax.ToString) Then
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.DisbursedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableMagazineDistributionDetail.Properties.ForeignDisbursedAmount.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail) Then
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.PrintLines.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.Rate.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignRate.ToString Then
                            ...
                            If GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.CostTypeFromOrderDetail.ToString) = "CPI" OrElse
                                ...
                                If Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignGrossAmount.ToString).Visible Then

                                    Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignGrossAmount.ToString)

                                ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.GrossAmount.ToString).Visible Then
                                ...
                                ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignNetAmount.ToString).Visible Then

                                    Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignNetAmount.ToString)
                        ...
                        ElseIf GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.SalesTaxCode.ToString) Is Nothing AndAlso
                                (Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.VendorTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignVendorTax.ToString) Then
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.DisbursedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableNewspaperDistributionDetail.Properties.ForeignDisbursedAmount.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail) Then
                        ...
                        ElseIf GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.CostType.ToString) = "NA" AndAlso
                                (Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.Impressions.ToString OrElse
                                 Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.Rate.ToString OrElse
                                 Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignRate.ToString) Then

                            If Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignGrossAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignGrossAmount.ToString)

                            ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.GrossAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.GrossAmount.ToString)

                            ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignNetAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignNetAmount.ToString)

                            Else

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.NetAmount.ToString)
                        ...
                        ElseIf GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.SalesTaxCode.ToString) Is Nothing AndAlso
                                (Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.VendorTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignVendorTax.ToString) Then
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.DisbursedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableInternetDistributionDetail.Properties.ForeignDisbursedAmount.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail) Then
                        ...
                        If Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.PostDate.ToString Then
                            ...
                            If Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.ForeignGrossAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.ForeignGrossAmount.ToString)

                            ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.GrossAmount.ToString).Visible Then
                            ...
                            ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.ForeignNetAmount.ToString).Visible Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.ForeignNetAmount.ToString)
                        ...
                        ElseIf GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.SalesTaxCode.ToString) Is Nothing AndAlso
                                (Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.VendorTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.ForeignVendorTax.ToString) Then
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.DisbursedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableOutOfHomeDistributionDetail.Properties.ForeignDisbursedAmount.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail) Then
                        ...
                        Else
                            ...
                            If Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.OrderLineNumber.ToString OrElse
                                ...
                                If Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.ForeignGrossAmount.ToString).Visible Then

                                    Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.ForeignGrossAmount.ToString)

                                ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.GrossAmount.ToString).Visible Then
                                ...
                                ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.ForeignExtendedNetAmount.ToString).Visible Then

                                    Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.ForeignExtendedNetAmount.ToString)
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.DisbursedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableRadioDistributionDetail.Properties.ForeignDisbursedAmount.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail) Then
                        ...
                        Else
                            ...
                            If Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.OrderLineNumber.ToString OrElse
                                ...
                                If Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.ForeignGrossAmount.ToString).Visible Then

                                    Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.ForeignGrossAmount.ToString)

                                ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.GrossAmount.ToString).Visible Then
                                ...
                                ElseIf Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.ForeignExtendedNetAmount.ToString).Visible Then

                                    Me.FocusedColumn = Me.Columns(AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.ForeignExtendedNetAmount.ToString)
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.DisbursedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.AccountPayable.Classes.AccountPayableTVDistributionDetail.Properties.ForeignDisbursedAmount.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Classes.ExpenseReportItem) Then
                        ...
                        If Column.FieldName = AdvantageFramework.Database.Classes.ExpenseReportItem.Properties.JobDescription.ToString OrElse
                            Column.FieldName = AdvantageFramework.Database.Classes.ExpenseReportItem.Properties.JobComponentDescription.ToString Then
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.AccountReceivable.Classes.ClientInvoice) Then
                        ...
                        ElseIf Column.FieldName = AdvantageFramework.AccountReceivable.Classes.ClientInvoice.Properties.Amount.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.AccountReceivable.Classes.ClientInvoice.Properties.AmountWriteoff.ToString OrElse
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem) Then
                        ...
                        If Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.EmployeeTimeID.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.Hours.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.TotalBill.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.Total.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.LineTotal.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.ResaleTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.NetApprovedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.SalesTaxStatePercentage.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.TaxCommissionOnly.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.TransferFromJCF.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.AdjustmentTransferUserCode.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.EmployeeTimeItem.Properties.AdjustmentTransferDate.ToString Then
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem) Then
                        ...
                        If Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.VendorName.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.PostPeriod.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.Rate.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.Total.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.ResaleTax.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.IsNonBillable.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.HasDocuments.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.NetApprovedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.StateTaxPercent.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.TaxCommissionsOnly.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.WriteOff.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.TransferFromJCF.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.AdjustmentTransferUserCode.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableProductionItem.Properties.AdjustmentTransferDate.ToString Then
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem) Then
                        ...
                        If Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.SequenceNumber.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.Quantity.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.Description.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.Total.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.TotalTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.LineTotal.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.NetApprovedAmount.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.StateTaxPercent.ToString OrElse
                                ...
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.TaxCommissionOnly.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.TransferFromJCF.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.AdjustmentTransferUserCode.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.IncomeOnlyItem.Properties.AdjustmentTransferDate.ToString Then
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem) Then
                        ...
                        If Me.FocusedRowHandle = DevExpress.XtraGrid.GridControl.NewItemRowHandle AndAlso
                                GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.FunctionCode.ToString) Is Nothing Then

                            Me.FocusedColumn = Me.Columns(AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.AmountToRecognize.ToString)

                        ElseIf Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.FunctionDescription.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.FunctionType.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.ResaleTax.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.LineTotal.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.PriorBilled.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.PriorIncomeRec.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.Amount.ToString Then

                            Column.OptionsColumn.AllowFocus = False

                        ElseIf Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.ExtendedNonResaleTax.ToString AndAlso
                                (GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.SalesTaxCode.ToString) Is Nothing OrElse
                                 GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.BillingCommandCenter.Classes.AdvanceBillingItem.Properties.IsResaleTax.ToString) = 1) Then
                    ...
                    ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff) Then

                        If Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.FunctionDescription.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.VendorName.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.InvoiceDate.ToString OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.InvoiceNumber.ToString Then

                            Me.FocusedColumn = Me.Columns(AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.Quantity.ToString)

                        ElseIf (Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.Quantity.ToString AndAlso
                                GetRowCellValue(Me.FocusedRowHandle, AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.OriginalQuantity.ToString) Is Nothing) OrElse
                                Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.Rate.ToString Then

                            Me.FocusedColumn = Me.Columns(AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.NetAmount.ToString)

                        ElseIf Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.TotalWriteOff.ToString Then

                            Me.FocusedColumn = Me.Columns(AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.GLACode.ToString)

                        ElseIf Column.FieldName = AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.GLAccountDescription.ToString Then

                            Me.FocusedColumn = Me.Columns(AdvantageFramework.BillingCommandCenter.Classes.AccountPayableWriteoff.Properties.PostPeriodCode.ToString)

                        End If

                    ElseIf _ObjectType Is GetType(AdvantageFramework.BillingCommandCenter.Classes.JobCoop) Then

                        If Column.FieldName <> AdvantageFramework.BillingCommandCenter.Classes.JobCoop.Properties.BillingCoopCode.ToString Then

                            Column.OptionsColumn.AllowFocus = False

                        End If

                    ElseIf _ObjectType Is GetType(AdvantageFramework.Database.Entities.ProductMediaOverrides) Then

                        If Me.IsNewItemOrAutoFilterRow() = False Then

                            If Column.FieldName = AdvantageFramework.Database.Entities.ProductMediaOverrides.Properties.SalesClassCode.ToString OrElse
                                    Column.FieldName = AdvantageFramework.Database.Entities.ProductMediaOverrides.Properties.MediaType.ToString Then

                                Me.FocusedColumn = Me.Columns(AdvantageFramework.Database.Entities.ProductMediaOverrides.Properties.RebatePercent.ToString)

                            End If

                        End If

                    ElseIf _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.MediaManagerOrderComment) Then

                        If Column.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerOrderComment.Properties.OrderNumber.ToString OrElse
                                Column.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerOrderComment.Properties.OrderDescription.ToString Then

                            Column.OptionsColumn.AllowFocus = False

                        End If

                    ElseIf _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.MediaManagerOrderLineComment) Then

                        If Column.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerOrderLineComment.Properties.OrderNumber.ToString OrElse
                                Column.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerOrderLineComment.Properties.OrderDescription.ToString OrElse
                                Column.FieldName = AdvantageFramework.MediaManager.Classes.MediaManagerOrderLineComment.Properties.LineNumber.ToString Then

                            Column.OptionsColumn.AllowFocus = False

                        End If

                    ElseIf _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.VendorCollectedDetail) Then

                        If Column.FieldName <> AdvantageFramework.MediaManager.Classes.VendorCollectedDetail.Properties.Comments.ToString Then

                            Column.OptionsColumn.AllowFocus = False

                        End If
                    ElseIf _ObjectType Is GetType(AdvantageFramework.Importing.Classes.ImportPTOItem) Then

                        If Column.FieldName = AdvantageFramework.Importing.Classes.ImportPTOItem.Properties.EmployeeName.ToString OrElse
                                Column.FieldName = AdvantageFramework.Importing.Classes.ImportPTOItem.Properties.EmployeeOffice.ToString Then
        ...
        Protected Sub ModifyBehaviorOptions()
            ...
            Select Case _ControlType
                ...
                Case DataGridView.Type.Default, DataGridView.Type.DynamicReport, DataGridView.Type.NonEditableGrid
                ...
                Case DataGridView.Type.DatabaseProfile
                ...
                Case DataGridView.Type.EditableGrid
        ...
        Protected Sub ModifyViewOptions()
            ...
            Select Case _ControlType
                ...
                Case DataGridView.Type.DynamicReport

                    Me.OptionsView.RowAutoHeight = True
                ...
                Case DataGridView.Type.Default, DataGridView.Type.DatabaseProfile, DataGridView.Type.EditableGrid, DataGridView.Type.NonEditableGrid
        ...
        Protected Sub ModifySelectionOptions()
            ...
            Select Case _ControlType
                ...
                Case DataGridView.Type.Default, DataGridView.Type.DatabaseProfile, DataGridView.Type.DynamicReport, DataGridView.Type.EditableGrid, DataGridView.Type.NonEditableGrid
        ...
        Protected Sub ModifyCustomizationOptions()
            ...
            Select Case _ControlType
                ...
                Case DataGridView.Type.Default, DataGridView.Type.DatabaseProfile, DataGridView.Type.NonEditableGrid
        ...
        Protected Sub ModifyNavigationOptions()
            ...
            Select Case _ControlType
                ...
                Case DataGridView.Type.Default, DataGridView.Type.DatabaseProfile, DataGridView.Type.NonEditableGrid, DataGridView.Type.DynamicReport
        ...
        End Sub
        Protected Sub ModifyPrintOptions()
            ...
            Select Case _ControlType
                ...
                Case DataGridView.Type.DynamicReport
                    ...
                    Me.AppearancePrint.Row.Options.UseTextOptions = True
                    Me.AppearancePrint.Row.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap
                    Me.AppearancePrint.Row.TextOptions.Trimming = DevExpress.Utils.Trimming.None

                    Me.OptionsPrint.AutoWidth = False
                    Me.OptionsPrint.UsePrintStyles = True
        ...
        End Function
        Private Sub SetRowCellValueByFieldName(ByVal RowHandle As Integer, ByVal FieldName As String, ByVal Value As Object)
            ...
            Try
                ...
                Select Case PropertyType
                    ...
                    Case BaseClasses.PropertyTypes.BillingCoopCode
                        ...
                        SetRowCellValueByDefaultColumnType(RowHandle, BaseClasses.DefaultColumnTypes.BillingCoopDescription, Nothing)

                    Case BaseClasses.PropertyTypes.TaskCode

                        SetRowCellValueByDefaultColumnType(RowHandle, BaseClasses.DefaultColumnTypes.TaskDescription, Nothing)
        ...
        End Sub
        Public Sub AutoSizeColumnHeaderPanel()

            'objects
            Dim ColumnCaptionLines As Integer = Nothing
            Dim LineBreakCharacter As Char = Global.Microsoft.VisualBasic.ChrW(10)

            If Me.Columns IsNot Nothing AndAlso Me.Columns.Count > 0 Then

                ColumnCaptionLines = Me.Columns.OfType(Of DevExpress.XtraGrid.Columns.GridColumn).Where(Function(gc) gc.Visible = True).Select(Function(gc) gc.Caption.Split(LineBreakCharacter).Count).Max

            End If

            If ColumnCaptionLines > 1 Then

                Me.ColumnPanelRowHeight = 17 * ColumnCaptionLines

            Else

                Me.ColumnPanelRowHeight = -1

            End If

        End Sub
        Public Overrides Function IsShowRowFooters() As Boolean

            Dim ShowRowFooters As Boolean = False

            If Me.SortInfo.GroupCount > 0 AndAlso
                    Not Me.IsAlignGroupRowSummariesUnderColumns AndAlso
                    (OptionsView.GroupFooterShowMode = DevExpress.XtraGrid.Views.Grid.GroupFooterShowMode.VisibleAlways OrElse
                     OptionsView.GroupFooterShowMode = DevExpress.XtraGrid.Views.Grid.GroupFooterShowMode.VisibleIfExpanded) Then

                ShowRowFooters = True

            Else

                ShowRowFooters = MyBase.IsShowRowFooters

            End If

            IsShowRowFooters = ShowRowFooters
...
#Region "  Control Event Handlers "
        ...
        Private Sub GridView_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles Me.CellValueChanged
            ...
            If _IsAutoFilling = False AndAlso Me.AutoFilterLookupColumns AndAlso _ControlType = DataGridView.Type.EditableGrid Then
        ...
        Private Sub GridView_ShownEditor(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ShownEditor
            ...
            If Me.AutoFilterLookupColumns AndAlso _ControlType = DataGridView.Type.EditableGrid Then
                    ...
                    ElseIf TypeOf e.Row Is AdvantageFramework.BaseClasses.BaseClass AndAlso _Session IsNot Nothing Then
                        ...
                        Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                            ...
                            Using DataContext = New AdvantageFramework.Database.DataContext(_Session.ConnectionString, _Session.UserCode)
                                ...
                                DirectCast(e.Row, AdvantageFramework.BaseClasses.BaseClass).DataContext = DataContext
        ...
        Private Sub GridView_MainView_ValidatingEditor(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs) Handles Me.ValidatingEditor
            ...
            If FocusedRow IsNot Nothing Then
                ...
                If _RunStandardValidation Then
                    ...
                    If TypeOf FocusedRow Is AdvantageFramework.BaseClasses.Interfaces.IValidatingClassBase Then
                        ...
                        If TypeOf FocusedRow Is AdvantageFramework.BaseClasses.Entity AndAlso _Session IsNot Nothing Then
                            ...
                            Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                                ...
                                Using DataContext = New AdvantageFramework.Database.DataContext(_Session.ConnectionString, _Session.UserCode)
                                    ...
                                    DirectCast(FocusedRow, AdvantageFramework.BaseClasses.Entity).DataContext = DataContext
                        ...
                        ElseIf TypeOf FocusedRow Is AdvantageFramework.BaseClasses.EntityBase AndAlso _Session IsNot Nothing Then

                            Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)

                                Using DataContext = New AdvantageFramework.Database.DataContext(_Session.ConnectionString, _Session.UserCode)

                                    DirectCast(FocusedRow, AdvantageFramework.BaseClasses.EntityBase).DbContext = DbContext
                                    DirectCast(FocusedRow, AdvantageFramework.BaseClasses.EntityBase).DataContext = DataContext
                        ...
                        ElseIf TypeOf FocusedRow Is AdvantageFramework.BaseClasses.BaseClass AndAlso _Session IsNot Nothing Then
                            ...
                            Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                                ...
                                Using DataContext = New AdvantageFramework.Database.DataContext(_Session.ConnectionString, _Session.UserCode)
                                    ...
                                    DirectCast(FocusedRow, AdvantageFramework.BaseClasses.BaseClass).DataContext = DataContext
            ...
            Else
                ...
                Try
                    ...
                    FocusedRow = DirectCast(sender, DevExpress.XtraGrid.Views.Grid.GridView).GetFocusedRow()
                    ...
                    If _RunStandardValidation Then
                        ...
                        If TypeOf FocusedRow Is AdvantageFramework.BaseClasses.Interfaces.IValidatingClassBase Then
                            ...
                            If TypeOf FocusedRow Is AdvantageFramework.BaseClasses.BaseClass Then
                                ...
                                DirectCast(sender, DevExpress.XtraGrid.Views.Grid.GridView).SetColumnError(sender.FocusedColumn, e.ErrorText)
        ...
        Protected Sub SubItemTextBox_ButtonClick()
            ...
            If Me.OptionsBehavior.Editable Then
                ...
                If _ObjectType Is GetType(AdvantageFramework.Database.Classes.ClientAccountsReceivableStatement) OrElse
                    _ObjectType Is GetType(AdvantageFramework.Database.Classes.ProductAccountsReceivableStatement) OrElse
                    _ObjectType Is GetType(AdvantageFramework.MediaManager.Classes.MediaManagerReviewDetail) Then
