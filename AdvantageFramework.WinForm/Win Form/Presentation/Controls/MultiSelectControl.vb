...
#Region " Variables "
        ...
        Private _ControlType As WinForm.Presentation.Controls.MultiSelectControl.Type = Nothing
...
#Region " Properties "
        ...
        Public ReadOnly Property AvailableDataGridView As AdvantageFramework.WinForm.Presentation.Controls.DataGridView
            Get
                AvailableDataGridView = DataGridViewLeftSection_AvailableObjects
            End Get
        End Property
        Public ReadOnly Property SelectedObjectsDataGridView As AdvantageFramework.WinForm.Presentation.Controls.DataGridView
            Get
                SelectedObjectsDataGridView = DataGridViewRightSection_SelectedObjects
            End Get
        End Property
        Public Property ControlType As WinForm.Presentation.Controls.MultiSelectControl.Type
            Get
                ControlType = _ControlType
            End Get
            Set(value As WinForm.Presentation.Controls.MultiSelectControl.Type)
                _ControlType = value
                SetControlType()
            End Set
        End Property
...
#Region " Methods "
        ...
        End Sub
        Private Function GetRowObject(ByVal DataGridView As AdvantageFramework.WinForm.Presentation.Controls.DataGridView, ByVal RowHandle As Integer) As Object
...
#Region "  Employee "
        ...
        Private Sub LoadObjects_Employee()
            ...
            If _SelectedObjects IsNot Nothing Then
                ...
                DataGridViewLeftSection_AvailableObjects.DataSource = (From AvailableObject In DirectCast(_AllAvailableObjects, Generic.List(Of AdvantageFramework.Database.Views.Employee)) _
                                                                       Where (From Entity In DirectCast(_SelectedObjects, Generic.List(Of AdvantageFramework.Database.Views.Employee)) _
                                                                              Select Entity).ToList.Contains(AvailableObject) = False _
                                                                       Select AvailableObject).ToList

                DataGridViewRightSection_SelectedObjects.DataSource = (From AvailableObject In DirectCast(_AllAvailableObjects, Generic.List(Of AdvantageFramework.Database.Views.Employee)) _
                                                                       Where (From Entity In DirectCast(_SelectedObjects, Generic.List(Of AdvantageFramework.Database.Views.Employee)) _
                                                                              Select Entity).ToList.Contains(AvailableObject) = True _
                                                                       Select AvailableObject).ToList
...
#Region "  Client Contact "
        ...
        Private Sub LoadObjects_ClientContact()
            ...
            If _SelectedObjects IsNot Nothing Then
                ...
                DataGridViewLeftSection_AvailableObjects.DataSource = (From AvailableObject In DirectCast(_AllAvailableObjects, Generic.List(Of AdvantageFramework.Database.Entities.ClientContact)) _
                                                                       Where (From Entity In DirectCast(_SelectedObjects, Generic.List(Of AdvantageFramework.Database.Entities.ClientContact)) _
                                                                              Select Entity).ToList.Contains(AvailableObject) = False _
                                                                       Select AvailableObject).ToList

                DataGridViewRightSection_SelectedObjects.DataSource = (From AvailableObject In DirectCast(_AllAvailableObjects, Generic.List(Of AdvantageFramework.Database.Entities.ClientContact)) _
                                                                       Where (From Entity In DirectCast(_SelectedObjects, Generic.List(Of AdvantageFramework.Database.Entities.ClientContact)) _
                                                                              Select Entity).ToList.Contains(AvailableObject) = True _
                                                                       Select AvailableObject).ToList
