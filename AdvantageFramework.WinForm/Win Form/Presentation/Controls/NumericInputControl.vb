...
#Region " Methods "
               ...
               Form.Controls.Find(Me.Name, True).Any Then
                ...
                If TypeOf Form Is AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm Then
                    ...
                    If DirectCast(Form, AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm).SuperValidator IsNot Nothing Then
                        ...
                        DirectCast(Form, AdvantageFramework.WinForm.Presentation.BaseForms.Interfaces.IBaseForm).SuperValidator.ErrorProvider.SetIconAlignment(Me, Me.ErrorIconAlignment)
        ...
        End Sub
        Public Sub SetPropertySettings(Optional ByVal DisplayName As String = "", _
...
#Region "  Control Event Handlers "
        ...
        End Sub
        Private Sub NumericInput_EditValueChanging(sender As Object, e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles Me.EditValueChanging

            'If e.NewValue IsNot Nothing AndAlso IsNumeric(e.NewValue) Then

            '    If Me.Properties.MinValue <> 0 Then

            '        If CDec(e.NewValue) < Me.Properties.MinValue Then
            ...
            '        If CDec(e.NewValue) > Me.Properties.MaxValue Then
        ...
        End Sub
        Private Sub NumericInput_HandleCreated(sender As Object, e As EventArgs) Handles Me.HandleCreated

            'AddHandler AdvantageFramework.WinForm.Presentation.Controls.LoadFormSettingsEvent, AddressOf LoadFormSettings

        End Sub
        Private Sub NumericInput_HandleDestroyed(sender As Object, e As EventArgs) Handles Me.HandleDestroyed
