...
#Region " Variables "
        ...
        Protected _ControlType As AdvantageFramework.WinForm.Presentation.Controls.SubItemImageCheckEditControl.Type = Type.Default
...
#Region " Properties "
        ...
        Public Property DbContext() As AdvantageFramework.Database.DbContext
            ...
            End Set
        End Property
        Public Property ControlType() As AdvantageFramework.WinForm.Presentation.Controls.SubItemImageCheckEditControl.Type
            Get
                ControlType = _ControlType
            End Get
            Set(ByVal value As AdvantageFramework.WinForm.Presentation.Controls.SubItemImageCheckEditControl.Type)
                _ControlType = value
                SetControlType()
            End Set
        End Property
