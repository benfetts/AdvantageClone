        ...
        Protected Sub SetControlType()
            ...
            Select Case _ControlType
                ...
                Case Type.EmployeeSelection
                    ...
                    CType(Control, AdvantageFramework.WinForm.Presentation.Controls.MultiSelectControl).Session = Me.Session
                    CType(Control, AdvantageFramework.WinForm.Presentation.Controls.MultiSelectControl).ControlType = MultiSelectControl.Type.Employee

                Case Type.ClientContactSelection

                    Control = New AdvantageFramework.WinForm.Presentation.Controls.MultiSelectControl
                    CType(Control, AdvantageFramework.WinForm.Presentation.Controls.MultiSelectControl).Session = Me.Session
                    CType(Control, AdvantageFramework.WinForm.Presentation.Controls.MultiSelectControl).ControlType = MultiSelectControl.Type.ClientContact
