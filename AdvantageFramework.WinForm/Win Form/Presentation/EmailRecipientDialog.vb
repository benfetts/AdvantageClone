Namespace WinForm.Presentation
    ...
    Public Class EmailRecipientDialog
...
#Region " Variables "
        ...
        Protected _Subject As String = Nothing
        Protected _Body As String = Nothing
        Protected _ShowSubjectAndBody As Boolean = False
...
#Region " Methods "
        ...
        Protected Sub New(ByVal ShowSubjectAndBody As Boolean, Optional Subject As String = Nothing, Optional Body As String = Nothing)

            ' This call is required by the Windows Form Designer.
            InitializeComponent()

            ' Add any initialization after the InitializeComponent() call.
            _ShowSubjectAndBody = ShowSubjectAndBody
            _Subject = Subject
            _Body = Body
        ...
        Protected Sub AddRecipientsToGrid(ByVal DataGridView As AdvantageFramework.WinForm.Presentation.Controls.DataGridView)
            ...
            Dim RecipientSource As EmailRecipientDialog.RecipientSource = Nothing
            ...
            If ComboBoxForm_Source.HasASelectedValue AndAlso DataGridViewForm_AvailableRecipients.HasASelectedRow Then
                ...
                Select Case AdvantageFramework.EnumUtilities.GetValue(GetType(RecipientSource), ComboBoxForm_Source.GetSelectedValue)
                    ...
                    Case EmailRecipientDialog.RecipientSource.Internal

                        Contacts = DataGridViewForm_AvailableRecipients.GetAllSelectedRowsCellValues(2)

                    Case EmailRecipientDialog.RecipientSource.ClientContacts

                        Contacts = DataGridViewForm_AvailableRecipients.GetAllSelectedRowsCellValues(3)

                    Case EmailRecipientDialog.RecipientSource.DivisionContacts

                        Contacts = DataGridViewForm_AvailableRecipients.GetAllSelectedRowsCellValues(4)

                    Case EmailRecipientDialog.RecipientSource.ProductContacts

                        Contacts = DataGridViewForm_AvailableRecipients.GetAllSelectedRowsCellValues(5)

                    Case EmailRecipientDialog.RecipientSource.VendorContacts

                        Contacts = DataGridViewForm_AvailableRecipients.GetAllSelectedRowsCellValues(3)

                    Case EmailRecipientDialog.RecipientSource.VendorRepresentatives
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByRef ToRecipients As IEnumerable(Of AdvantageFramework.Email.Classes.RecipientEmailAddress), _
                                              ByRef CCRecipients As IEnumerable(Of AdvantageFramework.Email.Classes.RecipientEmailAddress), _
                                              ByRef BCCRecipients As IEnumerable(Of AdvantageFramework.Email.Classes.RecipientEmailAddress)) As System.Windows.Forms.DialogResult

            'objects
            Dim EmailRecipientDialog As EmailRecipientDialog = Nothing

            EmailRecipientDialog = New EmailRecipientDialog(False)

            ShowFormDialog = EmailRecipientDialog.ShowDialog()

            If ShowFormDialog = Windows.Forms.DialogResult.OK Then

                ToRecipients = EmailRecipientDialog.ToRecipients
                CCRecipients = EmailRecipientDialog.CcRecipients
                BCCRecipients = EmailRecipientDialog.BccRecipients
        ...
        Public Shared Function ShowFormDialog(ByRef ToRecipients As IEnumerable(Of AdvantageFramework.Email.Classes.RecipientEmailAddress),
                                              ...
                                              ByRef Subject As String, ByRef Body As String) As System.Windows.Forms.DialogResult

            'objects
            Dim EmailRecipientDialog As EmailRecipientDialog = Nothing

            EmailRecipientDialog = New EmailRecipientDialog(True, Subject, Body)
            ...
            If ShowFormDialog = Windows.Forms.DialogResult.OK Then
                ...
                CCRecipients = EmailRecipientDialog.CcRecipients
                BCCRecipients = EmailRecipientDialog.BccRecipients
                Subject = EmailRecipientDialog.Subject
                Body = EmailRecipientDialog.Body
...
#Region "  Form Event Handlers "
        ...
        Protected Sub EmailRecipientDialog_Load(sender As Object, e As System.EventArgs) Handles Me.Load
            ...
            ComboBoxForm_Source.DataSource = (From EnumObject In AdvantageFramework.EnumUtilities.LoadEnumObjects(GetType(RecipientSource)) _
            ...
            LabelForm_Subject.Visible = _ShowSubjectAndBody
            TextBoxForm_Subject.Visible = _ShowSubjectAndBody
            TextBoxForm_Subject.Text = _Subject

            LabelForm_Body.Visible = _ShowSubjectAndBody
            TextBoxForm_Body.Visible = _ShowSubjectAndBody
            TextBoxForm_Body.Text = _Body

            Me.Height = If(_ShowSubjectAndBody, 711, 532)

            Me.FormAction = FormActions.None

        End Sub
        Protected Sub EmailRecipientDialog_Shown(sender As Object, e As EventArgs) Handles Me.Shown
...
#Region "  Control Event Handlers "
        ...
        Protected Sub ButtonForm_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonForm_OK.Click
            ...
            If _ToRecipients.Count > 0 OrElse _CcRecipients.Count > 0 OrElse _BccRecipients.Count > 0 Then
                ...
                _Subject = TextBoxForm_Subject.GetText
                _Body = TextBoxForm_Body.GetText
        ...
        Protected Sub ComboBoxForm_Source_SelectedValueChanged(sender As Object, e As EventArgs) Handles ComboBoxForm_Source.SelectedValueChanged
            ...
            If Me.FormAction = FormActions.None Then
