...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(ByRef [From] As Date, ByRef [To] As Date) As Windows.Forms.DialogResult
            ...
            'objects
            Dim SelectDateRangeDialog As AdvantageFramework.WinForm.Presentation.SelectDateRangeDialog = Nothing

            SelectDateRangeDialog = New AdvantageFramework.WinForm.Presentation.SelectDateRangeDialog([From], [To])
