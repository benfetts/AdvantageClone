...
#Region " Methods "
        ...
        Public Shared Function CreateEntityConnectionString(ConnectionString As String, DatabaseType As AdvantageFramework.Database.DatabaseTypes) As String
            ...
            ElseIf DatabaseType = AdvantageFramework.Database.Methods.DatabaseTypes.National Then

                EntityConnectionStringBuilder.Metadata = "res://*/National.Database.DbContext.csdl|res://*/National.Database.DbContext.ssdl|res://*/National.Database.DbContext.msl"
        ...
        'End Function
        Public Sub Detach(ByRef EntityObject As AdvantageFramework.BaseClasses.Entity)
