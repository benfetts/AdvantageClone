Namespace BillingCommandCenter.Database.ComplexTypes
    ...
    <System.Data.Objects.DataClasses.EdmComplexTypeAttribute(NamespaceName:="BCCObjectContext", Name:="ProductionSelectionByJob")>
    <Serializable()>
    Public Class ProductionSelectionByJob
