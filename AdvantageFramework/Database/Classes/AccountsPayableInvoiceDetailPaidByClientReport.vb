Namespace Database.Classes
    ...
    <Serializable()>
    Public Class AccountsPayableInvoiceDetailPaidByClientReport
...
#Region " Enum "
        ...
        Public Enum Properties
            ...
            ApprovalStatus
            NonBillable
            BilledReconciledCostAmount
            AdvanceCostAmountJobComp
            AdvanceCostAmountFunction
            AdvanceRetained
            LastCRCheckNumber
            LastCRCheckDate
            CashReceivedDirect
            CashReceivedFunction
            CashReceivedAll
        End Enum
...
#Region " Variables "
        ...
        Private _BilledReconciledCostAmount As Nullable(Of Decimal) = Nothing
        Private _AdvanceCostAmountJobComp As Nullable(Of Decimal) = Nothing
        Private _AdvanceCostAmountFunction As Nullable(Of Decimal) = Nothing
        Private _AdvanceRetained As Nullable(Of Decimal) = Nothing
        Private _LastCRCheckNumber As String = Nothing
        Private _LastCRCheckDate As Nullable(Of Date) = Nothing
        Private _CashReceivedDirect As Nullable(Of Decimal) = Nothing
        Private _CashReceivedFunction As Nullable(Of Decimal) = Nothing
        Private _CashReceivedAll As Nullable(Of Decimal) = Nothing
...
#Region " Properties "
        ...
        Public Property NonBillable() As String
            ...
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2", CustomColumnCaption:="Billed or Reconciled Cost Amount")>
        Public Property BilledReconciledCostAmount() As Nullable(Of Decimal)
            Get
                BilledReconciledCostAmount = _BilledReconciledCostAmount
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _BilledReconciledCostAmount = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property AdvanceCostAmountJobComp() As Nullable(Of Decimal)
            Get
                AdvanceCostAmountJobComp = _AdvanceCostAmountJobComp
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _AdvanceCostAmountJobComp = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property AdvanceCostAmountFunction() As Nullable(Of Decimal)
            Get
                AdvanceCostAmountFunction = _AdvanceCostAmountFunction
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _AdvanceCostAmountFunction = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property AdvanceRetained() As Nullable(Of Decimal)
            Get
                AdvanceRetained = _AdvanceRetained
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _AdvanceRetained = value
            End Set
        End Property
        <System.Runtime.Serialization.DataMemberAttribute(),
        AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property LastCRCheckNumber() As String
            Get
                LastCRCheckNumber = _LastCRCheckNumber
            End Get
            Set(ByVal value As String)
                _LastCRCheckNumber = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property LastCRCheckDate() As Nullable(Of Date)
            Get
                LastCRCheckDate = _LastCRCheckDate
            End Get
            Set(ByVal value As Nullable(Of Date))
                _LastCRCheckDate = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property CashReceivedDirect() As Nullable(Of Decimal)
            Get
                CashReceivedDirect = _CashReceivedDirect
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _CashReceivedDirect = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property CashReceivedFunction() As Nullable(Of Decimal)
            Get
                CashReceivedFunction = _CashReceivedFunction
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _CashReceivedFunction = value
            End Set
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property CashReceivedAll() As Nullable(Of Decimal)
            Get
                CashReceivedAll = _CashReceivedAll
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _CashReceivedAll = value
            End Set
        End Property
