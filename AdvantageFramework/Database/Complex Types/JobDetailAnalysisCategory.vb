Namespace Database.ComplexTypes
    ...
    <System.Data.Objects.DataClasses.EdmComplexTypeAttribute(NamespaceName:="ObjectContext", Name:="JobDetailAnalysisCategory")>
    <Serializable()>
...
#Region " Variables "
        ...
        Private _ItemCategory As String = Nothing
...
System.Runtime.Serialization.DataMemberAttribute()>
  Public Property ItemCategory() As String
            ...
            End Get
            Set(value As String)
                _ItemCategory = System.Data.Objects.DataClasses.StructuralObject.SetValidValue(value, True)
            End Set
        End Property
        <System.Data.Objects.DataClasses.EdmScalarPropertyAttribute(EntityKeyProperty:=False, IsNullable:=True),
System.Runtime.Serialization.DataMemberAttribute()>
