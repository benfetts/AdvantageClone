Namespace Database.ComplexTypes
    ...
    <System.Data.Objects.DataClasses.EdmComplexTypeAttribute(NamespaceName:="ObjectContext", Name:="JobDetailAnalysisQVA")>
    <Serializable()>
...
#Region " Variables "
        ...
        Private _SumOfNonBillableMarkup As Nullable(Of Decimal) = Nothing
...
System.Runtime.Serialization.DataMemberAttribute()>
  Public Property SumOfNonBillableAmount() As Nullable(Of Decimal)
        ...
        Public Property SumOfNonBillableMarkup() As Nullable(Of Decimal)
            Get
                SumOfNonBillableMarkup = _SumOfNonBillableMarkup
            End Get
            Set(value As Nullable(Of Decimal))
                _SumOfNonBillableMarkup = System.Data.Objects.DataClasses.StructuralObject.SetValidValue(value)
            End Set
        End Property
        <System.Data.Objects.DataClasses.EdmScalarPropertyAttribute(EntityKeyProperty:=False, IsNullable:=True),
System.Runtime.Serialization.DataMemberAttribute()>
