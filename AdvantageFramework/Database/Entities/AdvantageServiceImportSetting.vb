Namespace Database.Entities
    ...
    <NotMapped>
    <System.Data.Linq.Mapping.Table(Name:="dbo.ADV_SERVICE_IMPORT_SETTING")>
    Public Class AdvantageServiceImportSetting
...
#Region " Variables "
        ...
        Private _AdvantageServiceImportID As Long = 0
...
#Region " Properties "
        ...
        <System.Data.Linq.Mapping.Column(UpdateCheck:=System.Data.Linq.Mapping.UpdateCheck.Never, Name:="ADV_SERVICE_IMPORT_SETTING_ID", Storage:="_ID", IsPrimaryKey:=True, IsDbGenerated:=True, AutoSync:=System.Data.Linq.Mapping.AutoSync.OnInsert, DBType:="int NOT NULL IDENTITY"), _
        ...
        Public Property ID() As Long
            ...
            End Set
        End Property
        <System.Data.Linq.Mapping.Column(UpdateCheck:=System.Data.Linq.Mapping.UpdateCheck.Never, Name:="ADV_SERVICE_IMPORT_ID", Storage:="_AdvantageServiceImportID", DBType:="int"), _
        System.ComponentModel.DisplayName("AdvantageServiceImportID")> _
        Public Property AdvantageServiceImportID() As Long
            Get
                AdvantageServiceImportID = _AdvantageServiceImportID
            End Get
            Set(ByVal value As Long)
                _AdvantageServiceImportID = value
            End Set
        End Property
