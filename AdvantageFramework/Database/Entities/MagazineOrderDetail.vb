Namespace Database.Entities
	...
	<Table("MAGAZINE_DETAIL")>
	Public Class MagazineOrderDetail
...
#Region " Properties "
		...
		Public Property MagazineOrderNumber() As Integer
		<Key>
		<Required>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(14, 2)>
        Public Property BleedAmount() As Nullable(Of Decimal)
		<Column("POSITION_PCT")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(7, 3)>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(14, 2)>
        Public Property PositionAmount() As Nullable(Of Decimal)
		<Column("PREMIUM_PCT")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(7, 3)>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(14, 2)>
        Public Property PremiumAmount() As Nullable(Of Decimal)
		<Column("LINE_TOTAL")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(14, 2)>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecisionAttribute(15, 2)>
        Public Property FlatNetCharges() As Nullable(Of Decimal)
        ...
        <ForeignKey("MagazineOrderNumber")>
        Public Overridable Property MagazineOrder As Database.Entities.MagazineOrder
...
#Region " Methods "
        ...
        Public Overrides Function ToString() As String
            ...
            ToString = Me.MagazineOrderNumber.ToString
