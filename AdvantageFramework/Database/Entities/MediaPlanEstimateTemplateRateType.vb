Namespace Database.Entities
    ...
    <Table("MEDIA_PLAN_ESTIMATE_TEMPLATE_RATE_TYPE")>
    Public Class MediaPlanEstimateTemplateRateType
...
#Region " Properties "
        ...
        <Column("RATE_TYPE")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=True, DisplayFormat:="")>
        Public Property RateType() As AdvantageFramework.Database.Entities.MediaPlanEstimateTemplateRateTypeValue
