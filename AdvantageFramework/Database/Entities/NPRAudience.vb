...
#Region " Properties "
        ...
        <Required>
        <Column("PEOPLE_2PLUS_AUD")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=True, DisplayFormat:="")>
        Public Property People2Plus() As Integer
        <Required>
        <Column("MALES_2PLUS_AUD")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=True, DisplayFormat:="")>
