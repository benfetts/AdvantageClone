Namespace Database.Entities
	...
	<Table("RADIO_DETAIL1")>
	Public Class RadioOrderDetailLegacy
...
#Region " Enum "
		...
		Public Enum Properties
			RadioOrderNumberLegacy
			LineNumber
			RevisionNumberLegacy
			SequenceNumber
			BroadcastYear
			LinkID
			LinkDetailID
...
#Region " Properties "
        ...
        Public Property RadioOrderNumberLegacy() As Integer
        <Key>
        <Required>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property RevisionNumberLegacy() As Short
        <Key>
        <Required>
		...
		<Column("RATE")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecision(14, 4)>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecision(14, 2)>
        Public Property LineNetDescription() As Nullable(Of Decimal)
		<Column("NETCHARGES")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecision(14, 2)>
        ...
        <ForeignKey("RadioOrderNumberLegacy, LineNumber")>
        Public Overridable Property RadioOrderLegacy As Database.Entities.RadioOrderLegacy
...
#Region " Methods "
        ...
        Public Overrides Function ToString() As String
            ...
            ToString = Me.RadioOrderNumberLegacy.ToString
