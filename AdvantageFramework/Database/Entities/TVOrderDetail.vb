...
#Region " Properties "
        ...
        Public Property TVOrderNumber() As Integer
        <Key>
        <Required>
        ...
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property NetChargesDescription() As String
        <Column("ADDL_CHARGE")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        <AdvantageFramework.BaseClasses.Attributes.DecimalPrecision(14, 2)>
        ...
        '            If CDate(Me.StartTime).Hour < 3 Then
        ...
        '            If CDate(Me.EndTime).Hour < 3 OrElse (CDate(Me.EndTime).Hour = 3 AndAlso CDate(Me.EndTime).Minute = 0) Then
...
#Region " Methods "
        ...
        Public Function GetStartHourMinute(AdjacencyBefore As Short) As Integer
            ...
            If IsDate(Me.StartTime) Then
                ...
                If CDate(TempStartTime).Hour < 3 Then
        ...
        Public Function GetEndHourMinute(AdjacencyAfter As Short) As Integer
            ...
            If IsDate(Me.EndTime) Then
                ...
                If CDate(TempEndTime).Hour < 3 OrElse (CDate(TempEndTime).Hour = 3 AndAlso CDate(TempEndTime).Minute = 0) Then
        ...
        Public Overrides Function ToString() As String
            ...
            ToString = Me.TVOrderNumber.ToString
