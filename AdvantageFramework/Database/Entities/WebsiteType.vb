...
#Region " Methods "
        ...
        Public Overrides Function ValidateCustomProperties(ByVal PropertyName As String, ByRef IsValid As Boolean, ByRef Value As Object) As String
            ...
            Select Case PropertyName
                ...
                Case AdvantageFramework.Database.Entities.WebsiteType.Properties.Code.ToString

                    If Me.IsEntityBeingAdded() Then

                        PropertyValue = Value

                        If (From Entity In DirectCast(Me.DbContext, AdvantageFramework.Database.DbContext).WebsiteTypes
