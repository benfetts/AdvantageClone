Namespace Database.Procedures.JobDetailAnalysisComplexType
...
#Region " Methods "
        ...
        Public Function Load(ByVal DbContext As AdvantageFramework.BaseClasses.DbContext,
                             ...
                             Optional ByVal UserCode As String = "", Optional ByVal DateCutoff As String = "") As System.Collections.Generic.List(Of Database.Classes.JobDetailAnalysis)
            ...
            If DateCutoff = "" Then
                SqlParameterDateCutoff = New System.Data.SqlClient.SqlParameter("@DATE_CUTOFF", SqlDbType.VarChar) With {.Value = DBNull.Value}
            Else
            ...
            Load = DbContext.Database.SqlQuery(Of Database.Classes.JobDetailAnalysis)("EXEC dbo.advsp_job_detail_analysis_load_report @OPEN_JOB_ONLY, @EXCLUDE_NONBILL_HRS, @OFFICE_LIST, @CLIENT_LIST, @DIVISION_LIST, " &
                                                                                                                              "@PRODUCT_LIST, @JOB_LIST, @ACCT_EXEC_LIST, @SALES_CLASS_LIST, @DATE_CUTOFF, @USER_CODE",
                                                                                       SqlParameterIncludeOpenJobsOnly, SqlParameterExcludeNonBillableHours, SqlParameterOfficeList, SqlParameterClientList, SqlParameterDivisionList,
                                                                                       SqlParameterProductList, SqlParameterJobList, SqlParameterAccountExecutiveList, SqlParameterSalesClassList, SqlParameterDateCutoff, SqlParameterUserCode).ToList
