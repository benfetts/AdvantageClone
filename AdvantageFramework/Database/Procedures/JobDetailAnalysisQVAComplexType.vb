Namespace Database.Procedures.JobDetailAnalysisQVAComplexType
...
#Region " Methods "
        ...
        Public Function Load(DbContext As AdvantageFramework.BaseClasses.DbContext,
                             ...
                             Optional ByVal UserCode As String = "", Optional ByVal DateCutoff As String = "") As System.Collections.Generic.List(Of Database.Classes.JobDetailAnalysisQVA)
            ...
            Load = DbContext.Database.SqlQuery(Of Database.Classes.JobDetailAnalysisQVA)("EXEC dbo.advsp_job_detail_analysis_qva_load_report @OPEN_JOB_ONLY, @EXCLUDE_NONBILL_HRS, @OFFICE_LIST, @CLIENT_LIST, @DIVISION_LIST, @PRODUCT_LIST, " &
                                                                                                                                     "@JOB_LIST, @ACCT_EXEC_LIST, @SALES_CLASS_LIST, @DATE_CUTOFF, @USER_CODE",
                                                                                         SqlParameterIncludeOpenJobsOnly, SqlParameterExcludeNonBillableHours, SqlParameterOfficeList, SqlParameterClientList, SqlParameterDivisionList, SqlParameterProductList,
                                                                                         SqlParameterJobList, SqlParameterAccountExecutiveList, SqlParameterSalesClassList, SqlParameterDateCutoff, SqlParameterUserCode).ToList
