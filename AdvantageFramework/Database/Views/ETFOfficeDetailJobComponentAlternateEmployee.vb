Namespace Database.Views
    ...
    <Table("V_ETF_OFFDTLJC_AE")>
    Public Class ETFOfficeDetailJobComponentAlternateEmployee
...
#Region " Enum "
        ...
        Public Enum Properties
            ...
            EmployeeTimeForecastOfficeDetailJobComponentAlternateEmployeeID
...
#Region " Properties "
        ...
        <Required>
        <Column("EmployeeTimeForecastOfficeDetailJobComponentAlternateEmployeeID")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property EmployeeTimeForecastOfficeDetailJobComponentAlternateEmployeeID() As Integer
        <Required>
