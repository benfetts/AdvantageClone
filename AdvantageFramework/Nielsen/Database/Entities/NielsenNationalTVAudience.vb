Namespace Nielsen.Database.Entities
    ...
    <Table("NIELSEN_NATIONAL_TV_AUDIENCE")>
...
#Region " Properties "
        ...
        <Required>
        <Column("NIELSEN_NATIONAL_TV_AUDIENCE_ID")>
        ...
        <Required>
        <Column("AUDIENCE_DATE")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=True, DisplayFormat:="")>
        Public Property AudienceDate() As Date
        <Required>
        <Column("AUDIENCE_TIME")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=True, DisplayFormat:="")>
