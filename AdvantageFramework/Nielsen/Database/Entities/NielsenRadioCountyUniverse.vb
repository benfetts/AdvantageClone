Namespace Nielsen.Database.Entities
    ...
    <Table("NIELSEN_RADIO_COUNTY_UNIVERSE")>
...
#Region " Properties "
        ...
        <Required>
        <Column("NIELSEN_RADIO_COUNTY_UNIVERSE_ID")>
