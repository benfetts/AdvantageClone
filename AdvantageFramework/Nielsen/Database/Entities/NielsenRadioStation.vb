...
#Region " Methods "
        ...
        Public Overrides Sub SetRequiredFields()
            ...
            SetRequired(AdvantageFramework.Nielsen.Database.Entities.NielsenRadioStation.Properties.NielsenRadioFormatCode.ToString, (Me.Source = RadioSource.Nielsen))
            SetRequired(AdvantageFramework.Nielsen.Database.Entities.NielsenRadioStation.Properties.Frequency.ToString, (Me.Source = RadioSource.Nielsen))
