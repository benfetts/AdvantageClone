Namespace Reporting.Database.Classes
    ...
    <Serializable>
    Public Class AlertRecipientsReport
...
#Region " Variables "
        ...
        Private _RecipientEmployee As String = Nothing
        Private _RecipientEmailAddress As String = Nothing
        Private _IsCC As String = Nothing
        Private _NewAlert As String = Nothing
        Private _ReadAlert As String = Nothing
        Private _IsDismissed As String = Nothing
        Private _DismissedDate As Nullable(Of Date) = Nothing
...
#Region " Properties "
        ...
        Public Property RecipientEmployeeCode() As String
            ...
            End Get
            Set(value As String)
                _RecipientEmployeeCode = value
            End Set
        End Property
        Public Property RecipientEmployee() As String
            Get
                RecipientEmployee = _RecipientEmployee
            End Get
            Set(value As String)
                _RecipientEmployee = value
            End Set
        End Property
        Public Property RecipientEmailAddress() As String
            ...
            End Set
        End Property
        Public Property IsCC() As String
            Get
                IsCC = _IsCC
            End Get
            Set(value As String)
            ...
            End Set
        End Property
        Public Property NewAlert() As String
            Get
                NewAlert = _NewAlert
            End Get
            Set(value As String)
            ...
            End Set
        End Property
        Public Property ReadAlert() As String
            Get
                ReadAlert = _ReadAlert
            End Get
            Set(value As String)
                _ReadAlert = value
            End Set
        End Property
        Public Property IsDismissed() As String
            Get
            ...
            End Set
        End Property
        Public Property DismissedDate() As Nullable(Of Date)
            Get
