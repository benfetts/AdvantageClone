Namespace Reporting.Database.Classes
    ...
    <Serializable()>
    Public Class BillingWorksheetProductionReportV2
...
#Region " Properties "
        ...
        Public Property GLLabor() As String
        <AdvantageFramework.BaseClasses.Attributes.Entity(DisplayFormat:="")>
        Public Property GLVendorCosts() As String
        <AdvantageFramework.BaseClasses.Attributes.Entity(DisplayFormat:="")>
        Public Property GLOther() As String
