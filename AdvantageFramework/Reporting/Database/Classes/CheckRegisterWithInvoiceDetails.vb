Namespace Reporting.Database.Classes
    ...
    <Serializable>
    Public Class CheckRegisterWithInvoiceDetails
...
#Region " Variables "
        ...
        Private _InvoiceAmountPaid As Nullable(Of Decimal) = Nothing
...
#Region " Properties "
        ...
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="n2")>
        Public Property InvoiceAmountPaid() As Nullable(Of Decimal)
            Get
                InvoiceAmountPaid = _InvoiceAmountPaid
            End Get
            Set(ByVal value As Nullable(Of Decimal))
                _InvoiceAmountPaid = value
            End Set
        End Property
