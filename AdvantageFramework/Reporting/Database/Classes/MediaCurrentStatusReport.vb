...
#Region " Variables "
        ...
        Private _BilledPostingPeriod As String = Nothing
        ...
        Private _LineRevisionNumber As Nullable(Of Integer) = Nothing
        Private _LineSequenceNumber As Nullable(Of Integer) = Nothing
...
#Region " Properties "
        ...
        End Property
        <System.Runtime.Serialization.DataMemberAttribute()>
        Public Property BilledPostingPeriod() As String
            Get
                BilledPostingPeriod = _BilledPostingPeriod
            End Get
            Set(value As String)
                _BilledPostingPeriod = value
            End Set
        End Property
        <System.Runtime.Serialization.DataMemberAttribute()>
        ...
        End Property
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="f0")>
        Public Property LineSequenceNumber() As Nullable(Of Short)
            Get
                LineSequenceNumber = _LineSequenceNumber
            End Get
            Set(value As Nullable(Of Short))
