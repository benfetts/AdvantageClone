Namespace Reporting.Database.ComplexTypes
    ...
    <System.Data.Objects.DataClasses.EdmComplexTypeAttribute(NamespaceName:="ReportingObjectContext", Name:="ARPaymentHistoryReport")>
    <Serializable()>
...
#Region " Variables "
        ...
        Private _ARCostAmount As Nullable(Of Decimal) = Nothing
...
#Region " Properties "
        ...
        Public Property ARCostAmount() As Nullable(Of Decimal)
            Get
                ARCostAmount = _ARCostAmount
            End Get
            Set(value As Nullable(Of Decimal))
                _ARCostAmount = System.Data.Objects.DataClasses.StructuralObject.SetValidValue(value)
            End Set
        End Property
        <System.Data.Objects.DataClasses.EdmScalarPropertyAttribute(EntityKeyProperty:=False, IsNullable:=True),
        System.Runtime.Serialization.DataMemberAttribute()>
