Namespace Reporting.Database.Procedures.MediaCurrentStatusReportComplexType
...
#Region " Methods "
        ...
        Public Function Load(ByVal ReportingObjectContext As Reporting.Database.ObjectContext, ByVal ParameterDictionary As System.Collections.Generic.Dictionary(Of String, Object)) As System.Data.Objects.ObjectResult(Of Database.ComplexTypes.MediaCurrentStatusReport)

            Load = Load(ReportingObjectContext, ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.OrderStatus.ToString), ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.StartDate.ToString), _
                        ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.StartMonth.ToString), ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.StartYear.ToString), _
                        ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.EndDate.ToString), ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.EndMonth.ToString), _
                        ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.EndYear.ToString), ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.IncludeInternet.ToString), _
                        ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.IncludeMagazine.ToString), ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.IncludeNewspaper.ToString), _
                        ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.IncludeOutOfHome.ToString), ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.IncludeRadio.ToString), _
                        ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.IncludeTelevision.ToString))
        ...
        Public Function Load(ByVal ReportingObjectContext As Reporting.Database.ObjectContext, Optional ByVal OrderStatus As String = "O", Optional ByVal StartDate As Date = #1/1/1900#, _
                             ...
                             Optional ByVal IncludeRadio As Boolean = True, Optional ByVal IncludeTelevision As Boolean = True) As System.Data.Objects.ObjectResult(Of Database.ComplexTypes.MediaCurrentStatusReport)
            ...
            Load = ReportingObjectContext.ExecuteFunction(Of Database.ComplexTypes.MediaCurrentStatusReport)("LoadMediaCurrentStatusReport", OrderStatusObjectParameter, StartDateObjectParameter, _
