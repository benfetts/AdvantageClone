Namespace Reporting.Database.Procedures.RevenueForecastReport
...
#Region " Methods "
        ...
        Public Function Load(ByVal ReportingDbContext As Reporting.Database.DbContext, ByVal ParameterDictionary As System.Collections.Generic.Dictionary(Of String, Object)) As System.Data.Entity.Infrastructure.DbRawSqlQuery(Of Database.Classes.RevenueForecastReport)
        ...
        Public Function Load(ByVal ReportingDbContext As Reporting.Database.DbContext, ByVal StartingPostPeriodCode As String,
                             ...
                             ByVal CurrentPeriod As String, ByVal DisplayOption As Integer, ByVal ActualizeDate As DateTime) As System.Data.Entity.Infrastructure.DbRawSqlQuery(Of Database.Classes.RevenueForecastReport)
            ...
            Load = ReportingDbContext.Database.SqlQuery(Of Database.Classes.RevenueForecastReport)("EXEC dbo.usp_wv_Revenue_Forecast_Report @DATE_TYPE, @START_PERIOD, @END_PERIOD, @OFFICE_CODES, @SALES_CLASS_CODES, @CURRENT_PERIOD, @DISPLAY_OPTION, @ACTUALIZE_DATE",
