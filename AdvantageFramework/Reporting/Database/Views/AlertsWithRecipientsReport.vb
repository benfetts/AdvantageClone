Namespace Reporting.Database.Views
    ...
    <Table("V_DRPT_ALERTS_RECIPIENTS_LIVE")>
    Public Class AlertsWithRecipientsReport
...
#Region " Properties "
        ...
        <MaxLength(6)>
        <Column("RecipientEmployeeCode", TypeName:="varchar")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property RecipientEmployeeCode() As String
        <MaxLength(64)>
        <Column("RecipientEmployee", TypeName:="varchar")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property RecipientEmployee() As String
        <MaxLength(50)>
        <Column("RecipientEmailAddress", TypeName:="varchar")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property RecipientEmailAddress() As String
        <Required>
        <MaxLength(3)>
        <Column("NewAlert", TypeName:="varchar")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property NewAlert() As String
        <Required>
        <MaxLength(3)>
        <Column("ReadAlert", TypeName:="varchar")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property ReadAlert() As String
        <Required>
        <MaxLength(9)>
        <Column("IsDismissed", TypeName:="varchar")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
