Namespace Reporting.Database.Views
	...
	<Table("V_DRPT_JOB_PO")>
	Public Class JobPurchaseOrderReport
...
#Region " Properties "
		...
		<MaxLength(40)>
		<Column("LineDescription", TypeName:="varchar")>
		<AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
