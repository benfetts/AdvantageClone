Namespace Security.Database.Entities
	...
	Public Class ClientPortalWorkspaceObject
...
#Region " Properties "
		...
		<Column("WORKSPACE_ID")>
        <AdvantageFramework.BaseClasses.Attributes.Entity(IsRequired:=False, DisplayFormat:="")>
        Public Property ClientPortalUserWorkspaceID() As Integer
        <Required>
        ...
        Public Overridable Property ClientPortalUserWorkspace As Database.Entities.ClientPortalUserWorkspace
