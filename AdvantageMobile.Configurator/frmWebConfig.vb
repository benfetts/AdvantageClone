...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.XtraTabControlMain.TabPages.AddRange(New DevExpress.XtraTab.XtraTabPage() {Me.XtraTabPageIIS, Me.XtraTabPageApplication, Me.XtraTabPageRegistry, Me.XtraTabPageDatabase, Me.XtraTabPageWebServices, Me.XtraTabPageSMTP})
        '
        'XtraTabPageIIS
        '
        ...
        Me.btnChangeSMTPSettings.Location = New System.Drawing.Point(8, 393)
        Me.btnChangeSMTPSettings.Name = "btnChangeSMTPSettings"
        Me.btnChangeSMTPSettings.Size = New System.Drawing.Size(371, 42)
...
#Region " Controls "
    ...
    Private Sub btnSetupVirtDir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetupVirtDir.Click
            ...
            Try
                ...
                Select Case Me.SelectedApplication
                    ...
                    Case App.Webvantage, App.MobileDataservices
                        ...
                        CopyDirectory(Application.StartupPath, Me.txtPhysicalPath.Text.Trim)

                    Case App.ClientPortal

                        CopyDirectoryCP(Application.StartupPath, Me.txtPhysicalPath.Text.Trim)
        ...
        SetACEPermissions(txtPhysicalPath.Text.Trim, strConnString)
    ...
    Private Sub btnSmtpInstall_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSmtpInstall.Click
        ...
        Try
            ...
            If is64Bit() = True Then
                ...
                Try
                    File.Copy(Application.StartupPath & "\SMTP\Mailbee64.dll", sSystem32Directory & "\System32\Mailbee64.dll")
                    Exists = True
                Catch ex As Exception
                ...
                Try
                    ...
                    File.Copy(Application.StartupPath & "\SMTP\Mailbee.dll", sSystem32Directory & "\SysWow64\Mailbee.dll")
                    Exists = True
            ...
            Else
                ...
                Try
                    ...
                    File.Copy(Application.StartupPath & "\SMTP\Mailbee.dll", sSystem32Directory & "\System32\Mailbee.dll")
                    Exists = True
        ...
        Try
            ...
            Select Case Me.SelectedApplication
                ...
                Case App.MobileDataservices
                    ...
                    Me._EventLogName = "Adv Dataservice Log"

                    If Not System.Diagnostics.EventLog.SourceExists(Me._EventSource) Then

                        System.Diagnostics.EventLog.CreateEventSource(Me._EventSource, _EventLogName)
                        Created = True

                    End If
                    If Not System.Diagnostics.EventLog.SourceExists("Adv Dataservice Debug Message") Then

                        System.Diagnostics.EventLog.CreateEventSource("Adv Dataservice Debug Message", _EventLogName)
                        Created = True

                    End If
                    If Not System.Diagnostics.EventLog.SourceExists("Adv Dataservice Warning") Then

                        System.Diagnostics.EventLog.CreateEventSource("Adv Dataservice Warning", _EventLogName)
                        Created = True

                    End If
                    If Not System.Diagnostics.EventLog.SourceExists("Adv Dataservice Error") Then

                        System.Diagnostics.EventLog.CreateEventSource("Adv Dataservice Error", _EventLogName)
                        Created = True
                ...
                Case Else
                    ...
                    If Not System.Diagnostics.EventLog.SourceExists(Me._EventSource) Then
                        ...
                        System.Diagnostics.EventLog.CreateEventSource(Me._EventSource, Me._EventLogName)
                        Created = True
            ...
            If Created = True Then
                ...
                MsgBox("Event Log created", MsgBoxStyle.OkOnly)
...
#Region " Form "
    ...
    Private Sub frmWebConfig_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Select Case Me.SelectedApplication
                ...
                Case App.MobileDataservices
                    ...
                    Me.Text = "Configure Mobile Data Services"

                    Me.txtVirtualDirectory.Text = "MobileData"
                    Me.GroupControlVirtualDirectory.Text = "Mobile Data Services Virtual Directory"
                    Me.chkVirtualDirectory.Text = "Create Mobile Data Services Directory"
                    Me.chkUpperCaseUser.Visible = True
                    Me.chkChooseServer.Checked = True
                    Me.chkChooseServer.Visible = True
                    Me.Label30.Text = "Enter URL for Mobile Data Services:"
                    Me.Label13.Text = "Location of the Mobile Data Services web.config file:"
        ...
        Try
            ...
            If System.Diagnostics.EventLog.SourceExists(Me._EventSource) = False Then
