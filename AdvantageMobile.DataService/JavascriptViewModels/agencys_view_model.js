...
(function() {
    AdvantageMobile_UI.AgencyViewModel = function(data) {
				...
				this.TIME_REQ_ASSN = ko.observable();
				this.TIME_UNIQUE_ROW = ko.observable();
				this.ALLOW_PROOFHQ = ko.observable();
		        if(data)
					this.fromJS(data);
    };
    ...
    $.extend(AdvantageMobile_UI.AgencyViewModel.prototype, {
        toJS: function() {
			...
			TIME_REQ_ASSN: this.TIME_REQ_ASSN(),
			TIME_UNIQUE_ROW: this.TIME_UNIQUE_ROW(),
			ALLOW_PROOFHQ: this.ALLOW_PROOFHQ(),
			};
        },
        ...
        fromJS: function(data) {
            if(data) {
				...
				this.TIME_REQ_ASSN(data.TIME_REQ_ASSN);
				this.TIME_UNIQUE_ROW(data.TIME_UNIQUE_ROW);
				this.ALLOW_PROOFHQ(data.ALLOW_PROOFHQ);
