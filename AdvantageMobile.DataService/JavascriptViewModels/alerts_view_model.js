...
(function() {
    AdvantageMobile_UI.AlertViewModel = function(data) {
				...
				this.IS_WORK_ITEM = ko.observable();
				this.BOARD_STATE_ID = ko.observable();
				this.EPIC_ID = ko.observable();
				this.HRS_ALLOWED = ko.observable();
				this.BACKLOG_SEQ_NBR = ko.observable();
    ...
    $.extend(AdvantageMobile_UI.AlertViewModel.prototype, {
        toJS: function() {
			...
			IS_WORK_ITEM: this.IS_WORK_ITEM(),
			BOARD_STATE_ID: this.BOARD_STATE_ID(),
			EPIC_ID: this.EPIC_ID(),
			HRS_ALLOWED: String(this.HRS_ALLOWED() || 0),
			BACKLOG_SEQ_NBR: this.BACKLOG_SEQ_NBR(),
        ...
        fromJS: function(data) {
            if(data) {
				...
				this.IS_WORK_ITEM(data.IS_WORK_ITEM);
				this.BOARD_STATE_ID(data.BOARD_STATE_ID);
				this.EPIC_ID(data.EPIC_ID);
				this.HRS_ALLOWED(data.HRS_ALLOWED);
				this.BACKLOG_SEQ_NBR(data.BACKLOG_SEQ_NBR);
