...
(function() {
    AdvantageMobile_UI.ClientViewModel = function(data) {
				...
				this.BILLER_EMP_CODE = ko.observable();
				this.CLIENT_DISCOUNT_CODE = ko.observable();
				this.LIMIT_TIME_FUNCTIONS_TO_BILLING_HIERARCHY = ko.observable();
				this.TV_UNIT_PRODUCT_SPLIT = ko.observable();
				this.CALC_LATE_FEE = ko.observable();
				this.LATE_FEE_PERCENT = ko.observable();
				this.AUTOMATED_ASSIGNMENT_JOB_NUMBER = ko.observable();
				this.AUTOMATED_ASSIGNMENT_JOB_COMPONENT_NBR = ko.observable();
				this.VAT_NUMBER = ko.observable();
		        if(data)
					this.fromJS(data);
    };
    ...
    $.extend(AdvantageMobile_UI.ClientViewModel.prototype, {
        toJS: function() {
			...
			BILLER_EMP_CODE: this.BILLER_EMP_CODE(),
			CLIENT_DISCOUNT_CODE: this.CLIENT_DISCOUNT_CODE(),
			LIMIT_TIME_FUNCTIONS_TO_BILLING_HIERARCHY: this.LIMIT_TIME_FUNCTIONS_TO_BILLING_HIERARCHY(),
			TV_UNIT_PRODUCT_SPLIT: this.TV_UNIT_PRODUCT_SPLIT(),
			CALC_LATE_FEE: this.CALC_LATE_FEE(),
			LATE_FEE_PERCENT: String(this.LATE_FEE_PERCENT() || 0),
			AUTOMATED_ASSIGNMENT_JOB_NUMBER: this.AUTOMATED_ASSIGNMENT_JOB_NUMBER(),
			AUTOMATED_ASSIGNMENT_JOB_COMPONENT_NBR: this.AUTOMATED_ASSIGNMENT_JOB_COMPONENT_NBR(),
        ...
        fromJS: function(data) {
            if(data) {
				...
				this.BILLER_EMP_CODE(data.BILLER_EMP_CODE);
				this.CLIENT_DISCOUNT_CODE(data.CLIENT_DISCOUNT_CODE);
				this.LIMIT_TIME_FUNCTIONS_TO_BILLING_HIERARCHY(data.LIMIT_TIME_FUNCTIONS_TO_BILLING_HIERARCHY);
				this.TV_UNIT_PRODUCT_SPLIT(data.TV_UNIT_PRODUCT_SPLIT);
				this.CALC_LATE_FEE(data.CALC_LATE_FEE);
				this.LATE_FEE_PERCENT(data.LATE_FEE_PERCENT);
				this.AUTOMATED_ASSIGNMENT_JOB_NUMBER(data.AUTOMATED_ASSIGNMENT_JOB_NUMBER);
				this.AUTOMATED_ASSIGNMENT_JOB_COMPONENT_NBR(data.AUTOMATED_ASSIGNMENT_JOB_COMPONENT_NBR);
