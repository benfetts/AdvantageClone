...
(function() {
    AdvantageMobile_UI.OfficeViewModel = function(data) {
				...
				this.GLACODE_CLIENT_LATE_PAYMENT_FEE = ko.observable();
		        if(data)
					this.fromJS(data);
    };
    ...
    $.extend(AdvantageMobile_UI.OfficeViewModel.prototype, {
        toJS: function() {
			...
			GLACODE_CLIENT_LATE_PAYMENT_FEE: this.GLACODE_CLIENT_LATE_PAYMENT_FEE(),
			};
        },
        ...
        fromJS: function(data) {
            if(data) {
				...
				this.GLACODE_CLIENT_LATE_PAYMENT_FEE(data.GLACODE_CLIENT_LATE_PAYMENT_FEE);
