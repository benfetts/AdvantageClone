...
#Region " Methods "
        ...
        Private Sub New(Connectionstring As String, ClientID As Integer, ClientName As String, ClientOrderID As Integer, Optional ByVal ClientOrderIDCopy As Nullable(Of Integer) = Nothing)
...
#Region "  Show Form Methods "
        ...
        Public Shared Function ShowFormDialog(Connectionstring As String, ClientID As Integer, ClientName As String, ByRef ClientOrderID As Integer) As System.Windows.Forms.DialogResult

            Using ClientOrderEditDialog As New WinForm.Presentation.Maintenance.ClientOrderEditDialog(Connectionstring, ClientID, ClientName, ClientOrderID)
        ...
        End Function
        Public Shared Function ShowFormDialog(Connectionstring As String, ClientID As Integer, ClientName As String, ClientOrderIDCopy As Integer, ByRef ClientOrderID As Integer) As System.Windows.Forms.DialogResult

            Using ClientOrderEditDialog As New WinForm.Presentation.Maintenance.ClientOrderEditDialog(Connectionstring, ClientID, ClientName, ClientOrderID, ClientOrderIDCopy)
...
#Region "  Form Event Handlers "
        ...
        Private Sub ClientOrderEditDialog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If _ClientOrderIDCopy.HasValue Then
                ...
                If ClientOrderControl_Order.LoadControl(_Connectionstring, _ClientID, _ClientOrderIDCopy.Value, True) = False Then
            ...
            Else
                ...
                If ClientOrderControl_Order.LoadControl(_Connectionstring, _ClientID, _ClientOrderID) = False Then
