CREATE FUNCTION [dbo].[advtf_ncc_tv_fusion_audience_book_quarter_hour](
...
BEGIN
	...
	FROM (
		...
		FROM @RESULTS a
		WHERE [MATCH] > 0
		GROUP BY a.NIELSEN_TV_BOOK_ID, a.STATION_CODE, a.ID, a.NUMBER_DAYS, AdjustedHour, MINUTEPART, AdjustedDateTime, a.[week]
	...
	SELECT
			u.nielsen_demo_code, u.audience, u.station_code, u.nielsen_tv_book_id, u.[week], u.media_spot_tv_research_daytime_id, u.number_days, MINUTEPART, AdjustedDateTime, AdjustedHour
	FROM @tt
	UNPIVOT
	(
		audience
