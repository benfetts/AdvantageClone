...
SET @StationCodes = '5094'
SET @BookIDs = '17'

	insert into @MEDIA_SPOT_TV_RESEARCH_DAYTIME_TYPE (ID, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, StartTime, EndTime, StartHour, EndHour)
	select MEDIA_SPOT_TV_RESEARCH_DAYTIME_ID, MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY, START_TIME, END_TIME, START_HOUR, END_HOUR
	from [MCHRISTMAN-PC].ADVAN67002.dbo.MEDIA_SPOT_TV_RESEARCH_DAYTIME
	WHERE MEDIA_SPOT_TV_RESEARCH_ID = 22
