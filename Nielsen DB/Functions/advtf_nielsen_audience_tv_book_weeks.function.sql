CREATE FUNCTION [dbo].[advtf_nielsen_audience_tv_book_weeks](
...
BEGIN
	...
	FROM (
		...
		GROUP BY a.NIELSEN_TV_BOOK_ID, [week], a.STATION_CODE, a.ID, a.NUMBER_DAYS, AdjustedHour, MINUTEPART 
	...
	SELECT
			u.nielsen_demo_code, u.audience, u.station_code, u.nielsen_tv_book_id, [week], u.media_spot_tv_research_daytime_id, u.number_days
	FROM @tt
	UNPIVOT
	(
		audience
...
GRANT SELECT ON [advtf_nielsen_audience_tv_book_weeks] TO PUBLIC
GO
