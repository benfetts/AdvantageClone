CREATE FUNCTION [dbo].[advtf_nielsen_radio_audience_spot_radio_research_cume](
...
BEGIN
	...
	SELECT
		u.nielsen_demo_code, u.cume, NIELSEN_RADIO_SEGMENT_PARENT_ID, NIELSEN_RADIO_SEGMENT_CHILD_ID, NIELSEN_RADIO_STATION_COMBO_ID, NIELSEN_RADIO_DAYPART_ID
	FROM (
		SELECT
			...
			[254] = a.[MALES_18TO20_CUME] + CASE WHEN @NIELSEN_RADIO_QUALITATIVE_ID > 1 THEN a.MALES_18TO24_CUME ELSE 0 END,
			[255] = a.[MALES_21TO24_CUME],
			[3] = a.[MALES_25TO34_CUME],
			[4] = a.[MALES_35TO44_CUME] + CASE WHEN @NIELSEN_RADIO_QUALITATIVE_ID > 1 THEN a.MALES_35TO49_CUME ELSE 0 END,
			[5] = a.[MALES_45TO49_CUME],
			[6] = a.[MALES_50TO54_CUME],
			[82] = a.[MALES_55TO64_CUME],
			[7] = a.[MALES_65PLUS_CUME],
			[267] = a.[FEMALES_18TO20_CUME] + CASE WHEN @NIELSEN_RADIO_QUALITATIVE_ID > 1 THEN a.FEMALES_18TO24_CUME ELSE 0 END,
			[268] = a.[FEMALES_21TO24_CUME],
			[10] = a.[FEMALES_25TO34_CUME],
			[11] = a.[FEMALES_35TO44_CUME] + CASE WHEN @NIELSEN_RADIO_QUALITATIVE_ID > 1 THEN a.FEMALES_35TO49_CUME ELSE 0 END,
...
GRANT SELECT ON [advtf_nielsen_radio_audience_spot_radio_research_cume] TO PUBLIC
GO