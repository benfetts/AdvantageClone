CREATE PROCEDURE [dbo].[advsp_hosted_spottv_get_market_numbers]
...
BEGIN
	...
	SELECT DISTINCT NIELSEN_MARKET_NUM 
...
GRANT EXEC ON [advsp_hosted_spottv_get_market_numbers] TO PUBLIC
GO