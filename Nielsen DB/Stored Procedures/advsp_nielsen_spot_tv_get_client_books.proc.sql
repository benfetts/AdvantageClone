CREATE PROCEDURE [dbo].[advsp_nielsen_spot_tv_get_client_books]
	@CLIENT_CODE varchar(6)
AS 
BEGIN
	
	SELECT DISTINCT
		[NielsenTVBookID] = b.NIELSEN_TV_BOOK_ID,
...
GRANT EXEC ON [advsp_nielsen_spot_tv_get_client_books] TO PUBLIC
GO