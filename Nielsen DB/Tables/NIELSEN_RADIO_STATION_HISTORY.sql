CREATE TABLE [dbo].[NIELSEN_RADIO_STATION_HISTORY] (
    [NIELSEN_RADIO_STATION_HISTORY_ID] INT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_NIELSEN_RADIO_STATION_HISTORY] PRIMARY KEY CLUSTERED ([NIELSEN_RADIO_STATION_HISTORY_ID] ASC)
);
