...
BEGIN
	...
	INSERT INTO @tt
	SELECT
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([hh] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([hh]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([c2-5] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([c2-5]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([c6-11] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([c6-11]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m12-14] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m12-14]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m15-17] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m15-17]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m18-20] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m18-20]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m21-24] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m21-24]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m25-34] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m25-34]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m35-49] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m35-49]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m50-54] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m50-54]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m55-64] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m55-64]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([m65P] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([m65P]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f12-14] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f12-14]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f15-17] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f15-17]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f18-20] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f18-20]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f21-24] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f21-24]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f25-34] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f25-34]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f35-49] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f35-49]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f50-54] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f50-54]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f55-64] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f55-64]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([f65P] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([f65P]) END,
		CASE WHEN OutsideOfBook = 0 THEN CAST (ROUND( CAST( SUM([ww] * MINUTEPART) as decimal(20)) / CAST( SUM(MINUTEPART) as decimal(20)), 0) as bigint) ELSE AVG([ww]) END,
		[nielsen_tv_book_id],
	...
	FROM (
		...
		FROM
			...
			HUTPUT_DATETIME, d.ExactSpotDate, START_DATETIME, END_DATETIME, StartTime, EndTime
			FROM 
				(SELECT
					HOUSEHOLD_HUT,
					CHILDREN_2TO5_PUT,
		...
		GROUP BY a.NIELSEN_TV_BOOK_ID, a.ID, AdjustedHour, MINUTEPART, OutsideOfBook, HUTPUT_DATETIME, ExactSpotDate, START_DATETIME, 
				END_DATETIME , AdjustedDateTime, StartTime, EndTime
		HAVING AVG(a.HOUSEHOLD_HUT) IS NOT NULL

		) suma
	GROUP BY [nielsen_tv_book_id], [media_spot_tv_research_daytime_id], OutsideOfBook
...
GRANT SELECT ON [advtf_nielsen_hutput_spot_tv_research] TO PUBLIC
GO
