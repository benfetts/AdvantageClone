...
BEGIN
	...
	AND (
		...
		OR
			...
			AND nrp.NIELSEN_RADIO_PERIOD_ID IN (SELECT NIELSEN_RADIO_PERIOD_ID 
												FROM dbo.V_HOSTED_RADIO_PERIODS 
	...
	FROM dbo.[advtf_nielsen_radio_audience_get_cume](@NIELSEN_RADIO_SEGMENT_PARENT_IDs, @LISTENING_LOCATION, @STATION_COMBO_TYPE, @SelectedMediaDemographicIDs, @MEDIA_DEMO_DETAIL_TYPE, @MEDIA_SPOT_TV_RESEARCH_DAYTIME_TYPE) CUME
...
GRANT EXEC ON [advsp_radio_worksheet_rating] TO PUBLIC
GO