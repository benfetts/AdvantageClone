IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[advsp_tv_worksheet_postbuy_rating]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[advsp_tv_worksheet_postbuy_rating]
GO
