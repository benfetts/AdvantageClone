Namespace BaseClasses
    ...
    Public MustInherit Class Entity
        Implements System.ComponentModel.IDataErrorInfo,
                   BaseClasses.Interfaces.IValidatingClass,
...
#Region " Variables "
        ...
        'Protected _DataContext As BaseClasses.DataContext = Nothing
        <System.NonSerialized>
        Protected _DbContext As BaseClasses.DbContext = Nothing
...
#Region " Properties "
        ...
        <Xml.Serialization.XmlIgnore()>
        <System.ComponentModel.DataAnnotations.Schema.NotMapped>
        Public Property DbContext As BaseClasses.DbContext
            Get
                DbContext = _DbContext
            End Get
            Set(ByVal value As BaseClasses.DbContext)
                _DbContext = value
            End Set
        End Property
        '<System.ComponentModel.Browsable(False)>
...
#Region " Methods "
        ...
        Public Overridable Sub LoadPropertyAttributes(ByVal PropertyName As String,
            ...
            LoadPropertyAttributes(Me.GetType, PropertyName, IsEntityKey, IsNullable, IsRequired, MaxLength, Precision, Scale, DisplayName)
        ...
        End Function
        Public Function ImportFromXML(ByVal XML As String) As BaseClasses.Entity Implements Interfaces.IValidatingClass.ImportFromXML
        ...
        Public Overridable Function ValidateEntityProperty(ByVal PropertyName As String, ByRef IsValid As Boolean, ByRef Value As Object) As String Implements Interfaces.IValidatingClass.ValidateEntityProperty
            ...
            FinalizeEntityPropertyValidation(PropertyName, IsValid, Value, ErrorText, IsEntityKey, IsNullable, IsRequired, MaxLength, Precision, Scale)
        ...
        Protected Overridable Sub FinalizeEntityPropertyValidation(ByVal PropertyName As String, ByRef IsValid As Boolean, ByRef Value As Object, ByRef ErrorText As String,
                                                                   ...
                                                                   ByVal Precision As Long, ByVal Scale As Long)
        ...
        Public Shared Function LoadPropertyMaxLength(PropertyDescriptor As System.ComponentModel.PropertyDescriptor) As Integer
            ...
            If PropertyDescriptor IsNot Nothing Then
                ...
                LoadPropertyAttributes(PropertyDescriptor, IsEntityKey, IsNullable, IsRequired, MaxLength, Precision, Scale, DisplayName)
        ...
        Public Shared Function LoadPropertyMaxLength(EntityType As Type, PropertyName As String) As Integer
            ...
            If EntityType IsNot Nothing AndAlso String.IsNullOrWhiteSpace(PropertyName) = False Then
                ...
                LoadPropertyAttributes(EntityType, PropertyName, IsEntityKey, IsNullable, IsRequired, MaxLength, Precision, Scale, DisplayName)
