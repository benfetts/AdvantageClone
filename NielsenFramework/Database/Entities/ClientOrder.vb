...
#Region " Properties "
        ...
        Public Overridable Property ClientOrderMarkets As ICollection(Of Database.Entities.ClientOrderMarket)

        Public Overridable Property ClientOrderStates As ICollection(Of Database.Entities.ClientOrderState)
...
#Region " Methods "
        ...
        Public Sub New()
            ...
            Me.ClientOrderMarkets = New HashSet(Of Database.Entities.ClientOrderMarket)
            Me.ClientOrderStates = New HashSet(Of Database.Entities.ClientOrderState)
