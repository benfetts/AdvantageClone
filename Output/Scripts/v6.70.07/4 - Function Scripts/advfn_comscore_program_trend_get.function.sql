CREATE FUNCTION [dbo].[advfn_comscore_program_trend_get](
	@MARKET_NUMBER int,
	@SHARE_BOOK_ID int,
	@STATION_CODE int,
...
DECLARE @MARKET_NUMBER int,
	...
	set @Friday = 0
	set @Saturday = 1
	set @WeekStartDate = '2020-02-27 03:00:00'
	set @WeekEndDate = '2020-03-05 02:59:00'
*/
	...
	FROM (
			...
			FROM dbo.COMSCORE_CACHE_DETAIL d
				...
				INNER JOIN dbo.COMSCORE_TV_BOOK b ON d.QTR_HR BETWEEN @WeekStartDate AND @WeekEndDate
