IF EXISTS ( SELECT * FROM sysobjects WHERE id = OBJECT_ID( N'[dbo].[advtf_alert_dashboard_NS_NEW]' ) AND xtype IN ( N'FN', N'IF', N'TF' ))
BEGIN
	DROP FUNCTION [dbo].[advtf_alert_dashboard_NS_NEW]
END
GO
CREATE FUNCTION [dbo].[advtf_alert_dashboard_NS_NEW] (
