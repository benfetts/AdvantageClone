if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[advsp_job_detail_oop_by_job_load_minimized]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[advsp_job_detail_oop_by_job_load_minimized]
GO

CREATE PROCEDURE [dbo].[advsp_job_detail_oop_by_job_load_minimized](
	@DATE_TYPE AS int,
