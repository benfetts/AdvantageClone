...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_wv_calendar_task_month_rpt]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_wv_calendar_task_month_rpt]
GO
...
********************************************************************************************/
CREATE PROCEDURE [dbo].[usp_wv_calendar_task_month_rpt] 
@UserID VarChar(100),
@EmpCode Varchar(6),
