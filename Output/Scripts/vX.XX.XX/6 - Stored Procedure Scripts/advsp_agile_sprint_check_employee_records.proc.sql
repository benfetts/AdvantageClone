IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[advsp_agile_sprint_check_employee_records]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
    DROP PROCEDURE [dbo].[advsp_agile_sprint_check_employee_records]
GO
-- exec advsp_agile_sprint_check_employee_records 19,null,0
CREATE PROCEDURE [dbo].[advsp_agile_sprint_check_employee_records] 
@ALERT_ID INT,
