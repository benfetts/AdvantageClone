CREATE PROCEDURE [dbo].[advsp_invoice_printing_load_currentttdinvoicedetails]
...
BEGIN
	...
	IF @IsDraft = 1 BEGIN
		...
		FROM 
			...
			FROM 
				#JOBS_FUNCTIONS AS J LEFT OUTER JOIN
				(SELECT
						ARS.JOB_NUMBER,
						ARS.JOB_COMPONENT_NBR,
						ARS.FNC_CODE,
						ARS.FNC_TYPE,
						[HRS_QTY] = SUM(CAST(0 AS decimal(18,2))),
					...
					(SELECT
						...
						GROUP BY
							...
							ARS.FNC_TYPE) AS CTD ON CTD.JOB_NUMBER = J.JOB_NUMBER AND 
													...
													CTD.FNC_CODE = J.FNC_CODE) AS TD LEFT OUTER JOIN
	...
	END ELSE BEGIN
		...
		FROM 
			...
			FROM 
				#JOBS_FUNCTIONS AS J INNER JOIN
				(SELECT
						ARS.JOB_NUMBER,
						ARS.JOB_COMPONENT_NBR,
						ARS.FNC_CODE,
