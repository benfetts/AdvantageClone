...
FROM
	...
	SELECT
		...
		AP_GROSS_AMOUNT = CASE WHEN NET_GROSS = 1 THEN CAST(AP.NET_AMT / (1 - AP.COMM_PCT/100) as decimal(16,2)) ELSE CAST(AP.NET_AMT + (AP.NET_AMT * AP.MARKUP_PCT / 100) as decimal(16,2)) END,
...
FROM
	...
	SELECT
		...
		AP_GROSS_AMOUNT = CASE WHEN NET_GROSS = 1 THEN CAST(AP.NET_PLUS / (1 - AP.COMM_PCT/100) as decimal(16,2)) ELSE CAST(AP.NET_PLUS + (AP.NET_PLUS * AP.MARKUP_PCT / 100) as decimal(16,2)) END
...
FROM
	...
	SELECT
		...
		AP_GROSS_AMOUNT = CASE WHEN NET_GROSS = 1 THEN CAST(AP.EXT_NET_AMT / (1 - AP.COMM_PCT/100) as decimal(16,2)) ELSE CAST(AP.EXT_NET_AMT + (AP.EXT_NET_AMT * AP.MARKUP_PCT / 100) as decimal(16,2)) END,
