...
IF NOT EXISTS(SELECT [NAME] FROM [dbo].[EXPORT_TEMPLATE] WHERE [TYPE] = 10 AND [SYSTEM_TEMPLATE] = 1) BEGIN
	...
	VALUES (10, N'YayPay Invoice Transaction Allocations', 1, N',', @USER_CREATED, GETDATE(), NULL, NULL, 1, NULL, 1)
...
INSERT [dbo].[EXPORT_TEMPLATE_DTL] ([EXPORT_TEMPLATE_ID], [FIELD_NAME], [POSITION], [START], [LENGTH], [USER_CREATED], [CREATED_DATE], [USER_MODIFIED], [MODIFIED_DATE])
VALUES (@EXPORT_TEMPLATE_ID, N'amount', 2, NULL, 16, @USER_CREATED, GETDATE(), NULL, NULL)
INSERT [dbo].[EXPORT_TEMPLATE_DTL] ([EXPORT_TEMPLATE_ID], [FIELD_NAME], [POSITION], [START], [LENGTH], [USER_CREATED], [CREATED_DATE], [USER_MODIFIED], [MODIFIED_DATE])
VALUES (@EXPORT_TEMPLATE_ID, N'date', 3, NULL, 20, @USER_CREATED, GETDATE(), NULL, NULL)
INSERT [dbo].[EXPORT_TEMPLATE_DTL] ([EXPORT_TEMPLATE_ID], [FIELD_NAME], [POSITION], [START], [LENGTH], [USER_CREATED], [CREATED_DATE], [USER_MODIFIED], [MODIFIED_DATE])
VALUES (@EXPORT_TEMPLATE_ID, N'paid', 4, NULL, 16, @USER_CREATED, GETDATE(), NULL, NULL)
