...
Public Class cApplication
    ...
    Public Sub AddDirectorySecurity(ByVal FileName As String, ByVal Account As String, ByVal Rights As FileSystemRights, ByVal ControlType As AccessControlType)
        Try
            ...
            'Dim sUser As String = System.Environment.UserDomainName + "\\" + Account
    ...
    Public Function CopyWebConfig(ByVal NTAuth As Boolean, ByVal strPhysicalPath As String)


    End Function

    Public Function dbTestConnection() As Double
        ...
        Try
            ...
            Else
                Return -2
            End If
            'AC:  This code is never reached!
            Try
                Return oSql.ExecuteScalar(mConnString, CommandType.Text, "SELECT APPVALUE FROM WV_APPLICATION WHERE SETTINGS = 'DatabaseVersion'")
            Catch
                Return 0
            End Try
        Catch
    ...
    Public Function set_WebVirtDir(ByVal strWebName As String, ByVal strPath As String, ByVal strIISPATH As String)
        ...
        objIIS = Nothing
    End Function
    Public Sub CreateVirtualDir(ByVal IISWebSite As String, ByVal AppName As String, ByVal strPath As String, ByVal sSessionTimeout As Integer)
        ...
        Try
            ...
            VDir.Properties("DefaultDoc").Item(0) = System.Configuration.ConfigurationManager.AppSettings("IISDocuments").ToString '"default.htm,default.aspx,default.asp"
    ...
    Public Function UpdateRSReportServer(ByVal xmlpath As String)
        Dim doc As XmlDocument = New XmlDocument
        doc.Load(xmlpath)

        'Create a new attribute.
        Dim newAttr As XmlAttribute = doc.CreateAttribute("WVSQLDB")
        newAttr.Value = "wvSQLDB.wvSQLDBConnection,wvSQLDB"

        Dim inode As Integer = 0
        Dim nodelist As XmlNodeList = doc.SelectNodes("//Extension")
        Dim node As XmlNode
        For Each node In nodelist
            If nodelist.Item(inode).Attributes.Item(0).Value = "ORACLE" Then
                nodelist.Item(inode).Attributes.Item(0).Value = "WVSQLDB"
                nodelist.Item(inode).Attributes.Item(1).Value = "wvSQLDB.wvSQLDBConnection,wvSQLDB"
            End If
            inode = inode + 1
        Next
        doc.PreserveWhitespace = True

        Dim wrtr As XmlTextWriter = New XmlTextWriter(xmlpath, Encoding.ASCII)
    ...
    Public Function GetIISPath() As String
        ...
        Try
            IISregKey = Microsoft.Win32.Registry.LocalMachine
