...
@Component({
  selector: 'proof-workspace-view-split-vertical',
  templateUrl: './workspace-view-split-vertical.component.html',
  styleUrls: ['./workspace-view-split-vertical.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class WorkspaceViewSplitVerticalComponent implements OnInit, OnDestroy {
  ...
  public comparedSides = ['first', 'second'];
  ...
  public viewType = VIEW_VERSIONS_TYPES.SPLIT_VERTICAL;
  ...
  public handleFocusOnSide(side: string): void {
    this.viewContainer['first'].selected = false;
    this.viewContainer['second'].selected = false;
