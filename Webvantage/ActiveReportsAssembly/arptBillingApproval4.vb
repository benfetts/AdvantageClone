...
Public Class arptBillingApproval4
        ...
        Try
            ...
            If addressOption = "Contact" Then
                ...
                If Me.TextBox7.Text <> "" Then
                    Me.txtAddressInfo.Text = Me.txtAddressInfo.Text & vbCrLf & Me.TextBox7.Text
                End If
            ...
            Me.txtPageNumber.Text = Me.PageNumber.ToString
        Catch ex As Exception
    ...
    Private Sub Detail1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.BeforePrint
        Try
            If count > 0 Then
                Me.txtTaxableText.Visible = True
            Else
                Me.txtTaxableText.Visible = False
            End If
        Catch ex As Exception
    ...
    Private Sub GroupHeader2_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupHeader2.Format
        Try
            ...
            If Me.txtCampaignName.Text = "" Then
                Me.txtCampaignLabel.Text = ""
            Else
                Me.txtCampaignLabel.Text = "Campaign:"
            End If
            'End If
        Catch ex As Exception
    ...
    Private Sub GroupFooter4_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter4.Format
        Try
            Me.txtSalesTaxAmtJC.Text = String.Format("{0:#,##0.00}", CDbl(Me.txtSalesTaxAmtJC.Text))
            Me.txtsumJC.Text = String.Format("{0:#,##0.00}", (CDbl(Me.txtsumJC.Text) + CDbl(Me.txtSalesTaxAmtJC.Text)))
        Catch ex As Exception
