...
Public Class arptClientARStatement002
    ...
    'Private ds As arptClient002DS
    'Private dt As New arptClient002DS.usp_wv_reports_ar_statements_client_002DataTable
    Public CultureCode As String = "en-US"
    Public _LocationLogo As AdvantageFramework.Database.Entities.LocationLogo = Nothing
    Private Sub arptClientARStatement002_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ReportFunctions.SetCulture(Me, CultureCode)
        'ds = New arptClient002DS
        'Dim t As New arptClient002DSTableAdapters.usp_wv_reports_ar_statements_client_002TableAdapter
