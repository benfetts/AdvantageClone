...
Public Class arptClientARStatement003
    ...
    'Private ds As arptClient003DS
    'Private dt As New arptClient003DS.usp_wv_reports_ar_statements_client_003DataTable
    Public _LocationLogo As AdvantageFramework.Database.Entities.LocationLogo = Nothing

    Public CultureCode As String = "en-US"
    Private Sub arptClientARStatement003_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ReportFunctions.SetCulture(Me, CultureCode)
        'ds = New arptClient003DS
        'Dim t As New arptClient003DSTableAdapters.usp_wv_reports_ar_statements_client_003TableAdapter
