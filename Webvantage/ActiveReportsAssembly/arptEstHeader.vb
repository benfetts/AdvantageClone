...
Public Class arptEstHeader
    ...
    Private Sub Detail1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Try
            ...
            If Me.rpttype = "Estimating008" Or Me.rpttype = "Estimating009" Or Me.rpttype = "EstimatingTAP" Or rpttype = "EstimatingTAP2" Then
                ...
                If addressOption = "Contact" Then
                    dv = New DataView(dt)
                    dv.RowFilter = "JOB_NUMBER = '" & job & "' AND JOB_COMPONENT_NBR = '" & comp & "'"
                    dt = dv.ToTable()
            ...
            Else
                If addressOption = "Client" Then
                    If addressInfo.Rows.Count > 0 Then
                        ...
                        End If
                        If rpttype = "arptEstimating314" Then
                            If IsDBNull(dt.Rows(0)("CONT_FML")) = False Then
                                Me.txtContact.Text = dt.Rows(0)("CONT_FML")
                            End If
                        Else
                ...
                If addressOption = "Product" Then
                    If addressInfo.Rows.Count > 0 Then
                        ...
                        End If
                        If addressInfo.Rows(0)("PRD_BILL_COUNTRY") <> "" Then
