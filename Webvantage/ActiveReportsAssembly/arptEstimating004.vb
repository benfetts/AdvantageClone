...
Public Class arptEstimating004
    ...
    Private Sub arptEstimating004_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ...
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                ...
                If dtPrintDef.Rows(0)("SUBTOT_ONLY") = 1 Then
                    Me.txtFinalActual.Visible = False
                    ...
                    End If
                Else
                    Me.txtFinalActual.Visible = True
            ...
            If Me.txtOriginalAmt.Text <> "" Then
                Me.txtOriginalAmt.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtOriginalAmt.Text)))
            End If
            If Me.txtVariance.Text <> "" Then
                Me.txtVariance.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtVariance.Text)))
            End If
            If Me.txtRevisedAmt.Text <> "" Then
                Me.txtRevisedAmt.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtRevisedAmt.Text)))
            End If
            If Me.txtFinalActual.Text <> "" Then
                Me.txtFinalActual.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtFinalActual.Text)))
            End If
        Catch ex As Exception
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                ...
                Else
                    Me.txtFinalActual.Text = CDec(Me.txtFinalActual.Text) - CDec(Me.txtNB.Text)
                End If
                ...
                Else
                    ...
                    Me.txtFinalActual.Text = CDec(ReportFunctions.FormatDecimal(Me.txtFinalActual.Text)) + CDec(ReportFunctions.FormatDecimal(Me.txtActualTax.Text))
                    If dtPrintDef.Rows(0)("PRT_NONBILL") = 1 Then
                    Else
                        Me.txtFinalActual.Text = CDec(ReportFunctions.FormatDecimal(Me.txtFinalActual.Text)) - CDec(ReportFunctions.FormatDecimal(Me.txtNBTax.Text))
                    End If
                End If
                If dtPrintDef.Rows(0)("COMM_MU_SEPARATE") = 1 Then
                ...
                Else
                    ...
                    Me.txtFinalActual.Text = CDec(ReportFunctions.FormatDecimal(Me.txtFinalActual.Text)) + CDec(ReportFunctions.FormatDecimal(Me.txtActualMarkup.Text))
                    If dtPrintDef.Rows(0)("PRT_NONBILL") = 1 Then

                    Else
                        Me.txtFinalActual.Text = CDec(ReportFunctions.FormatDecimal(Me.txtFinalActual.Text)) - CDec(ReportFunctions.FormatDecimal(Me.txtNBMarkup.Text))
                    End If
                End If
    ...
    Private Sub GroupFooter1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter1.BeforePrint
        Try
            ...
            If Me.txtSubTotal.Text <> "" Then
                Me.txtSubTotal.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtSubTotal.Text)))
            End If
            ...
            If Me.txtCommission.Text <> "" Then
                Me.txtCommission.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtCommission.Text)))
            End If
            ...
            If Me.txtTax.Text <> "" Then
                Me.txtTax.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.txtTax.Text)))
            End If
        ...
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                If dtPrintDef.Rows(0)("TAX_SEPARATE") <> 1 Then
                    ...
                    Else
                        Me.txtSubTotal.Text = CDec(Me.txtSubTotal.Text) - CDec(Me.txtNBTaxTotal.Text)
                    End If
                Else
                    If dtPrintDef.Rows(0)("PRT_NONBILL") = 1 Then

                    Else
                        Me.txtTax.Text = CDec(Me.txtTax.Text) - CDec(Me.txtNBTaxTotal.Text)
                    End If
                End If
                If dtPrintDef.Rows(0)("COMM_MU_SEPARATE") <> 1 Then
                    ...
                    Else
                        Me.txtSubTotal.Text = CDec(Me.txtSubTotal.Text) - CDec(Me.txtNBMarkupTotal.Text)
                    End If
                Else
                    If dtPrintDef.Rows(0)("PRT_NONBILL") = 1 Then

                    Else
                        Me.txtCommission.Text = CDec(Me.txtCommission.Text) - CDec(Me.txtNBMarkupTotal.Text)
                    End If
                End If
            ...
            Else
                Me.txtSubTotal.Text = CDec(Me.txtSubTotal.Text) - CDec(Me.txtNBTotal.Text)
            End If
            ...
            If dtPrintDef.Rows.Count > 0 Then
                If dtPrintDef.Rows(0)("COMM_MU_SEPARATE") = 1 Then
                    ...
                    'Else
                    '    Me.txtTotalForEst.Text = CDec(Me.txtTotalForEst.Text) - CDec(Me.txtNBMarkupTotal.Text)
                    'End If
                End If
                If dtPrintDef.Rows(0)("TAX_SEPARATE") = 1 Then
                    ...
                    'Else
                    '    Me.txtTotalForEst.Text = CDec(Me.txtTotalForEst.Text) - CDec(Me.txtNBTaxTotal.Text)
                    'End If
                End If
                If dtPrintDef.Rows(0)("CONTINGENCY") = 1 And dtPrintDef.Rows(0)("CONT_SEPARATE") = 1 Then
            ...
            End If
            Me.txtVarianceCont2Total.Text = CDec(Me.txtRevisedCont2Total.Text) - CDec(Me.txtOrigCont2Total.Text)

            'If dtPrintDef.Rows(0)("PRT_NONBILL") = 1 Then
            '    Me.txtTotalForEst.Text = CDec(Me.txtTotalForEst.Text) + CDec(Me.txtNBTotal.Text)
            'End If
            ReportFunctions.SetCulture(Me, CultureCode)
        ...
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                If dtPrintDef.Rows(0)("TAX_SEPARATE") <> 1 Then
                    ...
                    Else
                        Me.txtTotalGrouping.Text = CDec(Me.txtTotalGrouping.Text) - CDec(Me.txtNBTaxGrouping.Text)
                    End If
                End If
                If dtPrintDef.Rows(0)("COMM_MU_SEPARATE") <> 1 Then
                    ...
                    Else
                        Me.txtTotalGrouping.Text = CDec(Me.txtTotalGrouping.Text) - CDec(Me.txtNBMarkupGrouping.Text)
                    End If
                End If
                If dtPrintDef.Rows(0)("FUNCTION_OPTION") = "T" Then
                    Me.GroupFooter2.Visible = False
                ...
                Else
                    Me.txtTotalGrouping.Text = CDec(Me.txtTotalGrouping.Text) - CDec(Me.txtNBTotalGrouping.Text)
                End If
            End If
    ...
    Private Sub GroupHeader1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader1.BeforePrint
        Try
            ...
            '.Text = Me.txtRevisionNumber.Text.PadLeft(2, "0")
        Catch ex As Exception
