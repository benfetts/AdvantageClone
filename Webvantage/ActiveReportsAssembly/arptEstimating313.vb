...
Public Class arptEstimating313
    ...
    Private Sub arptEstimating313_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ...
        Try
            ...
            If dtPrintDef.Rows(0)("SIGNATURE") = 0 Then
                ...
                Me.ReportInfo2.SummaryGroup = "GroupFooter5"
            End If
    ...
    Private Sub GroupHeader6_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader6.Format
        Try
            If dtPrintDef.Rows.Count > 0 Then
                ...
                End If
            End If
            If Me.txtOneRev.Text = "1" And Me.txtMaxRevision.Text = "0" Then
                Me.txtOriginalLabel.Text = ""
                Me.txtRevisedLabel.Text = "Revision 0" & Me.txtMaxRevision.Text
            Else
                Me.txtOriginalLabel.Text = "Revision 0" & CDec(Me.txtMaxRevision.Text) - 1
                Me.txtRevisedLabel.Text = "Revision 0" & Me.txtMaxRevision.Text
            End If
        Catch ex As Exception
