...
Public Class arptEstimating315
    ...
    Public IncludeRate As Boolean = False
    ...
    Private Sub arptEstimating_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ...
        Try
            ...
            If dtPrintDef.Rows(0)("SIGNATURE") = 0 Then
                Me.GroupFooter3.NewPage = NewPage.None
                Me.GroupFooter5.NewPage = NewPage.After
            End If
        ...
        Try
            If dtPrintDef.Rows.Count > 0 Then
                ...
                If dtPrintDef.Rows(0)("FUNCTION_OPTION") = "R" Then
                    ...
                    If Me.txtRate.Text.EndsWith("0") Then
                        Me.txtRate.Text = Me.txtRate.Text.Substring(0, Me.txtRate.Text.Length - 1)
                    End If
                    If Me.txtRate.Text.EndsWith("0") Then
                        Me.txtRate.Text = Me.txtRate.Text.Substring(0, Me.txtRate.Text.Length - 1)
                    End If
                ...
                End If
                If dtPrintDef.Rows(0)("FUNC_COMMENT") = 1 Then
                    Me.RichTextBoxEstFunctionComment.Visible = True
                    Me.RichTextBoxEstFunctionComment.Html = Me.RichTextBoxEstFunctionComment.Text
                Else
                    Me.RichTextBoxEstFunctionComment.Text = ""
                    Me.RichTextBoxEstFunctionComment.Html = ""
                End If
                If dtPrintDef.Rows(0)("SUP_BY_NOTES") = 1 Then
                    Me.RichTextBoxSuppliedByNotes.Visible = True
                    Me.RichTextBoxSuppliedByNotes.Html = Me.RichTextBoxSuppliedByNotes.Text
                Else
                    Me.RichTextBoxSuppliedByNotes.Text = ""
                    Me.RichTextBoxSuppliedByNotes.Html = ""
                End If
                If dtPrintDef.Rows(0)("GROUP_OPTION") = "HT" Then
        ...
        Try
            If dtPrintDef.Rows.Count > 0 Then
                ...
                Else
                    ...
                    Me.RichTextBoxEstimateComment.Html = ""
                End If
                ...
                Else
                    ...
                    Me.RichTextBoxEstCompComment.Html = ""
                End If
                ...
                Else
                    ...
                    Me.RichTextBoxEstQuoteComment.Html = ""
                End If
                ...
                Else
                    ...
                    Me.RichTextBoxEstRevisionComment.Html = ""
                End If
            End If
        Catch ex As Exception
