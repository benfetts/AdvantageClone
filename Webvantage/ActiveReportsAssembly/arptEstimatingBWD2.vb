...
Public Class arptEstimatingBWD2
    ...
    Private Sub PageHeader1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles PageHeader1.Format
        ...
        Try
            ...
            Else
                Me.TextBoxLocation.Visible = True
                Me.TextBox48.Visible = True
                Me.TextBox49.Visible = True
                Me.TextBoxLocation.Text = LocationName
    ...
    Private Sub Detail1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.BeforePrint
        Try
            ...
            If Me.txtRate.Text <> "" Then
                Me.txtRate.Text = String.Format("{0:$#,##0.000}", CDec(ReportFunctions.FormatDecimal(Me.txtRate.Text)))
            End If
        Catch ex As Exception
    ...
    Private Sub ReportHeader1_Format(sender As Object, e As System.EventArgs) Handles ReportHeader1.Format
        Try
