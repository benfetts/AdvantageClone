...
Public Class arptEstimatingInfinity
    ...
    Public JobComments As String
    Public JobCompComments As String
    ...
    Private Sub Detail1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.BeforePrint
        Try
            ...
            If Me.txtQty.Text <> "" Then
                Me.txtQty.Text = String.Format("{0:0.000}", CDec(ReportFunctions.FormatDecimal(Me.txtQty.Text)))
            End If
        Catch ex As Exception
    ...
    Private Sub Detail1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        Try
            ...
            '    Me.txtAmount.Text = CDec(Me.txtAmount.Text) + CDec(Me.txtContingency.Text)
            'End If
            If Me.txtAmount.Text <> "" And Me.txtEstQuantity.Text <> "" Then
                If CDec(Me.txtEstQuantity.Text) > 0 Then
                    txtQty.Text = CDec(Me.txtAmount.Text) / CDec(Me.txtEstQuantity.Text)
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub GroupFooter1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter1.BeforePrint
        Try
            ...
            If Me.txtTotalPerPiece.Text <> "" Then
                Me.txtTotalPerPiece.Text = String.Format("{0:#,##0.000}", CDec(ReportFunctions.FormatDecimal(Me.txtTotalPerPiece.Text)))
            End If
            If dtPrintDef.Rows.Count > 0 Then
                If dtPrintDef.Rows(0)("RPT_TITLE") <> "" Then
    ...
    Private Sub GroupFooter1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter1.Format
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                ...
                'End If
            End If
            If Me.txtTotalForEst.Text <> "" And Me.txtEstQuantity.Text <> "" Then
                If CDec(Me.txtEstQuantity.Text) > 0 Then
                    txtTotalPerPiece.Text = CDec(Me.txtTotalForEst.Text) / CDec(Me.txtEstQuantity.Text)
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub GroupHeader1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        Try
            ...
            '    Me.txtJobNumber.Text = ""
            'End If
            Me.txtJobComments.Text = JobComments
            Me.txtJobCompComments.Text = JobCompComments
        Catch ex As Exception
