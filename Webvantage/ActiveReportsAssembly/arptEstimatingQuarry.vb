...
Public Class arptEstimatingQuarry
    ...
    Public ESTReport As arptEstHeaderQuarry
    ...
    Private Sub GroupFooter3_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter3.BeforePrint
        Try
            Me.TextBox5.Text = String.Format("{0:#,##0.00}", CDec(Me.TextBox5.Text))
        Catch ex As Exception
    ...
    Private Sub GroupFooter3_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter3.Format
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                ...
                End If
            End If
            Me.TextBox5.Text = CDec(Me.TextBox5.Text) + CDec(Me.TextBox11.Text)
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub GroupHeader5_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader5.Format
        Try
            Me.ESTReport = New arptEstHeaderQuarry
            Me.ESTReport.dt = dtTotals
            Me.ESTReport.quotenum = Me.TextBox12.Text
    ...
    Private Sub GroupFooter7_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter7.BeforePrint
        Try
            Me.TextBox34.Text = String.Format("{0:#,##0.00}", CDec(Me.TextBox34.Text))
        Catch ex As Exception
    ...
    Private Sub GroupFooter7_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter7.Format
        Try
            Me.TextBox34.Text = CDec(Me.TextBox34.Text) + CDec(Me.txtMarkupQuoteBefore.Text)
        Catch ex As Exception
