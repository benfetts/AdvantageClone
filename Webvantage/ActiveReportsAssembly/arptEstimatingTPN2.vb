...
Public Class arptEstimatingTPN2
    ...
    Private Sub arptEstimatingTPN2_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
    ...
    Private Sub Detail1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.BeforePrint
        Try
            ...
            End If
            'Me.txtFinalActual.Text = String.Format("{0:#,##0.00}", CDec(Me.txtFinalActual.Text))
        Catch ex As Exception
    ...
    Private Sub GroupHeader1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        Try
            ...
            If Me.txtJobNumber.Text = "0" Then
                Me.txtJobNumber.Text = ""
            End If
            If Not dtlabels Is Nothing Then
                If dtlabels.Rows.Count > 0 Then
                    Me.txtCompanyLabel.Text = dtlabels.Rows(0)("LABEL1").ToString
                    Me.txtCompany.Text = dtlabels.Rows(0)("DESC1").ToString
                    Me.txtBusinessLabel.Text = dtlabels.Rows(0)("LABEL2").ToString
                    Me.txtBusiness.Text = dtlabels.Rows(0)("DESC2").ToString
                    If Me.txtCompanyLabel.Text.EndsWith(":") Then

                    Else
                        Me.txtCompanyLabel.Text = Me.txtCompanyLabel.Text & ":"
                    End If
                    If Me.txtBusinessLabel.Text.EndsWith(":") Then

                    Else
                        Me.txtBusinessLabel.Text = Me.txtBusinessLabel.Text & ":"
                    End If
                End If
            End If
        Catch ex As Exception
