...
Public Class arptEstimatingTap
    ...
    Public ESTReport As arptEstHeaderTap
    Public ESTReport2 As arptEstHeaderTap2
    Public ESTReportQ As arptEstHeaderQuarry
    Public dtTotals As DataTable
    Public connstring As String
    Public rpttype As String
    Public DefaultFooterFontSize As Double = 0
    Public FunctionComment As Boolean
    ...
    Private Sub Detail1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Try
            Dim s As String = "Professional Services"
            ReportFunctions.SetCulture(Me, CultureCode)
            If dtPrintDef.Rows.Count > 0 Then
                If dtPrintDef.Rows(0)("VENDOR_DESC") = 1 Then
            ...
            End If
            If rpttype = "EstimatingTAP2" Then
    ...
    Private Sub GroupHeader1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader1.BeforePrint
        Try
            If Me.TextBox6.Text <> "" Then
                Me.TextBox6.Text = CDec(Me.TextBox6.Text) + CDec(Me.TextBox11.Text)
            End If
            If Me.TextBox6.Text <> "" Then
                Me.TextBox6.Text = String.Format("{0:#,##0.00}", CDec(ReportFunctions.FormatDecimal(Me.TextBox6.Text)))
            End If
        Catch ex As Exception
    ...
    Private Sub GroupHeader1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        Try
            ...
            Dim MyPage As New DataDynamics.ActiveReports.Document.Page
            Dim s As String = "Professional Services"
            If rpttype = "EstimatingTAP" Then
                If Me.TextBox27.Text <> "" Then
                    If TextBox27.Text = 0 Then
                        Dim sz As SizeF = MyPage.MeasureText(s)
                        Me.TextBox20.Text = s
                        Me.TextBox20.Width = sz.Width + sz.Width + sz.Width * 0.075
                        Me.TextBox21.Text = ""
                        Me.TextBox27.Text = ""
                        Me.txtJobDesc.Text = ""
                        Me.TextBox28.Text = ""
                        ...
                        Me.Detail1.Visible = False
                        Me.GroupHeader1.Height = Me.GroupHeader1.Height * 1.25
                    Else
    ...
    Private Sub GroupFooter3_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter3.Format
        Try
            ...
            If dtPrintDef.Rows.Count > 0 Then
                ...
                End If
            End If
            Me.TextBox5.Text = CDec(Me.TextBox5.Text) + CDec(Me.TextBox40.Text) + CDec(Me.TextBox41.Text)
            If UseEmpSig Then
    ...
    Private Sub GroupHeader3_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader3.Format
        Try
            ...
            Me.ESTReport = New arptEstHeaderTap
            Me.ESTReport.dt = dt
            Me.ESTReport.dtPrintDef = dtPrintDef
            ...
            Me.ESTReport.estnum = Me.txtEstNumber.Text
            Me.ESTReport.estcompnum = Me.txtEstCompNumber.Text
            Me.SubReport1.Report = ESTReport

            Me.ESTReport2 = New arptEstHeaderTap2
            Me.ESTReport2.dt = dt
            Me.ESTReport2.ae = Me.TextBox17.Text
            Me.ESTReport2.cmpname = Me.TextBox18.Text
            Me.SubReport3.Report = ESTReport2
        Catch ex As Exception
    ...
    Private Sub GroupFooter7_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter7.Format
        Try
            Me.TextBox34.Text = CDec(Me.TextBox34.Text) + CDec(Me.TextBox36.Text)
    ...
    Private Sub GroupHeader5_BeforePrint(sender As Object, e As System.EventArgs) Handles GroupHeader5.BeforePrint
        Try
    ...
    Private Sub GroupHeader5_Format(sender As Object, e As System.EventArgs) Handles GroupHeader5.Format
        Try
            If dtPrintDef.Rows.Count > 0 Then
                If dtPrintDef.Rows(0)("CMP_SUMMARY") = 1 Then
                    Me.GroupHeader5.Visible = True
                End If
            End If
            Me.ESTReportQ = New arptEstHeaderQuarry
            Me.ESTReportQ.dt = dtTotals
            Me.ESTReportQ.quotenum = Me.TextBox12.Text
            Me.ESTReportQ.rpttype = rpttype
            Me.SubReport2.Report = ESTReportQ
