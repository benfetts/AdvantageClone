...
Public Class arptJobTrafficSchedulebyJob3
    ...
    Public AssignmentReport As arptAlertAssignment
    ...
    Private Sub Detail1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Try
            ...
            For Each TxtBoxControl In DirectCast(sender, Detail).Controls.OfType(Of TextBox)
                ...
                ElseIf TxtBoxControl Is txtEmployees Then
            ...
            Me.AssignmentReport = New arptAlertAssignment
            Me.AssignmentReport.job = Me.txtJobNumber.Text
            Me.AssignmentReport.comp = Me.txtComponent.Text
            Me.AssignmentReport.seq = Me.txtSEQ_NBR.Text
            Me.AssignmentReport.DueDateLocation = New System.Drawing.PointF(txtDueDate.Location.X - Me.SubReport1.Location.X, 0)
            Me.AssignmentReport.StartDateLocation = New System.Drawing.PointF(txtStartDate.Location.X - Me.SubReport1.Location.X, 0)
            Me.AssignmentReport.dt = dtAssignments
            Me.SubReport1.Report = AssignmentReport
            ...
            ElseIf dtAssignments IsNot Nothing AndAlso dtAssignments.Rows.Count > 0 Then

                Me.TxtSpacer.Location = New Drawing.PointF(Me.TxtSpacer.Location.X, Me.SubReport1.Location.Y + Me.SubReport1.Size.Height)

            Else

                Me.TxtSpacer.Location = New Drawing.PointF(Me.TxtSpacer.Location.X, Me.SubReport1.Location.Y)
