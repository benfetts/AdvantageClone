...
Public Class arptJobTrafficSchedulebyJobDueDate
    ...
    Private Sub Detail1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Try
            ...
            End If
            If Me.txtMilestone.Text = "1" And ms = "False" Then
                Me.txtTaskDesc.Style = "font-weight: bold"
                Me.txtTaskDesc.ForeColor = Drawing.Color.Red
                Me.txtTaskComments.Style = "font-weight: bold"
                Me.txtTaskComments.ForeColor = Drawing.Color.Red
                Me.txtDueDate.Style = "font-weight: bold"
                Me.txtDueDate.ForeColor = Drawing.Color.Red
                Me.txtEmployees.Style = "font-weight: bold"
                Me.txtEmployees.ForeColor = Drawing.Color.Red
            Else
                Me.txtTaskDesc.Style = ""
                Me.txtTaskDesc.ForeColor = Drawing.Color.Black
                Me.txtTaskComments.Style = ""
                Me.txtTaskComments.ForeColor = Drawing.Color.Black
                Me.txtDueDate.Style = ""
                Me.txtDueDate.ForeColor = Drawing.Color.Black
                Me.txtEmployees.Style = ""
                Me.txtEmployees.ForeColor = Drawing.Color.Black
            End If
            If Me.txtClientContacts.Text <> "" Then
                If Me.txtEmployees.Text <> "" Then
                    Me.txtEmployees.Text += ", " & Me.txtClientContacts.Text
                Else
                    Me.txtEmployees.Text = Me.txtClientContacts.Text
                End If
            End If
            ...
            For Each TxtBoxControl In DirectCast(sender, Detail).Controls.OfType(Of TextBox)
                ...
                If TxtBoxControl Is txtEmployees Then

                    HeaderControl = lblAssigned

                ElseIf TxtBoxControl Is txtDueDate Then

                    HeaderControl = lblDueDate

                ElseIf TxtBoxControl Is txtTaskDesc Then

                    txtTaskDesc.Width = lblTask.Width
            ...
            TxtSpacer.Location = New Drawing.PointF(TxtSpacer.Location.X, Math.Max(txtTaskComments.Size.Height, txtTaskDesc.Size.Height))
