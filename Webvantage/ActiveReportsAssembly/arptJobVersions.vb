...
Public Class arptJobVersions
    Public dtData As DataTable
    Public description As String
    Public AgencyDesc As String
        ...
        If Me.omitEmptyFields = True Then
            ...
            For j = 0 To Me.dtData.Rows.Count - 1
                If j <= Me.dtData.Rows.Count - 1 Then
                    If Me.dtData.Rows(j).Item(2).ToString = "" Or IsDBNull(Me.dtData.Rows(j).Item(2)) Then
        ...
        Else
            ...
            If Me.dtAgency.Rows.Count > 0 And Me.LogoID <> "None" And Me.dtAgency.Rows(0)("PRT_HEADER").ToString = "1" Then
                ...
                If Me.dtAgency.Rows(0)("PRT_CITY").ToString = "1" And Me.dtAgency.Rows(0)("CITY").ToString <> "" Then
                    ...
                    cityStZip = Me.dtAgency.Rows(0)("CITY").ToString & ", "
                End If
                If Me.dtAgency.Rows(0)("PRT_STATE").ToString = "1" And Me.dtAgency.Rows(0)("STATE").ToString <> "" Then
                    ...
                    cityStZip = cityStZip & Me.dtAgency.Rows(0)("STATE").ToString & "  "
                End If
                If Me.dtAgency.Rows(0)("PRT_ZIP").ToString = "1" And Me.dtAgency.Rows(0)("ZIP").ToString <> "" Then
                    ...
                    cityStZip = cityStZip & Me.dtAgency.Rows(0)("ZIP").ToString
                End If
                If cityStZip > "" Then
                    If str3 > "" Then
                        str3 = str3 & " • "
    ...
    Private Sub GroupHeader1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        Try
            ...
            Else
                Me.lblReportTitle.Text = "Job Versions Report"
            End If
            ...
            Dim txtVer, jobVerDesc, tmplDesc As String

            If Me.lblJobVerdesc.Text Is Nothing Then
                jobVerDesc = ""
            Else
                jobVerDesc = Me.lblJobVerdesc.Text
            End If

            If txtVersion.Text Is Nothing Then
                txtVer = ""
            Else
                txtVer = txtVersion.Text.ToString.PadLeft(3, "0")
            End If

            If Me.lblJobVerdesc.Text Is Nothing Then
                tmplDesc = ""
            Else
                tmplDesc = Me.lblJvTmpltDesc.Text
            End If

            'If dtAgency.Rows.Count > 0 Then
            Me.txtDesc.Text = txtVer & " - " & jobVerDesc  'dtData.Rows(0)("JOB_VER_DESC").ToString
            Me.lblTemp.Text = "Template: " & tmplDesc 'dtData.Rows(0)("JV_TMPLT_DESC").ToString
            'End If
