...
Public Class arptMyTaskListByDueDate
    ...
    Public chkRevDueDate As Boolean = False
    ...
    Private Sub arptMyTaskListByDueDate_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ...
        ''tempDView.Sort = "[Rev Due Date] ASC,CCode,DCode,PCode,JobNum,CompNum,task"
    ...
    Private Sub GroupHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        If Me.txtRev_Due_Date2.Text <> "" Then
            Me.txtRev_Due_Date2.Text = CDate(Me.txtRev_Due_Date2.Text).ToShortDateString
        End If
        Me.DueDate.Text = "Due Date: " & Me.txtRev_Due_Date2.Text
    End Sub
    Private Sub ReportHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ReportHeader1.Format
        'Me.MyTaskList.Text = Me.MyTaskList.Text & " (" & strEmpName & ") by Due Date"
