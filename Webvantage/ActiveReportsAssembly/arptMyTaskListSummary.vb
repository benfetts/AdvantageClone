...
Public Class arptMyTaskListSummary
    ...
    Private Sub arptMyTaskListSummary_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
