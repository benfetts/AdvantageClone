...
Public Class arptProductARStatement001
    ...
    Private Sub arptProductARStatement001_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ReportFunctions.SetCulture(Me, CultureCode)
        'ds = New arptProduct001DS
        'Dim t As New arptProduct001DSTableAdapters.usp_wv_reports_ar_statements_product_001TableAdapter
        ...
        Try
            ...
            Else
                Me.GroupHeader1.Height = 2.119 '+ Me.Comments.Height + 0.02
                With Me.Line6
                    .Y1 = 2
                    .Y2 = 2
                End With
    ...
    Private Sub Detail1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.BeforePrint
        Try
            ...
            If Me.TextBox1.Text = "0" Then
                Me.TextBox1.Text = ""
            Else
                Me.TextBox1.Text = Me.TextBox1.Text.PadLeft(4, "0")
            End If
        Catch ex As Exception
