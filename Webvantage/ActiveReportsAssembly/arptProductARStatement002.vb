...
Public Class arptProductARStatement002
    ...
    'Private ds As arptProduct002DS
    'Private dt As New arptProduct002DS.usp_wv_reports_ar_statements_productDataTable
    Public CultureCode As String = "en-US"
    Public _LocationLogo As AdvantageFramework.Database.Entities.LocationLogo = Nothing
    Private Sub arptProductARStatement002_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ReportFunctions.SetCulture(Me, CultureCode)
        'ds = New arptProduct002DS
        'Dim t As New arptProduct002DSTableAdapters.usp_wv_reports_ar_statements_productTableAdapter
        ...
        Try
            ...
            If strExclude = "1" Then
                ...
                Me.JobDescription.Visible = False
