...
Public Class arptProductARStatement004
    ...
    'Private ds As arptProduct003DS
    'Private dt As New arptProduct003DS.usp_wv_reports_ar_statements_product_003DataTable
    Public CultureCode As String = "en-US"
    Public _LocationLogo As AdvantageFramework.Database.Entities.LocationLogo = Nothing
    Private Sub arptProductARStatement004_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ReportFunctions.SetCulture(Me, CultureCode)
        'ds = New arptProduct003DS
        'Dim t As New arptProduct003DSTableAdapters.usp_wv_reports_ar_statements_product_003TableAdapter
        't.Fill(dt, strID, strPostPeriod, strLocation, strAgedDate, strFooter)
        Try
            Me.DataSource = dt
            If Me.PutCommentInFooter = True Then
                Me.GroupHeader1.Height = 2.158
                With Me.Line6
                    .Y1 = 1.75
                    .Y2 = 1.75
                End With
                Me.GroupFooter1.Height = 1.606
                Me.Comments.Visible = False
                Me.CommentsFooter.Visible = True
            Else
                Me.GroupHeader1.Height = 2.119
                With Me.Line6
                    .Y1 = 2
                    .Y2 = 2
                End With
                Me.GroupFooter1.Height = 1.408
    ...
    Private Sub GroupFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupFooter1.Format
        Try
            ...
            If Not (Me.OnAccountAmount.Text Is Nothing) Then
    ...
    Private Sub GroupHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        Try
            'Client Name, Division, Product Description, and Address
            Dim str As String = Me.ClientName.Text
            If Me.ClientName.Text <> Me.DivisionName.Text Then
                str = str & vbCrLf & Me.DivisionName.Text
            End If
            If Me.DivisionName.Text <> Me.ProductDescription.Text Then
                str = str & vbCrLf & Me.ProductDescription.Text
            End If
    ...
    Private Sub Detail1_BeforePrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.BeforePrint
        Try
            ...
            If Me.Fields.Item("InvoiceSeq").Value = 0 Then
                Me.TextBox1.Text = ""
            Else
                Me.TextBox1.Text = Format(Me.Fields.Item("InvoiceSeq").Value, "0000")
            End If
        Catch ex As Exception
