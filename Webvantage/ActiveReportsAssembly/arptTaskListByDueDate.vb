...
Public Class arptTaskListByDueDate
    ...
    Private Sub arptTaskListByDueDate_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        ...
        ''tempDView.Sort = "[Rev Due Date],CCode,DCode,PCode,JobNum,CompNum,task"
