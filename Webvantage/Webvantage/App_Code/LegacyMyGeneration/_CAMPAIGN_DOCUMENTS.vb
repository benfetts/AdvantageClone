...
Public MustInherit Class _CAMPAIGN_DOCUMENTS
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "CAMPAIGN_DOCUMENTS"
        Me.MappingName = "CAMPAIGN_DOCUMENTS"
    End Sub
    ...
    Public Function LoadAll() As Boolean
        ...
        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_CAMPAIGN_DOCUMENTSLoadAll]", parameters)
    ...
    Public Overridable Function LoadByPrimaryKey(ByVal DOCUMENT_ID As Integer) As Boolean
        ...
        parameters.Add(_CAMPAIGN_DOCUMENTS.Parameters.DOCUMENT_ID, DOCUMENT_ID)


        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_CAMPAIGN_DOCUMENTSLoadByPrimaryKey]", parameters)
    ...
    Public Class ColumnNames
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(DOCUMENT_ID) = _CAMPAIGN_DOCUMENTS.PropertyNames.DOCUMENT_ID
                ht(CMP_IDENTIFIER) = _CAMPAIGN_DOCUMENTS.PropertyNames.CMP_IDENTIFIER
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(DOCUMENT_ID) = _CAMPAIGN_DOCUMENTS.ColumnNames.DOCUMENT_ID
                ht(CMP_IDENTIFIER) = _CAMPAIGN_DOCUMENTS.ColumnNames.CMP_IDENTIFIER
...
#End Region
    ...
    Protected Overrides Function GetInsertCommand() As IDbCommand
        ...
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_CAMPAIGN_DOCUMENTSInsert]"
    ...
    Protected Overrides Function GetUpdateCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_CAMPAIGN_DOCUMENTSUpdate]"
    ...
    Protected Overrides Function GetDeleteCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_CAMPAIGN_DOCUMENTSDelete]"
