...
Public MustInherit Class _CP_ALERTLIST
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "CP_ALERTLIST"
        Me.MappingName = "CP_ALERTLIST"
    End Sub
    ...
    Public Class ColumnNames
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(ALERT_ID) = _CP_ALERTLIST.PropertyNames.ALERT_ID
                ht(SUBJECT) = _CP_ALERTLIST.PropertyNames.SUBJECT
                ht(GENERATED) = _CP_ALERTLIST.PropertyNames.GENERATED
                ht(USER_NAME) = _CP_ALERTLIST.PropertyNames.USER_NAME
                ht(PRIORITY) = _CP_ALERTLIST.PropertyNames.PRIORITY
                ht(TYPE) = _CP_ALERTLIST.PropertyNames.TYPE
                ht(CATEGORY) = _CP_ALERTLIST.PropertyNames.CATEGORY
                ht(ALERT_TYPE_ID) = _CP_ALERTLIST.PropertyNames.ALERT_TYPE_ID
                ht(ALERT_CAT_ID) = _CP_ALERTLIST.PropertyNames.ALERT_CAT_ID
                ht(ATTACHMENTCOUNT) = _CP_ALERTLIST.PropertyNames.ATTACHMENTCOUNT
                ht(ALERT_LEVEL) = _CP_ALERTLIST.PropertyNames.ALERT_LEVEL
                ht(OFFICE_CODE) = _CP_ALERTLIST.PropertyNames.OFFICE_CODE
                ht(CL_CODE) = _CP_ALERTLIST.PropertyNames.CL_CODE
                ht(DIV_CODE) = _CP_ALERTLIST.PropertyNames.DIV_CODE
                ht(PRD_CODE) = _CP_ALERTLIST.PropertyNames.PRD_CODE
                ht(CMP_CODE) = _CP_ALERTLIST.PropertyNames.CMP_CODE
                ht(JOB_NUMBER) = _CP_ALERTLIST.PropertyNames.JOB_NUMBER
                ht(JOB_COMPONENT_NBR) = _CP_ALERTLIST.PropertyNames.JOB_COMPONENT_NBR
                ht(SENDER_EMP_CODE) = _CP_ALERTLIST.PropertyNames.SENDER_EMP_CODE
                ht(DISMISSED_DATE) = _CP_ALERTLIST.PropertyNames.DISMISSED_DATE
                ht(CL_NAME) = _CP_ALERTLIST.PropertyNames.CL_NAME
                ht(DIV_NAME) = _CP_ALERTLIST.PropertyNames.DIV_NAME
                ht(PRD_DESCRIPTION) = _CP_ALERTLIST.PropertyNames.PRD_DESCRIPTION
                ht(CMP_NAME) = _CP_ALERTLIST.PropertyNames.CMP_NAME
                ht(BODY) = _CP_ALERTLIST.PropertyNames.BODY
                ht(LOWER_SUBJECT) = _CP_ALERTLIST.PropertyNames.LOWER_SUBJECT
                ht(LOWER_BODY) = _CP_ALERTLIST.PropertyNames.LOWER_BODY
                ht(OFFICE_NAME) = _CP_ALERTLIST.PropertyNames.OFFICE_NAME
                ht(JOB_DESC) = _CP_ALERTLIST.PropertyNames.JOB_DESC
                ht(JOB_COMP_DESC) = _CP_ALERTLIST.PropertyNames.JOB_COMP_DESC
                ht(PROCESSED) = _CP_ALERTLIST.PropertyNames.PROCESSED
                ht(CDP_CONTACT_ID) = _CP_ALERTLIST.PropertyNames.CDP_CONTACT_ID
                ht(ALERT_USER) = _CP_ALERTLIST.PropertyNames.ALERT_USER
                ht(CP_ALERT) = _CP_ALERTLIST.PropertyNames.CP_ALERT
                ht(NEW_ALERT) = _CP_ALERTLIST.PropertyNames.NEW_ALERT
                ht(READ_ALERT) = _CP_ALERTLIST.PropertyNames.READ_ALERT
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(ALERT_ID) = _CP_ALERTLIST.ColumnNames.ALERT_ID
                ht(SUBJECT) = _CP_ALERTLIST.ColumnNames.SUBJECT
                ht(GENERATED) = _CP_ALERTLIST.ColumnNames.GENERATED
                ht(USER_NAME) = _CP_ALERTLIST.ColumnNames.USER_NAME
                ht(PRIORITY) = _CP_ALERTLIST.ColumnNames.PRIORITY
                ht(TYPE) = _CP_ALERTLIST.ColumnNames.TYPE
                ht(CATEGORY) = _CP_ALERTLIST.ColumnNames.CATEGORY
                ht(ALERT_TYPE_ID) = _CP_ALERTLIST.ColumnNames.ALERT_TYPE_ID
                ht(ALERT_CAT_ID) = _CP_ALERTLIST.ColumnNames.ALERT_CAT_ID
                ht(ATTACHMENTCOUNT) = _CP_ALERTLIST.ColumnNames.ATTACHMENTCOUNT
                ht(ALERT_LEVEL) = _CP_ALERTLIST.ColumnNames.ALERT_LEVEL
                ht(OFFICE_CODE) = _CP_ALERTLIST.ColumnNames.OFFICE_CODE
                ht(CL_CODE) = _CP_ALERTLIST.ColumnNames.CL_CODE
                ht(DIV_CODE) = _CP_ALERTLIST.ColumnNames.DIV_CODE
                ht(PRD_CODE) = _CP_ALERTLIST.ColumnNames.PRD_CODE
                ht(CMP_CODE) = _CP_ALERTLIST.ColumnNames.CMP_CODE
                ht(JOB_NUMBER) = _CP_ALERTLIST.ColumnNames.JOB_NUMBER
                ht(JOB_COMPONENT_NBR) = _CP_ALERTLIST.ColumnNames.JOB_COMPONENT_NBR
                ht(SENDER_EMP_CODE) = _CP_ALERTLIST.ColumnNames.SENDER_EMP_CODE
                ht(DISMISSED_DATE) = _CP_ALERTLIST.ColumnNames.DISMISSED_DATE
                ht(CL_NAME) = _CP_ALERTLIST.ColumnNames.CL_NAME
                ht(DIV_NAME) = _CP_ALERTLIST.ColumnNames.DIV_NAME
                ht(PRD_DESCRIPTION) = _CP_ALERTLIST.ColumnNames.PRD_DESCRIPTION
                ht(CMP_NAME) = _CP_ALERTLIST.ColumnNames.CMP_NAME
                ht(BODY) = _CP_ALERTLIST.ColumnNames.BODY
                ht(LOWER_SUBJECT) = _CP_ALERTLIST.ColumnNames.LOWER_SUBJECT
                ht(LOWER_BODY) = _CP_ALERTLIST.ColumnNames.LOWER_BODY
                ht(OFFICE_NAME) = _CP_ALERTLIST.ColumnNames.OFFICE_NAME
                ht(JOB_DESC) = _CP_ALERTLIST.ColumnNames.JOB_DESC
                ht(JOB_COMP_DESC) = _CP_ALERTLIST.ColumnNames.JOB_COMP_DESC
                ht(PROCESSED) = _CP_ALERTLIST.ColumnNames.PROCESSED
                ht(CDP_CONTACT_ID) = _CP_ALERTLIST.ColumnNames.CDP_CONTACT_ID
                ht(ALERT_USER) = _CP_ALERTLIST.ColumnNames.ALERT_USER
                ht(CP_ALERT) = _CP_ALERTLIST.ColumnNames.CP_ALERT
                ht(NEW_ALERT) = _CP_ALERTLIST.ColumnNames.NEW_ALERT
                ht(READ_ALERT) = _CP_ALERTLIST.ColumnNames.READ_ALERT
