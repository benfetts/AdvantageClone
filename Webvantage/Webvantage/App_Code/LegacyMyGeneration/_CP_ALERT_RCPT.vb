...
Public MustInherit Class _CP_ALERT_RCPT
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "CP_ALERT_RCPT"
        Me.MappingName = "CP_ALERT_RCPT"
    End Sub
    ...
    Public Function LoadAll() As Boolean
        ...
        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_CP_ALERT_RCPTLoadAll]", parameters)
    ...
    Public Overridable Function LoadByPrimaryKey(ByVal ALERT_ID As Integer, ByVal ALERT_RCPT_ID As Integer) As Boolean
        ...
        parameters.Add(_CP_ALERT_RCPT.Parameters.ALERT_ID, ALERT_ID)

        parameters.Add(_CP_ALERT_RCPT.Parameters.ALERT_RCPT_ID, ALERT_RCPT_ID)


        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_CP_ALERT_RCPTLoadByPrimaryKey]", parameters)
    ...
    Public Class ColumnNames
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(ALERT_ID) = _CP_ALERT_RCPT.PropertyNames.ALERT_ID
                ht(ALERT_RCPT_ID) = _CP_ALERT_RCPT.PropertyNames.ALERT_RCPT_ID
                ht(CDP_CONTACT_ID) = _CP_ALERT_RCPT.PropertyNames.CDP_CONTACT_ID
                ht(EMAIL_ADDRESS) = _CP_ALERT_RCPT.PropertyNames.EMAIL_ADDRESS
                ht(PROCESSED) = _CP_ALERT_RCPT.PropertyNames.PROCESSED
                ht(NEW_ALERT) = _CP_ALERT_RCPT.PropertyNames.NEW_ALERT
                ht(READ_ALERT) = _CP_ALERT_RCPT.PropertyNames.READ_ALERT
                ht(CURRENT_RCPT) = _CP_ALERT_RCPT.PropertyNames.CURRENT_RCPT
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(ALERT_ID) = _CP_ALERT_RCPT.ColumnNames.ALERT_ID
                ht(ALERT_RCPT_ID) = _CP_ALERT_RCPT.ColumnNames.ALERT_RCPT_ID
                ht(CDP_CONTACT_ID) = _CP_ALERT_RCPT.ColumnNames.CDP_CONTACT_ID
                ht(EMAIL_ADDRESS) = _CP_ALERT_RCPT.ColumnNames.EMAIL_ADDRESS
                ht(PROCESSED) = _CP_ALERT_RCPT.ColumnNames.PROCESSED
                ht(NEW_ALERT) = _CP_ALERT_RCPT.ColumnNames.NEW_ALERT
                ht(READ_ALERT) = _CP_ALERT_RCPT.ColumnNames.READ_ALERT
                ht(CURRENT_RCPT) = _CP_ALERT_RCPT.ColumnNames.CURRENT_RCPT
...
#End Region
    ...
    Protected Overrides Function GetInsertCommand() As IDbCommand
        ...
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_CP_ALERT_RCPTInsert]"
    ...
    Protected Overrides Function GetUpdateCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_CP_ALERT_RCPTUpdate]"
    ...
    Protected Overrides Function GetDeleteCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_CP_ALERT_RCPTDelete]"
