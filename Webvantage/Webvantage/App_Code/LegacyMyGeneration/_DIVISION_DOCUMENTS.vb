...
Public MustInherit Class _DIVISION_DOCUMENTS
	Inherits SqlClientEntity

		Public Sub New() 
			Me.QuerySource = "DIVISION_DOCUMENTS"
			Me.MappingName = "DIVISION_DOCUMENTS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_DIVISION_DOCUMENTSLoadAll]", parameters)
	...
	Public Overridable Function LoadByPrimaryKey(ByVal DOCUMENT_ID As Integer) As Boolean
		...
		parameters.Add(_DIVISION_DOCUMENTS.Parameters.DOCUMENT_ID, DOCUMENT_ID)

		
		Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_DIVISION_DOCUMENTSLoadByPrimaryKey]", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(DOCUMENT_ID) = _DIVISION_DOCUMENTS.PropertyNames.DOCUMENT_ID
				ht(CL_CODE) = _DIVISION_DOCUMENTS.PropertyNames.CL_CODE
				ht(DIV_CODE) = _DIVISION_DOCUMENTS.PropertyNames.DIV_CODE
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(DOCUMENT_ID) = _DIVISION_DOCUMENTS.ColumnNames.DOCUMENT_ID
				ht(CL_CODE) = _DIVISION_DOCUMENTS.ColumnNames.CL_CODE
				ht(DIV_CODE) = _DIVISION_DOCUMENTS.ColumnNames.DIV_CODE
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_DIVISION_DOCUMENTSInsert]" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_DIVISION_DOCUMENTSUpdate]" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_DIVISION_DOCUMENTSDelete]" 
