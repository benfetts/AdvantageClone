...
Public MustInherit Class _DOCUMENTS
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "DOCUMENTS"
        Me.MappingName = "DOCUMENTS"
    End Sub
    ...
    Public Function LoadAll() As Boolean
        ...
        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_DOCUMENTSLoadAll]", parameters)
    ...
    Public Overridable Function LoadByPrimaryKey(ByVal DOCUMENT_ID As Integer) As Boolean
        ...
        parameters.Add(_DOCUMENTS.Parameters.DOCUMENT_ID, DOCUMENT_ID)


        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_DOCUMENTSLoadByPrimaryKey]", parameters)
...
#Region "Parameters"
    Protected Class Parameters
        ...
        Public Shared ReadOnly Property DOCUMENT_TYPE_ID() As SqlParameter
            Get
                Return New SqlParameter("@DOCUMENT_TYPE_ID", SqlDbType.Int, 0)
            End Get
        End Property
...
#Region "ColumnNames"
    Public Class ColumnNames
        ...
        Public Const DOCUMENT_TYPE_ID As String = "DOCUMENT_TYPE_ID"
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(DOCUMENT_ID) = _DOCUMENTS.PropertyNames.DOCUMENT_ID
                ht(FILENAME) = _DOCUMENTS.PropertyNames.FILENAME
                ht(REPOSITORY_FILENAME) = _DOCUMENTS.PropertyNames.REPOSITORY_FILENAME
                ht(MIME_TYPE) = _DOCUMENTS.PropertyNames.MIME_TYPE
                ht(DESCRIPTION) = _DOCUMENTS.PropertyNames.DESCRIPTION
                ht(KEYWORDS) = _DOCUMENTS.PropertyNames.KEYWORDS
                ht(UPLOADED_DATE) = _DOCUMENTS.PropertyNames.UPLOADED_DATE
                ht(USER_CODE) = _DOCUMENTS.PropertyNames.USER_CODE
                ht(FILE_SIZE) = _DOCUMENTS.PropertyNames.FILE_SIZE
                ht(PRIVATE_FLAG) = _DOCUMENTS.PropertyNames.PRIVATE_FLAG
                ht(DOCUMENT_TYPE_ID) = _DOCUMENTS.PropertyNames.DOCUMENT_TYPE_ID
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(DOCUMENT_ID) = _DOCUMENTS.ColumnNames.DOCUMENT_ID
                ht(FILENAME) = _DOCUMENTS.ColumnNames.FILENAME
                ht(REPOSITORY_FILENAME) = _DOCUMENTS.ColumnNames.REPOSITORY_FILENAME
                ht(MIME_TYPE) = _DOCUMENTS.ColumnNames.MIME_TYPE
                ht(DESCRIPTION) = _DOCUMENTS.ColumnNames.DESCRIPTION
                ht(KEYWORDS) = _DOCUMENTS.ColumnNames.KEYWORDS
                ht(UPLOADED_DATE) = _DOCUMENTS.ColumnNames.UPLOADED_DATE
                ht(USER_CODE) = _DOCUMENTS.ColumnNames.USER_CODE
                ht(FILE_SIZE) = _DOCUMENTS.ColumnNames.FILE_SIZE
                ht(PRIVATE_FLAG) = _DOCUMENTS.ColumnNames.PRIVATE_FLAG
                ht(DOCUMENT_TYPE_ID) = _DOCUMENTS.ColumnNames.DOCUMENT_TYPE_ID
...
#Region "StringPropertyNames"
    Public Class StringPropertyNames
        ...
        Public Const DOCUMENT_TYPE_ID As String = "s_DOCUMENT_TYPE_ID"
...
#Region "Properties"
    ...
    Public Overridable Property DOCUMENT_TYPE_ID() As Integer
        Get
            Return MyBase.GetInteger(ColumnNames.DOCUMENT_TYPE_ID)
        End Get
        Set(ByVal Value As Integer)
            MyBase.SetInteger(ColumnNames.DOCUMENT_TYPE_ID, Value)
        End Set
    End Property
...
#Region "String Properties"
    ...
    Public Overridable Property s_DOCUMENT_TYPE_ID() As String
        Get
            If Me.IsColumnNull(ColumnNames.DOCUMENT_TYPE_ID) Then
                Return String.Empty
            Else
                Return MyBase.GetIntegerAsString(ColumnNames.DOCUMENT_TYPE_ID)
            End If
        End Get
        Set(ByVal Value As String)
            If String.Empty = value Then
                Me.SetColumnNull(ColumnNames.DOCUMENT_TYPE_ID)
            Else
                Me.DOCUMENT_TYPE_ID = MyBase.SetIntegerAsString(ColumnNames.DOCUMENT_TYPE_ID, Value)
            End If
        End Set
    End Property
...
#Region "TearOff's"
        Public Class TearOffWhereParameter
            ...
            Public ReadOnly Property DOCUMENT_TYPE_ID() As WhereParameter
                Get
                    Dim where As WhereParameter = New WhereParameter(ColumnNames.DOCUMENT_TYPE_ID, Parameters.DOCUMENT_TYPE_ID)
                    Me._clause._entity.Query.AddWhereParemeter(where)
                    Return where
                End Get
            End Property
...
#End Region
        ...
        Public ReadOnly Property DOCUMENT_TYPE_ID() As WhereParameter
            Get
                If _DOCUMENT_TYPE_ID_W Is Nothing Then
                    _DOCUMENT_TYPE_ID_W = TearOff.DOCUMENT_TYPE_ID
                End If
                Return _DOCUMENT_TYPE_ID_W
            End Get
        End Property
        ...
        Private _DOCUMENT_TYPE_ID_W As WhereParameter = Nothing
...
#Region "AggregateParameter TearOff's"
        Public Class TearOffAggregateParameter
            ...
            Public ReadOnly Property DOCUMENT_TYPE_ID() As AggregateParameter
                Get
                    Dim where As AggregateParameter = New AggregateParameter(ColumnNames.DOCUMENT_TYPE_ID, Parameters.DOCUMENT_TYPE_ID)
                    Me._clause._entity.Query.AddAggregateParameter(where)
                    Return where
                End Get
            End Property
...
#End Region
        ...
        Private _DOCUMENT_TYPE_ID_W As AggregateParameter = Nothing
...
#End Region
    ...
    Protected Overrides Function GetInsertCommand() As IDbCommand
        ...
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_DOCUMENTSInsert]"

        CreateParameters(cmd)

        Dim p As SqlParameter
        p = cmd.Parameters(Parameters.DOCUMENT_ID.ParameterName)
    ...
    Protected Overrides Function GetUpdateCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_DOCUMENTSUpdate]"
    ...
    Protected Overrides Function GetDeleteCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_DOCUMENTSDelete]"
    ...
    Private Sub CreateParameters(ByVal cmd As SqlCommand)
        ...
        p = cmd.Parameters.Add(Parameters.REPOSITORY_FILENAME)
        p.SourceColumn = ColumnNames.REPOSITORY_FILENAME
        p.SourceVersion = DataRowVersion.Current

        p = cmd.Parameters.Add(Parameters.MIME_TYPE)
        p.SourceColumn = ColumnNames.MIME_TYPE
        p.SourceVersion = DataRowVersion.Current
        ...
        p = cmd.Parameters.Add(Parameters.UPLOADED_DATE)
        p.SourceColumn = ColumnNames.UPLOADED_DATE
        p.SourceVersion = DataRowVersion.Current
        ...
        p = cmd.Parameters.Add(Parameters.FILE_SIZE)
        p.SourceColumn = ColumnNames.FILE_SIZE
        p.SourceVersion = DataRowVersion.Current

        p = cmd.Parameters.Add(Parameters.PRIVATE_FLAG)
        p.SourceColumn = ColumnNames.PRIVATE_FLAG
        p.SourceVersion = DataRowVersion.Current

        p = cmd.Parameters.Add(Parameters.DOCUMENT_TYPE_ID)
        p.SourceColumn = ColumnNames.DOCUMENT_TYPE_ID
        p.SourceVersion = DataRowVersion.Current
