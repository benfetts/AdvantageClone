...
Public MustInherit Class _EXEC_DESKTOP_DOCUMENTS
	Inherits SqlClientEntity

		Public Sub New() 
			Me.QuerySource = "EXEC_DESKTOP_DOCUMENTS"
			Me.MappingName = "EXEC_DESKTOP_DOCUMENTS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_EXEC_DESKTOP_DOCUMENTSLoadAll]", parameters)
	...
	Public Overridable Function LoadByPrimaryKey(ByVal DOCUMENT_ID As Integer) As Boolean
		...
		parameters.Add(_EXEC_DESKTOP_DOCUMENTS.Parameters.DOCUMENT_ID, DOCUMENT_ID)

		
		Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_EXEC_DESKTOP_DOCUMENTSLoadByPrimaryKey]", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(DOCUMENT_ID) = _EXEC_DESKTOP_DOCUMENTS.PropertyNames.DOCUMENT_ID
				ht(OFFICE_CODE) = _EXEC_DESKTOP_DOCUMENTS.PropertyNames.OFFICE_CODE
                ht(EMP_CODE) = _EXEC_DESKTOP_DOCUMENTS.PropertyNames.EMP_CODE
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(DOCUMENT_ID) = _EXEC_DESKTOP_DOCUMENTS.ColumnNames.DOCUMENT_ID
				ht(OFFICE_CODE) = _EXEC_DESKTOP_DOCUMENTS.ColumnNames.OFFICE_CODE
                ht(EMP_CODE) = _EXEC_DESKTOP_DOCUMENTS.ColumnNames.EMP_CODE
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_EXEC_DESKTOP_DOCUMENTSInsert]" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_EXEC_DESKTOP_DOCUMENTSUpdate]" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_EXEC_DESKTOP_DOCUMENTSDelete]" 
