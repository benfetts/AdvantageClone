...
Public MustInherit Class _JOB_TRAFFIC_DET_PREDS
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "JOB_TRAFFIC_DET_PREDS"
        Me.MappingName = "JOB_TRAFFIC_DET_PREDS"
    End Sub
    ...
    Public Function LoadAll() As Boolean
        ...
        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_JOB_TRAFFIC_DET_PREDSLoadAll]", parameters)
    ...
    Public Overridable Function LoadByPrimaryKey(ByVal ID As Integer) As Boolean
        ...
        parameters.Add(_JOB_TRAFFIC_DET_PREDS.Parameters.ID, ID)


        Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_JOB_TRAFFIC_DET_PREDSLoadByPrimaryKey]", parameters)
...
#Region "Parameters"
    Protected Class Parameters
        ...
        Public Shared ReadOnly Property PREDECESSOR_SEQ_NBR() As SqlParameter
            Get
                Return New SqlParameter("@PREDECESSOR_SEQ_NBR", SqlDbType.SmallInt, 0)
            End Get
        End Property
...
#Region "ColumnNames"
    Public Class ColumnNames
        ...
        Public Const PREDECESSOR_SEQ_NBR As String = "PREDECESSOR_SEQ_NBR"
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(ID) = _JOB_TRAFFIC_DET_PREDS.PropertyNames.ID
                ht(JOB_NUMBER) = _JOB_TRAFFIC_DET_PREDS.PropertyNames.JOB_NUMBER
                ht(JOB_COMPONENT_NBR) = _JOB_TRAFFIC_DET_PREDS.PropertyNames.JOB_COMPONENT_NBR
                ht(SEQ_NBR) = _JOB_TRAFFIC_DET_PREDS.PropertyNames.SEQ_NBR
                ht(PREDECESSOR_SEQ_NBR) = _JOB_TRAFFIC_DET_PREDS.PropertyNames.PREDECESSOR_SEQ_NBR
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(ID) = _JOB_TRAFFIC_DET_PREDS.ColumnNames.ID
                ht(JOB_NUMBER) = _JOB_TRAFFIC_DET_PREDS.ColumnNames.JOB_NUMBER
                ht(JOB_COMPONENT_NBR) = _JOB_TRAFFIC_DET_PREDS.ColumnNames.JOB_COMPONENT_NBR
                ht(SEQ_NBR) = _JOB_TRAFFIC_DET_PREDS.ColumnNames.SEQ_NBR
                ht(PREDECESSOR_SEQ_NBR) = _JOB_TRAFFIC_DET_PREDS.ColumnNames.PREDECESSOR_SEQ_NBR
...
#Region "StringPropertyNames"
    Public Class StringPropertyNames
        ...
        Public Const PREDECESSOR_SEQ_NBR As String = "s_PREDECESSOR_SEQ_NBR"
...
#Region "Properties"
    ...
    Public Overridable Property PREDECESSOR_SEQ_NBR() As Short
        Get
            Return MyBase.GetShort(ColumnNames.PREDECESSOR_SEQ_NBR)
        End Get
        Set(ByVal Value As Short)
            MyBase.SetShort(ColumnNames.PREDECESSOR_SEQ_NBR, Value)
        End Set
    End Property
...
#Region "String Properties"
    ...
    Public Overridable Property s_PREDECESSOR_SEQ_NBR() As String
        Get
            If Me.IsColumnNull(ColumnNames.PREDECESSOR_SEQ_NBR) Then
                Return String.Empty
            Else
                Return MyBase.GetShortAsString(ColumnNames.PREDECESSOR_SEQ_NBR)
            End If
        End Get
        Set(ByVal Value As String)
            If String.Empty = Value Then
                Me.SetColumnNull(ColumnNames.PREDECESSOR_SEQ_NBR)
            Else
                Me.PREDECESSOR_SEQ_NBR = MyBase.SetShortAsString(ColumnNames.PREDECESSOR_SEQ_NBR, Value)
            End If
        End Set
    End Property
...
#Region "TearOff's"
        Public Class TearOffWhereParameter
            ...
            Public ReadOnly Property PREDECESSOR_SEQ_NBR() As WhereParameter
                Get
                    Dim where As WhereParameter = New WhereParameter(ColumnNames.PREDECESSOR_SEQ_NBR, Parameters.PREDECESSOR_SEQ_NBR)
                    Me._clause._entity.Query.AddWhereParemeter(where)
                    Return where
                End Get
            End Property
...
#End Region
        ...
        Public ReadOnly Property PREDECESSOR_SEQ_NBR() As WhereParameter
            Get
                If _PREDECESSOR_SEQ_NBR_W Is Nothing Then
                    _PREDECESSOR_SEQ_NBR_W = TearOff.PREDECESSOR_SEQ_NBR
                End If
                Return _PREDECESSOR_SEQ_NBR_W
            End Get
        End Property
        ...
        Private _PREDECESSOR_SEQ_NBR_W As WhereParameter = Nothing
        ...
        Public Sub WhereClauseReset()
            ...
            _SEQ_NBR_W = Nothing
            _PREDECESSOR_SEQ_NBR_W = Nothing
...
#Region "AggregateParameter TearOff's"
        Public Class TearOffAggregateParameter
            ...
            Public ReadOnly Property PREDECESSOR_SEQ_NBR() As AggregateParameter
                Get
                    Dim where As AggregateParameter = New AggregateParameter(ColumnNames.PREDECESSOR_SEQ_NBR, Parameters.PREDECESSOR_SEQ_NBR)
                    Me._clause._entity.Query.AddAggregateParameter(where)
                    Return where
                End Get
            End Property
...
#End Region
        ...
        Private _PREDECESSOR_SEQ_NBR_W As AggregateParameter = Nothing
...
#End Region
    ...
    Protected Overrides Function GetInsertCommand() As IDbCommand
        ...
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_JOB_TRAFFIC_DET_PREDSInsert]"
    ...
    Protected Overrides Function GetUpdateCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_JOB_TRAFFIC_DET_PREDSUpdate]"
    ...
    Protected Overrides Function GetDeleteCommand() As IDbCommand
        ...
        Dim cmd As SqlCommand = New SqlCommand
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_JOB_TRAFFIC_DET_PREDSDelete]"
    ...
    Private Sub CreateParameters(ByVal cmd As SqlCommand)
        ...
        p = cmd.Parameters.Add(Parameters.PREDECESSOR_SEQ_NBR)
        p.SourceColumn = ColumnNames.PREDECESSOR_SEQ_NBR
        p.SourceVersion = DataRowVersion.Current
