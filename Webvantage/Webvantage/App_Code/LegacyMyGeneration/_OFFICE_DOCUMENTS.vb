...
Public MustInherit Class _OFFICE_DOCUMENTS
	Inherits SqlClientEntity

		Public Sub New() 
			Me.QuerySource = "OFFICE_DOCUMENTS"
			Me.MappingName = "OFFICE_DOCUMENTS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_OFFICE_DOCUMENTSLoadAll]", parameters)
	...
	Public Overridable Function LoadByPrimaryKey(ByVal DOCUMENT_ID As Integer) As Boolean
		...
		parameters.Add(_OFFICE_DOCUMENTS.Parameters.DOCUMENT_ID, DOCUMENT_ID)

		
		Return MyBase.LoadFromSql("[" + Me.SchemaStoredProcedure + "proc_OFFICE_DOCUMENTSLoadByPrimaryKey]", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(DOCUMENT_ID) = _OFFICE_DOCUMENTS.PropertyNames.DOCUMENT_ID
				ht(OFFICE_CODE) = _OFFICE_DOCUMENTS.PropertyNames.OFFICE_CODE
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(DOCUMENT_ID) = _OFFICE_DOCUMENTS.ColumnNames.DOCUMENT_ID
				ht(OFFICE_CODE) = _OFFICE_DOCUMENTS.ColumnNames.OFFICE_CODE
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_OFFICE_DOCUMENTSInsert]" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_OFFICE_DOCUMENTSUpdate]" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As SqlCommand = New SqlCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = "[" + Me.SchemaStoredProcedure + "proc_OFFICE_DOCUMENTSDelete]" 
