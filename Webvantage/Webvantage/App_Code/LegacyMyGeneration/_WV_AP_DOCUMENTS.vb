...
Public MustInherit Class _WV_AP_DOCUMENTS
	Inherits  SqlClientEntity
	
		Public Sub New() 
			Me.QuerySource = "WV_AP_DOCUMENTS"
			Me.MappingName = "WV_AP_DOCUMENTS"
		End Sub
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(AP_ID) = _WV_AP_DOCUMENTS.PropertyNames.AP_ID
				ht(DOCUMENT_ID) = _WV_AP_DOCUMENTS.PropertyNames.DOCUMENT_ID
				ht(FILENAME) = _WV_AP_DOCUMENTS.PropertyNames.FILENAME
				ht(MIME_TYPE) = _WV_AP_DOCUMENTS.PropertyNames.MIME_TYPE
				ht(DESCRIPTION) = _WV_AP_DOCUMENTS.PropertyNames.DESCRIPTION
				ht(KEYWORDS) = _WV_AP_DOCUMENTS.PropertyNames.KEYWORDS
				ht(UPLOADED_DATE) = _WV_AP_DOCUMENTS.PropertyNames.UPLOADED_DATE
				ht(USER_CODE) = _WV_AP_DOCUMENTS.PropertyNames.USER_CODE
				ht(FILE_SIZE) = _WV_AP_DOCUMENTS.PropertyNames.FILE_SIZE
				ht(USER_NAME) = _WV_AP_DOCUMENTS.PropertyNames.USER_NAME
				ht(REPOSITORY_FILENAME) = _WV_AP_DOCUMENTS.PropertyNames.REPOSITORY_FILENAME
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(AP_ID) = _WV_AP_DOCUMENTS.ColumnNames.AP_ID
				ht(DOCUMENT_ID) = _WV_AP_DOCUMENTS.ColumnNames.DOCUMENT_ID
				ht(FILENAME) = _WV_AP_DOCUMENTS.ColumnNames.FILENAME
				ht(MIME_TYPE) = _WV_AP_DOCUMENTS.ColumnNames.MIME_TYPE
				ht(DESCRIPTION) = _WV_AP_DOCUMENTS.ColumnNames.DESCRIPTION
				ht(KEYWORDS) = _WV_AP_DOCUMENTS.ColumnNames.KEYWORDS
				ht(UPLOADED_DATE) = _WV_AP_DOCUMENTS.ColumnNames.UPLOADED_DATE
				ht(USER_CODE) = _WV_AP_DOCUMENTS.ColumnNames.USER_CODE
				ht(FILE_SIZE) = _WV_AP_DOCUMENTS.ColumnNames.FILE_SIZE
				ht(USER_NAME) = _WV_AP_DOCUMENTS.ColumnNames.USER_NAME
				ht(REPOSITORY_FILENAME) = _WV_AP_DOCUMENTS.ColumnNames.REPOSITORY_FILENAME
