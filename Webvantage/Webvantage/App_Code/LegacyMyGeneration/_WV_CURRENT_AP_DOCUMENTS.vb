...
Public MustInherit Class _WV_CURRENT_AP_DOCUMENTS
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "WV_CURRENT_AP_DOCUMENTS"
        Me.MappingName = "WV_CURRENT_AP_DOCUMENTS"
    End Sub
...
#Region "Parameters"
    Protected Class Parameters
        ...
        Public Shared ReadOnly Property AP_ID() As SqlParameter
            Get
                Return New SqlParameter("AP_ID", SqlDbType.Int, 0)
            End Get
        End Property
...
#Region "ColumnNames"
    Public Class ColumnNames
        ...
        Public Const AP_ID As String = "AP_ID"
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(AP_ID) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.AP_ID
                ht(DOCUMENT_ID) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.DOCUMENT_ID
                ht(FILENAME) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.FILENAME
                ht(MIME_TYPE) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.MIME_TYPE
                ht(DESCRIPTION) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.DESCRIPTION
                ht(KEYWORDS) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.KEYWORDS
                ht(UPLOADED_DATE) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.UPLOADED_DATE
                ht(USER_CODE) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.USER_CODE
                ht(FILE_SIZE) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.FILE_SIZE
                ht(USER_NAME) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.USER_NAME
                ht(REPOSITORY_FILENAME) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.REPOSITORY_FILENAME
                ht(DOCUMENT_TYPE_DESC) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.DOCUMENT_TYPE_DESC
                ht(PRIVATE_FLAG) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.PRIVATE_FLAG
                ht(LEVEL) = _WV_CURRENT_AP_DOCUMENTS.PropertyNames.LEVEL
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(AP_ID) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.AP_ID
                ht(DOCUMENT_ID) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.DOCUMENT_ID
                ht(FILENAME) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.FILENAME
                ht(MIME_TYPE) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.MIME_TYPE
                ht(DESCRIPTION) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.DESCRIPTION
                ht(KEYWORDS) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.KEYWORDS
                ht(UPLOADED_DATE) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.UPLOADED_DATE
                ht(USER_CODE) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.USER_CODE
                ht(FILE_SIZE) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.FILE_SIZE
                ht(USER_NAME) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.USER_NAME
                ht(REPOSITORY_FILENAME) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.REPOSITORY_FILENAME
                ht(DOCUMENT_TYPE_DESC) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.DOCUMENT_TYPE_DESC
                ht(PRIVATE_FLAG) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.PRIVATE_FLAG
                ht(LEVEL) = _WV_CURRENT_AP_DOCUMENTS.ColumnNames.LEVEL
...
#Region "StringPropertyNames"
    Public Class StringPropertyNames
        ...
        Public Const AP_ID As String = "s_AP_ID"
...
#Region "Properties"
    Public Overridable Property AP_ID() As Integer
        Get
            Return MyBase.GetInteger(ColumnNames.AP_ID)
        End Get
        Set(ByVal Value As Integer)
            MyBase.SetInteger(ColumnNames.AP_ID, Value)
        End Set
    End Property
...
#Region "String Properties"
    ...
    Public Overridable Property s_AP_ID() As String
        Get
            If Me.IsColumnNull(ColumnNames.AP_ID) Then
                Return String.Empty
            Else
                Return MyBase.GetIntegerAsString(ColumnNames.AP_ID)
            End If
        End Get
        Set(ByVal Value As String)
            If String.Empty = value Then
                Me.SetColumnNull(ColumnNames.AP_ID)
            Else
                Me.AP_ID = MyBase.SetIntegerAsString(ColumnNames.AP_ID, Value)
            End If
        End Set
    End Property
    ...
    Public Overridable Property s_LEVEL() As String
        ...
        Set(ByVal Value As String)
            ...
            Else
                Me.DOCUMENT_TYPE_DESC = MyBase.SetStringAsString(ColumnNames.LEVEL, Value)
            End If
        End Set
    End Property
...
#Region "TearOff's"
        Public Class TearOffWhereParameter
            ...
            Public ReadOnly Property AP_ID() As WhereParameter
                Get
                    Dim where As WhereParameter = New WhereParameter(ColumnNames.AP_ID, Parameters.AP_ID)
...
#End Region
        ...
        Public ReadOnly Property AP_ID() As WhereParameter
            Get
                If _AP_ID_W Is Nothing Then
                    _AP_ID_W = TearOff.AP_ID
                End If
                Return _AP_ID_W
            End Get
        End Property
        ...
        Private _AP_ID_W As WhereParameter = Nothing
...
#Region "AggregateParameter TearOff's"
        Public Class TearOffAggregateParameter
            ...
            Public ReadOnly Property AP_ID() As AggregateParameter
                Get
                    Dim where As AggregateParameter = New AggregateParameter(ColumnNames.AP_ID, Parameters.AP_ID)
...
#End Region
        ...
        Private _AP_ID_W As AggregateParameter = Nothing
