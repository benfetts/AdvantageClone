...
Public MustInherit Class _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS
    Inherits SqlClientEntity

    Public Sub New()
        Me.QuerySource = "WV_CURRENT_EXEC_DESKTOP_DOCUMENTS"
        Me.MappingName = "WV_CURRENT_EXEC_DESKTOP_DOCUMENTS"
    End Sub
    ...
    Public Class ColumnNames
        ...
        Public Shared Function ToPropertyName(ByVal columnName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(OFFICE_CODE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.OFFICE_CODE
                ht(DOCUMENT_ID) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.DOCUMENT_ID
                ht(FILENAME) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.FILENAME
                ht(REPOSITORY_FILENAME) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.REPOSITORY_FILENAME
                ht(MIME_TYPE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.MIME_TYPE
                ht(DESCRIPTION) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.DESCRIPTION
                ht(KEYWORDS) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.KEYWORDS
                ht(UPLOADED_DATE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.UPLOADED_DATE
                ht(USER_CODE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.USER_CODE
                ht(FILE_SIZE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.FILE_SIZE
                ht(USER_NAME) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.USER_NAME
                ht(DOCUMENT_TYPE_DESC) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.DOCUMENT_TYPE_DESC
                ht(PRIVATE_FLAG) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.PRIVATE_FLAG
                ht(LEVEL) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.LEVEL
                ht(EMP_CODE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.PropertyNames.EMP_CODE
    ...
    Public Class PropertyNames
        ...
        Public Shared Function ToColumnName(ByVal propertyName As String) As String
            ...
            If ht Is Nothing Then
                ...
                ht(OFFICE_CODE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.OFFICE_CODE
                ht(DOCUMENT_ID) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.DOCUMENT_ID
                ht(FILENAME) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.FILENAME
                ht(REPOSITORY_FILENAME) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.REPOSITORY_FILENAME
                ht(MIME_TYPE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.MIME_TYPE
                ht(DESCRIPTION) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.DESCRIPTION
                ht(KEYWORDS) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.KEYWORDS
                ht(UPLOADED_DATE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.UPLOADED_DATE
                ht(USER_CODE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.USER_CODE
                ht(FILE_SIZE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.FILE_SIZE
                ht(USER_NAME) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.USER_NAME
                ht(DOCUMENT_TYPE_DESC) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.DOCUMENT_TYPE_DESC
                ht(PRIVATE_FLAG) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.PRIVATE_FLAG
                ht(LEVEL) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.LEVEL
                ht(EMP_CODE) = _WV_CURRENT_EXEC_DESKTOP_DOCUMENTS.ColumnNames.EMP_CODE
