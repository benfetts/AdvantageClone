...
Public MustInherit Class _WV_EXEC_DESKTOP_DOCUMENTS
	Inherits  SqlClientEntity
	
		Public Sub New() 
			Me.QuerySource = "WV_EXEC_DESKTOP_DOCUMENTS"
			Me.MappingName = "WV_EXEC_DESKTOP_DOCUMENTS"
		End Sub
	...
	Protected class Parameters 
        ...
        Public Shared ReadOnly Property EMP_CODE As SqlParameter
            Get
                Return New SqlParameter("EMP_CODE", SqlDbType.VarChar, 4)
            End Get
        End Property
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(OFFICE_CODE) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.OFFICE_CODE
				ht(DOCUMENT_ID) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.DOCUMENT_ID
				ht(FILENAME) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.FILENAME
				ht(REPOSITORY_FILENAME) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.REPOSITORY_FILENAME
				ht(MIME_TYPE) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.MIME_TYPE
				ht(DESCRIPTION) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.DESCRIPTION
				ht(KEYWORDS) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.KEYWORDS
				ht(UPLOADED_DATE) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.UPLOADED_DATE
				ht(USER_CODE) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.USER_CODE
				ht(FILE_SIZE) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.FILE_SIZE
				ht(USER_NAME) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.USER_NAME
                ht(EMP_CODE) = _WV_EXEC_DESKTOP_DOCUMENTS.PropertyNames.EMP_CODE
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(OFFICE_CODE) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.OFFICE_CODE
				ht(DOCUMENT_ID) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.DOCUMENT_ID
				ht(FILENAME) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.FILENAME
				ht(REPOSITORY_FILENAME) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.REPOSITORY_FILENAME
				ht(MIME_TYPE) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.MIME_TYPE
				ht(DESCRIPTION) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.DESCRIPTION
				ht(KEYWORDS) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.KEYWORDS
				ht(UPLOADED_DATE) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.UPLOADED_DATE
				ht(USER_CODE) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.USER_CODE
				ht(FILE_SIZE) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.FILE_SIZE
				ht(USER_NAME) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.USER_NAME
                ht(EMP_CODE) = _WV_EXEC_DESKTOP_DOCUMENTS.ColumnNames.EMP_CODE
