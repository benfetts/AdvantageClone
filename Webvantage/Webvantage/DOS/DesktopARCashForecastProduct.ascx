<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopARCashForecastProduct.ascx.vb"
    Inherits="Webvantage.DesktopARCashForecastProduct" %>
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    ...
    <div class="DO-Container">
        <ew:CollapsablePanel ID="CollapsablePanelFilter" runat="server" TitleText="Filter" Collapsed="true" Visible="false">
            <table id="TableFilterARForecastProduct" width="100%" border="0" cellspacing="2"
                cellpadding="0">
                <tr>
                    <td width="1%">&nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="DivisionDropDownList" runat="server" AutoPostBack="true"
                            width="220">
                        </telerik:RadComboBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ProductDropDownList" runat="server" AutoPostBack="true"
                            width="220">
                        </telerik:RadComboBox>
                    </td>
                </tr>
