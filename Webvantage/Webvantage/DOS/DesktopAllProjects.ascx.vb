Partial Public Class DesktopAllProjects
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            Me.butPrint.Attributes.Add("onclick", "window.open('dtp_myprojects.aspx?type=all&sort=" & Me.DropSort.SelectedValue & "', 'PopLookup','screenX=150,left=150,screenY=150,top=150,width=1000,height=400,scrollbars=yes,resizable=no,menubar=no,maximazable=no');return false;")
            Me.butExport.Attributes.Add("onclick", "window.open('dtp_myprojects.aspx?export=1&type=all&sort=" & Me.DropSort.SelectedValue & "', 'PopLookup','screenX=150,left=150,screenY=150,top=150,width=50,height=50,scrollbars=yes,resizable=no,menubar=no,maximazable=no');return false;")
            'LoadGrid("duedate")
    ...
    Private Sub LoadGrid(ByVal SortBy As String)
        ...
        'Me.ProjectRadGrid.DataSource = oDO.DesktopObject_GetAllProjectsSort(CStr(Session("EmpCode")), SortBy, Me.txtSearch.Text)
    ...
    Private Sub DropSort_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropSort.SelectedIndexChanged
        'Dim oDO As cDesktopObjects = New cDesktopObjects(CStr(Session("ConnString")))
        'Me.ProjectRadGrid.DataSource = oDO.DesktopObject_GetAllProjectsSort(CStr(Session("EmpCode")), DropSort.SelectedValue, Me.txtSearch.Text)
    ...
    Private Sub butRefresh_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles butRefresh.Click
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "AllProjects", "ProjectAllSearch", "", Me.txtSearch.Text)
    ...
    Private Sub imgbtnSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnSearch.Click
        ...
        'LoadGrid(DropSort.SelectedValue)
        ProjectRadGrid.Rebind()
    End Sub

    Private Sub ProjectRadGrid_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles ProjectRadGrid.ItemCommand
    ...
    Private Sub ProjectRadGrid_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles ProjectRadGrid.NeedDataSource
        ...
        SortBy = Me.DropSort.SelectedValue
    ...
    Private Sub ProjectRadGrid_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles ProjectRadGrid.PreRender
        Session("AllProjectsDOSortExp") = Me.ProjectRadGrid.MasterTableView.SortExpressions.GetSortString
    End Sub
    ...
    Private Sub ProjectRadGrid_SortCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridSortCommandEventArgs) Handles ProjectRadGrid.SortCommand
        'LoadGrid(Me.DropSort.SelectedValue)
    End Sub
    ...
    Private Sub ImageButtonBookmark_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButtonBookmark.Click
        Try
            ...
            With b
                ...
                .BookmarkType = AdvantageFramework.Web.Presentation.Bookmarks.BookmarkType.ProjectManagement_Projects
                .UserCode = Session("UserCode")
                .Name = "Projects (All)"
                .Description = "Projects (All)"
