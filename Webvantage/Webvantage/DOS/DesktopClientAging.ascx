<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopClientAging.ascx.vb" Inherits="Webvantage.DesktopClientAging" %>
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    ...
    <div class="DO-Container">
        <ew:CollapsablePanel ID="CollapsablePanelFilter" runat="server" SkinID="CollapsablePanelDesktopObjectFilter" Collapsed="true" Visible="false">
            ...
            <table id="TableFilterClientAging" cellpadding="2"
                cellspacing="0">
                <tr>
                    <td width="60%">
