...
Public Class DesktopEmployeeTimeForecast
        ...
        Try
            ...
            If DropDownListMonth.SelectedValue <> "" AndAlso IsNumeric(DropDownListMonth.SelectedValue) AndAlso
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    ...
                    '                                                                                                                                     "", Me.CheckboxAlternateEmployee.Checked, False, 0, "", RadComboBoxDepartment.SelectedValue, False, False, 0, Me.CheckboxForecastOnly.Checked, _Session.UserCode)
                    ...
                    If Me.RadComboBoxView.SelectedValue = 0 Then
                        If Me.CheckboxSummary.Checked Then
                            ...
                            RadGridEmployeeTimeForcastEmployeeSummary.DataSource = AdvantageFramework.EmployeeTimeForecast.LoadEmployeeTimeForecastDO(DbContext, DropDownListPostPeriodYear.SelectedValue, DropDownListMonth.SelectedValue, RadComboBoxYearTo.SelectedValue, RadComboBoxMonthTo.SelectedValue,
                                                                                                                                                             "", Me.CheckboxAlternateEmployee.Checked, False, 0, "", RadComboBoxDepartment.SelectedValue, False, False,
                    ...
                    ElseIf Me.RadComboBoxView.SelectedValue = 1 Then
                        ...
                        RadGridEmployeeTimeForecastEmployeeutilization.DataSource = AdvantageFramework.EmployeeTimeForecast.LoadEmployeeTimeForecastDO(DbContext, DropDownListPostPeriodYear.SelectedValue, DropDownListMonth.SelectedValue, RadComboBoxYearTo.SelectedValue, RadComboBoxMonthTo.SelectedValue,
                                                                                                                                                         "", 0, False, 0, "", RadComboBoxDepartment.SelectedValue, False, False, Me.RadComboBoxView.SelectedValue, False, _Session.UserCode, False)
                        Try
                            Dim GrpExpr As Telerik.Web.UI.GridGroupByExpression = New Telerik.Web.UI.GridGroupByExpression
                            Dim GrpExpr2 As Telerik.Web.UI.GridGroupByExpression = New Telerik.Web.UI.GridGroupByExpression
                            Dim GrpExpr3 As Telerik.Web.UI.GridGroupByExpression = New Telerik.Web.UI.GridGroupByExpression
                    ...
                    ElseIf Me.RadComboBoxView.SelectedValue = 2 Then
                        ...
                        EmployeeTimeForecastDetail = AdvantageFramework.EmployeeTimeForecast.LoadEmployeeTimeForecastDO(DbContext, DropDownListPostPeriodYear.SelectedValue, DropDownListMonth.SelectedValue, RadComboBoxYearTo.SelectedValue, RadComboBoxMonthTo.SelectedValue,
                                                                                                                                                       "", 0, False, 0, "", RadComboBoxDepartment.SelectedValue, False, False, Me.RadComboBoxView.SelectedValue, 0, _Session.UserCode, False)


                        Dim DatatableByMonth As DataTable
                        DatatableByMonth = New DataTable("ByMonth")

                        DatatableByMonth.Columns.Clear()
                    ...
                    ElseIf Me.RadComboBoxView.SelectedValue = 3 Then
                        ...
                        RadGridEmployeeTimeForecastByClient.DataSource = AdvantageFramework.EmployeeTimeForecast.LoadEmployeeTimeForecastDO(DbContext, DropDownListPostPeriodYear.SelectedValue, DropDownListMonth.SelectedValue, RadComboBoxYearTo.SelectedValue, RadComboBoxMonthTo.SelectedValue,
                                                                                                                                                         "", Me.CheckboxAlternateEmployee.Checked, False, 0, "", RadComboBoxDepartment.SelectedValue, False, False, Me.RadComboBoxView.SelectedValue, Me.CheckboxForecastOnly.Checked, _Session.UserCode, Me.CheckboxSummary.Checked)
                    ...
                    ElseIf Me.RadComboBoxView.SelectedValue = 4 Then
                        ...
                        EmployeeTimeForecastDetail = AdvantageFramework.EmployeeTimeForecast.LoadEmployeeTimeForecastDO(DbContext, DropDownListPostPeriodYear.SelectedValue, DropDownListMonth.SelectedValue, RadComboBoxYearTo.SelectedValue, RadComboBoxMonthTo.SelectedValue,
                                                                                                                                                       "", Me.CheckboxAlternateEmployee.Checked, False, 0, "", RadComboBoxDepartment.SelectedValue, False, False, Me.RadComboBoxView.SelectedValue, 0, _Session.UserCode, Me.CheckboxSummary.Checked)
                    ...
                    Session("AllETF_Month") = DropDownListMonth.SelectedValue
                    Session("AllETF_Year") = DropDownListPostPeriodYear.SelectedValue

                    Session("AllETF_MonthTo") = RadComboBoxMonthTo.SelectedValue
                    Session("AllETF_YearTo") = RadComboBoxYearTo.SelectedValue

                    Session("AllETF_AlternateEmployees") = Me.CheckboxAlternateEmployee.Checked
                    Session("AllETF_Department") = Me.RadComboBoxDepartment.SelectedValue
                    Session("AllETF_JobDetail") = CheckboxIncludeJobDetail.Checked
                    Session("AllETF_ForecastOnly") = CheckboxForecastOnly.Checked
                    Session("AllETF_View") = RadComboBoxView.SelectedValue
                    Session("AllETF_Display") = RadComboBoxDisplay.SelectedValue
                    Session("AllETF_Summary") = CheckboxSummary.Checked
                    Session("AllETF_DO") = "All"
        ...
        Try
            ...
            Try
                If otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "AlternateEmployee") <> "" Then
                    Me.CheckboxAlternateEmployee.Checked = CType(otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "AlternateEmployee"), Boolean)
                End If
            Catch ex As Exception
            ...
            Try
                If otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "ForecastOnly") <> "" Then
                    Me.CheckboxForecastOnly.Checked = CType(otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "ForecastOnly"), Boolean)
                End If
            Catch ex As Exception
            ...
            Try
                If otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "OfficeGroup") <> "" Then
                    Me.CheckBoxOfficeGroup.Checked = CType(otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "OfficeGroup"), Boolean)
                End If
            Catch ex As Exception
            ...
            Try
                If otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "DepartmentGroup") <> "" Then
                    Me.CheckBoxDepartmentGroup.Checked = CType(otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "DepartmentGroup"), Boolean)
                End If
            Catch ex As Exception
            ...
            Try
                If otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "EmployeeGroup") <> "" Then
                    Me.CheckBoxEmployeeGroup.Checked = CType(otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "EmployeeGroup"), Boolean)
                End If
            Catch ex As Exception
            ...
            Try
                If otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "ClientGroup") <> "" Then
                    Me.CheckBoxClientGroup.Checked = CType(otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "ClientGroup"), Boolean)
                End If
            Catch ex As Exception
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "Department")
            If taskVar <> "" Then
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "ETFDisplay")
            If taskVar <> "" Then
    ...
    Private Sub DesktopObject_MyEmployeeTimeForecast_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                ...
                taskVar = otask.getAppVars(Session("UserCode"), "EmployeeTimeForecast", "View")
                If taskVar <> "" Then
...
#Region "  Control Event Handlers "
    ...
    Private Sub CheckboxAlternateEmployee_CheckedChanged(sender As Object, e As EventArgs) Handles CheckboxAlternateEmployee.CheckedChanged
        ...
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "AlternateEmployee", "", Me.CheckboxAlternateEmployee.Checked)
    ...
    Private Sub RadComboBoxDepartment_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles RadComboBoxDepartment.SelectedIndexChanged
        ...
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "Department", "", Me.RadComboBoxDepartment.SelectedValue)
    ...
    Private Sub CheckBoxOfficeGroup_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxOfficeGroup.CheckedChanged
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "OfficeGroup", "", Me.CheckBoxOfficeGroup.Checked)
    ...
    Private Sub CheckBoxDepartmentGroup_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxDepartmentGroup.CheckedChanged
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "DepartmentGroup", "", Me.CheckBoxDepartmentGroup.Checked)
    ...
    Private Sub CheckBoxEmployeeGroup_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxEmployeeGroup.CheckedChanged
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "EmployeeGroup", "", Me.CheckBoxEmployeeGroup.Checked)
    ...
    Private Sub CheckBoxClientGroup_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxClientGroup.CheckedChanged
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "ClientGroup", "", Me.CheckBoxClientGroup.Checked)
    ...
    Private Sub CheckboxForecastOnly_CheckedChanged(sender As Object, e As EventArgs) Handles CheckboxForecastOnly.CheckedChanged
        ...
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "ForecastOnly", "", Me.CheckboxForecastOnly.Checked)
    ...
    Private Sub RadComboBoxView_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles RadComboBoxView.SelectedIndexChanged
        Try
            Dim otask As cTasks = New cTasks(Session("ConnString"))
            otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "View", "", Me.RadComboBoxView.SelectedValue)
    ...
    Private Sub RadComboBoxDisplay_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles RadComboBoxDisplay.SelectedIndexChanged
        ...
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "ETFDisplay", "", Me.RadComboBoxDisplay.SelectedValue)
    ...
    Private Sub CheckboxSummary_CheckedChanged(sender As Object, e As EventArgs) Handles CheckboxSummary.CheckedChanged
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "EmployeeTimeForecast", "Summary", "", Me.CheckboxSummary.Checked)
    ...
    Private Sub ImageButtonBookmark_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButtonBookmark.Click
        Try
            ...
            With b
                ...
                .BookmarkType = AdvantageFramework.Web.Presentation.Bookmarks.BookmarkType.Employee_Time
                .UserCode = Session("UserCode")
                .Name = "Employee Time (All)"
                .Description = "Employee Time (All)"
    ...
    'Private Sub ImageButtonEUTEST_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButtonEUTEST.Click
    '    Try
    '        Dim qs As New AdvantageFramework.Web.QueryString()

    '        qs.Page = "Dashboards/EmployeeUtilization/Index"

    '        Me.OpenWindow("Employee Utilization Dashboard", qs.ToString(True))
    '    Catch ex As Exception
