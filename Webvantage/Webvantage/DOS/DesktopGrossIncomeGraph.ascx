<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopGrossIncomeGraph.ascx.vb"
    Inherits="Webvantage.DesktopGrossIncomeGraph" %>
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    ...
    <div class="DO-Container">
        <telerik:RadHtmlChart ID="RadHtmlChartGrossIncomeGraph" runat="server" Height="400">
