...
Partial Public Class DesktopGrossIncomeGraph
    ...
    Private Sub LoadChart()
        ...
        Try
            DtGraphData = oDO.GetGrossIncome(startPP, endPP, Office, SalesClass, 0, Session("UserCode"), client, 0, Me.CheckboxIncludeManualInvoices.Checked, Me.CheckboxIncludeGLEntries.Checked)
        Catch
        ...
        Try
            ...
            DataSourceList = DataTable.AsEnumerable() _
                                ...
                                .Select(Function(DataRow) New With {.Name = DataRow.Item(NamePosition),
                                                                    ...
                                                                    .ShowLabel = True,
                                                                    .Color = Colors.LoadNextHexColorString()}).ToList
    ...
    Private Sub RadGridGrossIncomeClient_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGridGrossIncomeClient.NeedDataSource
        Try
            ...
            If SalesClass = "All" Then
                SalesClass = ""
            End If
            Me.RadGridGrossIncomeClient.DataSource = oDO.GetGrossIncome(Me.ddPPBegin.SelectedValue, Me.ddPPEnd.SelectedValue, Office, SalesClass, 0, Session("UserCode"), client, 0, Me.CheckboxIncludeManualInvoices.Checked, Me.CheckboxIncludeGLEntries.Checked)
        Catch ex As Exception
    ...
    Private Sub RadGridGrossIncomeCDP_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGridGrossIncomeCDP.NeedDataSource
        Try
            ...
            Me.RadGridGrossIncomeCDP.DataSource = oDO.GetGrossIncome(Me.ddPPBegin.SelectedValue, Me.ddPPEnd.SelectedValue, Office, SalesClass, 0, Session("UserCode"), client, 0, Me.CheckboxIncludeManualInvoices.Checked, Me.CheckboxIncludeGLEntries.Checked)
        Catch ex As Exception
    ...
    Private Sub ImageButtonPrint_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButtonPrint.Click
        ...
        Me.OpenFloatingWindow("Gross Income", qs.ToString(True))
    ...
    Private Sub ImageButtonBookmark_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButtonBookmark.Click
        Try
            ...
            With b
                ...
                .BookmarkType = AdvantageFramework.Web.Presentation.Bookmarks.BookmarkType.FinanceAccounting_GrossIncome
                .UserCode = Session("UserCode")
                .Name = "Gross Income (All)"
                .Description = "Gross Income (All)"
