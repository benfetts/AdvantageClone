<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopInOutBoard.ascx.vb" Inherits="Webvantage.DesktopInOutBoard" %>
...
<div class="DO-ButtonHeader">
    ...
    <div style="padding: 12px 0px 0px 0px; float: right; text-align: right; display: inline-block;">
        Group By:
            <telerik:RadComboBox ID="ddGroupBy" runat="server" AutoPostBack="true" TabIndex="1" width="220">
                <Items>
...
<div class="DO-Container">
    <telerik:RadGrid ID="InOutRadGrid" runat="server" AllowSorting="True" TabIndex="-1"
        AllowPaging="true" PageSize="10" EnableViewState="true" EnableAJAX="True" AutoGenerateColumns="False"
        GridLines="None" EnableEmbeddedSkins="True" Width="100%" GroupingSettings-GroupByFieldsSeparator="  ">
        ...
        <MasterTableView AllowMultiColumnSorting="True" TabIndex="-1" TableLayout="Auto" DataKeyNames="EMP_CODE, INOUT_REF">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DEPT" HeaderText="" UniqueName="GridBoundColumnDepartment" Visible="false" GroupByExpression="DEPT By Group By DEPT">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="OFFICE" HeaderText="" UniqueName="GridBoundColumnOffice" Visible="false" GroupByExpression="OFFICE By Group By OFFICE">
                </telerik:GridBoundColumn>
