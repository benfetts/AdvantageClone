<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopJobRequests.ascx.vb" Inherits="Webvantage.DesktopJobRequests" %>
...
<telerik:RadScriptBlock ID="sbControl_ScriptBlock" runat="server">
    <script type="text/javascript">
        function RadGridJobRequestsColumnPreferencesClick(event) {
            ...
            var grid = $find("<%= RadGridAllJobRequestsDO.ClientID %>");
...
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    ...
    <div class="DO-Container">
        <telerik:RadGrid ID="RadGridAllJobRequestsDO" runat="server" AllowPaging="True" AllowSorting="True"
