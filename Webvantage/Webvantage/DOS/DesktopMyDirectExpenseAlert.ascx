<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopMyDirectExpenseAlert.ascx.vb"
    Inherits="Webvantage.DesktopMyDirectExpenseAlert" %>
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    ...
    <div class="DO-ButtonHeader">
        <div style="float: left; text-align: left; vertical-align: middle; display: inline-block; width: 10%;">
                <asp:ImageButton ID="ImageButtonPrint" runat="server" SkinID="ImageButtonPrint"
                    OnClientClick="window.open('dtp_directExpenseAlert.aspx?from=mydexp', 'PopLookup','screenX=150,left=150,screenY=150,top=150,width=800,height=400,scrollbars=yes,resizable=yes,menubar=no,maximazable=no');return false;" />
    ...
    <div class="DO-Container">
        <telerik:RadGrid ID="DirectExpRadGrid" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            EnableEmbeddedSkins="True" ShowFooter="true">
            ...
            <MasterTableView AllowMultiColumnSorting="True" Width="100%" DataKeyNames="AP_INV_VCHR, VN_FRL_EMP_CODE,AP_ID">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="AMT" Aggregate="Sum" HeaderText="Net Amount"
                        DataFormatString="{0:#,##0.00}" UniqueName="column6">
