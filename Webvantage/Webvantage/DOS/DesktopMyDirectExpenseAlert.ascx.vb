...
Partial Public Class DesktopMyDirectExpenseAlert
    ...
    Private Sub LoadGrid(ByVal ab_bind As Boolean)
        ...
        Me.DirectExpRadGrid.DataSource = oDO.GetDirectExpense(startPP, endPP, Office, amount, Session("UserCode"), "mydexp")
        If ab_bind Then
    ...
    Private Sub ImageButtonBookmark_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButtonBookmark.Click
        Try
            ...
            With b
                ...
                .BookmarkType = AdvantageFramework.Web.Presentation.Bookmarks.BookmarkType.FinanceAccounting_MyDirectExpenseAlert
                .UserCode = Session("UserCode")
                .Name = "Direct Expense Alert (My)"
                .Description = "Direct Expense Alert (My)"
