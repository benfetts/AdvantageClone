<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopMyDirectTime.ascx.vb" Inherits="Webvantage.DesktopMyDirectTime" %>
            ...
            <MasterTableView AllowMultiColumnSorting="true" DataKeyNames="ClientCode,ClientDescription,DivisionCode,DivisionDescription,ProductCode,ProductDescription,Date,JobNumber,JobComponentNumber,Employee,FunctionCode,FunctionDescription, CDPName, JobComponent,JobComponentName" 
                ...
                <%--<GroupByExpressions>
                    <telerik:GridGroupByExpression>
                        <SelectFields>
                            <telerik:GridGroupByField FieldAlias="Client" FieldName="CDPName" />
                            <telerik:GridGroupByField FieldAlias="Job" FieldName="JobComponent" />
                        </SelectFields>
                        <GroupByFields>
                            <telerik:GridGroupByField FieldName="Grouping"/>
                        </GroupByFields>
                    </telerik:GridGroupByExpression>
                    <telerik:GridGroupByExpression>
                        <SelectFields>
                            <telerik:GridGroupByField FieldAlias="Employee" FieldName="Employee" />
                        </SelectFields>
                        <GroupByFields>
                    ...
                    <telerik:GridGroupByExpression>
                        <SelectFields>
                            <telerik:GridGroupByField FieldAlias="Function" FieldName="FunctionDescription" />
                        </SelectFields>
                        <GroupByFields>
                            <telerik:GridGroupByField FieldName="FunctionDescription"/>
                        </GroupByFields>
                    </telerik:GridGroupByExpression>
                </GroupByExpressions>--%>
