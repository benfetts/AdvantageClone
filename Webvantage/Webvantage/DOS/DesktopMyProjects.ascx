<%@ Control AutoEventWireup="false" CodeBehind="DesktopMyProjects.ascx.vb" Inherits="Webvantage.DesktopMyProjects"
    Language="vb" %>
...
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    <div class="DO-ButtonHeader">
        <div style="padding: 12px 0px 0px 0px; float: left; width: 59%; text-align: left;">
        ...
        <div style="padding: 12px 0px 0px 0px; float: right; width: 40%; text-align: right;">
