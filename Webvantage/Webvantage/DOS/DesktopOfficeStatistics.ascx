<%@ Control AutoEventWireup="false" CodeBehind="DesktopOfficeStatistics.ascx.vb"
    EnableViewState="True" Inherits="Webvantage.DesktopOfficeStatistics" Language="vb" %>
...
<div class="DO-Container">
    <ew:CollapsablePanel ID="CollapsablePanelFilter" runat="server" SkinID="CollapsablePanelDesktopObjectFilter" Collapsed="true" Visible="false">
        ...
        <table id='TableFilterOfficeStatistics' align="center" border="0" cellpadding="0" cellspacing="2" width="100%">
            <tr>
                <td>
    ...
    <telerik:RadGrid ID="JobStatsRadGrid" runat="server" AllowSorting="True" AutoGenerateColumns="true" EnableViewState="false"
