...
Partial Public Class DesktopProjectStatisticsGraph
    ...
    Public Sub LoadSelections()
        Try
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sEmployee")
            If taskVar <> "" Then
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sChkClosedStatus")
            If taskVar <> "" Then
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sManager")
            If taskVar <> "" Then
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDropTrafficFunctions")
            If taskVar <> "" Then
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDateStart")
            If taskVar <> "" Then
            ...
            taskVar = otask.getAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDateEnd")
            If taskVar <> "" Then
    ...
    Private Sub butrefresh_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles butrefresh.Click
        Try
            Dim otask As cTasks = New cTasks(Session("ConnString"))
            otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sChkClosedStatus", "", Me.ChkIsClosedStatus.Checked)
            otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sEmployee", "", Me.ddEmployee.SelectedValue)
            otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sManager", "", Me.ddManager.SelectedValue)
            otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDropTrafficFunctions", "", Me.DropTrafficFunctions.SelectedValue)
            otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDateStart", "", Me.RadDatePickerStartDate.SelectedDate)
            otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDateEnd", "", Me.RadDatePickerEndDate.SelectedDate)
            LoadData()
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub DropTrafficFunctions_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles DropTrafficFunctions.SelectedIndexChanged
        Dim otask As cTasks = New cTasks(Session("ConnString"))
        otask.setAppVars(Session("UserCode"), "ProjectStatisticsGraph", "sDropTrafficFunctions", "", Me.DropTrafficFunctions.SelectedValue)
        LoadData()
    End Sub
