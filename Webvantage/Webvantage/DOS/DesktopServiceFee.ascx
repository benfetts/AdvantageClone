<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DesktopServiceFee.ascx.vb" Inherits="Webvantage.DesktopServiceFee" %>
<div class="telerik-aqua-body" style="margin-top: 5px!important;">
    ...
    <div class="DO-Container">
        <telerik:RadHtmlChart ID="RadHtmlChartServiceFees" runat="server" Height="350">
    ...
    <telerik:RadScriptBlock ID="RadScriptBlockFooter" runat="server">
        ...
        <script type="text/javascript">
           ...
           <%-- $(window).resize(function () {
                $find('<%= RadHtmlChartServiceFees.ClientID%>').get_kendoWidget().resize();
            });--%>
        </script>
