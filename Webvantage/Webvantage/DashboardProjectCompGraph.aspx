<%@ Page AutoEventWireup="false" CodeBehind="DashboardProjectCompGraph.aspx.vb" Inherits="Webvantage.DashboardProjectCompGraph"
...
<asp:Content ID="ContentDashboard" runat="server" ContentPlaceHolderID="ContentPlaceHolderMain">
    ...
    <style type="text/css">
        svg > g > g:nth-child(3) > g:nth-child(4) > g:nth-child(1) > g > g  {
            cursor: pointer;
        }
    </style>
