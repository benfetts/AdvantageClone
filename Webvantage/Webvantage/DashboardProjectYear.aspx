<%@ Page AutoEventWireup="false" CodeBehind="DashboardProjectYear.aspx.vb" Inherits="Webvantage.DashboardProjectYear"
...
<asp:Content ID="ContentDashboard" runat="server" ContentPlaceHolderID="ContentPlaceHolderMain">
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td align="center" valign="top" colspan="2">
                                                    <asp:PlaceHolder ID="PlaceHolderGraph" runat="server" EnableViewState="false"></asp:PlaceHolder>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <telerik:RadGrid ID="RadGridYear" runat="server" AutoGenerateColumns="false" GridLines="None"
                                            AllowSorting="true" Visible="false" EnableEmbeddedSkins="True" HorizontalAlign="Center"
                                            ShowFooter="true">
    ...
    <style type="text/css">
        svg > g > g:nth-child(3) > g:nth-child(4) {
            cursor: pointer;
        }
    </style>
