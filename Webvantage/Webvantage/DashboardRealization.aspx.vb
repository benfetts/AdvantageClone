...
#Region " Page Functions "
    ...
    Private Sub DashboardRealization_Init(sender As Object, e As EventArgs) Handles Me.Init

        Dim Dashboard As Webvantage.cDashboard = Nothing

        Dashboard = New cDashboard(_Session.ConnectionString, _Session.UserCode)

        Dashboard.InitializeRadialGauge(RadRadialGaugeDirectHoursGoalVsBilledHoursGauge, "")
        Dashboard.InitializeRadialGauge(RadRadialGaugeDirectHoursVsBilledHoursGauge, "")
        Dashboard.InitializeRadialGauge(RadRadialGaugeBillableHoursGoalVsBilledHoursGauge, "")
        Dashboard.InitializeRadialGauge(RadRadialGaugeBillableHoursVsBilledHoursGauge, "")

        Dashboard.InitializeTotalsColumnChart(RadHtmlChartDirectHoursGoalVsBilledHoursChart, "")
        Dashboard.InitializeTotalsColumnChart(RadHtmlChartDirectHoursVsBilledHoursChart, "")
        Dashboard.InitializeTotalsColumnChart(RadHtmlChartBillableHoursGoalVsBilledHoursChart, "")
        Dashboard.InitializeTotalsColumnChart(RadHtmlChartBillableHoursVsBilledHoursChart, "")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            If Me.OfficeCode = "" Then
                Me.Title = "Realization Summary for All Offices\"
            Else
                Me.Title = "Realization Summary for " & Request.QueryString("OName") & "\"
            End If
            If Me.DeptCode = "" Then
            ...
            Select Case e.Item.Value
                ...
                Case "Print"
                    ...
                    For Each rtb As RadToolBarButton In Me.RadToolbarDash.Items
                        ...
                        End If
                    Next
                    Me.OpenWindow("Employee Utilization Print", "DashboardPrint.aspx?From=dashreal&EmpCode=" & EmpCode & "&EmpName=" & empname & "&month=" & month & "&year=" & year & "&include=" & include & "&Office=" & Me.OfficeCode & "&Dept=" & Me.DeptCode & "&billed=" & period & "&OName=" & officename & "&DName=" & deptname & "&Data=" & dash & "&yValue=" & yearValue & "&monthCount=" & count & "&month2=" & month2)
                Case Else
                    Dim y As String
                    Dim m As String
...
#Region " Functions "
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            'ds = dash.GetDirectHoursWithBilled(EmpCode, 1, month, year, Me.OfficeCode, Me.DeptCode, period)
            ...
            'ds = dash.GetBilledHoursWithBillable(EmpCode, 1, month, year, Me.OfficeCode, Me.DeptCode, period)
            ...
            ds = dash.GetBilledHoursWithGoal(EmpCode, 0, month, year, include, Me.OfficeCode, Me.DeptCode, period, Me.yearValue, Session("UserCode"), month2, count)
            Session("ds_DASH_BilledvsGoal") = ds
            'ds = dash.GetBilledHoursWithGoal(EmpCode, 1, month, year, include, Me.OfficeCode, Me.DeptCode, period, Me.yearValue)
    ...
    Private Sub CreateGauges()
        ...
        CreateGauge(RadRadialGaugeDirectHoursGoalVsBilledHoursGauge, Session("ds_DASH_DirectGoalvsBilledGauge"), "", "directgoal")
        CreateGauge(RadRadialGaugeDirectHoursVsBilledHoursGauge, Session("ds_DASH_BilledvsDirectGauge"), "", "directbilled")
        CreateGauge(RadRadialGaugeBillableHoursGoalVsBilledHoursGauge, Session("ds_DASH_BilledvsGoalGauge"), "", "billedgoal")
        CreateGauge(RadRadialGaugeBillableHoursVsBilledHoursGauge, Session("ds_DASH_BilledvsBillableGauge"), "", "billedbillable")
    ...
    Private Sub CreateCharts()
        ...
        CreateChart(RadHtmlChartDirectHoursGoalVsBilledHoursChart, Session("ds_DASH_DirectGoalvsBilled"), "", "directgoalbilled")
        CreateChart(RadHtmlChartDirectHoursVsBilledHoursChart, Session("ds_DASH_BilledvsDirect"), "", "billed")
        CreateChart(RadHtmlChartBillableHoursGoalVsBilledHoursChart, Session("ds_DASH_BilledvsGoal"), "", "billedgoal")
        CreateChart(RadHtmlChartBillableHoursVsBilledHoursChart, Session("ds_DASH_BilledvsBillable"), "", "billable")
