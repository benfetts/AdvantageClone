<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Documents_PDFViewer.aspx.vb"
    Inherits="Webvantage.Documents_PDFViewer" MasterPageFile="~/ChildPage.Master" Title="" %>
...
<asp:Content ID="ContentDocumentViewer" ContentPlaceHolderID="ContentPlaceHolderMain"
    ...
    <telerik:RadToolBar ID="RadToolBarDocumentViewer" runat="server" AutoPostBack="true"
        ...
        <Items>
            ...
            <telerik:RadToolBarButton ID="RadToolBarButtonDigitallySign" runat="server" Text="Digitally Sign"
                Value="DigitallySign" ToolTip="Digitally Sign the PDF"/>
