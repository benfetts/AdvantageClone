Public Class Documents_WordViewer
    ...
    Private Sub LoadQueryStringValues()
        ...
        Try
            ...
            If Request.QueryString("Width") IsNot Nothing Then
                ...
                _Width = CType(Request.QueryString("Width"), Double)
        ...
        Try
            ...
            If Request.QueryString("Height") IsNot Nothing Then
                ...
                _Height = CType(Request.QueryString("Height"), Double)
        ...
        Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
            ...
            If Document IsNot Nothing Then
                ...
                If Document.FileName.ToUpper.EndsWith(".DOC") OrElse Document.FileName.ToUpper.EndsWith(".DOCX") Then
                    ...
                    WordDocument = New Aspose.Words.Document(Folder & Document.FileSystemFileName)
...
#Region "  Form Event Handlers "
    ...
    Private Sub Documents_WordViewer_Init(sender As Object, e As System.EventArgs) Handles Me.Init

        Me.AllowFloat = True

    End Sub
    Private Sub Documents_WordViewer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Me.EventTarget.Contains(RadToolBarDocumentViewer.ID) Then
                ...
                If Me.EventArgument = "1" Then
                    ...
                    Me.Response.Redirect(String.Format("Documents_WordViewer.aspx?DocumentID={0}&PageNumber={1}&Width={2}&Height={3}", _DocumentID, 1, _Width, _Height))

                ElseIf Me.EventArgument = "3" Then

                    Me.Response.Redirect(String.Format("Documents_WordViewer.aspx?DocumentID={0}&PageNumber={1}&Width={2}&Height={3}", _DocumentID, _PageNumber - 1, _Width, _Height))
                ...
                ElseIf Me.EventArgument = "7" Then
                    ...
                    Me.Response.Redirect(String.Format("Documents_WordViewer.aspx?DocumentID={0}&PageNumber={1}&Width={2}&Height={3}", _DocumentID, Session(_DocumentID & "MaxPageNumber"), _Width, _Height))
                ...
                ElseIf Me.EventArgument = "17" Then
                    ...
                    Me.Response.Redirect(String.Format("Documents_WordViewer.aspx?DocumentID={0}&PageNumber={1}&Width={2}&Height={3}", _DocumentID, _PageNumber, _Width, _Height))
