<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Event_Print_HTML.aspx.vb" EnableEventValidation="false"
    Inherits="Webvantage.Event_Print_HTML" %>
                    ...
                    <tr>
                        <td>
                            <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                <asp:Label   ID="LblGroupingTitle" runat="server" Text="" CssClass="Header2"></asp:Label></font>
                        ...
                        <table width="900" border="0" align="center" cellpadding="2" cellspacing="0" style="border-top: #000000 1px solid;border-right: #000000 1px solid; border-left: #000000 1px solid; border-bottom: #000000 1px solid;background-color: #FFFFFF; color: #000000;">
                            <tr>
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">EVENT:</font>
                                </td>
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                            ...
                            <tr id="TrClient" runat="server">
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Client:</font>
                                </td>
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                        <%#Eval("CL_CODE")%>
                            ...
                            <tr id="TrNotes" runat="server">
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Notes:</font>
                                </td>
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                            ...
                            <tr id="TrResource" runat="server">
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Resource:</font>
                                </td>
                                <td align="left" valign="top">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                        <%#Eval("RESOURCE_CODE")%>
                            ...
                            <tr>
                                <td colspan="3" align="left" valign="top" style="border-top: #000000 1px solid; background-color: #FFFFFF;color: #000000;">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Tasks</font><br />
