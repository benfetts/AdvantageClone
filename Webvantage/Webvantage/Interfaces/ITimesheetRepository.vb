...
#Region " Methods "
        ...
        Function ValidateTimesheetEntry(ValidationRequest As TimesheetValidationRequest) As TimesheetValidationResult

        Function ValidateAccountSetupEntry(ValidationRequest As TimesheetValidationRequest) As TimesheetValidationResult
