<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_EmployeeUtilizationReports.aspx.vb"
    Inherits="Webvantage.Reporting_EmployeeUtilizationReports" Title="Employee Utilization Report Templates"
    MasterPageFile="~/ChildPage.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div id="TdRadToolBarDynamicReportTemplates" class="no-float-menu"
                       ">
