<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingARPaymentHistory.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingARPaymentHistory"
        ...
        <div class="form-layout label-left label-l">
            ...
            <ul>
                ...
                <li><asp:RadioButton id="RadioButtonInvoiceDate" runat="server" Text="Invoice Date" GroupName="AgingOption"/>
                    <asp:RadioButton id="RadioButtonInvoiceDueDate" runat="server" Text="Invoice Due Date" GroupName="AgingOption"/></li>
            </ul>
            <ul>
                <li>&nbsp;</li>
                <li><asp:CheckBox id="CheckBoxIncludeOnAccount" runat="server" Text="Include On Account" /></li>
            </ul>
        </div>        
    </div>
    <br />
