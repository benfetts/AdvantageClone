Public Class Reporting_InitialLoadingARPaymentHistory
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoadingARPaymentHistory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.ARPaymentHistoryParameters.StartingPeriodCode.ToString) AndAlso
                        IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.StartingPeriodCode.ToString)) = False Then

                    Try

                        RadComboBoxStart.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.StartingPeriodCode.ToString)
                ...
                If _ParameterDictionary.ContainsKey(AdvantageFramework.Reporting.ARPaymentHistoryParameters.EndingPeriodCode.ToString) AndAlso
                        IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.EndingPeriodCode.ToString)) = False Then

                    Try

                        RadComboBoxEnd.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.EndingPeriodCode.ToString)
                ...
                CheckBoxIncludeOnAccount.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.IncludeOnAccount.ToString)), True, _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.IncludeOnAccount.ToString))
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                If RadComboBoxStart.SelectedValue <= RadComboBoxEnd.SelectedValue Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.StartingPeriodCode.ToString) = RadComboBoxStart.SelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.EndingPeriodCode.ToString) = RadComboBoxEnd.SelectedValue

                    _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.AgingOption.ToString) = If(RadioButtonInvoiceDate.Checked, 1, 0)

                    _ParameterDictionary(AdvantageFramework.Reporting.ARPaymentHistoryParameters.IncludeOnAccount.ToString) = If(CheckBoxIncludeOnAccount.Checked, 1, 0)
