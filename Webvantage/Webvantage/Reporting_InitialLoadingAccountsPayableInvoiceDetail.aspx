<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingAccountsPayableInvoiceDetail.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingAccountsPayableInvoiceDetail"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div style="margin-top: 10px;">
        <div class="form-layout label-left label-l">
            ...
            <ul>
                <li style="vertical-align: top;">Media Option:</li>
                <li><asp:RadioButton id="RadioButtonSummarizeBroadcastByOrder" runat="server" Text="Summarize broadcast by order (exclude order line-month)" GroupName="MediaOption"/><br />
                    <asp:RadioButton id="RadioButtonIncludeBroadcastByOrderLineMonth" runat="server" Text="Include broadcast by order, line-month" GroupName="MediaOption"/></li>
            </ul>
        </div>        
    </div>
    <br />
