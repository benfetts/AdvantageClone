Public Class Reporting_InitialLoadingCRMProspects
    ...
    Private Sub Reporting_InitialLoadingPostPeriod_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            If _ParameterDictionary IsNot Nothing Then
                ...
                CheckBoxIncludeInactive.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.CRMProspectsParameters.IncludeInactiveCDPs.ToString)), True, _ParameterDictionary(AdvantageFramework.Reporting.CRMProspectsParameters.IncludeInactiveCDPs.ToString))

            Else

                CheckBoxIncludeInactive.Checked = False
    ...
    Private Sub RadToolBarDynamicReportInitialLoading_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportInitialLoading.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.CRMProspectsParameters.IncludeInactiveCDPs.ToString) = CheckBoxIncludeInactive.Checked
