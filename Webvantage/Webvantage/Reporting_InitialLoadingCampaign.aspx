<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingCampaign.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingCampaign"
            ...
            <td>
                <table width="99%" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:CheckBox id="CheckBoxIncludeClosed" runat="server" Text="Include Closed" />
                        </td>
                    </tr>
                </table>
            </td>
