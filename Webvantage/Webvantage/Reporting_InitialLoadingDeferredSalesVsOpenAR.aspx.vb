Public Class Reporting_InitialLoadingDeferredSalesVsOpenAR
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoadingSalesJournal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            Me.CheckboxIncludeMedia.Checked = True
    ...
    Private Sub RadToolBarDynamicReportInitialLoading_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportInitialLoading.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.DeferredSalesVsOpenARInitialParameters.PeriodCutoff.ToString) = RadComboBoxEnd.SelectedValue
                _ParameterDictionary(AdvantageFramework.Reporting.DeferredSalesVsOpenARInitialParameters.IncludeMedia.ToString) = If(CheckboxIncludeMedia.Checked, 2, 1)
