<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingEmployeeTimeAnalysis.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingEmployeeTimeAnalysis"
            ...
            <td align="left" valign="top" colspan="2">
                <telerik:RadTabStrip ID="RadTabStripTaskCalendar" runat="server" AutoPostBack="true" MultiPageID="RadMultiPageCalendar"
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab Text="Select Employees" PageViewID="RadPageViewSelectEmployees" Value="3">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
                         ...
                         <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="600px">
                                        <asp:CheckBox ID="CheckBoxIncludeActive" runat="server" Text="Include Active Employees Only" /> 
                                    </td>
                                </tr>
                                <tr><td>&nbsp;</td></tr>
                                <tr>
                                    ...
                                    <td align="left" width="220px" colspan="4">
                                        <asp:RadioButton ID="RadioButtonBillable" runat="server" GroupName="GroupBy" Text="Fee Time as Billable" Checked="true" /> 
                                        <asp:RadioButton ID="RadioButtonNonBillable" runat="server" GroupName="GroupBy" Text="Fee Time as NonBillable" /> 
                                    </td>
                                </tr> 
                        </table>
                     </telerik:RadPageView>
