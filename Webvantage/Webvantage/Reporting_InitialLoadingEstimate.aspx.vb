Public Class Reporting_InitialLoadingEstimate
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoading_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            If _DynamicReportType = AdvantageFramework.Reporting.DynamicReports.EstimateForm Then
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                If RadDatePickerFrom.SelectedDate <= RadDatePickerTo.SelectedDate Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimateParameters.FromDate.ToString) = RadDatePickerFrom.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimateParameters.ToDate.ToString) = RadDatePickerTo.SelectedDate
