Public Class Reporting_InitialLoadingEstimatedAndActualIncome
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoading_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            RadComboBoxCriteria.DataSource = AdvantageFramework.EnumUtilities.GetEnumDataTable(GetType(AdvantageFramework.Reporting.EstimatedAndActualIncomeInitialCriteria), False)
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    RadDatePickerFrom.SelectedDate = _ParameterDictionary(AdvantageFramework.Reporting.ClientPLParameters.StartingPostPeriodCode.ToString)
                ...
                Try
                    ...
                    RadDatePickerTo.SelectedDate = _ParameterDictionary(AdvantageFramework.Reporting.ClientPLParameters.EndingPostPeriodCode.ToString)
            ...
            If _DynamicReportType = AdvantageFramework.Reporting.DynamicReports.EstimatedAndActualIncome Then
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                If RadDatePickerFrom.SelectedDate <= RadDatePickerTo.SelectedDate Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimatedAndActualIncomeParameters.StartDate.ToString) = RadDatePickerFrom.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimatedAndActualIncomeParameters.EndDate.ToString) = RadDatePickerTo.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimatedAndActualIncomeParameters.DateType.ToString) = RadComboBoxCriteria.SelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.EstimatedAndActualIncomeParameters.Standard.ToString) = If(RadioButtonStandard.Checked, 1, 0)
