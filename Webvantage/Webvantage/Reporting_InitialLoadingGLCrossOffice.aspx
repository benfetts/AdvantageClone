<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingGLCrossOffice.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingGLCrossOffice"
            ...
            <telerik:RadMultiPage ID="RadMultiPageCalendar" runat="server" SelectedIndex="0">
                <telerik:RadPageView ID="RadPageViewOptions" runat="server">
                    <div class="form-layout label-left label-l" style="padding: 5px">
                        <ul>
                            <li style="vertical-align: top; width: 100px">Start Period:</li>
                            <li><telerik:RadComboBox ID="RadComboBoxStart" runat="server" AutoPostBack="false" SkinID="RadComboBoxPostPeriodStart"></telerik:RadComboBox></li>
                   ...
                   <div class="form-layout label-left label-l" style="padding: 5px">  
                        <ul>
                            ...
                            <li><telerik:RadComboBox ID="RadComboBoxEnd" runat="server" AutoPostBack="false" SkinID="RadComboBoxPostPeriodStart"></telerik:RadComboBox></li>  
