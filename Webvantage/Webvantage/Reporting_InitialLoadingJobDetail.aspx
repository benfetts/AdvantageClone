<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingJobDetail.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingJobDetail"
                                ...
                                <td>                                
                                    <table width="99%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <telerik:RadDatePicker ID="RadDatePickerCurrentStart" runat="server" AutoPostBack="false" SkinID="RadDatePickerStandard">
                                                    <DateInput DateFormat="d" EmptyMessage="" CssClass="RequiredInput">
                                                        <IncrementSettings InterceptArrowKeys="true" InterceptMouseWheel="true" />
                                                    </DateInput>
                                                </telerik:RadDatePicker>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Employee Time Date Required." ControlToValidate="RadDatePickerEmployeeTimeDate" CssClass="required"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table width="99%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <telerik:RadDatePicker ID="RadDatePickerCurrentEnd" runat="server" AutoPostBack="false" SkinID="RadDatePickerStandard">
                                                    <DateInput DateFormat="d" EmptyMessage="" CssClass="RequiredInput">
                                                        <IncrementSettings InterceptArrowKeys="true" InterceptMouseWheel="true" />
                                                    </DateInput>
                                                </telerik:RadDatePicker>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Income Only Date Required." ControlToValidate="RadDatePickerIncomeOnlyDate" CssClass="required"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>                              
                                    <table width="99%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <telerik:RadComboBox ID="RadComboBoxCurrentPeriod" runat="server" AutoPostBack="false" SkinID="RadComboBoxPostPeriod" CssClass="RequiredInput"></telerik:RadComboBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>                                
                                    <table width="99%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                            <td colspan="2">                                            
                                               <asp:CheckBox ID="CheckBoxIncludeBilledRange" runat="server" AutoPostBack="true" Checked="false" Text="Include Only for Range" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>                                
                                    <table width="99%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                            <td width="20%">
                                                 Starting Post Period:
                                            </td>
                                            <td width="60%">
                                                <telerik:RadComboBox ID="RadComboBoxStartingPostPeriod" runat="server" AutoPostBack="false" SkinID="RadComboBoxPostPeriod"></telerik:RadComboBox>
                                                &nbsp;&nbsp;
                                                <telerik:RadButton ID="RadButtonYTDBilled" runat="server" AutoPostBack="true" ButtonType="StandardButton" Text="YTD" Width="60"></telerik:RadButton>
                                                &nbsp;&nbsp;
                                                <telerik:RadButton ID="RadButton1YearBilled" runat="server" AutoPostBack="true" ButtonType="StandardButton" Text="1 Year" Width="60"></telerik:RadButton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>                                
                                    <table width="99%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <telerik:RadComboBox ID="RadComboBoxEndingPostPeriod" runat="server" AutoPostBack="false" SkinID="RadComboBoxPostPeriod"></telerik:RadComboBox>
                                                &nbsp;&nbsp;
                                                <telerik:RadButton ID="RadButtonMTDBilled" runat="server" AutoPostBack="true" ButtonType="StandardButton" Text="MTD" Width="60"></telerik:RadButton>
                                                &nbsp;&nbsp;
                                                <telerik:RadButton ID="RadButton2YearBilled" runat="server" AutoPostBack="true" ButtonType="StandardButton" Text="2 Year" Width="60"></telerik:RadButton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
