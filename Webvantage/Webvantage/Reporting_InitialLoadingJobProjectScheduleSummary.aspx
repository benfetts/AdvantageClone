<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingJobProjectScheduleSummary.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingJobProjectScheduleSummary"
                ...
                <telerik:RadPageView ID="RadPageViewOptions" runat="server">
                    <table align="center" border="0" cellpadding="0" cellspacing="0" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="CheckBoxInlcudeClosedJobs" runat="server" AutoPostBack="false"
                                    Checked="false" Text="Include Closed Jobs" Visible="true" />
                            </td>
                        </tr>
                    </table>                        
                </telerik:RadPageView>
