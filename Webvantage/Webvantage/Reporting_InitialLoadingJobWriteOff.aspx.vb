Public Class Reporting_InitialLoadingJobWriteOff
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    RadComboBoxStart.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.StartingPostPeriodCode.ToString)
                ...
                Try
                    ...
                    RadComboBoxEnd.SelectedValue = _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.EndingPostPeriodCode.ToString)

                Catch ex As Exception

                End Try

                CheckBoxEmployeeTime.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeEmployeeTime.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeEmployeeTime.ToString) = 1, True, False)
                CheckBoxVendor.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeVendor.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeVendor.ToString) = 1, True, False)
                CheckBoxIncomeOnly.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeIncomeOnly.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeIncomeOnly.ToString) = 1, True, False)
                CheckBoxGroupByComponent.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.GroupByComponent.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.GroupByComponent.ToString) = 1, True, False)


            Else

                CheckBoxEmployeeTime.Checked = True
                CheckBoxVendor.Checked = True
                CheckBoxIncomeOnly.Checked = True
                CheckBoxGroupByComponent.Checked = False
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                If RadComboBoxStart.SelectedValue <= RadComboBoxEnd.SelectedValue Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.StartingPostPeriodCode.ToString) = RadComboBoxStart.SelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.EndingPostPeriodCode.ToString) = RadComboBoxEnd.SelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeEmployeeTime.ToString) = Me.CheckBoxEmployeeTime.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeVendor.ToString) = Me.CheckBoxVendor.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.IncludeIncomeOnly.ToString) = Me.CheckBoxIncomeOnly.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.JobWriteOffParameters.GroupByComponent.ToString) = Me.CheckBoxGroupByComponent.Checked
