Public Class Reporting_InitialLoadingMediaPlan
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoadingMediaPlan_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub RadToolBarDynamicReportInitialLoading_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportInitialLoading.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.ClientPLParameters.BroadcastDates.ToString) = RadioButtonBroadcast.Checked
