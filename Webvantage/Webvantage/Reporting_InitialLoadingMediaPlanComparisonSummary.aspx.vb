Public Class Reporting_InitialLoadingMediaPlanComparisonSummary
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoadingMediaPlanComparisonSummary_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    RadNumericTextBoxFromYear.Value = _ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.StartYear.ToString)
                ...
                Try
                    ...
                    RadNumericTextBoxToYear.Value = _ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.EndYear.ToString)
...
#Region "  Control Event Handlers "
    ...
    Private Sub RadToolBarDynamicReportInitialLoading_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportInitialLoading.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.StartDate.ToString) = CDate(RadComboBoxFromMonth.SelectedValue & "/01/" & RadNumericTextBoxFromYear.Value)
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.StartYear.ToString) = RadNumericTextBoxFromYear.Value
                _ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.EndDate.ToString) = DateAdd(DateInterval.Day, -1, DateAdd(DateInterval.Month, 1, CDate(RadComboBoxToMonth.SelectedValue & "/01/" & RadNumericTextBoxToYear.Value))) ' CDate(RadComboBoxToMonth.SelectedValue & "/01/" & RadNumericTextBoxToYear.Value)
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.MediaCurrentStatusParameters.EndYear.ToString) = RadNumericTextBoxToYear.Value
    ...
    Private Sub RadioButtonBroadcast_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButtonBroadcast.CheckedChanged
        If RadioButtonBroadcast.Checked = True Then
            LabelDateRange.Text = "Broadcast Month/Year"
        End If
    ...
    Private Sub RadioButtonStandard_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButtonStandard.CheckedChanged
        If RadioButtonStandard.Checked = True Then
            LabelDateRange.Text = "Calendar Month/Year"
        End If
    End Sub
