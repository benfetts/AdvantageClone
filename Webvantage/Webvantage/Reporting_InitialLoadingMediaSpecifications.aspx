<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingMediaSpecifications.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingMediaSpecifications"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <table align="center" border="0" cellpadding="0" cellspacing="0" 
            ...
            <td>
                <table width="99%" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                        ...
                        <td width="90%">
                            <telerik:RadComboBox ID="RadComboBoxStatus" runat="server" AutoPostBack="false"
                                Width="100%" DataTextField="Name" DataValueField="Value">
                            </telerik:RadComboBox>
                        </td>
                    </tr>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBoxAcceptedOnly" runat="server" AutoPostBack="false"
                    Checked="false" Text="Accepted Only"  /><br />
            </td>
        </tr>
    </table>
    <br />
