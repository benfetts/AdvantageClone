Public Class Reporting_InitialLoadingMediaSpecifications
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_InitialLoading_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            RadComboBoxStatus.DataSource = AdvantageFramework.EnumUtilities.GetEnumDataTable(GetType(AdvantageFramework.Reporting.MediaSpecificationStatusCriteria), False, True)
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    RadDatePickerFrom.SelectedDate = _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.FromDate.ToString)
                ...
                Try
                    ...
                    RadDatePickerTo.SelectedDate = _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.ToDate.ToString)

                Catch ex As Exception

                End Try

                CheckBoxAcceptedOnly.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.AcceptedOnly.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.AcceptedOnly.ToString) = 1, True, False)
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                If RadDatePickerFrom.SelectedDate <= RadDatePickerTo.SelectedDate Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.FromDate.ToString) = RadDatePickerFrom.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.ToDate.ToString) = RadDatePickerTo.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.AcceptedOnly.ToString) = Me.CheckBoxAcceptedOnly.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.DateType.ToString) = Me.RadComboBoxCriteria.SelectedValue
                    _ParameterDictionary(AdvantageFramework.Reporting.MediaSpecificationParameters.Status.ToString) = Me.RadComboBoxStatus.SelectedValue
