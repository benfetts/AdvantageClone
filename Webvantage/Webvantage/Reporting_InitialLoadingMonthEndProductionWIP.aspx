<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingMonthEndProductionWIP.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingMonthEndProductionWIP"
        ...
        <div class="form-layout label-left label-l">
            ...
            <telerik:RadMultiPage ID="RadMultiPageCalendar" runat="server" SelectedIndex="0">
                <telerik:RadPageView ID="RadPageViewOptions" runat="server">
                   <div class="form-layout label-left label-l">
                        <ul>
                            <li style="vertical-align: top">End Period:</li>
