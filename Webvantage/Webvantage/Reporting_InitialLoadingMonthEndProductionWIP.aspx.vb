...
Public Class Reporting_InitialLoadingMonthEndProductionWIP
    ...
    Private Sub RadToolBarDynamicReportInitialLoading_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportInitialLoading.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                _ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.EndPeriod.ToString) = RadComboBoxEnd.SelectedValue
                '_ParameterDictionary(AdvantageFramework.Reporting.MonthEndProductionWIPParameters.OrderOption.ToString) = If(RadioButtonOpenOnly.Checked, 2, 1)
