<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingSecurityUserLoginAudit.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingSecurityUserLoginAudit"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <table align="center" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            ...
            <td>
                <table width="99%" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                        <td runat="server" id="tdStart" width="10%">
                            Start:
                        </td>
                        <td>
                            <telerik:RadDatePicker ID="RadDatePickerStart" runat="server" AutoPostBack="true" SkinID="RadDatePickerStandard">
            ...
            <td>
                <table width="99%" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <telerik:RadDatePicker ID="RadDatePickerEnd" runat="server" AutoPostBack="true" SkinID="RadDatePickerStandard">
                            </telerik:RadDatePicker>
                            &nbsp;&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBoxShowOnlyFailures" runat="server" AutoPostBack="false"
                    Checked="false" Text="Show Only Failures" Visible="true" />
            </td>
        </tr>
    </table>
    <br />
