<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_InitialLoadingTransfer.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.Reporting_InitialLoadingTransfer"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <table align="center" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBoxIncludeAP" runat="server" AutoPostBack="false"
                    Checked="false" Text="Include AP"  /><br />
                <asp:CheckBox ID="CheckBoxIncludeEmployeeTime" runat="server" AutoPostBack="false"
                    Checked="false" Text="Include Employee Time"  /><br />
                <asp:CheckBox ID="CheckBoxIncludeIncomeOnly" runat="server" AutoPostBack="false"
                    Checked="false" Text="Include Income Only"  />
            </td>
        </tr>
    </table>
    <br />
