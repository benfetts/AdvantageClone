Public Class Reporting_InitialLoadingTransfer
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            If _ParameterDictionary IsNot Nothing Then
                ...
                Try
                    ...
                    RadDatePickerFrom.SelectedDate = _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.FromDate.ToString)
                ...
                Try
                    ...
                    RadDatePickerTo.SelectedDate = _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.ToDate.ToString)

                Catch ex As Exception

                End Try

                CheckBoxIncludeAP.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeAP.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeAP.ToString) = 1, True, False)
                CheckBoxIncludeEmployeeTime.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeEmployeeTime.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeEmployeeTime.ToString) = 1, True, False)
                CheckBoxIncludeIncomeOnly.Checked = If(IsNothing(_ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeIncomeOnly.ToString)) OrElse _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeIncomeOnly.ToString) = 1, True, False)
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonOK.Value
                ...
                If RadDatePickerFrom.SelectedDate <= RadDatePickerTo.SelectedDate Then
                    ...
                    _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.FromDate.ToString) = RadDatePickerFrom.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.ToDate.ToString) = RadDatePickerTo.SelectedDate
                    _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeAP.ToString) = Me.CheckBoxIncludeAP.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeEmployeeTime.ToString) = Me.CheckBoxIncludeEmployeeTime.Checked
                    _ParameterDictionary(AdvantageFramework.Reporting.TransferParameters.IncludeIncomeOnly.ToString) = Me.CheckBoxIncludeIncomeOnly.Checked
