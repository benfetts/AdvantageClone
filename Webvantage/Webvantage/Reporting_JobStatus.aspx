<%@ Page Title="Job Status Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/ChildPage.Master" CodeBehind="Reporting_JobStatus.aspx.vb" Inherits="Webvantage.Reporting_JobStatus" %>
                                    ...
                                    <tr>
                                        <td>                                    
                                            <asp:CheckBox ID="CheckBoxShowJobsWithNoDetails" runat="server" AutoPostBack="false"
                                                Checked="false" Text="Show Jobs With No Details" /><br />
                                            <asp:CheckBox ID="CheckBoxShowInvoices" runat="server" AutoPostBack="false"
                                                Checked="false" Text="Show Invoices" /><br />        
                                            <asp:CheckBox ID="CheckBoxShowClosedJobs" runat="server" AutoPostBack="false"
                                        ...
                                        <td>
                                            <table width="500px" border="0" cellspacing="2" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <telerik:RadComboBox ID="RadComboBoxCriteria" runat="server" AutoPostBack="true" Width="220px"
