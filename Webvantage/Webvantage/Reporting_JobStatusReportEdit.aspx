<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_JobStatusReportEdit.aspx.vb"
    Inherits="Webvantage.Reporting_JobStatusReportEdit" Title="Job Status Report"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div class="telerik-aqua-body">
        <table align="center" border="0" cellpadding="0" cellspacing="0" 
                width="100%">
                <tr>
                    <td runat="server" id="TdRadToolBarDynamicReportTemplates" align="middle" valign="top"
                        colspan="2">
