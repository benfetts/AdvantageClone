Public Class Reporting_JobStatusReports
    ...
    Private Sub RadToolBarDynamicReportTemplates_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportTemplates.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonAdd.Value
                ...
                Me.OpenWindow("Job Status Report Edit", [String].Format("Reporting_JobStatusReportEdit.aspx"), 0, 0, False, True)
        ...
        Select Case e.CommandName
            ...
            Case "EditReport"
                ...
                If DynamicReportTemplateID > 0 AndAlso DynamicReportType > 0 Then
                    ...
                    Me.OpenWindow("", [String].Format("Reporting_JobStatus.aspx?DynamicReportTemplateID={0}", CurrentGridDataItem.GetDataKeyValue("ID")))
            ...
            Case "ViewReport"
                ...
                If DynamicReportTemplateID > 0 AndAlso DynamicReportType > 0 Then
                    ...
                    Else
                        ...
                        Me.OpenWindow("", [String].Format("Reporting_JobStatus.aspx?DynamicReportTemplateID={0}", DynamicReportTemplateID))
