<%@ Page Title="Job Version Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/ChildPage.Master" CodeBehind="Reporting_JobVersion.aspx.vb" Inherits="Webvantage.Reporting_JobVersion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
    ...
    <style type="text/css">       
        ...
        RadInput_Metro .rcInputCell  {
            height: 32px !important;
        }

        RadInput_Bootstrap .rcInputCell  {
            height: 32px !important;
        }
                ...
                <td colspan="2">
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage" runat="server" SelectedIndex="0" Width="100%">
                        <telerik:RadPageView ID="RadPageViewOptions" runat="server">
                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="wv-form "
                                width="100%">
                                <tr>
                                    <td  style="vertical-align:top;padding-top: 5px"">
                                        <table>
                                            <tr>
                                                <td style="font-size: 14px !important; font-weight: 600; font-family: 'Open Sans', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important;">
                                                    Template:&nbsp;
                                                </td>
                                                <td style="padding-bottom: 3px">
                                                     <telerik:RadComboBox ID="RadComboBoxJobVersionTemplate" runat="server" AutoPostBack="true" SkinID="RadComboBoxStandard"
                                                        DataTextField="Description" DataValueField="Code" Width="450px">
                                                    </telerik:RadComboBox>                                                    
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="CheckBoxShowJobsWithNoDetails" runat="server" AutoPostBack="true"
                                                        Checked="false" Text="Show Closed Jobs" />
                                                </td>
                                            </tr>
                                        </table>                                       
                                    </td>
                                    ...
                                    <td>
                                        <table width="500px" border="0" cellspacing="2" cellpadding="0">
                                            <tr>
                                                <td width="10%" style="padding-top: 5px;font-size: 14px !important; font-weight: 600; font-family: 'Open Sans', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important;">
                                                    Criteria:&nbsp;
                                                </td>
                                                <td colspan="3" style="padding-top: 5px; padding-bottom: 3px">
                                                    <telerik:RadComboBox ID="RadComboBoxCriteria" runat="server" AutoPostBack="true" Width="348px" SkinID="RadComboBoxStandard"
                                                        DataTextField="Name" DataValueField="Value">
                                                    </telerik:RadComboBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="10%" style="font-size: 14px !important; font-weight: 600; font-family: 'Open Sans', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important;">
                                                    From:
                                                </td>
                                                <td width="30%">
                                                    <telerik:RadDatePicker ID="RadDatePickerFrom" runat="server" AutoPostBack="true" SkinID="RadDatePickerStandardOld" Width="220px">
                                                    </telerik:RadDatePicker>
                                                </td>
                                                <td width="11%" style="padding-top: 3px">                                                
                                                    <telerik:RadButton ID="RadButtonYTD" runat="server" AutoPostBack="true" ButtonType="StandardButton" Width="50"
                                                        Text="YTD">
                                                    </telerik:RadButton>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%" style="padding-top: 3px">
                                                    <telerik:RadDatePicker ID="RadDatePickerTo" runat="server" AutoPostBack="true" SkinID="RadDatePickerStandardOld" Width="220px">
                                                    </telerik:RadDatePicker>
                                                </td>
                                                <td width="11%" style="padding-top: 3px">
                                                    <telerik:RadButton ID="RadButtonMTD" runat="server" AutoPostBack="true" ButtonType="StandardButton" Width="50"
                                                        Text="MTD">
                                                    </telerik:RadButton>
                                                </td>
                                                <td style="padding-top: 3px">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel" UpdateMode="Conditional" ChildrenAsTriggers="true">
                <ContentTemplate>
                        <dx:ASPxGridView ID="ASPxGridViewDynamicReport" runat="server" Width="100%" Settings-ShowHorizontalScrollBar="True"
                            ...
                            Settings-ShowGroupFooter="VisibleIfExpanded" EnableCallbackCompression="false" SettingsPager-PageSize="25" SettingsBehavior-AutoExpandAllGroups="false" Settings-ShowFooter="True">
