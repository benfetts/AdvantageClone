Public Class Reporting_JobVersionReportEdit
        ...
        If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
            ...
            Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                ...
                Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    ...
                    Me.RadComboBoxTemplateType.DataSource = AdvantageFramework.Database.Procedures.JobVersionTemplate.LoadAllActive(DbContext).ToList.OrderBy(Function(JobVersionTemplate) JobVersionTemplate.Description).ToList
                    Me.RadComboBoxTemplateType.DataTextField = "Description"
                    Me.RadComboBoxTemplateType.DataValueField = "Code"
                    Me.RadComboBoxTemplateType.DataBind()

                    RadComboBoxTemplateType.SelectedIndex = 0
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonAdd.Value
                ...
                If TextBoxDescription.Text <> "" Then
                    ...
                    If RadComboBoxTemplateType.SelectedIndex > -1 Then
                        ...
                        Try
                            ...
                            Session("DynamicReportTemplateCode") = RadComboBoxTemplateType.SelectedValue
                        ...
                        Me.CloseThisWindowAndOpenNewWindow("Reporting_JobVersion.aspx?From=reportJV", True)
