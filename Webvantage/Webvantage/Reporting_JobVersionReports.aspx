<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporting_JobVersionReports.aspx.vb"
    Inherits="Webvantage.Reporting_JobVersionReports" Title="Report Templates"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div class="telerik-aqua-body">
        <div class="more-info">
                <asp:Label ID="LabelReportCategory" runat="server" Text="Report Category:" style="font-size: 14px !important; font-weight: 600; font-family: 'Open Sans', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important;"></asp:Label>&nbsp;&nbsp;
                <telerik:RadComboBox ID="RadComboBoxReportCategory" runat="server" AutoPostBack="true" CssClass="wv-form"
