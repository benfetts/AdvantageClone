Public Class Reporting_JobVersionReports
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_DynamicReports_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If desc <> "" Then
            Me.PageTitle = desc & " Report Templates"
        End If
...
#Region "  Control Event Handlers "
    ...
    Private Sub RadToolBarDynamicReportTemplates_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportTemplates.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonAdd.Value
                ...
                Me.OpenWindow("Job Version", [String].Format("Reporting_JobVersionReportEdit.aspx"), 0, 0, False, True)
    ...
    Private Sub RadGridDynamicReportTemplates_ItemCommand(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGridDynamicReportTemplates.ItemCommand
        ...
        Dim JobVersionDynamicReport As AdvantageFramework.Reporting.Database.Entities.DynamicReport = Nothing
        ...
        Select Case e.CommandName
            ...
            Case "EditReport"
                ...
                Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                    Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                        If DynamicReportTemplateID > 0 Then
                            JobVersionDynamicReport = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.LoadByDynamicReportID(ReportingDbContext, DynamicReportTemplateID)
                            JobVersionTemplate = AdvantageFramework.Database.Procedures.JobVersionTemplate.LoadByJobVersionTemplateCode(DbContext, JobVersionDynamicReport.TemplateCode)
                            If JobVersionTemplate IsNot Nothing Then
                                If JobVersionTemplate.IsInactive = -1 Then
                                    Me.ShowMessage("The Job Version Template associated with this report is inactive. This report is no longer available.")
                                    Exit Sub
                                End If
                            Else
                                Me.ShowMessage("The Job Version Template associated with this report has been deleted. This report is no longer available.")
                                Exit Sub
                            End If
                        End If
                    End Using
                ...
                If DynamicReportTemplateID > 0 AndAlso DynamicReportType > 0 Then
                    ...
                    Me.OpenWindow("", [String].Format("Reporting_JobVersion.aspx?DynamicReportTemplateID={0}", CurrentGridDataItem.GetDataKeyValue("ID")))
            ...
            Case "ViewReport"
                ...
                If DynamicReportTemplateID > 0 AndAlso DynamicReportType > 0 Then
                    ...
                    If DynamicReportType = AdvantageFramework.Reporting.DynamicReports.DirectIndirectTime OrElse
                            ...
                            DynamicReportType = AdvantageFramework.Reporting.DynamicReports.VendorContracts Then
                    ...
                    ElseIf DynamicReportType = AdvantageFramework.Reporting.DynamicReports.JobProjectScheduleSummary Then
                    ...
                    Else
                        ...
                        Me.OpenWindow("", [String].Format("Reporting_JobVersion.aspx?DynamicReportTemplateID={0}", DynamicReportTemplateID))
