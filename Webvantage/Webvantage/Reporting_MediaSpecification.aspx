<%@ Page Title="Media Specification Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/ChildPage.Master" CodeBehind="Reporting_MediaSpecification.aspx.vb" Inherits="Webvantage.Reporting_MediaSpecification" %>
                        ...
                        <telerik:RadMultiPage ID="RadMultiPage" runat="server" SelectedIndex="0" Width="100%">
                            <telerik:RadPageView ID="RadPageViewOptions" runat="server">
                                <table align="left" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td>&nbsp;&nbsp;Status:&nbsp;<br />
                                            &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="RadioButtonOpenOnly" runat="server" Text="Open Only" GroupName="Open" /><br />
                                            &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="RadioButtonOpenAndClosed" runat="server" Text="Open and Closed" GroupName="Open" />
                                            &nbsp;&nbsp;<asp:CheckBox ID="CheckboxAcceptedOnly" runat="server" Text="Accepted Only" />
                                        </td>
                                        <td width="1%">&nbsp;
                                        </td>
                                        <td>
                                            <table width="500px" border="0" cellspacing="2" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <telerik:RadComboBox ID="RadComboBoxCriteria" runat="server" AutoPostBack="true" Width="270px"
