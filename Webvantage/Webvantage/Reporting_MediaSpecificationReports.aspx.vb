Public Class Reporting_MediaSpecificationReports
    ...
    Private Sub RadToolBarDynamicReportTemplates_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarDynamicReportTemplates.ButtonClick
        ...
        Select Case e.Item.Value
            ...
            Case RadToolBarButtonAdd.Value
                ...
                Me.OpenWindow("", [String].Format("Reporting_MediaSpecificationReportEdit.aspx"), 0, 0, False, True)
        ...
        Select Case e.CommandName
            ...
            Case "EditReport"
                ...
                If DynamicReportTemplateID > 0 AndAlso DynamicReportType > 0 Then
                    ...
                    Me.OpenWindow("", [String].Format("Reporting_MediaSpecification.aspx?DynamicReportTemplateID={0}", CurrentGridDataItem.GetDataKeyValue("ID")))
            ...
            Case "ViewReport"
                ...
                If DynamicReportTemplateID > 0 AndAlso DynamicReportType > 0 Then
                    ...
                    ElseIf DynamicReportType = AdvantageFramework.Reporting.DynamicReports.ProjectScheduleTasksByEmployee Then
                        ...
                        Me.OpenWindow("Job Project Schedule Tasks by Eployee Inital Criteria", String.Format("Reporting_InitialLoadingJobProjectScheduleSummary.aspx?DynamicReportTemplateID={0}", DynamicReportTemplateID), 525, 700, False, True)
                    ...
                    Else
                        ...
                        Me.OpenWindow("", [String].Format("Reporting_MediaSpecification.aspx?DynamicReportTemplateID={0}", DynamicReportTemplateID))
        ...
        Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
            ...
            Using SecurityDbContext = New AdvantageFramework.Security.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                ...
                If UserDefinedReportCategoryID > 0 Then
                    ...
                    RadGridDynamicReportTemplates.DataSource = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Load(ReportingDbContext).Include("UserDefinedReportCategory").ToList.Where(Function(DynamicReport) (DynamicReport.Type = AdvantageFramework.Reporting.DynamicReports.MediaSpecifications OrElse DynamicReport.Type = AdvantageFramework.Reporting.DynamicReports.MediaSpecificationsByDestination)).ToList.Where(Function(Entity) Entity.UserDefinedReportCategoryID.GetValueOrDefault(0) = UserDefinedReportCategoryID).Select(Function(Entity) New AdvantageFramework.Database.Classes.UDReport(Entity)).OrderBy(Function(Entity) Entity.ReportCategory).ThenBy(Function(Entity) Entity.Description).ThenBy(Function(Entity) Entity.DatasetType).ToList

                Else

                    RadGridDynamicReportTemplates.DataSource = AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Load(ReportingDbContext).Include("UserDefinedReportCategory").ToList.Where(Function(DynamicReport) (DynamicReport.Type = AdvantageFramework.Reporting.DynamicReports.MediaSpecifications OrElse DynamicReport.Type = AdvantageFramework.Reporting.DynamicReports.MediaSpecificationsByDestination)).ToList.Select(Function(Entity) New AdvantageFramework.Database.Classes.UDReport(Entity)).OrderBy(Function(Entity) Entity.ReportCategory).ThenBy(Function(Entity) Entity.Description).ThenBy(Function(Entity) Entity.DatasetType).ToList
