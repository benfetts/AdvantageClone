...
#Region " Methods "
            ...
            Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                ...
                Try
                    ...
                    Using SqlCommand = DbContext.CreateCommand()
                        ...
                        SqlCommand.Parameters.AddWithValue("@STARTING_WEEK", RadDatePickerStartingWeek.SelectedDate)
                        SqlCommand.Parameters.AddWithValue("@NUM_WEEKS", Me.RadComboBoxWeek.SelectedValue)
                    ...
                    Session("DynamicReportStartWeek") = RadDatePickerStartingWeek.SelectedDate
                    Session("DynamicReportNumWeeks") = Me.RadComboBoxWeek.SelectedValue
    ...
    Private Sub SaveDynamicReportTemplate(ByRef ReportingDbContext As AdvantageFramework.Reporting.Database.DbContext, ByRef DynamicReport As AdvantageFramework.Reporting.Database.Entities.DynamicReport)
        ...
        If AdvantageFramework.Reporting.Database.Procedures.DynamicReport.Update(ReportingDbContext, DynamicReport) Then
            ...
            Response.Redirect([String].Format("Reporting_Sprint.aspx?From=reportSP&DynamicReportTemplateID={0}", DynamicReport.ID))
    ...
    Private Sub SaveAsDynamicReportTemplate()
        ...
        Me.OpenWindow("Save As", "Reporting_SaveDynamicSprintReportTemplate.aspx", 200, 600)
    ...
    Private Sub SaveReportStateToSession()
        ...
        Try
            ...
            Session("DRPT_Type") = AdvantageFramework.Reporting.DynamicReports.ResourceAllocationByWeek
        ...
        Session("DRPT_SprintStartingWeek") = Me.RadDatePickerStartingWeek.SelectedDate
        Session("DRPT_SprintNumWeeks") = Me.RadComboBoxWeek.SelectedValue
...
#Region "  Form Event Handlers "
    ...
    Private Sub Reporting_Sprint_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            If Not Me.IsPostBack AndAlso Not Me.IsCallback Then
                ...
                If Request.QueryString("From") = "reportSP" Then
                    If Not Session("DynamicReportStartWeek") Is Nothing Then
                        RadDatePickerStartingWeek.SelectedDate = Session("DynamicReportStartWeek")
                    End If
                    If Not Session("DynamicReportNumWeeks") Is Nothing Then
                        Me.RadComboBoxWeek.SelectedValue = Session("DynamicReportNumWeeks")
                    End If
                End If
    ...
    Private Sub Reporting_Sprint_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub Reporting_Sprint_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        Try
            'objects
                ...
                If (Not Me.IsPostBack AndAlso Not Me.IsCallback) Or Me.EventArgument = "Refresh" Then
                    ...
                    If _DynamicReportTemplateID > 0 Then
                        ...
                        Using ReportingDbContext = New AdvantageFramework.Reporting.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                            ...
                            If DynamicReport IsNot Nothing Then
                                ...
                                If Session("SP_FilterReport_FilterString") Is Nothing Then

                                    ASPxGridViewDynamicReport.FilterExpression = DynamicReport.ActiveFilter

                                Else

                                    ASPxGridViewDynamicReport.FilterExpression = Session("SP_FilterReport_FilterString")

                                End If

                                If Session("DRPT_ColumnsListSP") Is Nothing Then
                                ...
                                Else
                                    ...
                                    Try
                                        DRPT_ColumnsList = Session("DRPT_ColumnsListSP")
                                ...
                                Me.Title = "Resource Allocation By Week Report - " & DynamicReport.Description
                    ...
                    Else
                        Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                            ...
                            If Session("DRPT_ColumnsListSP") IsNot Nothing Then
                            ...
                            ElseIf Session("SP_FilterReport_FilterString") IsNot Nothing Then
                        ...
                        Me.Title = "Resource Allocation By Week Report - " & _DynamicReportDescription
        ...
        If TypeOf e.Item Is Telerik.Web.UI.RadToolBarButton Then
            ...
            Select Case DirectCast(e.Item, Telerik.Web.UI.RadToolBarButton).CommandName
                ...
                Case RadToolBarButtonShowFilterEditor.CommandName
                    ...
                    Session("SP_FilterReport_FilterString") = ASPxGridViewDynamicReport.FilterExpression

                    Me.OpenWindow("Filter Report", String.Format("Reporting_FilterReport.aspx?Type=2&From=reportSP&DynamicReportTemplateID={0}", _DynamicReportTemplateID), 525, 1100, False, True)
                ...
                Case RadToolBarButtonCustomizeColumns.CommandName
                    ...
                    Session("DRPT_ColumnsListSP") = DRPT_ColumnsList

                    Me.OpenWindow("Edit Report Columns", String.Format("Reporting_DynamicReportColumnEdit.aspx?From=reportSP&DynamicReportTemplateID={0}", _DynamicReportTemplateID), 525, 575, False, False, "Refresh")
    ...
    Private Sub RadToolBarPrinting_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBarPrinting.ButtonClick
        ...
        Try
            ...
            Using DbContext = New AdvantageFramework.Database.DbContext(_Session.ConnectionString, _Session.UserCode)
                ...
                ASPxGridViewExporter.ReportHeader = "Resource Allocation By Week"

                ASPxGridViewExporter.ReportFooter = _DynamicReportActiveFilter 'DynamicReport.ActiveFilter

                ASPxGridViewExporter.FileName = "Resource Allocation By Week Report"
