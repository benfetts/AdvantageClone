...
Public Class securityappsbygroup
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            'Me.CheckAppAccess("Application Security")
            InitialLoad()
    ...
    Private Sub LoadData(ByVal GroupID As Integer)
        ...
        'drN = oSec.GetAppByGroupForSecurity(GroupID, False)
        ...
        'drA = oSec.GetAppByGroupForSecurity(GroupID, True)
