...
Public Class Security_Calendar
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.PageTitle = "Group Calendar Security"
        ...
        Else
            'Me.CheckAppAccess("Calendar Security")
            LoadData()
        End If
    ...
    Private Sub LoadData()
        ...
        'drN = oSec.GetGroupsByTaskCalAccess(False)
        ...
        'drA = oSec.GetGroupsByTaskCalAccess(True)
