<script type="text/javascript" src="~/JScripts/utilization.filter.mvc.js"></script>
...
<div>
    <ul id="panelbar" style="display:inline-block;position:relative;width:calc(100vw - 18px);min-width:calc(100vw - 18px);">
        <li class="k-state-active" style="position: relative;width:calc(100vw - 18px) !important;">
            ...
            <span id="ClientName" class="k-link k-state-selected" style="position:relative;width:calc(100vw - 45px) !important;font-weight:600;font-size:14px;"> Employee Utilization By Department</span>
