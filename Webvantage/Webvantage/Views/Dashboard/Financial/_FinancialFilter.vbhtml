<script type="text/javascript" src="~/JScripts/financial.dashboard.filter.mvc.js"></script>

<div>
    <ul id="panelbar" style="display:inline-block;position:relative;width:100%;min-width:100%;">
        <li class="k-state-active" style="">
            ...
            <span id="ClientName" class="k-link k-state-selected" style="font-weight:600;font-size:14px;"> Financial Dashboard</span>
        ...
        <td style="width:170px;min-width:170px;margin:4px;padding-right: 60px;">
            ...
            <input id="duedate" title="The Start and End date filters are applied based on the Last Updated date in the grid." style="width: 100px; color: #767676;" />
                        ...
                        <td style="width:100px !important;min-width:100px !important;margin:4px 4px 4px 4px;">
                            <div id="tdFilter">
                                <div style="padding-bottom: 4px; color: #767676;"><span class="glyphicon glyphicon-filter"></span>Office Filter:</div>
                        ...
                        <td style="width:395px;min-width:395px;vertical-align:bottom;">
                            ...
                            <div style="width:365px;float:left;margin:4px 4px 2px 30px;" id="officeFilterContainer" class="display-none">
                                <input type="text" id="officeMS" title="Filter by Office" style="width:365px;" />
                            </div>
...
<script>    
    ...
    $("#officeMS").kendoMultiSelect({   
            ...
            dataSource: new kendo.data.DataSource({
                    transport: {
                        read: {
                            url: "@Url.Content("~/Dashboard/Financial/GetOffices")",
                            data: (() => {                                                                
                            })
                        },
                        dataType: "json"
