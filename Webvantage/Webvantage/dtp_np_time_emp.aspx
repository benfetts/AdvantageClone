<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dtp_np_time_emp.aspx.vb"
    Inherits="Webvantage.dtp_np_time_emp" MasterPageFile="~/ChildPage.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <script type="text/javascript">
            ...
            function PrintRadGrid2() {
                ...
                var htmlcontent = styleStr + "<body>" + window["RadGrid1"].outerHTML + "<br/>" + window["RadGrid2"].outerHTML + "</body></html>";
                htmlcontent = htmlcontent.replace(/<script .*?>(.|\n)*?<\/script>/gi, "");
    ...
    <table align="center" cellpadding="2" cellspacing="0" width="100%">
        ...
        <tr>
            <td colspan="2">
                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" GridLines="None" ClientIDMode="Static" 
    ...
    <table border="0" cellpadding="2" cellspacing="0" width="100%">
        <tr>
            <td>
                <telerik:RadGrid ID="RadGrid2" runat="server" AutoGenerateColumns="False" GridLines="None" ClientIDMode="Static" 
                    EnableEmbeddedSkins="True">
                    <MasterTableView>
                        <Columns>
                            <telerik:GridBoundColumn DataField="EMPLOYEE_NAME" HeaderText="Employee" UniqueName="column1">
