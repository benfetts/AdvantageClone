<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dtp_tasklistPrint.aspx.vb"
    MasterPageFile="~/ChildPage.Master" Inherits="Webvantage.dt_tasklistPrint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <script type="text/javascript">
        function PrintRadGrid() {
            ...
            var htmlcontent = styleStr + "<body>" + window["TasksRG"].outerHTML + "</body></html>";
    ...
    <table border="0" bordercolor="#333399" cellpadding="2" cellspacing="0" width="99%" align="center">
        ...
        <tr>
            <td colspan="8">
                <telerik:RadGrid ID="TasksRG" runat="server" AutoGenerateColumns="False" ClientIDMode="Static" AllowSorting="True"
                    Width="99%">
                    <MasterTableView AllowMultiColumnSorting="True">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="TaskComment" HeaderText="Task Comment" UniqueName="column31">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="HoursAllowed" HeaderText="Hours" UniqueName="column5">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="StartDate" HeaderText="Start" UniqueName="column6"
                                DataFormatString="{0:d}">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="DueDate" HeaderText="Due" UniqueName="column66"
                                DataFormatString="{0:d}">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="DueTime" HeaderText="Due by" UniqueName="column7"
                                ItemStyle-Width="50px">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="TASK_STATUS" UniqueName="column12" HeaderText="Status">
                            </telerik:GridBoundColumn>
